...
export const OH_Print_StartPrintWithJobStateCallback1: () => number;
export const OH_Print_StartPrintWithJobStateCallback2: () => number;
export const OH_Print_StartPrintWithJobStateCallback3: () => number;
...
export const OH_Scan_GetScannerParameter: () => number;
