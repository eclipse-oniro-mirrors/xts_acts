...
export class KeyboardDelegate {
    ...
    function subscriberCallback(err, data) {
      ...
      switch (data.code) {
        ...
        case 120:
          ...
          break;
        case 121:
          console.info(TAG + '====>Sub_Misc_inputMethod_onSelectByMovement_0121 event:' + data.event);
          that.Sub_Misc_inputMethod_onSelectByMovement_0121();
          break;
        case 122:
          console.info(TAG + '====>Sub_Misc_inputMethod_onSelectByMovement_0122 event:' + data.event);
          that.Sub_Misc_inputMethod_onSelectByMovement_0122();
          break;
        case 123:
          console.info(TAG + '====>Sub_Misc_inputMethod_onSelectByMovement_0123 event:' + data.event);
          that.Sub_Misc_inputMethod_onSelectByMovement_0123();
          break;
        case 130:
  ...
  private inputMethodAbility_test_getInputMethodAbility_001(): void {
    ...
    commoneventmanager.publish("inputMethodAbility_test_getInputMethodAbility_001", commonEventPublishData,
  ...
  private inputMethodAbility_test_getKeyboardDelegate_001(): void {
    ...
    commoneventmanager.publish("inputMethodAbility_test_getKeyboardDelegate_001", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async inputMethodAbility_test_038() {
    ...
    let commonEventPublishData;
    this.InputClient.getEditorAttribute((err, Attribute) => {
      if (err) {
        ...
        console.info(TAG + '====>inputMethodAbility_test_038 getEditorAttribute value:' + JSON.stringify(Attribute));
        let value = typeof(Attribute.enterKeyType) === 'number' && typeof(Attribute.inputPattern) === 'number' &&
         typeof(Attribute.isTextPreviewSupported) === 'boolean' && typeof(Attribute.bundleName) === 'string' &&
         typeof(Attribute.immersiveMode) === 'number' && typeof(Attribute.windowId) === 'number' &&
         typeof(Attribute.displayId) === 'number' && typeof(Attribute.placeholder) === 'string' &&
         typeof(Attribute.abilityName) === 'string' && typeof(Attribute.capitalizeMode) === 'number' &&
         typeof(Attribute.gradientMode) === 'number' && typeof(Attribute.extraConfig) === 'object'; 
        console.info(TAG + '====>inputMethodAbility_test_038 getEditorAttribute:' + JSON.stringify(value));
        if (value) {
          commonEventPublishData = {
            data: "SUCCESS"
          };
  ...
  async inputMethodAbility_test_039() {
    ...
    console.info(TAG + '====>inputMethodAbility_test_039 getEditorAttribute value:' + JSON.stringify(Attribute));
    let value = typeof(Attribute.enterKeyType) === 'number' && typeof(Attribute.inputPattern) === 'number' &&
     typeof(Attribute.isTextPreviewSupported) === 'boolean' && typeof(Attribute.bundleName) === 'string' &&
     typeof(Attribute.immersiveMode) === 'number' && typeof(Attribute.windowId) === 'number' &&
     typeof(Attribute.displayId) === 'number' && typeof(Attribute.placeholder) === 'string' &&
     typeof(Attribute.abilityName) === 'string' && typeof(Attribute.capitalizeMode) === 'number' &&
     typeof(Attribute.gradientMode) === 'number' && typeof(Attribute.extraConfig) === 'object'; 
    console.info(TAG + '====>inputMethodAbility_test_039 getEditorAttribute:' + JSON.stringify(value));
    if (value) {
      commonEventPublishData = {
        data: "SUCCESS"
      };
  ...
  async Sub_Misc_inputMethod_onSelectByRange_0110() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_onSelectByRange_0110 selectByRange catch err:' +
      JSON.stringify(err));
    }
  }
  ...
  async Sub_Misc_inputMethod_onSelectByMovement_0120() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_onSelectByMovement_0120 onSelectByMovement catch err:' +
      JSON.stringify(err));
    }
  }

  async Sub_Misc_inputMethod_onSelectByMovement_0121() {
    console.info(TAG + '====>receive Sub_Misc_inputMethod_onSelectByMovement_0121 success');
    let movement = { direction: inputMethodEngine.CURSOR_UP };
    try {
      console.info(TAG + '====>Sub_Misc_inputMethod_onSelectByMovement_0121 onSelectByMovement start');
      await this.InputClient.selectByMovement(movement);
    } catch (err) {
      console.info(TAG + '====>Sub_Misc_inputMethod_onSelectByMovement_0121 onSelectByMovement catch err:' +
      JSON.stringify(err));
    }
  }

  async Sub_Misc_inputMethod_onSelectByMovement_0122() {
    console.info(TAG + '====>receive Sub_Misc_inputMethod_onSelectByMovement_0122 success');
    let movement = { direction: inputMethodEngine.CURSOR_LEFT };
    try {
      console.info(TAG + '====>Sub_Misc_inputMethod_onSelectByMovement_0122 onSelectByMovement start');
      await this.InputClient.selectByMovement(movement);
    } catch (err) {
      console.info(TAG + '====>Sub_Misc_inputMethod_onSelectByMovement_0122 onSelectByMovement catch err:' +
      JSON.stringify(err));
    }
  }

  async Sub_Misc_inputMethod_onSelectByMovement_0123() {
    console.info(TAG + '====>receive Sub_Misc_inputMethod_onSelectByMovement_0123 success');
    let movement = { direction: inputMethodEngine.CURSOR_RIGHT };
    try {
      console.info(TAG + '====>Sub_Misc_inputMethod_onSelectByMovement_0123 onSelectByMovement start');
      await this.InputClient.selectByMovement(movement);
    } catch (err) {
      console.info(TAG + '====>Sub_Misc_inputMethod_onSelectByMovement_0123 onSelectByMovement catch err:' +
      JSON.stringify(err));
    }
  }
  ...
  async Sub_Misc_inputMethod_offSelectByRange_0130() {
    ...
    let t = setInterval(async () => {
      ...
      timeCount += 1;
      console.info(TAG +
        '====>Sub_Misc_inputMethod_offSelectByRange_0130 this.softKeyboardPanel.hide setInterval timeCount: ' +
        timeCount);
      if (timeCount === 2) {
        clearInterval(t);
      }
  ...
  async Sub_Misc_inputMethod_offSelectByMovement_0140() {
    ...
    let t1 = setInterval(async () => {
      ...
      timeCount += 1;
      console.info(TAG +
        '====>Sub_Misc_inputMethod_offSelectByMovement_0140 this.softKeyboardPanel.hide setInterval timeCount: ' +
        timeCount);
      if (timeCount === 2) {
        clearInterval(t1);
      }
  ...
  async Sub_Misc_inputMethod_sendExtendAction_0170() {
    ...
    try {
      this.InputClient.sendExtendAction(inputMethodEngine.ExtendAction.COPY, (err,) => {
        if (err) {
          console.info(TAG + '====>Sub_Misc_inputMethod_sendExtendAction_0170 sendExtendAction err:' +
          JSON.stringify(err));
          commonEventPublishData = {
            data: "FAILED"
          };
        ...
        commoneventmanager.publish("Sub_Misc_inputMethod_sendExtendAction_0170", commonEventPublishData,
          this.publishCallback);
      });
    } catch (err) {
      commonEventPublishData = {
  ...
  async Sub_Misc_inputMethod_sendExtendAction_0180() {
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_sendExtendAction_0180", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_getForward_sync_0200() {
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_getForward_sync_0200", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_getForward_sync_0201() {
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_getForward_sync_0201", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_getBackward_sync_0210() {
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_getBackward_sync_0210", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_getBackward_sync_0211() {
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_getBackward_sync_0211", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_getTextIndexAtCursor_sync_0220() {
    ...
    console.info(TAG + '====>Sub_Misc_inputMethod_getTextIndexAtCursor_sync_0220 getTextIndexAtCursorSync num: ' +
    JSON.stringify(num));
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_getTextIndexAtCursor_sync_0220", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_getTextIndexAtCursor_sync_0221() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_getTextIndexAtCursor_sync_0221 getTextIndexAtCursorSync err: ' +
      JSON.stringify(err));
    }
    commoneventmanager.publish("Sub_Misc_inputMethod_getTextIndexAtCursor_sync_0221", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_getEditorAttribute_sync_0230() {
    ...
    console.info(TAG + '====>Sub_Misc_inputMethod_getEditorAttribute_sync_0230 getEditorAttributeSync enterKeyType: ' +
    JSON.stringify(obj.enterKeyType));
    console.info(TAG + '====>Sub_Misc_inputMethod_getEditorAttribute_sync_0230 getEditorAttributeSync inputPattern: ' +
    JSON.stringify(obj.inputPattern));
    console.info(TAG +
      '====>Sub_Misc_inputMethod_getEditorAttribute_sync_0230 getEditorAttributeSync isTextPreviewSupported: ' +
    JSON.stringify(obj.isTextPreviewSupported));
    if (typeof (obj.enterKeyType) === 'number' && typeof (obj.inputPattern) === 'number' &&
      typeof (obj.isTextPreviewSupported) === 'boolean') {
      commonEventPublishData = {
        data: "SUCCESS"
      };
    }
    commoneventmanager.publish("Sub_Misc_inputMethod_getEditorAttribute_sync_0230", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_getEditorAttribute_sync_0231() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_getEditorAttribute_sync_0231 getEditorAttributeSync err: ' +
      JSON.stringify(err));
    }
  ...
  async Sub_Misc_inputMethod_moveCursor_sync_0241() {
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_moveCursor_sync_0241", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_deleteForward_sync_0250() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_deleteForward_sync_0250 deleteForwardSync err: ' +
      JSON.stringify(err));
    }
    commoneventmanager.publish("Sub_Misc_inputMethod_deleteForward_sync_0250", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_deleteForward_sync_0251() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_deleteForward_sync_0251 deleteForwardSync err: ' +
      JSON.stringify(err));
      if (err.code === 401) {
        commonEventPublishData = {
          data: "SUCCESS"
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_deleteForward_sync_0251", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_deleteBackward_sync_0260() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_deleteBackward_sync_0260 deleteBackwardSync err: ' +
      JSON.stringify(err));
    }
    commoneventmanager.publish("Sub_Misc_inputMethod_deleteBackward_sync_0260", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_deleteBackward_sync_0261() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_deleteBackward_sync_0261 deleteBackwardSync err: ' +
      JSON.stringify(err));
      if (err.code === 401) {
        commonEventPublishData = {
          data: "SUCCESS"
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_deleteBackward_sync_0261", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_insertText_sync_0270() {
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_insertText_sync_0270", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_insertText_sync_0271() {
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_insertText_sync_0271", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_selectByRange_sync_0280() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_selectByRange_sync_0280 selectByRangeSync err: ' +
      JSON.stringify(err));
    }
    commoneventmanager.publish("Sub_Misc_inputMethod_selectByRange_sync_0280", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_selectByRange_sync_0281() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_selectByRange_sync_0281 selectByRangeSync err: ' +
      JSON.stringify(err));
      if (err.code === 401) {
        commonEventPublishData = {
          data: "SUCCESS"
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_selectByRange_sync_0281", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_selectByMovement_sync_0290() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_selectByMovement_sync_0290 selectByMovementSync err: ' +
      JSON.stringify(err));
    }
    commoneventmanager.publish("Sub_Misc_inputMethod_selectByMovement_sync_0290", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_inputMethod_selectByMovement_sync_0291() {
    ...
    try {
      ...
      console.info(TAG + '====>Sub_Misc_inputMethod_selectByMovement_sync_0291 selectByMovementSync err: ' +
      JSON.stringify(err));
      if (err.code === 401) {
        commonEventPublishData = {
          data: "SUCCESS"
    ...
    commoneventmanager.publish("Sub_Misc_inputMethod_selectByMovement_sync_0291", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async Sub_Misc_Request_InputMethod_selectContext_0400() {
    ...
    try {
      this.InputClient.selectByRange(range, (err) => {
        if (err) {
          console.info(TAG + '====>Sub_Misc_Request_InputMethod_selectContext_0400 selectByRange err:' +
          JSON.stringify(err));
          commonEventPublishData = {
            data: "FAILED"
          };
        ...
        commoneventmanager.publish('Sub_Misc_Request_InputMethod_selectContext_0400', commonEventPublishData,
          this.publishCallback);
      });
    } catch (err) {
      commonEventPublishData = {
  ...
  async Sub_Misc_Request_InputMethod_selectContext_0500() {
    ...
    try {
      this.InputClient.selectByRange(range, (err) => {
        if (err) {
          console.info(TAG + '====>Sub_Misc_Request_InputMethod_selectContext_0500 selectByRange err:' +
          JSON.stringify(err));
          commonEventPublishData = {
            data: "SUCCESS"
          };
        ...
        commoneventmanager.publish('Sub_Misc_Request_InputMethod_selectContext_0500', commonEventPublishData,
          this.publishCallback);
      });
    } catch (err) {
      commonEventPublishData = {
  ...
  async Sub_Misc_Request_InputMethod_selectContext_0600() {
    ...
    try {
      this.InputClient.selectByRange(range, (err) => {
        if (err) {
          console.info(TAG + '====>Sub_Misc_Request_InputMethod_selectContext_0600 selectByRange err:' +
          JSON.stringify(err));
          commonEventPublishData = {
            data: "FAILED"
          };
        ...
        commoneventmanager.publish('Sub_Misc_Request_InputMethod_selectContext_0600', commonEventPublishData,
          this.publishCallback);
      });
    } catch (err) {
      commonEventPublishData = {
  ...
  async SUB_InputMethod_IsTextPreviewSupport_0100() {
    ...
    try {
      ...
      console.info(TAG + '====>SUB_InputMethod_IsTextPreviewSupport_0100 setPreviewText catch err: ' +
      JSON.stringify(err));
      if (err.code === 401) {
        commonEventPublishData = {
          data: "SUCCESS"
    ...
    commoneventmanager.publish("SUB_InputMethod_IsTextPreviewSupport_0100", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async SUB_InputMethod_IsTextPreviewSupport_0200() {
    ...
    let range: inputMethodEngine.Range = { start: -1, end: -4 }
    try {
      ...
      console.info(TAG + '====>SUB_InputMethod_IsTextPreviewSupport_0200 setPreviewTextSync catch err:' +
      JSON.stringify(err));
      if (err.code === 401) {
        commonEventPublishData = {
          data: "SUCCESS"
      ...
      commoneventmanager.publish('SUB_InputMethod_IsTextPreviewSupport_0200', commonEventPublishData,
        this.publishCallback);
    }
  }
  ...
  async SUB_InputMethod_IsTextPreviewSupport_0300() {
    ...
    try {
      ...
      console.info(TAG + '====>SUB_InputMethod_IsTextPreviewSupport_0300 finishTextPreview catch err:' +
      JSON.stringify(err));
    }
    commoneventmanager.publish("SUB_InputMethod_IsTextPreviewSupport_0300", commonEventPublishData,
      this.publishCallback);
  }
  ...
  async SUB_InputMethod_IsTextPreviewSupport_0400() {
    ...
    try {
      ...
      console.info(TAG + '====>SUB_InputMethod_IsTextPreviewSupport_0400 finishTextPreviewSync catch err:' +
      JSON.stringify(err));
    }
    commoneventmanager.publish('SUB_InputMethod_IsTextPreviewSupport_0400', commonEventPublishData,
      this.publishCallback);
  }
  ...
  async SUB_InputMethod_IME_PrivateDateTransferred_0500() {
    ...
    try {
      ...
      console.info(TAG + '====>SUB_InputMethod_IME_PrivateDateTransferred_0500 setPreviewTextSync catch err:' +
      JSON.stringify(err));
      ...
      commoneventmanager.publish('SUB_InputMethod_IME_PrivateDateTransferred_0500', commonEventPublishData,
        this.publishCallback);
    }
  }
  ...
  async SUB_InputMethod_IME_PrivateDateTransferred_0600() {
    ...
    try {
      ...
      console.info(TAG + '====>SUB_InputMethod_IME_PrivateDateTransferred_0600 on(privateCommand) err: ' +
      JSON.stringify(err));
    }
    commoneventmanager.publish("SUB_InputMethod_IME_PrivateDateTransferred_0600", commonEventPublishData,
      this.publishCallback);
  }
