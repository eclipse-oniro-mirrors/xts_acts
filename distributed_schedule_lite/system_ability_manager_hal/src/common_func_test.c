 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(CommonTestSuite, testCommon0010, Function | MediumTest | Level2)
{
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(CommonTestSuite, testCommon0020, Function | MediumTest | Level2)
{
    Vector nodeVector = VECTOR_Make((VECTOR_Key)GetNode, (VECTOR_Compare)CompareNode);
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(CommonTestSuite, testCommon0030, Function | MediumTest | Level2)
{
    Vector nodeVector = VECTOR_Make((VECTOR_Key)GetNode, (VECTOR_Compare)CompareNode);
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(CommonTestSuite, testCommon0040, Function | MediumTest | Level2)
{
    Vector nodeVector = VECTOR_Make((VECTOR_Key)GetNode, (VECTOR_Compare)CompareNode);
    Node node[] = {
        {0, "node"},
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(CommonTestSuite, testCommon0050, Function | MediumTest | Level2)
{
    Vector nodeVector = VECTOR_Make((VECTOR_Key)GetNode, (VECTOR_Compare)CompareNode);
    Node node[] = {
        {0, "node"},
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(CommonTestSuite, testCommon0060, Function | MediumTest | Level2)
{
    Vector nodeVector = VECTOR_Make((VECTOR_Key)GetNode, (VECTOR_Compare)CompareNode);
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(CommonTestSuite, testCommon0070, Function | MediumTest | Level2)
{
    Vector nodeVector = VECTOR_Make((VECTOR_Key)GetNode, (VECTOR_Compare)CompareNode);
    Node node = {1, "node1"};
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(CommonTestSuite, testCommon0080, Function | MediumTest | Level2)
{
    Vector nodeVector = VECTOR_Make((VECTOR_Key)GetNode, (VECTOR_Compare)CompareNode);
    Node node = {1, "node1"};
    VECTOR_Add(&nodeVector, &node);
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(CommonTestSuite, testCommon0090, Function | MediumTest | Level2)
{
    Vector nodeVector = VECTOR_Make((VECTOR_Key)GetNode, (VECTOR_Compare)CompareNode);
    Node node = {1, "node1"};
    VECTOR_Add(&nodeVector, &node);
