 ...
 * @tc.level  LEVEL1
 */
LITE_TEST_CASE(Broadcast02TestSuite, testPublish0010, Function | MediumTest | Level1)
{
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(Broadcast02TestSuite, testPublish0020, Function | MediumTest | Level2)
{
    PubSubInterface *fapi = CASE_GetIUnknown();
    if (fapi == NULL) {
        TEST_FAIL();
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(Broadcast02TestSuite, testPublish0030, Function | MediumTest | Level2)
{
    PubSubInterface *fapi = CASE_GetIUnknown();
    if (fapi == NULL) {
        TEST_FAIL();
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(Broadcast02TestSuite, testPublish0050, Function | MediumTest | Level2)
{
    PubSubInterface *fapi = CASE_GetIUnknown();
    if (fapi == NULL) {
        TEST_FAIL();
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(Broadcast02TestSuite, testPublish0060, Function | MediumTest | Level2)
{
    PubSubInterface *fapi = CASE_GetIUnknown();
    if (fapi == NULL) {
        TEST_FAIL();
 ...
 * @tc.level  LEVEL2
 */
LITE_TEST_CASE(Broadcast02TestSuite, testPublish0070, Function | MediumTest | Level2)
{
    PubSubInterface *fapi = CASE_GetIUnknown();
    if (fapi == NULL) {
        TEST_FAIL();
