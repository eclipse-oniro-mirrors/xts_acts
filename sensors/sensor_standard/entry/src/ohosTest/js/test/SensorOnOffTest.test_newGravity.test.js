...
describe("SensorJsTest_sensor_42", function () {
     ...
     * @tc.number SUB_SensorsSystem_NEWGRAVITY_JsTest_0270
     * @tc.desc   Functional Use Cases
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
    ...
    it("newGravity_SensorJsTest027", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        const TAG = 'newGravity_SensorJsTest027'
        try{
            const deviceId = -1;
            const result = sensor.getSingleSensorByDeviceSync(sensor.SensorId.GRAVITY, deviceId);
            if (result.length === 0) {
                ...
                setTimeout(() => {
                    ...
                    sensor.off(sensor.SensorId.GRAVITY, sensorInfoParam, callback);
