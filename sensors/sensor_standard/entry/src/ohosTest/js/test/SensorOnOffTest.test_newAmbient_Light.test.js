...
describe("SensorJsTest_sensor_41", function () {
    ...
    /**
     * @tc.name   newAmbientLight_SensorJsTest025Adapt001
     ...
     * @tc.level  LEVEL3
     */
    it("newAmbientLight_SensorJsTest025Adapt001", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
