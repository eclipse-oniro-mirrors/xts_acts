...
namespace ArkUICapiTest {
    ...
    void SetBackgroundColor1(ArkUI_NodeHandle &node, uint32_t color = COLOR_BLUE)
    {
        if (!nodeAPI) {
            return;
        }
    ...
    void SetCommonAttribute(ArkUI_NodeHandle &node, float width = SIZE_200, float height = SIZE_200,
                            unsigned int color = COLOR_BLUE, float margin = DEFAULT_MARGIN)
    {
    ...
    void SetText(ArkUI_NodeHandle &node, const char *str, float size = SIZE_50)
    {
        ...
        ArkUI_AttributeItem fontItem = {fontSize, PARAM_1};
    ...
    {
        int32_t requestId = PARAM_NEGATIVE_1;
    ...
    void GetTextDragResult(ArkUI_DragEvent* dragEvent)
    {
        ...
        if (operation == ARKUI_DROP_OPERATION_COPY) {
            ...
            SetText(dragText3, "ARKUI_DROP_OPERATION_COPY", SIZE_10);
            ...
            SetText(dragText3, "ARKUI_DROP_OPERATION_MOVE", SIZE_10);
    ...
    void ResetButton(ArkUI_NodeHandle &column)
    {
        ...
        nodeAPI->registerNodeEvent(resetButton, NODE_ON_CLICK_EVENT, PARAM_1, nullptr);
    ...
    napi_value NativeDragDropTest::CreateNativeNode(napi_env env, napi_callback_info info)
    {
        size_t argc = PARAM_1;
        ...
        auto textRow = nodeAPI->createNode(ARKUI_NODE_COLUMN);
        ...
        SetCommonAttribute(dragArea3, SIZE_150, SIZE_50, COLOR_BLUE, SIZE_10);
        ...
        SetText(dragText3, "drag me", SIZE_30);
        nodeAPI->registerNodeEvent(dragText3, NODE_ON_PRE_DRAG, PARAM_1, nullptr);
        nodeAPI->registerNodeEvent(dragText3, NODE_ON_DRAG_START, PARAM_1, nullptr);
        nodeAPI->registerNodeEvent(dragText3, NODE_ON_DRAG_END, PARAM_1, nullptr);
        ...
        SetCommonAttribute(dropArea3, SIZE_150, SIZE_50, COLOR_BLUE, SIZE_10);
        ...
        nodeAPI->registerNodeEvent(dropArea3, NODE_ON_DROP, PARAM_1, nullptr);
