...
#define SUCCESS 401
void EnableDropDisallowedBadgeTest::CreateNativeNode(ani_env *env,ani_object info,ani_object NodeContent) {
  ...
  if (errorCode == SUCCESS) {
    ...
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "Manager","Badge color_item:%{public}d;", color_item);
  }
