...
namespace {
    ...
    std::array<ani_native_function, 4> methods = {
        ani_native_function {"buttonGetTypeTest", testSignature, reinterpret_cast<void *>(ArkUICapiTest::ButtonGetTypeTest::CreateNativeNode)},
        ani_native_function {"dragEventGetDisplayId", testSignature, reinterpret_cast<void *>(ArkUICapiTest::GetDisplayIdTest::CreateNativeNode)},
        ani_native_function {"dragEventGetDragSource", testSignature, reinterpret_cast<void *>(ArkUICapiTest::GetDragSourceTest::CreateNativeNode)},
        ani_native_function {"enableDropDisallowedBadge", testSignature, reinterpret_cast<void *>(ArkUICapiTest::EnableDropDisallowedBadgeTest::CreateNativeNode)}
    };
}
