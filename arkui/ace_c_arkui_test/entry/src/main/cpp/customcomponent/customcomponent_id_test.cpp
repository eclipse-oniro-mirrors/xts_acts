...
ArkUI_NodeHandle CustomComponentIdTest::CreateSubCustomComponentNode(ArkUI_NativeNodeAPI_1 *node_api, const char *id,
                                                                     uint32_t eventId)
{
    float width = PARAM_0_POINT_5;
    float height = PARAM_0_POINT_2;
    ...
    node_api->setAttribute(custom, NODE_WIDTH_PERCENT, &widthItem);
    ...
    node_api->setAttribute(custom, NODE_HEIGHT_PERCENT, &heightItem);
