...
static napi_value TestImageOrientation001(napi_env env, napi_callback_info info)
{
...
static napi_value TestImageOrientation002(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static napi_value TestImageOrientation003(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static napi_value TestImageOrientation004(napi_env env, napi_callback_info info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
