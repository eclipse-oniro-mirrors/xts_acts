...
#ifndef ARKUI_CAPI_XTS_LIST_SCROLL_BAR_COLOR_TEST_H
#define ARKUI_CAPI_XTS_LIST_SCROLL_BAR_COLOR_TEST_H
...
class ListScrollBarColorTest {
public:
    ~ListScrollBarColorTest();
...
#endif  //  ARKUI_CAPI_XTS_LIST_SCROLL_BAR_COLOR_TEST_H