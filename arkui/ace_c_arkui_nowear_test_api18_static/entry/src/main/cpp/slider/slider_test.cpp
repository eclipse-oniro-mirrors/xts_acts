...
static ani_int TestSliderEnableHpaticFeedback001(ani_env* env, ani_object obj)
{
...
static ani_int TestSliderEnableHpaticFeedback002(ani_env* env, ani_object obj)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
    int32_t haptic = true;
...
static ani_int TestSliderEnableHpaticFeedback003(ani_env* env, ani_object obj)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
...
static ani_int TestSliderEnableHpaticFeedback004(ani_env* env, ani_object obj)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
...
static ani_int TestSliderEnableHpaticFeedback005(ani_env* env, ani_object obj)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
