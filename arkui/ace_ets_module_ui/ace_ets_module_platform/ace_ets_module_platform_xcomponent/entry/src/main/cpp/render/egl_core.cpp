...
const GLfloat BACKGROUND_COLOR_TRANSLUCENT[] = {244.0f / 255, 244.0f / 255, 244.0f / 255, 0.5f};
...
const GLfloat DRAW_COLOR_TRANSLUCENT[] = {126.0f / 255, 143.0f / 255, 251.0f / 255, 0.5f};
...
void EGLCore::Draw(int& hasDraw)
{
    ...
    if (!ExecuteDraw(position, BACKGROUND_COLOR_TRANSLUCENT,
                     BACKGROUND_RECTANGLE_VERTICES, sizeof(BACKGROUND_RECTANGLE_VERTICES))) {
    ...
    if (!ExecuteDraw(position, DRAW_COLOR_TRANSLUCENT, shapeVertices, sizeof(shapeVertices))) {
