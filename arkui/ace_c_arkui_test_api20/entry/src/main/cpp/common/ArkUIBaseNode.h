...
protected:
    ...
    virtual void OnAddChild(const std::shared_ptr<ArkUIBaseNode> &child) = 0;
    virtual void OnRemoveChild(const std::shared_ptr<ArkUIBaseNode> &child) = 0;
    virtual void OnInsertChild(const std::shared_ptr<ArkUIBaseNode> &child, int32_t index) = 0;
