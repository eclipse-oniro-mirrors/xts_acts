...
{
    OH_LOG_INFO(LOG_APP, "CustomComponentOnDrawTest");
    if (event == nullptr) {
        OH_LOG_INFO(LOG_APP, "CustomComponentOnDrawTest");
        return;
    }
...
void ArkUIAniTest::CustomComponentOnDrawBehindTest::CreateNativeNode(ani_env* env, ani_object info, ani_object NodeContent)
{
