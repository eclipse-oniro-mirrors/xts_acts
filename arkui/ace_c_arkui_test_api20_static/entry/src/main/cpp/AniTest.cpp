...
namespace {
    ...
    std::array methods = {
        ani_native_function {"testPostOnIdle", testSignature, reinterpret_cast<void *>(ArkUIAniTest::PostOnIdleTest::testPostOnIdle001)},
        ani_native_function {"customComponentOnDrawFrontTest", testSignature, reinterpret_cast<void *>(ArkUIAniTest::CustomComponentOnDrawFrontTest::CreateNativeNode)},
        ani_native_function {"customComponentOnDrawBehindTest", testSignature, reinterpret_cast<void *>(ArkUIAniTest::CustomComponentOnDrawBehindTest::CreateNativeNode)},
        ani_native_function {"testEmbeddedComponentOption", testSignature, reinterpret_cast<void *>(ArkUIAniTest::EmbeddedComponentOptionTest::testEmbeddedComponentOption001)},
        ani_native_function {"uiStatesTest", testSignature, reinterpret_cast<void *>(ArkUIAniTest::UiStatesTest::CreateNativeNode)},
    };
}
