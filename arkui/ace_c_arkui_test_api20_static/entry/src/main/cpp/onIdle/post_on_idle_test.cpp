...
{
    OH_LOG_Print(LOG_APP, LOG_INFO, ArkUIAniTest::LOG_PRINT_DOMAIN, "AddCAPIFrameCallback",
...
void PostOnIdleTest::testPostOnIdle001(ani_env* env, ani_object info, ani_object NodeContent)
{
    OH_LOG_Print(LOG_APP, LOG_INFO, ArkUIAniTest::LOG_PRINT_DOMAIN, "testAddCustomProperty001", "CreateNativeNode");
    ...
    nodeAPI->registerNodeEventReceiver([](ArkUI_NodeEvent *event) {
        ...
        if (targetId == NUMBER_3) {
            ...
            OH_LOG_Print(LOG_APP, LOG_INFO, ArkUIAniTest::LOG_PRINT_DOMAIN, "Manager", "PostOnIdleTest code = %{public}d", a);
        ...
        if (targetId == NUMBER_4) {
            ...
            OH_LOG_Print(LOG_APP, LOG_INFO, ArkUIAniTest::LOG_PRINT_DOMAIN, "Manager", "PostOnIdleTest code = %{public}d", b);
        ...
        if (targetId == NUMBER_5) {
            ...
            OH_LOG_Print(LOG_APP, LOG_INFO, ArkUIAniTest::LOG_PRINT_DOMAIN, "Manager", "PostOnIdleTest code = %{public}d", c);
        ...
        if (targetId == NUMBER_2) {
            ...
            OH_LOG_Print(LOG_APP, LOG_INFO, ArkUIAniTest::LOG_PRINT_DOMAIN, "Manager", "PostOnIdleTest code = %{public}d", d);
