...
function onPushListener(source, template, data, extraData) {
    ...
    var jsonObject = JSON.parseJsonElement(data.componentTemplate.source)
...
export default {
    ...
    Push() {
        ...
        pluginComponentManager.push(
            {
                want: {
                    bundleName: "com.arkui.ace.FrameNodeNoWear.api12",
                    abilityName: "com.arkui.ace.FrameNodeNoWear.api12.MainAbility",
                    "parameters": {
