...
//        ani_native_function {"getContext", nullptr, reinterpret_cast<void *>(PluginManager::GetContext)},
        ani_native_function {"buttonOnHoverEventTest", testSignature, reinterpret_cast<void *>(ArkUICapiTest::ButtonOnHoverEventTest::CreateNativeNode)},
        ani_native_function {"buttonAxisEventTest", testSignature, reinterpret_cast<void *>(ArkUICapiTest::ButtonAxisEventTest::CreateNativeNode)},
        ani_native_function {"buttonRollAngleTest", testSignature, reinterpret_cast<void *>(ArkUICapiTest::ButtonRollAngleTest::CreateNativeNode)},
    };
}
