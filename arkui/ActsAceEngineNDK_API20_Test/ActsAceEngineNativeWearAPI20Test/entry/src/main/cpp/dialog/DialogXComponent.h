...
#ifndef ACTSACEENGINENATIVEAPI20TEST_DIALOGXCOMPONENT_H
#define ACTSACEENGINENATIVEAPI20TEST_DIALOGXCOMPONENT_H
...
#endif //ACTSACEENGINENATIVEAPI20TEST_DIALOGXCOMPONENT_H
