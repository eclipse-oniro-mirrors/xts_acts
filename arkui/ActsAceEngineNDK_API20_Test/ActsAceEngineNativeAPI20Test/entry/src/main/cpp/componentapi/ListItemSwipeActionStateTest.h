 ...
 */
#ifndef ACTSWINDOWNDKAPI20TEST_LISTITEMSWIPEACTIONSTATETEST_H
#define ACTSWINDOWNDKAPI20TEST_LISTITEMSWIPEACTIONSTATETEST_H
...
#endif //ACTSWINDOWNDKAPI20TEST_LISTITEMSWIPEACTIONSTATETEST_H
