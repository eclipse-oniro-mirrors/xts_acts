...
napi_value CreateResource(napi_env env, napi_callback_info info)
{
    ...
    g_nodenapiresult5 = OH_ArkUI_GetDrawableDescriptorFromResourceNapiValue(env, args[0], &drawableDescriptor) ==
...
{
    napi_value retValue;
    napi_create_int32(env, g_nodenapiresult5 ? 0 : 1, &retValue);
    return retValue;
}
...
napi_value GetDrawableDescriptorFromResourceTest_002(napi_env env, napi_callback_info info)
{
    ...
    auto ret = OH_ArkUI_GetDrawableDescriptorFromResourceNapiValue(nullptr, nullptr, &drawableDescriptor);
    napi_value retValue;
