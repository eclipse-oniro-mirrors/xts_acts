...
#include "UnregisterCommonAreaApproximateChangeEventTest.h"
#include <cstdint>
#include <iostream>
#include <string>
#include <cstdio>
...
napi_value UnregisterCommonAreaApproximateChangeEventTest::CreateNativeNode(napi_env env, napi_callback_info info)
{
    OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "UnregisterCommonAreaApproximateChangeEventTest", 
        "CreateNativeNode");
    ...
    auto ret1 = OH_ArkUI_NativeModule_UnregisterCommonAreaApproximateChangeEvent( //释放
        image);          
    if ( ARKUI_ERROR_CODE_NO_ERROR == ret1 ){
        ...
        item2.string = "ARKUI_ERROR_CODE_NO_ERROR";
        nodeAPI->setAttribute(Text22, NODE_TEXT_CONTENT, &item2);
        }
