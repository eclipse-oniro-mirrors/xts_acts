...
#include "keyEvent_GetKeyIntensionCode.h"
...
{
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "KeyEventGetKeyIntensionCode", "OnEventReceive");
    if (event == nullptr) {
        OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "KeyEventGetKeyIntensionCode", "OnEventReceive: event is null");
        return;
    }
...
void KeyEventGetKeyIntensionCodeTest::KeyEventGetKeyIntensionCodeTest_001(ani_env* env, ani_object info, ani_object NodeContent)
{
    ...
    id_item.string = "KeyEventGetKeyIntensionCode";
    ArkUI_AttributeItem textId = {.string = "KeyEventGetKeyIntensionCode"};
