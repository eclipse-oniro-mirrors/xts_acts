...
#include "keyEvent_GetDeviceId.h"
...
{
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "KeyEventGetDeviceId", "OnEventReceive");
    if (event == nullptr) {
...
void KeyEventGetGetDeviceIdTest::KeyEventGetGetDeviceIdTest_001(ani_env* env, ani_object info, ani_object NodeContent)
{
