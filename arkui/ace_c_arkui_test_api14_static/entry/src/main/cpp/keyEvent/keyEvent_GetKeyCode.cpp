...
static void OnEventReceive(ArkUI_NodeEvent *event)
{
    ...
    if (type == 2049) {
        ...
        OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "KeyEventGetKeyCode",
                     "KeyEventGetKeyCode result : %{public}d", type);
    }
}

void KeyEventGetKeyCodeTest::KeyEventGetKeyCodeTest_001(ani_env* env, ani_object info, ani_object NodeContent)
{
    ...
    id_item.string = "KeyEventGetKeyCode";
     ArkUI_AttributeItem textId = {.string = "KeyEventGetKeyCode"};
