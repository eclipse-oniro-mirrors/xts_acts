...
#ifndef CAPIXTS_SWIPER_COMPONENT_H
#define CAPIXTS_SWIPER_COMPONENT_H
...
public:
    ...
    void SetSwiperIndex(int32_t index, int32_t animationMode);
    ...
    void RegisterOnSelect(const std::function<void(ArkUI_NodeEvent* event)>& onSelect);
