...
static ani_double TestSwiperArrowStyle001(ani_env* env, ani_object info)
{
...
static ani_double TestSwiperArrowStyle002(ani_env* env, ani_object info)
{
    ArkUI_SwiperArrowStyle* arrowStyle = OH_ArkUI_SwiperArrowStyle_Create();
...
static ani_double TestSwiperArrowStyle003(ani_env* env, ani_object info)
{
    ArkUI_SwiperArrowStyle* arrowStyle = OH_ArkUI_SwiperArrowStyle_Create();
...
static ani_double TestSwiperArrowStyle004(ani_env* env, ani_object info)
{
    ArkUI_SwiperArrowStyle* arrowStyle = OH_ArkUI_SwiperArrowStyle_Create();
...
static ani_double TestSwiperArrowStyle005(ani_env* env, ani_object info)
{
    ArkUI_SwiperArrowStyle* arrowStyle = OH_ArkUI_SwiperArrowStyle_Create();
...
static ani_double TestSwiperArrowStyle006(ani_env* env, ani_object info)
{
    ArkUI_SwiperArrowStyle* arrowStyle = OH_ArkUI_SwiperArrowStyle_Create();
