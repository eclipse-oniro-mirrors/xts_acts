...
static ani_double TestSwiperDigitIndicator001(ani_env* env, ani_object info)
{
    ...
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "KeyEventPatchTest", "[swiper_dot_indicator_test]ASSERT_EQ1 start");
    ASSERT_EQ(OH_ArkUI_SwiperIndicator_GetSpace(indicator), PARAM_5);
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "KeyEventPatchTest", "[swiper_dot_indicator_test]ASSERT_EQ1 end");
...
static ani_double TestSwiperDigitIndicator002(ani_env* env, ani_object info)
{
...
static ani_double TestSwiperDigitIndicator003(ani_env* env, ani_object info)
{
    auto digitIndicator = OH_ArkUI_SwiperDigitIndicator_Create();
    ArkUI_NumberValue value_digit[] = {{.i32 = ARKUI_SWIPER_INDICATOR_TYPE_DIGIT}};
    ArkUI_AttributeItem item_digit = {.value=value_digit, .size=1, .object=digitIndicator};
...
static ani_double TestSwiperDigitIndicator004(ani_env* env, ani_object info)
{
    auto digitIndicator = OH_ArkUI_SwiperDigitIndicator_Create();
    ArkUI_NumberValue value_digit[] = {{.i32 = ARKUI_SWIPER_INDICATOR_TYPE_DIGIT}};
    ArkUI_AttributeItem item_digit = {.value=value_digit, .size=1, .object=digitIndicator};
...
static ani_double TestSwiperDigitIndicator005(ani_env* env, ani_object info)
{
    auto digitIndicator = OH_ArkUI_SwiperDigitIndicator_Create();
    ArkUI_NumberValue value_digit[] = {{.i32 = ARKUI_SWIPER_INDICATOR_TYPE_DIGIT}};
    ArkUI_AttributeItem item_digit = {.value=value_digit, .size=1, .object=digitIndicator};
...
static ani_double TestSwiperDigitIndicator006(ani_env* env, ani_object info)
{
    auto digitIndicator = OH_ArkUI_SwiperDigitIndicator_Create();
    ArkUI_NumberValue value_digit[] = {{.i32 = ARKUI_SWIPER_INDICATOR_TYPE_DIGIT}};
    ArkUI_AttributeItem item_digit = {.value=value_digit, .size=1, .object=digitIndicator};
...
static ani_double TestSwiperDigitIndicator007(ani_env* env, ani_object info)
{
    auto digitIndicator = OH_ArkUI_SwiperDigitIndicator_Create();
    ArkUI_NumberValue value_digit[] = {{.i32 = ARKUI_SWIPER_INDICATOR_TYPE_DIGIT}};
    ArkUI_AttributeItem item_digit = {.value=value_digit, .size=1, .object=digitIndicator};
...
static ani_double TestSwiperDigitIndicator008(ani_env* env, ani_object info)
{
    auto digitIndicator = OH_ArkUI_SwiperDigitIndicator_Create();
    ArkUI_NumberValue value_digit[] = {{.i32 = ARKUI_SWIPER_INDICATOR_TYPE_DIGIT}};
    ArkUI_AttributeItem item_digit = {.value=value_digit, .size=1, .object=digitIndicator};
