...
static ani_double TestSliderBlockColor001(ani_env* env, ani_object info)
{
...
static ani_double TestSliderBlockColor002(ani_env* env, ani_object info)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
...
static ani_double TestSliderBlockColor003(ani_env* env, ani_object info)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
...
static ani_double TestSliderBlockColor004(ani_env* env, ani_object info)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
...
static ani_double TestSliderBlockColor005(ani_env* env, ani_object info)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
...
static ani_double TestSliderBlockColor006(ani_env* env, ani_object info)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
...
static ani_double TestSliderBlockColor007(ani_env* env, ani_object info)
{
    NAPI_START(slider, ARKUI_NODE_SLIDER);
