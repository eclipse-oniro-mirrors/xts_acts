...
static ani_double TestCommonAttrsLinearGradient001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsLinearGradient002(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float angle = 90;
...
static ani_double TestCommonAttrsLinearGradient003(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float angle = 90;
...
static ani_double TestCommonAttrsLinearGradient004(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float angle = 90;
...
static ani_double TestCommonAttrsLinearGradient005(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float angle = 90;
...
static ani_double TestCommonAttrsLinearGradient006(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float angle = 90;
...
static ani_double TestCommonAttrsLinearGradient007(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float angle = 90;
...
static ani_double TestCommonAttrsLinearGradient008(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float angle = 90;
...
static ani_double TestCommonAttrsLinearGradient009(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float angle = 90;
...
static ani_double TestCommonAttrsLinearGradient010(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float angle = 90;
