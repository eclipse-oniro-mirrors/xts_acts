...
static ani_double TestCommonAttrsBackgroundImagePixelMap001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsBackgroundImagePixelMap002(ani_env* env, ani_object info)
{
    OH_PixelmapNativeHandle pixelMap = nullptr;
    ArkUI_DrawableDescriptor* descriptor = nullptr;
...
static ani_double TestCommonAttrsBackgroundImagePixelMap003(ani_env* env, ani_object info)
{
    OH_PixelmapNativeHandle pixelMap = nullptr;
    ArkUI_DrawableDescriptor* descriptor = nullptr;
...
static ani_double TestCommonAttrsBackgroundImagePixelMap004(ani_env* env, ani_object info)
{
    OH_PixelmapNativeHandle pixelMap = nullptr;
    ArkUI_DrawableDescriptor* descriptor = nullptr;
...
static ani_double TestCommonAttrsBackgroundImagePixelMap005(ani_env* env, ani_object info)
{
    OH_PixelmapNativeHandle pixelMap = nullptr;
    ArkUI_DrawableDescriptor* descriptor = nullptr;
...
static ani_double TestCommonAttrsBackgroundImagePixelMap006(ani_env* env, ani_object info)
{
    OH_PixelmapNativeHandle pixelMap = nullptr;
    ArkUI_DrawableDescriptor* descriptor = nullptr;
...
static ani_double TestCommonAttrsBackgroundImagePixelMap007(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    int32_t imageRepeat = ARKUI_IMAGE_REPEAT_X;
    ArkUI_NumberValue value[] = {{.i32 = imageRepeat}};
