...
static ani_double TestCommonAttrsBackgroundImage001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsBackgroundImage002(ani_env* env, ani_object info)
{
    const char *backgroundImage = "resource://media/icon.png";
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestCommonAttrsBackgroundImage003(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsBackgroundImage004(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsBackgroundImage005(ani_env* env, ani_object info)
{
    const char *backgroundImage = "resource://media/icon.png";
...
static ani_double TestCommonAttrsBackgroundImage006(ani_env* env, ani_object info)
{
    const char *backgroundImage = "resource://media/icon.png";
...
static ani_double TestCommonAttrsBackgroundImage007(ani_env* env, ani_object info)
{
    const char *backgroundImage = "resource://media/icon.png";
...
static ani_double TestCommonAttrsBackgroundImage008(ani_env* env, ani_object info)
{
    const char *backgroundImage = "resource://media/icon.png";
...
static ani_double TestCommonAttrsBackgroundImage009(ani_env* env, ani_object info)
{
    const char *backgroundImage = "resource://media/icon.png";
...
static ani_double TestCommonAttrsBackgroundImage010(ani_env* env, ani_object info)
{
    const char *backgroundImage = "resource://media/icon.png";
    uint32_t imageRepeat = ARKUI_IMAGE_REPEAT_XY;
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestCommonAttrsBackgroundImage011(ani_env* env, ani_object info)
{
    const char *backgroundImage = "resource://media/icon.png";
    uint32_t imageRepeat = ARKUI_IMAGE_REPEAT_XY;
    NAPI_START(column, ARKUI_NODE_COLUMN);
