...
static ani_double TestCommonAttrsDefaultFocus001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsDefaultFocus002(ani_env* env, ani_object info)
{
    NAPI_START(button, ARKUI_NODE_BUTTON);
...
static ani_double TestCommonAttrsDefaultFocus003(ani_env* env, ani_object info)
{
    NAPI_START(button, ARKUI_NODE_BUTTON);
...
static ani_double TestCommonAttrsDefaultFocus004(ani_env* env, ani_object info)
{
    NAPI_START(button, ARKUI_NODE_BUTTON);
    int32_t defaultfocus = PARAM_1;
    ArkUI_NumberValue value[] = {{.i32 = defaultfocus}};
