...
static ani_double TestCommonAttrsCustomShadow001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsCustomShadow002(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestCommonAttrsCustomShadow003(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestCommonAttrsCustomShadow004(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float blurRadius = PARAM_0;
...
static ani_double TestCommonAttrsCustomShadow005(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float blurRadius = PARAM_0;
    int32_t strategy = PARAM_0;
...
static ani_double TestCommonAttrsCustomShadow006(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float blurRadius = PARAM_0;
    int32_t strategy = PARAM_0;
...
static ani_double TestCommonAttrsCustomShadow007(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float blurRadius = PARAM_0;
    int32_t strategy = PARAM_0;
...
static ani_double TestCommonAttrsCustomShadow008(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float blurRadius = PARAM_0;
    int32_t strategy = PARAM_0;
...
static ani_double TestCommonAttrsCustomShadow009(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float blurRadius = PARAM_0;
    int32_t strategy = PARAM_0;
