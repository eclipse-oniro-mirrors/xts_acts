...
static ani_double TestCommonAttrsVisibility001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsVisibility002(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestCommonAttrsVisibility003(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestCommonAttrsVisibility004(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestCommonAttrsVisibility005(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestCommonAttrsVisibility006(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    int32_t visibility = ARKUI_VISIBILITY_NONE;
    ArkUI_NumberValue value[] = {{.i32 = visibility}};
