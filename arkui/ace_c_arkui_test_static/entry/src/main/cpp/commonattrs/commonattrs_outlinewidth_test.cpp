...
static ani_double TestCommonAttrsOutlineWidth001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsOutlineWidth002(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float left = PARAM_0;
    float top = PARAM_0;
...
static ani_double TestCommonAttrsOutlineWidth003(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
