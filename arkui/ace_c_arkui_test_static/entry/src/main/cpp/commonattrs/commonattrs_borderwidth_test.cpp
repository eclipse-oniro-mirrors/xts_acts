...
static ani_double TestCommonAttrsBorderWidth001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsBorderWidth002(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestCommonAttrsBorderWidth003(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestCommonAttrsBorderWidth004(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
