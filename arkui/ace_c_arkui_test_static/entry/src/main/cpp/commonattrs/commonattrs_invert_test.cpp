...
static ani_double TestCommonAttrsInvert001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsInvert002(ani_env* env, ani_object info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
    float invert = 0.5;
...
static ani_double TestCommonAttrsInvert003(ani_env* env, ani_object info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
    float invert = 0.8;
    ArkUI_NumberValue value[] = {{.f32 = invert}};
...
static ani_double TestCommonAttrsInvert004(ani_env* env, ani_object info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
    float invert = 1.0;
    ArkUI_NumberValue value[] = {{.f32 = invert}};
...
static ani_double TestCommonAttrsInvert005(ani_env* env, ani_object info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
...
static ani_double TestCommonAttrsInvert006(ani_env* env, ani_object info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
