...
static ani_double TestCommonAttrsBorderStyle001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsBorderStyle002(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestCommonAttrsBorderStyle003(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestCommonAttrsBorderStyle004(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
    ArkUI_NumberValue value[] = {{.i32 = ARKUI_BORDER_STYLE_SOLID},
...
static ani_double TestCommonAttrsBorderStyle005(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
    ArkUI_NumberValue value[] = {{.i32 = ARKUI_BORDER_STYLE_DASHED},
...
static ani_double TestCommonAttrsBorderStyle006(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
    ArkUI_NumberValue value[] = {{.i32 = ARKUI_BORDER_STYLE_DOTTED},
