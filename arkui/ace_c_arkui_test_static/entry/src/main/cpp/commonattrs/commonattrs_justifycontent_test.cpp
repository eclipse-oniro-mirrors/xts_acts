...
static ani_double TestCommonAttrsJustifyContent001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsJustifyContent002(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestCommonAttrsJustifyContent003(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestCommonAttrsJustifyContent004(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestCommonAttrsJustifyContent005(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestCommonAttrsJustifyContent006(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestCommonAttrsJustifyContent007(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsJustifyContent008(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    ArkUI_NumberValue value[] = {{.i32 = ARKUI_FLEX_ALIGNMENT_CENTER}};
    ArkUI_AttributeItem value_item = {value, sizeof(value) / sizeof(ArkUI_NumberValue)};
...
static ani_double TestCommonAttrsJustifyContent009(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    ArkUI_NumberValue value[] = {{.i32 = ARKUI_FLEX_ALIGNMENT_END}};
    ArkUI_AttributeItem value_item = {value, sizeof(value) / sizeof(ArkUI_NumberValue)};
...
static ani_double TestCommonAttrsJustifyContent010(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    ArkUI_NumberValue value[] = {{.i32 = ARKUI_FLEX_ALIGNMENT_SPACE_BETWEEN}};
    ArkUI_AttributeItem value_item = {value, sizeof(value) / sizeof(ArkUI_NumberValue)};
...
static ani_double TestCommonAttrsJustifyContent011(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    ArkUI_NumberValue value[] = {{.i32 = ARKUI_FLEX_ALIGNMENT_SPACE_AROUND}};
    ArkUI_AttributeItem value_item = {value, sizeof(value) / sizeof(ArkUI_NumberValue)};
...
static ani_double TestCommonAttrsJustifyContent012(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    ArkUI_NumberValue value[] = {{.i32 = ARKUI_FLEX_ALIGNMENT_SPACE_EVENLY}};
    ArkUI_AttributeItem value_item = {value, sizeof(value) / sizeof(ArkUI_NumberValue)};
