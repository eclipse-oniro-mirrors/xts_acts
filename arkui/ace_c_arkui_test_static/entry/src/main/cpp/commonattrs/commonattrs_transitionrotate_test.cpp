...
static ani_double TestCommonAttrsTransitionRotate001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsTransitionRotate002(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestCommonAttrsTransitionRotate003(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_5;
    float y = PARAM_5;
...
static ani_double TestCommonAttrsTransitionRotate004(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_5;
    float y = PARAM_5;
...
static ani_double TestCommonAttrsTransitionRotate005(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_5;
    float y = PARAM_5;
...
static ani_double TestCommonAttrsTransitionRotate006(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_5;
    float y = PARAM_5;
...
static ani_double TestCommonAttrsTransitionRotate007(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_0;
    float y = PARAM_0;
...
static ani_double TestCommonAttrsTransitionRotate008(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_0;
    float y = PARAM_0;
