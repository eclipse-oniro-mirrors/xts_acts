...
static ani_double TestCommonAttrsMask001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsMask002(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask003(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask004(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask005(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask006(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask007(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask008(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask009(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask010(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask011(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask012(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask013(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    uint32_t maskFillColor = 0xFFFF3333;
    uint32_t maskStrokeColor = 0xFF000000;
...
static ani_double TestCommonAttrsMask014(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
...
static ani_double TestCommonAttrsMask015(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    int32_t maskType = ARKUI_MASK_TYPE_PROGRESS;
...
static ani_double TestCommonAttrsMask016(ani_env* env, ani_object info)
{
    NAPI_START(mask, ARKUI_NODE_COLUMN);
    int32_t maskType = ARKUI_MASK_TYPE_PROGRESS;
    float maskProgressCurrentValue = -50.00;
