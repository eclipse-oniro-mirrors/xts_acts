...
#include "commonattrs_focusable_test.h"
...
void CommonAttrsFocusableTest::CreateNativeNode(ani_env* env, ani_object info, ani_object NodeContent)
{
    ...
    id_item.string = "FocusableTestButton";
    nodeAPI->setAttribute(button, NODE_ID, &id_item);
    id_item.string = "FocusableTestButtonCompare";
    nodeAPI->setAttribute(buttonCompare, NODE_ID, &id_item);
    id_item.string = "FocusableTestButtonDisable";
