...
static ani_double TestCommonAttrsWidth001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsWidth002(ani_env* env, ani_object info)
{
    NAPI_START(button, ARKUI_NODE_BUTTON);
...
static ani_double TestCommonAttrsWidth003(ani_env* env, ani_object info)
{
    NAPI_START(button, ARKUI_NODE_BUTTON);
