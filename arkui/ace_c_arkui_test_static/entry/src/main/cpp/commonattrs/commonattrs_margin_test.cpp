...
static ani_double TestCommonAttrsMargin001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsMargin002(ani_env* env, ani_object info)
{
    NAPI_START(flex, ARKUI_NODE_FLEX);
...
static ani_double TestCommonAttrsMargin003(ani_env* env, ani_object info)
{
    NAPI_START(flex, ARKUI_NODE_FLEX);
...
static ani_double TestCommonAttrsMargin004(ani_env* env, ani_object info)
{
    NAPI_START(flex, ARKUI_NODE_FLEX);
