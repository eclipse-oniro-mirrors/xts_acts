...
static ani_double TestCommonAttrsRotate001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsRotate002(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_1;
    float y = PARAM_1;
...
static ani_double TestCommonAttrsRotate003(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_1;
    float y = PARAM_1;
...
static ani_double TestCommonAttrsRotate004(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestCommonAttrsRotate005(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_NEGATIVE_1;
    float y = PARAM_NEGATIVE_1;
...
static ani_double TestCommonAttrsRotate006(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_1;
    float y = PARAM_NEGATIVE_1;
...
static ani_double TestCommonAttrsRotate007(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_NEGATIVE_1;
    float y = PARAM_1;
...
static ani_double TestCommonAttrsRotate008(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_NEGATIVE_1;
    float y = PARAM_NEGATIVE_1;
...
static ani_double TestCommonAttrsRotate009(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    float x = PARAM_NEGATIVE_1;
    float y = PARAM_1;
