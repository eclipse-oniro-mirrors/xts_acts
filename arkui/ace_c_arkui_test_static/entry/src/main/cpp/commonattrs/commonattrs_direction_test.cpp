...
static ani_double TestCommonAttrsDirection001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsDirection002(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestCommonAttrsDirection003(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestCommonAttrsDirection004(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
    int32_t direction = ARKUI_DIRECTION_AUTO;
    ASSERT_EQ(nodeAPI->getAttribute(row, NODE_DIRECTION)->value[PARAM_0].u32, direction);
...
static ani_double TestCommonAttrsDirection005(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
