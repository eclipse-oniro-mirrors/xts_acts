...
static ani_double TestCommonAttrsOutlineColor001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsOutlineColor002(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
...
static ani_double TestCommonAttrsOutlineColor003(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
...
static ani_double TestCommonAttrsOutlineColor004(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    uint32_t outlineColor = COLOR_RED;
    ArkUI_NumberValue value[] = {{.u32 = outlineColor}};
