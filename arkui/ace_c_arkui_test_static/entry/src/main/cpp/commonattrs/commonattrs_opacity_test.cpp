...
static ani_double TestCommonAttrsOpacity001(ani_env* env, ani_object info)
{
...
static ani_double TestCommonAttrsOpacity002(ani_env* env, ani_object info)
{
    NAPI_START(checkbox, ARKUI_NODE_CHECKBOX);
    float opacity = 0.5;
...
static ani_double TestCommonAttrsOpacity003(ani_env* env, ani_object info)
{
    NAPI_START(checkbox, ARKUI_NODE_CHECKBOX);
    float opacity = 0.8;
    ArkUI_NumberValue value[] = {{.f32 = opacity}};
...
static ani_double TestCommonAttrsOpacity004(ani_env* env, ani_object info)
{
    NAPI_START(checkbox, ARKUI_NODE_CHECKBOX);
...
static ani_double TestCommonAttrsOpacity005(ani_env* env, ani_object info)
{
    NAPI_START(checkbox, ARKUI_NODE_CHECKBOX);
...
static ani_double TestCommonAttrsOpacity006(ani_env* env, ani_object info)
{
    NAPI_START(checkbox, ARKUI_NODE_CHECKBOX);
