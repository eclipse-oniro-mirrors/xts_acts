...
static ani_double TestRowAlignItems001(ani_env* env, ani_object info)
{
...
static ani_double TestRowAlignItems002(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestRowAlignItems003(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
...
static ani_double TestRowAlignItems004(ani_env* env, ani_object info)
{
    NAPI_START(row, ARKUI_NODE_ROW);
