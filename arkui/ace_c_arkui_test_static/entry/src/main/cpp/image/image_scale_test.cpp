...
static ani_double TestImageScale001(ani_env* env, ani_object info)
{
...
static ani_double TestImageScale002(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static ani_double TestImageScale003(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
