...
static ani_double TestImageDraggable001(ani_env* env, ani_object info)
{
...
static ani_double TestImageDraggable002(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static ani_double TestImageDraggable003(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static ani_double TestImageDraggable004(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static ani_double TestImageDraggable005(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
