...
static ani_double TestImageClip001(ani_env* env, ani_object info)
{
...
static ani_double TestImageClip002(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static ani_double TestImageClip003(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static ani_double TestImageClip004(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static ani_double TestImageClip005(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float width = OUTER_WIDTH_VALUE;
    float height = OUTER_HEIGHT_VALUE;
...
static ani_double TestImageClip006(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float width = OUTER_WIDTH_VALUE;
    float height = OUTER_HEIGHT_VALUE;
...
static ani_double TestImageClip007(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float width = OUTER_WIDTH_VALUE;
    float height = OUTER_HEIGHT_VALUE;
