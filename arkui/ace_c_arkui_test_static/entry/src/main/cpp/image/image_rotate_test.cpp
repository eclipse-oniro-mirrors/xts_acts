...
static ani_double TestImageRotate001(ani_env* env, ani_object info)
{
...
static ani_double TestImageRotate002(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float x = PARAM_0;
    float y = PARAM_0;
...
static ani_double TestImageRotate003(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float x = PARAM_1;
    float y = PARAM_0;
...
static ani_double TestImageRotate004(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float x = PARAM_0;
    float y = PARAM_1;
