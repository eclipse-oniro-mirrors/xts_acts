...
static ani_double TestImageSweepGradient001(ani_env* env, ani_object info)
{
...
static ani_double TestImageSweepGradient002(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    uint32_t colors[] = {FIRST_COLOR_VALUE, SECOND_COLOR_VALUE};
    float stops[] = {FIRST_MIDDLE_VALUE, SECOND_MIDDLE_VALUE};
...
static ani_double TestImageSweepGradient003(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    uint32_t colors[] = {FIRST_COLOR_VALUE, SECOND_COLOR_VALUE};
    float stops[] = {FIRST_MIDDLE_VALUE, SECOND_MIDDLE_VALUE};
...
static ani_double TestImageSweepGradient004(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    uint32_t colors[] = {FIRST_COLOR_VALUE, SECOND_COLOR_VALUE};
    float stops[] = {FIRST_MIDDLE_VALUE, SECOND_MIDDLE_VALUE};
