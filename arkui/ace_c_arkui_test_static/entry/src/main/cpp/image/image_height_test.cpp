...
static ani_double TestImageHeight001(ani_env* env, ani_object info)
{
...
static ani_double TestImageHeight002(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float height = -50;
...
static ani_double TestImageHeight003(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float height = 500;
