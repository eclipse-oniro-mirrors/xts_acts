...
static ani_double TestImageBlur001(ani_env* env, ani_object info)
{
...
static ani_double TestImageBlur002(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static ani_double TestImageBlur003(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
