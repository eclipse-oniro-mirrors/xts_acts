...
static ani_double TestImageWidth001(ani_env* env, ani_object info)
{
...
static ani_double TestImageWidth002(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float width = -100;
...
static ani_double TestImageWidth003(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    float width = 500;
