...
static ani_double TestProgressStyle001(ani_env* env, ani_object info)
{
...
static ani_double TestProgressStyle002(ani_env* env, ani_object info)
{
    NAPI_START(progress, ARKUI_NODE_PROGRESS);
...
static ani_double TestProgressStyle003(ani_env* env, ani_object info)
{
    NAPI_START(progress, ARKUI_NODE_PROGRESS);
...
static ani_double TestProgressStyle004(ani_env* env, ani_object info)
{
    NAPI_START(progress, ARKUI_NODE_PROGRESS);
...
static ani_double TestProgressStyle005(ani_env* env, ani_object info)
{
    NAPI_START(progress, ARKUI_NODE_PROGRESS);
...
static ani_double TestProgressStyle006(ani_env* env, ani_object info)
{
    NAPI_START(progress, ARKUI_NODE_PROGRESS);
