...
static ani_double TestProgressValue001(ani_env* env, ani_object info)
{
...
static ani_double TestProgressValue002(ani_env* env, ani_object info)
{
    NAPI_START(progress, ARKUI_NODE_PROGRESS);
...
static ani_double TestProgressValue003(ani_env* env, ani_object info)
{
    NAPI_START(progress, ARKUI_NODE_PROGRESS);
...
static ani_double TestProgressValue004(ani_env* env, ani_object info)
{
    NAPI_START(progress, ARKUI_NODE_PROGRESS);
...
static ani_double TestProgressValue005(ani_env* env, ani_object info)
{
    NAPI_START(progress, ARKUI_NODE_PROGRESS);
...
static ani_double TestProgressValue006(ani_env* env, ani_object info)
{
    NAPI_START(progress, ARKUI_NODE_PROGRESS);
...
static ani_double TestProgressValue007(ani_env* env, ani_object info)
{
    NAPI_START(progress, ARKUI_NODE_PROGRESS);
    ArkUI_NumberValue value[] = {{.f32 = PARAM_50_POINT_5}};
    ArkUI_AttributeItem value_item = {value, sizeof(value) / sizeof(ArkUI_NumberValue)};
