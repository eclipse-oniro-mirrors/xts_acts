...
static ani_double TestRelativeContainerBarrierOptionCreate001(ani_env* env, ani_object info)
{
...
static ani_double TestRelativeContainerBarrierOptionDispose001(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
    OH_ArkUI_BarrierOption_Dispose(barrier);
    NAPI_END;
...
static ani_double TestRelativeContainerBarrierOptionSetId001(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
...
static ani_double TestRelativeContainerBarrierOptionSetId002(ani_env* env, ani_object info)
{
    const char* barrierId = "BarrierOption";
...
static ani_double TestRelativeContainerBarrierOptionSetId003(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
    const char* barrierId = "BarrierOption";
...
static ani_double TestRelativeContainerBarrierOptionSetId004(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
    const char* barrierId = "BarrierOption";
...
static ani_double TestRelativeContainerBarrierOptionGetId001(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
    const char* barrierId = "BarrierOption";
    OH_ArkUI_BarrierOption_SetId(barrier, barrierId, PARAM_0);
...
static ani_double TestRelativeContainerBarrierOptionGetId002(ani_env* env, ani_object info)
{
    const char* barrierId = "BarrierOption";
...
static ani_double TestRelativeContainerBarrierOptionSetDirection001(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
...
static ani_double TestRelativeContainerBarrierOptionSetDirection002(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
...
static ani_double TestRelativeContainerBarrierOptionSetDirection003(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
...
static ani_double TestRelativeContainerBarrierOptionSetDirection004(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
...
static ani_double TestRelativeContainerBarrierOptionSetDirection005(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
...
static ani_double TestRelativeContainerBarrierOptionSetDirection006(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
...
static ani_double TestRelativeContainerBarrierOptionGetDirection001(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
    OH_ArkUI_BarrierOption_SetDirection(barrier, ARKUI_BARRIER_DIRECTION_START, PARAM_0);
    ASSERT_EQ(OH_ArkUI_BarrierOption_GetDirection(barrier, PARAM_0), ARKUI_BARRIER_DIRECTION_START);
...
static ani_double TestRelativeContainerBarrierOptionGetDirection002(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
    OH_ArkUI_BarrierOption_SetDirection(barrier, ARKUI_BARRIER_DIRECTION_START, PARAM_NEGATIVE_1);
...
static ani_double TestRelativeContainerBarrierOptionSetReferencedId001(ani_env* env, ani_object info)
{
...
static ani_double TestRelativeContainerBarrierOptionSetReferencedId002(ani_env* env, ani_object info)
{
    auto barrier = OH_ArkUI_BarrierOption_Create(PARAM_1);
...
static ani_double TestRelativeContainerBarrierOptionSetReferencedId003(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    ArkUI_AttributeItem textItem = {};
    textItem.string = "Test";
...
static ani_double TestRelativeContainerBarrierOptionGetReferencedId001(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    ArkUI_AttributeItem textItem = {};
    textItem.string = "Test";
...
static ani_double TestRelativeContainerBarrierOptionGetReferencedId002(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    ArkUI_AttributeItem textItem = {};
    textItem.string = "Test";
...
static ani_double TestRelativeContainerBarrierOptionGetReferencedId003(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    ArkUI_AttributeItem textItem = {};
    textItem.string = "Test";
...
static ani_double TestRelativeContainerBarrierOptionGetReferencedSize001(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    ArkUI_AttributeItem textItem = {};
    textItem.string = "Test";
...
static ani_double TestRelativeContainerBarrierOptionGetReferencedSize002(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
    ArkUI_AttributeItem textItem = {};
    textItem.string = "Test";
