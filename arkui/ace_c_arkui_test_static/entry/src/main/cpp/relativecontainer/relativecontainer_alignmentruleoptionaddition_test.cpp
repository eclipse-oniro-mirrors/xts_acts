...
static ani_double TestRelativeContaineAlignmentRuleOptionCreate001(ani_env* env, ani_object info)
{
...
static ani_double TestRelativeContaineAlignmentRuleOptionDispose001(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto alignmentRule = OH_ArkUI_AlignmentRuleOption_Create();
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetStart001(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetStart002(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetStart003(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetEnd001(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetEnd002(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetEnd003(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetCenterHorizontal001(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetCenterHorizontal002(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetCenterHorizontal003(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetTop001(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetTop002(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetTop003(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetBottom001(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetBottom002(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetBottom003(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetCenterVertical001(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetCenterVertical002(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetCenterVertical003(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1* nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto text = nodeAPI->createNode(ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetBiasHorizontal001(ani_env* env, ani_object info)
{
    auto alignmentRule = OH_ArkUI_AlignmentRuleOption_Create();
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetBiasHorizontal002(ani_env* env, ani_object info)
{
    auto alignmentRule = OH_ArkUI_AlignmentRuleOption_Create();
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetBiasVertical001(ani_env* env, ani_object info)
{
    auto alignmentRule = OH_ArkUI_AlignmentRuleOption_Create();
...
static ani_double TestRelativeContaineAlignmentRuleOptionSetBiasVertical002(ani_env* env, ani_object info)
{
    auto alignmentRule = OH_ArkUI_AlignmentRuleOption_Create();
