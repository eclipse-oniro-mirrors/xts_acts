...
static ani_double TestAttributeSetting001(ani_env* env, ani_object info)
{
...
static ani_double TestAttributeSetting002(ani_env* env, ani_object info)
{
    NAPI_START(button, ARKUI_NODE_BUTTON);
...
static ani_double TestAttributeSetting003(ani_env* env, ani_object info)
{
...
static ani_double TestAttributeSetting004(ani_env* env, ani_object info)
{
    NAPI_START(button, ARKUI_NODE_BUTTON);
...
static ani_double TestAttributeSetting005(ani_env* env, ani_object info)
{
    NAPI_START(button, ARKUI_NODE_BUTTON);
...
static ani_double TestAttributeSetting006(ani_env* env, ani_object info)
{
    NAPI_START(stack, ARKUI_NODE_STACK);
...
static ani_double TestAttributeSetting007(ani_env* env, ani_object info)
{
...
static ani_double TestAttributeSetting008(ani_env* env, ani_object info)
{
    NAPI_START(span, ARKUI_NODE_SPAN);
...
static ani_double TestAttributeSetting009(ani_env* env, ani_object info)
{
...
static ani_double TestAttributeSetting010(ani_env* env, ani_object info)
{
    auto nodeAPI = reinterpret_cast<ArkUI_NativeNodeAPI_1*>(
        OH_ArkUI_QueryModuleInterfaceByName(ARKUI_NATIVE_NODE, "ArkUI_NativeNodeAPI_1"));
