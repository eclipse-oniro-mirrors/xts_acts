...
static ani_double TestLoadingProgressColor001(ani_env* env, ani_object info)
{
...
static ani_double TestLoadingProgressColor002(ani_env* env, ani_object info)
{
    NAPI_START(loadingProgress, ARKUI_NODE_LOADING_PROGRESS);
...
static ani_double TestLoadingProgressColor003(ani_env* env, ani_object info)
{
    NAPI_START(loadingProgress, ARKUI_NODE_LOADING_PROGRESS);
