...
static ani_double TestScrollHeight001(ani_env* env, ani_object info)
{
...
static ani_double TestScrollHeight002(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
    float height = -100;
    ArkUI_NumberValue height_value[] = {{.f32 = height}};
...
static ani_double TestScrollHeight003(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
    float height = 10000;
    ArkUI_NumberValue height_value[] = {{.f32 = height}};
