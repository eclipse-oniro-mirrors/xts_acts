...
static ani_double TestScrollBorderWidth001(ani_env* env, ani_object info)
{
...
static ani_double TestScrollBorderWidth002(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
...
static ani_double TestScrollBorderWidth003(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
