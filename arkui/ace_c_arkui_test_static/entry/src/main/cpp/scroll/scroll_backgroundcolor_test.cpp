...
static ani_double TestScrollBackgroundColor001(ani_env* env, ani_object info)
{
...
static ani_double TestScrollBackgroundColor002(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
...
static ani_double TestScrollBackgroundColor003(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
