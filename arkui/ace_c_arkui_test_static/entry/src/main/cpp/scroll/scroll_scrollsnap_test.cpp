...
static ani_double TestScrollScrollSnap001(ani_env* env, ani_object info)
{
...
static ani_double TestScrollScrollSnap002(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
    float param = 1.0;
    float paramSecond = SIZE_100;
...
static ani_double TestScrollScrollSnap003(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
    float param = 1.0;
    float paramSecond = SIZE_100;
...
static ani_double TestScrollScrollSnap004(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
    float param = 1.0;
    float paramSecond = SIZE_100;
