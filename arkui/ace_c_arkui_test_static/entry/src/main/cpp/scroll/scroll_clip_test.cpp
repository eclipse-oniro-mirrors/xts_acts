...
static ani_double TestScrollClip001(ani_env* env, ani_object info)
{
...
static ani_double TestScrollClip002(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
...
static ani_double TestScrollClip003(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
