...
static ani_double TestScrollBlur001(ani_env* env, ani_object info)
{
...
static ani_double TestScrollBlur002(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
...
static ani_double TestScrollBlur003(ani_env* env, ani_object info)
{
    NAPI_START(scroll, ARKUI_NODE_SCROLL);
