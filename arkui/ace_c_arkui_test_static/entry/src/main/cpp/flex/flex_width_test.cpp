...
static ani_double TestFlexWidth001(ani_env* env, ani_object info)
{
...
static ani_double TestFlexWidth002(ani_env* env, ani_object info)
{
    NAPI_START(flex, ARKUI_NODE_FLEX);
    float width = -100;
...
static ani_double TestFlexWidth003(ani_env* env, ani_object info)
{
    NAPI_START(flex, ARKUI_NODE_FLEX);
    float width = 500;
