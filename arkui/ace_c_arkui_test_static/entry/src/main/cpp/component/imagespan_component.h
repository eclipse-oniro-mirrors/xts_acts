...
#ifndef ARKUI_CAPI_XTS_IMAGESPAN_COMPONENT_H
#define ARKUI_CAPI_XTS_IMAGESPAN_COMPONENT_H
...
public:
    explicit ImageSpanComponent() : Component(ARKUI_NODE_IMAGE_SPAN) {}
...
#endif //ARKUI_CAPI_XTS_IMAGESPAN_COMPONENT_H