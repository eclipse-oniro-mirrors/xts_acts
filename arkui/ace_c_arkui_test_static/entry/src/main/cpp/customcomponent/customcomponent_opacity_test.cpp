...
static ani_double TestCustomComponentOpacity001(ani_env* env, ani_object info)
{
...
static ani_double TestCustomComponentOpacity002(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float opacity = 0.5;
...
static ani_double TestCustomComponentOpacity003(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float opacity = 0.8;
    ArkUI_NumberValue value[] = {{.f32 = opacity}};
...
static ani_double TestCustomComponentOpacity004(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static ani_double TestCustomComponentOpacity005(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static ani_double TestCustomComponentOpacity006(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
