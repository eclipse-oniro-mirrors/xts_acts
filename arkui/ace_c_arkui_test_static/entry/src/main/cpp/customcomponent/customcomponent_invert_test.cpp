...
static ani_double TestCustomComponentInvert001(ani_env* env, ani_object info)
{
...
static ani_double TestCustomComponentInvert002(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float invert = 0.5;
...
static ani_double TestCustomComponentInvert003(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float invert = 0.8;
    ArkUI_NumberValue value[] = {{.f32 = invert}};
...
static ani_double TestCustomComponentInvert004(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float invert = 1.0;
    ArkUI_NumberValue value[] = {{.f32 = invert}};
...
static ani_double TestCustomComponentInvert005(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static ani_double TestCustomComponentInvert006(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
