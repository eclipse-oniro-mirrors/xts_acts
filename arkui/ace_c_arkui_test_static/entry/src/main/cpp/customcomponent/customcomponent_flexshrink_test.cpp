...
static ani_double TestCustomComponentFlexShrink001(ani_env* env, ani_object info)
{
...
static ani_double TestCustomComponentFlexShrink002(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float width = -100.0;
    ArkUI_NumberValue value[] = {{.f32 = width}};
