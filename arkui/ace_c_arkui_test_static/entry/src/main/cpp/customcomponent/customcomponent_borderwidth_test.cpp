...
static ani_double TestCustomComponentBorderWidth001(ani_env* env, ani_object info)
{
...
static ani_double TestCustomComponentBorderWidth002(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static ani_double TestCustomComponentBorderWidth003(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static ani_double TestCustomComponentBorderWidth004(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
