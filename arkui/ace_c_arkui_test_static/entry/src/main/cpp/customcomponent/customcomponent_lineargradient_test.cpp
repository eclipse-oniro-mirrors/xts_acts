...
static ani_double TestCustomComponentLinearGradient001(ani_env* env, ani_object info)
{
...
static ani_double TestCustomComponentLinearGradient002(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float angle = 90;
...
static ani_double TestCustomComponentLinearGradient003(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float angle = 90;
...
static ani_double TestCustomComponentLinearGradient004(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float angle = 90;
...
static ani_double TestCustomComponentLinearGradient005(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float angle = 90;
...
static ani_double TestCustomComponentLinearGradient006(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float angle = 90;
...
static ani_double TestCustomComponentLinearGradient007(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float angle = 90;
...
static ani_double TestCustomComponentLinearGradient008(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float angle = 90;
...
static ani_double TestCustomComponentLinearGradient009(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float angle = 90;
...
static ani_double TestCustomComponentLinearGradient010(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float angle = 90;
