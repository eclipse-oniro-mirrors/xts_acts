...
static ani_double TestCustomComponentRadialGradient001(ani_env* env, ani_object info)
{
...
static ani_double TestCustomComponentRadialGradient002(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static ani_double TestCustomComponentRadialGradient003(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float offsetValue = 25;
    int32_t repeat = 0;
...
static ani_double TestCustomComponentRadialGradient004(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float offsetValue = 25;
    int32_t repeat = 1;
