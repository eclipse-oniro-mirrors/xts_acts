...
static ani_double TestCustomComponentGrayscale001(ani_env* env, ani_object info)
{
...
static ani_double TestCustomComponentGrayscale002(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float grayScale = 0.5;
...
static ani_double TestCustomComponentGrayscale003(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
    float grayScale = 0.8;
    ArkUI_NumberValue value[] = {{.f32 = grayScale}};
...
static ani_double TestCustomComponentGrayscale004(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static ani_double TestCustomComponentGrayscale005(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
...
static ani_double TestCustomComponentGrayscale006(ani_env* env, ani_object info)
{
    NAPI_START(custom, ARKUI_NODE_CUSTOM);
