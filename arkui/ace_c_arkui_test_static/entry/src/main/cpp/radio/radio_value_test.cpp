...
static ani_double TestRadioValue001(ani_env* env, ani_object info)
{
...
static ani_double TestRadioValue002(ani_env* env, ani_object info)
{
    NAPI_START(radio, ARKUI_NODE_RADIO);
...
static ani_double TestRadioValue003(ani_env* env, ani_object info)
{
    NAPI_START(radio, ARKUI_NODE_RADIO);
