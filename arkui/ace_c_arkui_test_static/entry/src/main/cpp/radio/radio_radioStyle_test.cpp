...
static ani_double TestRadioRadioStyle001(ani_env* env, ani_object info)
{
...
static ani_double TestRadioRadioStyle002(ani_env* env, ani_object info)
{
    NAPI_START(radio, ARKUI_NODE_RADIO);
...
static ani_double TestRadioRadioStyle003(ani_env* env, ani_object info)
{
    NAPI_START(radio, ARKUI_NODE_RADIO);
...
static ani_double TestRadioRadioStyle004(ani_env* env, ani_object info)
{
    NAPI_START(radio, ARKUI_NODE_RADIO);
...
static ani_double TestRadioRadioStyle005(ani_env* env, ani_object info)
{
    NAPI_START(radio, ARKUI_NODE_RADIO);
