...
static ani_double TestRadioChecked001(ani_env* env, ani_object info)
{
...
static ani_double TestRadioChecked002(ani_env* env, ani_object info)
{
    NAPI_START(radio, ARKUI_NODE_RADIO);
...
static ani_double TestRadioChecked003(ani_env* env, ani_object info)
{
    NAPI_START(radio, ARKUI_NODE_RADIO);
...
static ani_double TestRadioChecked004(ani_env* env, ani_object info)
{
    NAPI_START(radio, ARKUI_NODE_RADIO);
...
static ani_double TestRadioChecked005(ani_env* env, ani_object info)
{
    NAPI_START(radio, ARKUI_NODE_RADIO);
    ArkUI_NumberValue value[] = {{.i32 = 1}};
    ArkUI_AttributeItem value_item = {value, sizeof(value) / sizeof(ArkUI_NumberValue)};
...
static ani_double TestRadioChecked006(ani_env* env, ani_object info)
{
...
static ani_double TestRadioChecked007(ani_env* env, ani_object info)
{
    ArkUI_NativeNodeAPI_1 *nodeAPI = nullptr;
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
    auto radio1 = nodeAPI->createNode(ARKUI_NODE_RADIO);
