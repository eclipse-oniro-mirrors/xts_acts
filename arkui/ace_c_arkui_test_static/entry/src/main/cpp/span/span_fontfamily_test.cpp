...
static ani_double TestSpanFontFamily001(ani_env* env, ani_object info)
{
...
static ani_double TestSpanFontFamily002(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_SPAN);
    ArkUI_AttributeItem valueItem = {};
    auto ret = nodeAPI->setAttribute(text, NODE_FONT_FAMILY, &valueItem);
...
static ani_double TestSpanFontFamily003(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_SPAN);
    ArkUI_AttributeItem valueItem = {};
