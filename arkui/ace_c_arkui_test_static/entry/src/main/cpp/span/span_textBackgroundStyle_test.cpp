...
static ani_double TestSpanTextBackgroundStyle001(ani_env* env, ani_object info)
{
...
static ani_double TestSpanTextBackgroundStyle002(ani_env* env, ani_object info)
{
    NAPI_START(span, ARKUI_NODE_SPAN);
...
static ani_double TestSpanTextBackgroundStyle003(ani_env* env, ani_object info)
{
    NAPI_START(span, ARKUI_NODE_SPAN);
...
static ani_double TestSpanTextBackgroundStyle004(ani_env* env, ani_object info)
{
    NAPI_START(span, ARKUI_NODE_SPAN);
...
static ani_double TestSpanTextBackgroundStyle005(ani_env* env, ani_object info)
{
    NAPI_START(span, ARKUI_NODE_SPAN);
...
static ani_double TestSpanTextBackgroundStyle006(ani_env* env, ani_object info)
{
    NAPI_START(span, ARKUI_NODE_SPAN);
