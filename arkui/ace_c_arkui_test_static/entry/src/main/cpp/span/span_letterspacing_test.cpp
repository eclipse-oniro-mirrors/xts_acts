...
static ani_double TestSpanLetterSpacing001(ani_env* env, ani_object info)
{
...
static ani_double TestSpanLetterSpacing002(ani_env* env, ani_object info)
{
    NAPI_START(span, ARKUI_NODE_SPAN);
...
static ani_double TestSpanLetterSpacing003(ani_env* env, ani_object info)
{
    NAPI_START(span, ARKUI_NODE_SPAN);
