...
static ani_double TestSpanTextCase001(ani_env* env, ani_object info)
{
...
static ani_double TestSpanTextCase002(ani_env* env, ani_object info)
{
    NAPI_START(span, ARKUI_NODE_SPAN);
...
static ani_double TestSpanTextCase003(ani_env* env, ani_object info)
{
    NAPI_START(span, ARKUI_NODE_SPAN);
...
static ani_double TestSpanTextCase004(ani_env* env, ani_object info)
{
    NAPI_START(span, ARKUI_NODE_SPAN);
