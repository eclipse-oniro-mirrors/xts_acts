...
static ani_double DialogModelTest_001(ani_env* env, ani_object info)
{
    ...
    ASSERT_EQ(nEvent == nullptr, true);
    NAPI_END;
}
static ani_double DialogModelTest_002(ani_env* env, ani_object info)
{
    ArkUI_DialogDismissEvent* nEvent = new ArkUI_DialogDismissEvent({ nullptr, 0, false });
...
static ani_double DialogModelTest_003(ani_env* env, ani_object info)
{
    ArkUI_DialogDismissEvent* nEvent = new ArkUI_DialogDismissEvent({ nullptr, 0, false });
