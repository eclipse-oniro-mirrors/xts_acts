...
static ani_double TestDatePickerStart001(ani_env* env, ani_object info)
{
...
static ani_double TestDatePickerStart002(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
...
static ani_double TestDatePickerStart003(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
...
static ani_double TestDatePickerStart004(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
