...
static ani_double TestDatePickerTextStyle001(ani_env* env, ani_object info)
{
    ...
    ASSERT_STREQ(nodeAPI->getAttribute(datePicker, NODE_DATE_PICKER_TEXT_STYLE)->string, "#FF182431;14;normal;Arial,HarmonyOS Sans;normal");
    NAPI_END;
}

static ani_double TestDatePickerTextStyle002(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
...
static ani_double TestDatePickerTextStyle003(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
...
static ani_double TestDatePickerTextStyle004(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
...
static ani_double TestDatePickerTextStyle005(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
...
static ani_double TestDatePickerTextStyle006(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
    ...
    auto ret = nodeAPI->setAttribute(datePicker, NODE_DATE_PICKER_TEXT_STYLE, &value_item);
    ASSERT_EQ(ret, SUCCESS);
    ASSERT_STREQ(nodeAPI->getAttribute(datePicker, NODE_DATE_PICKER_TEXT_STYLE)->string, "#FF182431;14;medium;Arial,HarmonyOS Sans;normal");
    NAPI_END;
}

static ani_double TestDatePickerTextStyle007(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
    ...
    auto ret = nodeAPI->setAttribute(datePicker, NODE_DATE_PICKER_TEXT_STYLE, &value_item);
    ASSERT_EQ(ret, SUCCESS);
    ASSERT_STREQ(nodeAPI->getAttribute(datePicker, NODE_DATE_PICKER_TEXT_STYLE)->string, "#FF182431;14;regular;Arial,HarmonyOS Sans;normal");
    NAPI_END;
}

static ani_double TestDatePickerTextStyle008(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
...
static ani_double TestDatePickerTextStyle009(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
...
static ani_double TestDatePickerTextStyle010(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
...
static ani_double TestDatePickerTextStyle011(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
...
static ani_double TestDatePickerTextStyle012(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
...
static ani_double TestDatePickerTextStyle013(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
    ArkUI_AttributeItem value_item = {};
