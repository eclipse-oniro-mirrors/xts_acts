...
static ani_double TestDatePickerLunar001(ani_env* env, ani_object info)
{
...
static ani_double TestDatePickerLunar002(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
...
static ani_double TestDatePickerLunar003(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
...
static ani_double TestDatePickerLunar004(ani_env* env, ani_object info)
{
    NAPI_START(datePicker, ARKUI_NODE_DATE_PICKER);
