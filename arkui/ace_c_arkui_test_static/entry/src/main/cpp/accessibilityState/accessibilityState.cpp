...
static ani_double accessibilityState_001(ani_env* env, ani_object info)
{
...
static ani_double accessibilityState_002(ani_env* env, ani_object info)
{
    auto statePrt = OH_ArkUI_AccessibilityState_Create();
...
static ani_double accessibilityState_003(ani_env* env, ani_object info)
{
    auto statePrt = OH_ArkUI_AccessibilityState_Create();
