...
static ani_double TestListItemRotate001(ani_env* env, ani_object info)
{
...
static ani_double TestListItemRotate002(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
...
static ani_double TestListItemRotate003(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float rotateX = SIZE_100;
    float rotateY = SIZE_100;
...
static ani_double TestListItemRotate004(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float rotateX = PARAM_0;
    float rotateY = PARAM_0;
...
static ani_double TestListItemRotate005(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float rotateX = PARAM_0;
    float rotateY = PARAM_0;
