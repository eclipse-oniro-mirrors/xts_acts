...
static ani_double TestListItemBrightness001(ani_env* env, ani_object info)
{
...
static ani_double TestListItemBrightness002(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
...
static ani_double TestListItemBrightness003(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
...
static ani_double TestListItemBrightness004(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
