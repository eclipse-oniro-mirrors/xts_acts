...
static ani_double TestListItemScale001(ani_env* env, ani_object info)
{
...
static ani_double TestListItemScale002(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float scaleX = PARAM_0_POINT_5;
...
static ani_double TestListItemScale003(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
...
static ani_double TestListItemScale004(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float scaleX = PARAM_2;
    float scaleY = PARAM_1;
...
static ani_double TestListItemScale005(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
