 ...
 * @tc.level      : Level 1
 */
static ani_double TestListItemSaturate001(ani_env* env, ani_object info)
{
 ...
 * @tc.level      : Level 1
 */
static ani_double TestListItemSaturate002(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
 ...
 * @tc.level      : Level 1
 */
static ani_double TestListItemSaturate003(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
 ...
 * @tc.level      : Level 1
 */
static ani_double TestListItemSaturate004(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
 ...
 * @tc.level      : Level 2
 */
static ani_double TestListItemSaturate005(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
 ...
 * @tc.level      : Level 2
 */
static ani_double TestListItemSaturate006(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
 ...
 * @tc.level      : Level 1
 */
static ani_double TestListItemSaturate007(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float saturate = 1.0;
