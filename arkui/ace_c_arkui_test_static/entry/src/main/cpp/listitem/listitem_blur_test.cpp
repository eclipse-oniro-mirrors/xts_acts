...
static ani_double TestListItemBlur001(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
    float blur = PARAM_1_POINT_5;
    ArkUI_NumberValue value[] = {{.f32 = blur}};
...
static ani_double TestListItemBlur002(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
