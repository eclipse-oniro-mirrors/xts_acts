...
static ani_double TestListItemShadow001(ani_env* env, ani_object info)
{
...
static ani_double TestListItemShadow002(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
...
static ani_double TestListItemShadow003(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
...
static ani_double TestListItemShadow004(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
...
static ani_double TestListItemShadow005(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
...
static ani_double TestListItemShadow006(ani_env* env, ani_object info)
{
    NAPI_START(listItem, ARKUI_NODE_LIST_ITEM);
