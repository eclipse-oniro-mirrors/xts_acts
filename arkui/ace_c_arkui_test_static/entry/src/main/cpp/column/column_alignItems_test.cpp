...
static ani_double TestColumnAlignItems001(ani_env* env, ani_object info)
{
...
static ani_double TestColumnAlignItems002(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestColumnAlignItems003(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestColumnAlignItems004(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
