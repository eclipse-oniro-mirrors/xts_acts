...
static ani_double TestColumnJustifyContent001(ani_env* env, ani_object info)
{
...
static ani_double TestColumnJustifyContent002(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestColumnJustifyContent003(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestColumnJustifyContent004(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestColumnJustifyContent005(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestColumnJustifyContent006(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
...
static ani_double TestColumnJustifyContent007(ani_env* env, ani_object info)
{
    NAPI_START(column, ARKUI_NODE_COLUMN);
    ...
    ASSERT_EQ(nodeAPI->getAttribute(column, NODE_COLUMN_JUSTIFY_CONTENT)->value[PARAM_0].i32, PARAM_0);
    NAPI_END;
}
}