...
static ani_double TestRefreshOffset001(ani_env* env, ani_object info)
{
...
static ani_double TestRefreshOffset002(ani_env* env, ani_object info)
{
    NAPI_START(refresh, ARKUI_NODE_REFRESH);
...
static ani_double TestRefreshOffset003(ani_env* env, ani_object info)
{
    NAPI_START(refresh, ARKUI_NODE_REFRESH);
...
static ani_double TestRefreshOffset004(ani_env* env, ani_object info)
{
    NAPI_START(refresh, ARKUI_NODE_REFRESH);
    ArkUI_NumberValue value[] = {{.f32 = PARAM_80}};
    ArkUI_AttributeItem value_item = {value, sizeof(value) / sizeof(ArkUI_NumberValue)};
