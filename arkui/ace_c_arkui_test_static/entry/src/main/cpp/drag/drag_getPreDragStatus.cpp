...
#include "drag_getPreDragStatus.h"
...
static void OnEventReceive(ArkUI_NodeEvent *event)
{
    ...
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, "DragGetPreDragStatusTest",
                 "Drag GetPreDragStatus result : %{public}d", result);
...
void GetPreDragStatusTest::CreateNativeNode(ani_env* env, ani_object info, ani_object NodeContent)
{
