...
static ani_double drag_setGetUdmfData_001(ani_env* env, ani_object info)
{
...
static ani_double drag_setGetUdmfData_002(ani_env* env, ani_object info)
{
    OH_UdmfRecord *record = OH_UdmfRecord_Create();
    OH_UdsPlainText *plainText = OH_UdsPlainText_Create();
    OH_UdsPlainText_SetAbstract(plainText, "this is plainText Abstract example");
...
static ani_double drag_setGetUdmfData_003(ani_env* env, ani_object info)
{
