...
static ani_double TestGridColumnTemplate001(ani_env* env, ani_object info)
{
...
static ani_double TestGridColumnTemplate002(ani_env* env, ani_object info)
{
    NAPI_START(grid, ARKUI_NODE_GRID);
...
static ani_double TestGridColumnTemplate003(ani_env* env, ani_object info)
{
    NAPI_START(grid, ARKUI_NODE_GRID);
