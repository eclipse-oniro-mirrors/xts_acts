...
static ani_double TestRelativeContaineAlignmentRuleOption001(ani_env* env, ani_object info)
{
...
static ani_double TestRelativeContaineAlignmentRuleOption002(ani_env* env, ani_object info)
{
    NAPI_START(text, ARKUI_NODE_TEXT);
...
static ani_double TestRelativeContaineAlignmentRuleOption003(ani_env* env, ani_object info)
{
    auto alignmentrule = OH_ArkUI_AlignmentRuleOption_Create();
