...
static ani_double TestImageSpanAlt001(ani_env* env, ani_object info)
{
...
static ani_double TestImageSpanAlt002(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static ani_double TestImageSpanAlt003(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    ArkUI_AttributeItem valueItem = {};
...
static ani_double TestImageSpanAlt004(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    OH_PixelmapNativeHandle pixelMap = nullptr;
    size_t dataSize = PARAM_960000;
...
static ani_double TestImageSpanAlt005(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    const char *value = FIRST_MIDDLE_VALUE;
    ArkUI_AttributeItem valueItem = {};
