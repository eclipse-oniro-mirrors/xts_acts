...
static ani_double TestImageSpanObjectFit001(ani_env* env, ani_object info)
{
...
static ani_double TestImageSpanObjectFit002(ani_env* env, ani_object info)
{
    NAPI_START(imageSpan, ARKUI_NODE_IMAGE_SPAN);
...
static ani_double TestImageSpanObjectFit003(ani_env* env, ani_object info)
{
    NAPI_START(imageSpan, ARKUI_NODE_IMAGE_SPAN);
...
static ani_double TestImageSpanObjectFit004(ani_env* env, ani_object info)
{
    NAPI_START(imageSpan, ARKUI_NODE_IMAGE_SPAN);
...
static ani_double TestImageSpanObjectFit005(ani_env* env, ani_object info)
{
    NAPI_START(imageSpan, ARKUI_NODE_IMAGE_SPAN);
...
static ani_double TestImageSpanObjectFit006(ani_env* env, ani_object info)
{
    NAPI_START(imageSpan, ARKUI_NODE_IMAGE_SPAN);
...
static ani_double TestImageSpanObjectFit007(ani_env* env, ani_object info)
{
    NAPI_START(imageSpan, ARKUI_NODE_IMAGE_SPAN);
    int32_t objectFit = -1;
