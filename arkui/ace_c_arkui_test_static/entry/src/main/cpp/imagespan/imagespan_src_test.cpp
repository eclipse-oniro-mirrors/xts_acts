...
static ani_double TestImageSpanSrc001(ani_env* env, ani_object info)
{
...
static ani_double TestImageSpanSrc002(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static ani_double TestImageSpanSrc003(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
...
static ani_double TestImageSpanSrc004(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    OH_PixelmapNativeHandle pixelMap = nullptr;
    OH_PixelmapNativeHandle pixelMap1 = nullptr;
...
static ani_double TestImageSpanSrc005(ani_env* env, ani_object info)
{
    NAPI_START(image, ARKUI_NODE_IMAGE);
    ArkUI_AttributeItem valueItem = {};
