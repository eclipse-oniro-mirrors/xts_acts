...
static ani_double TestCheckboxAccessibilityLevel001(ani_env* env, ani_object info)
{
...
static ani_double TestCheckboxAccessibilityLevel002(ani_env* env, ani_object info)
{
    NAPI_START(checkbox, ARKUI_NODE_CHECKBOX);
...
static ani_double TestCheckboxAccessibilityLevel003(ani_env* env, ani_object info)
{
    NAPI_START(checkbox, ARKUI_NODE_CHECKBOX);
...
static ani_double TestCheckboxAccessibilityLevel004(ani_env* env, ani_object info)
{
    NAPI_START(checkbox, ARKUI_NODE_CHECKBOX);
...
static ani_double TestCheckboxAccessibilityLevel005(ani_env* env, ani_object info)
{
    NAPI_START(checkbox, ARKUI_NODE_CHECKBOX);
...
static ani_double TestCheckboxAccessibilityLevel006(ani_env* env, ani_object info)
{
    NAPI_START(checkbox, ARKUI_NODE_CHECKBOX);
