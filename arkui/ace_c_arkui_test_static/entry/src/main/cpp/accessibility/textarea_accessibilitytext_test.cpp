...
static ani_double TestTextAreaAccessibilityText001(ani_env* env, ani_object info)
{
...
static ani_double TestTextAreaAccessibilityText002(ani_env* env, ani_object info)
{
    NAPI_START(textArea, ARKUI_NODE_TEXT_AREA);
    ArkUI_NumberValue value[] = {};
    ArkUI_AttributeItem valueItem = {value, sizeof(value) / sizeof(ArkUI_NumberValue)};
