...
static ani_double TestDrawableDescriptorCreate001(ani_env* env, ani_object info)
{
...
static ani_double TestDrawableDescriptorCreate002(ani_env* env, ani_object info)
{
    OH_PixelmapNativeHandle pixelMap = nullptr;
    OH_PixelmapNativeHandle pixelMap1 = nullptr;
    ArkUI_DrawableDescriptor* descriptorAnimated = nullptr;
...
static ani_double TestDrawableDescriptorCreate003(ani_env* env, ani_object info)
{
    ArkUI_DrawableDescriptor *drawable = nullptr;
    ani_object args = nullptr;

    ASSERT_EQ(OH_ArkUI_NativeModule_GetDrawableDescriptorFromAniValue(env, args, &drawable), ARKUI_ERROR_CODE_PARAM_INVALID);
    ASSERT_EQ(OH_ArkUI_NativeModule_GetDrawableDescriptorFromResourceAniValue(env, args, &drawable), ARKUI_ERROR_CODE_NO_ERROR);
