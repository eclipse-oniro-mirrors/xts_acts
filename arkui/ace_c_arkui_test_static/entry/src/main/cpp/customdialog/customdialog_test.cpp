...
void CustomDialogTest::CreateNativeNodeSetAutoCancel(ani_env* env, ani_object info, ani_object NodeContent)
{
...
void CustomDialogTest::CreateNativeNodeRegisterOnWillDismiss(ani_env* env, ani_object info, ani_object NodeContent)
{
    OH_LOG_INFO(LOG_APP, " [cf]TestEventInfoGetPressedTime001 start -> 66");
    //获取节点的前置框架代码，直接写就行
    ArkUI_NativeNodeAPI_1 *nodeAPI = nullptr;
