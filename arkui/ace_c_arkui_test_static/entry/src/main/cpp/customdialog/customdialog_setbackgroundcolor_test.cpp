...
static ani_double TestCustomDialogSetBackgroundColor001(ani_env* env, ani_object info)
{
...
static ani_double TestCustomDialogSetBackgroundColor002(ani_env* env, ani_object info)
{
    const ArkUI_NativeDialogAPI_1* dialogAPI = reinterpret_cast<ArkUI_NativeDialogAPI_1 *>(
    OH_ArkUI_QueryModuleInterfaceByName(ARKUI_NATIVE_DIALOG, "ArkUI_NativeDialogAPI_1"));
    ArkUI_NativeDialogHandle customDialog = dialogAPI->create();
...
static ani_double TestCustomDialogSetBackgroundColor003(ani_env* env, ani_object info)
{
    const ArkUI_NativeDialogAPI_1* dialogAPI = reinterpret_cast<ArkUI_NativeDialogAPI_1 *>(
    OH_ArkUI_QueryModuleInterfaceByName(ARKUI_NATIVE_DIALOG, "ArkUI_NativeDialogAPI_1"));
    ArkUI_NativeDialogHandle customDialog = dialogAPI->create();
...
static ani_double TestCustomDialogSetBackgroundColor004(ani_env* env, ani_object info)
{
    const ArkUI_NativeDialogAPI_1* dialogAPI = reinterpret_cast<ArkUI_NativeDialogAPI_1 *>(
    OH_ArkUI_QueryModuleInterfaceByName(ARKUI_NATIVE_DIALOG, "ArkUI_NativeDialogAPI_1"));
    ArkUI_NativeDialogHandle customDialog = dialogAPI->create();
