...
static ani_double TestListItemGroupSetFooter001(ani_env* env, ani_object info)
{
...
static ani_double TestListItemGroupSetFooter002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    auto group = CreateGroupWithFooter(list);
    auto footer = nodeAPI->createNode(ARKUI_NODE_COLUMN);
...
static ani_double TestListItemGroupSetFooter003(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    auto group = CreateGroupWithFooter(list);
