...
static ani_double TestListItemSwipeAction001(ani_env* env, ani_object info)
{
...
static ani_double TestListItemSwipeAction002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    auto option = nullptr;
    auto ret = SetItemSwipeAction(list, option);
...
static ani_double TestListItemSwipeAction003(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListItemSwipeAction004(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    auto option = CreateSwipeAction();
...
static ani_double TestListItemSwipeAction005(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    auto option = CreateSwipeAction();
...
static ani_double TestListItemSwipeAction006(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    auto option = CreateSwipeAction();
