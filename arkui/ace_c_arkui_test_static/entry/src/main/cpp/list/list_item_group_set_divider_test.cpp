...
static ani_double TestListItemGroupSetDivider001(ani_env* env, ani_object info)
{
...
static ani_double TestListItemGroupSetDivider002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    auto group = CreateGroupWithDivider(list);
    uint32_t color = COLOR_YELLOW;
...
static ani_double TestListItemGroupSetDivider003(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    auto group = CreateGroupWithDivider(list);
    uint32_t color = COLOR_YELLOW;
...
static ani_double TestListItemGroupSetDivider004(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    auto group = CreateGroupWithDivider(list);
    uint32_t color = COLOR_YELLOW;
...
static ani_double TestListItemGroupSetDivider005(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    auto group = CreateGroupWithDivider(list);
