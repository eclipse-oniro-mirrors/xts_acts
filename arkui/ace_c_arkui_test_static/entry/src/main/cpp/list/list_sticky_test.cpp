...
static ani_double TestListSticky001(ani_env* env, ani_object info)
{
...
static ani_double TestListSticky002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListSticky003(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListSticky004(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListSticky005(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
