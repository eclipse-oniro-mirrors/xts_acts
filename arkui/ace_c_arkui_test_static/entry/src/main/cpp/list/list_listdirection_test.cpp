...
static ani_double TestListListDirection001(ani_env* env, ani_object info)
{
...
static ani_double TestListListDirection002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListListDirection003(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListListDirection004(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
