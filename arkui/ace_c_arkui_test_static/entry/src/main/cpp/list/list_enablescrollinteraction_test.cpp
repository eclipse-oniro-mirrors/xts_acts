...
static ani_double TestListEnableScrollInteraction001(ani_env* env, ani_object info)
{
...
static ani_double TestListEnableScrollInteraction002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    int32_t enableScrollInteraction = false;
...
static ani_double TestListEnableScrollInteraction003(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    int32_t enableScrollInteraction = PARAM_NEGATIVE_1;
    ArkUI_NumberValue value[] = {{.i32 = enableScrollInteraction}};
    ArkUI_AttributeItem valueItem = {value, sizeof(value) / sizeof(ArkUI_NumberValue)};
    auto ret = nodeAPI->setAttribute(list, NODE_SCROLL_ENABLE_SCROLL_INTERACTION, &valueItem);
