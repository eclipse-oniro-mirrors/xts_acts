...
#ifndef ARKUI_CAPI_XTS_LIST_SCROLL_BY_TEST_H
#define ARKUI_CAPI_XTS_LIST_SCROLL_BY_TEST_H
...
class ListScrollByTest {
public:
    ~ListScrollByTest() = default;
    static void TestListScrollBy001(ani_env* env, ani_object info, ani_object NodeContent);
    static void TestListScrollBy002(ani_env* env, ani_object info, ani_object NodeContent);
    static void TestListScrollBy003(ani_env* env, ani_object info, ani_object NodeContent);
    static void TestListScrollBy004(ani_env* env, ani_object info, ani_object NodeContent);
    static ani_object GetScrollByData(ani_env* env, ani_object info);
...
#endif // ARKUI_CAPI_XTS_LIST_SCROLL_BY_TEST_H
