...
static ani_double TestListClip001(ani_env* env, ani_object info)
{
...
static ani_double TestListClip002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListClip003(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListClip004(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListClip005(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    float width = SIZE_300;
...
static ani_double TestListClip006(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    float width = SIZE_300;
    float height = SIZE_200;
...
static ani_double TestListClip007(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    float width = SIZE_300;
    float height = SIZE_200;
