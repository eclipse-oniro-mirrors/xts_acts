...
static ani_double TestListTranslate001(ani_env* env, ani_object info)
{
...
static ani_double TestListTranslate002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    float translateX = SIZE_100;
...
static ani_double TestListTranslate003(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListTranslate004(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    float translateX = PARAM_0;
    float translateY = PARAM_0;
...
static ani_double TestListTranslate005(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListTranslate006(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    float translateX = PARAM_0;
    float translateY = PARAM_0;
