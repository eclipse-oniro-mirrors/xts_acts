...
static ani_double TestListNestedScroll001(ani_env* env, ani_object info)
{
...
static ani_double TestListNestedScroll002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListNestedScroll003(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListNestedScroll004(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListNestedScroll005(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListNestedScroll006(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListNestedScroll007(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
