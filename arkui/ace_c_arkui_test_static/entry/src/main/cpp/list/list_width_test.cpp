...
static ani_double TestListWidth001(ani_env* env, ani_object info)
{
...
static ani_double TestListWidth002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListWidth003(ani_env* env, ani_object info)
{
