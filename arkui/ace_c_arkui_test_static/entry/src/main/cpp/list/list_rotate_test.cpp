...
static ani_double TestListRotate001(ani_env* env, ani_object info)
{
...
static ani_double TestListRotate002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListRotate003(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    float rotateX = SIZE_100;
    float rotateY = SIZE_100;
...
static ani_double TestListRotate004(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    float rotateX = PARAM_0;
    float rotateY = PARAM_0;
...
static ani_double TestListRotate005(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
    float rotateX = PARAM_0;
    float rotateY = PARAM_0;
