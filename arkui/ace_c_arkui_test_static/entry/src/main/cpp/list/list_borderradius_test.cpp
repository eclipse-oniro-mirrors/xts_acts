...
static ani_double TestListBorderRadius001(ani_env* env, ani_object info)
{
...
static ani_double TestListBorderRadius002(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListBorderRadius003(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListBorderRadius004(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
...
static ani_double TestListBorderRadius005(ani_env* env, ani_object info)
{
    NAPI_START(list, ARKUI_NODE_LIST);
