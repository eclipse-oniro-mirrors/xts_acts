...
export const openCriticalScopeCheckArg: () => boolean;
export const closeCriticalScopeDouble: () => boolean;
export const closeCriticalScopeCheckArg: () => boolean;
export const stringCheckArg: () => boolean;
export const stringLineStringTest: () => boolean;
export const stringLineStringUTF8Test: () => boolean;
export const stringLineStringlatin1Test: () => boolean;
export const stringWithoutScopTest: () => boolean;
export const stringNotString: () => boolean;
export const stringNotLineString: (a: string) => boolean;
export const openCriticalScopeMultiThread: () => boolean;
export const closeCriticalScopeMultiThread: () => boolean;
export const getBufferStringMultiThread: () => boolean;
export const stringLineStringInErrorEnvTest: () => boolean;
export const stringLineStringInContextEnvTest: () => boolean;
export const stringLineStringInArkRuntimeTest: () => boolean;
export const stringLineStringFromEts: (a: string) => boolean;
export const stringArrayTest: (arr: Array<any>) => boolean;
export const createStrongRefCheckArg: () => boolean;
export const createStrongRefSingle: (a: Function) => boolean;
export const createStrongRef2Ref: (a: Function) => boolean;
export const createStrongRef2Obj: (a: Function) => boolean;
export const getStrongRefCheckArg: () => boolean;
export const getStrongRef: () => boolean;
export const deleteStrongRefCheckArg: () => boolean;
export const deleteStrongRef: (a: Function) => boolean;
export const deleteStrongRef2Ref: (a: Function) => boolean;
export const deleteStrongRefDouble: (a: Function) => boolean;
export const repeateCreateDeleteStrongRef: () => boolean;
export const deleteUndefindAndCreateRef: () => boolean;
export const optStrongRefInErrorEnvTest: (a: Function) => boolean;
export const optStrongRefInContextEnvTest: () => boolean;
export const optStrongRefInArkRuntimeTest: () => boolean;
export const optStrongRefStress: () => boolean;
export const sameObjMutilStrongRef: (a: Function) => boolean;
export const gradualReferenceRelease: (a: Function) => boolean;
export const strongRefVariousTypes: () => boolean;
export const postDeleteBehavior: () => boolean;
export const crossScopeStrongRef: () => boolean;
export const manyStrongReferences: () => boolean;