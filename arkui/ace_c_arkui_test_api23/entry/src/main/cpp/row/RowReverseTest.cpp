...
napi_value RowReverseTest::CreateNativeNode(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    ...
    nodeAPI->setAttribute(Row, NODE_LINEAR_LAYOUT_REVERSE, &ReverseItem);
    ...
    nodeAPI->registerNodeEventReceiver([](ArkUI_NodeEvent *event) {
        ...
        switch (targetId) {
            case PARAM_1: {
                ...
                ArkUI_AttributeItem ReverseItem = {ReverseValue, sizeof(ReverseValue) / sizeof(ArkUI_NumberValue)};
                nodeAPI->setAttribute(Row, NODE_LINEAR_LAYOUT_REVERSE, &ReverseItem);
                auto getResReverse = nodeAPI->getAttribute(Row, NODE_LINEAR_LAYOUT_REVERSE);
