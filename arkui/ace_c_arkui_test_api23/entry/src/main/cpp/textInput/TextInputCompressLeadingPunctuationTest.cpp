...
#include "TextInputCompressLeadingPunctuationTest.h"
#include <string>
...
napi_value TextInputCompressLeadingPunctuationTest::CreateNativeNode(napi_env env, napi_callback_info info) 
{
    size_t argc = 1;
    ...
    IDTest(button, "textInputbuttonCompressLeadingPunctuation");
    ...
    IDTest(button1, "textInputbuttonCompressLeadingPunctuation1");
    ...
    IDTest(textInput, "TextInputCompressLeadingPunctuation");
    ArkUI_AttributeItem item10;
    item10.string = "【HarmonyOS】";
    nodeAPI->setAttribute( textInput , NODE_TEXT_INPUT_TEXT , &item10 );
    ArkUI_NumberValue value11[] = {{.i32 = false}};
    ArkUI_AttributeItem item11 = {value11, sizeof(value11)/ sizeof(ArkUI_NumberValue)};
    nodeAPI->setAttribute(textInput, NODE_TEXT_INPUT_COMPRESS_LEADING_PUNCTUATION, &item11);
        ...
        switch (eventType) {
            case NODE_ON_CLICK_EVENT: {
                switch (targetId) {
                    ...
                    case 1: {
                        ArkUI_NumberValue value11[] = {{.i32 = true}};
                        ArkUI_AttributeItem item11 = {value11, sizeof(value11)/ sizeof(ArkUI_NumberValue)};
                        nodeAPI->setAttribute(textInput, NODE_TEXT_INPUT_COMPRESS_LEADING_PUNCTUATION, &item11);
                        } break;
                }
