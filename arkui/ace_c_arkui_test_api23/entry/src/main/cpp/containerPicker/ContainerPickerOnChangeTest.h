...
#ifndef ARKUI_CAPI_XTS_TEXT_CONTAINERPICKER_ONCHANGE_TEST_H
#define ARKUI_CAPI_XTS_TEXT_CONTAINERPICKER_ONCHANGE_TEST_H
...
class ContainerPickerOnChangeTest {
public:
    ~ContainerPickerOnChangeTest();
...
#endif // ARKUI_CAPI_XTS_TEXT_CONTAINERPICKER_ONCHANGE_TEST_H