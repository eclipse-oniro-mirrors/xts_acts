...
#include "TextCompressLeadingPunctuationTest.h"
#include <string>
...
napi_value TextCompressLeadingPunctuationTest::CreateNativeNode(napi_env env, napi_callback_info info)
 {
    size_t argc = 1;
    ...
    IDTest(button, "textButtonCompressLeadingPunctuation");
    ...
    IDTest(button1, "textButtonCompressLeadingPunctuation1");
    ...
    IDTest(text, "TextCompressLeadingPunctuation");
    ArkUI_AttributeItem item0;
    item0.string = "【HarmonyOS】文本";
    ...
    nodeAPI->setAttribute(text, NODE_TEXT_COMPRESS_LEADING_PUNCTUATION , &item1);
        ...
        switch (eventType) {
            case NODE_ON_CLICK_EVENT: {
                switch (targetId) {
                    ...
                    case 1: {
                        ArkUI_NumberValue value1[] = {{.i32 = true}};
                        ArkUI_AttributeItem item1 = {value1, sizeof(value1)/ sizeof(ArkUI_NumberValue)};
                        nodeAPI->setAttribute( text , NODE_TEXT_COMPRESS_LEADING_PUNCTUATION , &item1 );
                        } break;
                }
