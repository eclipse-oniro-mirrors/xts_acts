...
void RefreshComponent::SetPullUpToCancelRefresh(bool noCancel)
{
    ArkUI_NumberValue value[] = { { .i32 = NoCancel } };
    ArkUI_AttributeItem item = { value, 1 };
    _nodeAPI->setAttribute(_component, NODE_REFRESH_PULL_UP_TO_CANCEL_REFRESH, &item);
}
