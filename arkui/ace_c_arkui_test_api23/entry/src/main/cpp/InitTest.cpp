...
#include <hilog/log.h>
#include "SelectedDragPreviewStyle/SelectedDragPreviewStyleTest.h"
...
//             {"getContext", nullptr, Manager::GetContext, nullptr, nullptr, nullptr, napi_default, nullptr},
            {"createNativeNode", nullptr, ColorManager::CreateNativeNode, nullptr, nullptr, nullptr, napi_default, nullptr},
//             {"upDateNativeNode", nullptr, Manager::UpdateNativeNode, nullptr, nullptr, nullptr, napi_default, nullptr}
        ...
        ColorManager::GetInstance()->Export(env, exports);
        return exports;
    }
    EXTERN_C_END
