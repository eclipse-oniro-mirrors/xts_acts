...
napi_value DeleteBackwardTest::CreateNativeNode(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    ...
    OH_ArkUI_GetModuleInterface(ARKUI_NATIVE_NODE, ArkUI_NativeNodeAPI_1, nodeAPI);
            ...
            auto text_input = nodeAPI->createNode(ARKUI_NODE_TEXT_INPUT);

            ArkUI_AttributeItem text_placeholder{ .string = "测试文本!⛏️⛏️⛏️⛏️⛏️" };
            IDTest(text_input, "textInputMiningTips");
            ...
            nodeAPI->setAttribute(text_input, NODE_TEXT_INPUT_TEXT_CONTENT_CONTROLLER_BASE, &item_controller);
            ...
            IDTest(button, "buttonDeleteBackward");
