...
#include "EllipsisModeCenterTest.h"
...
namespace ArkUICapiTest {
    ...
    napi_value EllipsisModeCenterTest::CreateNativeNode(napi_env env, napi_callback_info info)
    {
        size_t argc = PARAM_1;
        ...
        ArkUI_NumberValue TextEllipsisModeItem = {.i32 = ARKUI_ELLIPSIS_MODE_MULTILINE_CENTER};
        ArkUI_AttributeItem LABEL_Item = {&TextEllipsisModeItem, 1};
        ArkUI_AttributeItem textId = {.string = "text"};
        ...
        ArkUI_NumberValue TextInputEllipsisModeItem = {.i32 = ARKUI_ELLIPSIS_MODE_MULTILINE_CENTER};
        ArkUI_AttributeItem LABEL_Item2 = {&TextInputEllipsisModeItem, 1};
        ArkUI_AttributeItem textInputId = {.string = "textInput"};
        ...
        ArkUI_NumberValue TextAreaEllipsisModeItem = {.i32 = ARKUI_ELLIPSIS_MODE_MULTILINE_CENTER};
