...
{
    ArkUI_NumberValue value[] = { { .i32 = index }, { .i32 = ARKUI_SWIPER_DEFAULT_ANIMATION } };
    ArkUI_AttributeItem item = { value, 1 };
...
void SwiperComponent::SetSwiperCurve(int32_t curve)
{
     ArkUI_NumberValue value[] = { { .i32 = curve } };
    ArkUI_AttributeItem item = { value, 1 };
    _nodeAPI->setAttribute(_component, NODE_SWIPER_CURVE, &item);
}
