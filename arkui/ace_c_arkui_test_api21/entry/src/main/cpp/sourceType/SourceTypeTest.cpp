...
#define EVENT_JOYSTICK_TEST 1
#define EVENT_KEY_TEST      2
...
namespace ArkUICapiTest {
    ...
    static auto createChildNode(ArkUI_NativeNodeAPI_1 *nodeAPI, bool enabled)
    {
        ...
        ArkUI_AttributeItem btnIdItem = {.string = "buttonJoystickTest"};
        nodeAPI->setAttribute(nodeHandle, NODE_ID, &btnIdItem);
        ...
        nodeAPI->registerNodeEvent(nodeHandle, NODE_ON_CLICK_EVENT, EVENT_JOYSTICK_TEST, nullptr);
    ...
    static auto createChildNode1(ArkUI_NativeNodeAPI_1 *nodeAPI, bool enabled)
    {
        ...
        ArkUI_AttributeItem btnIdItem = {.string = "buttonKeyTest"};
        nodeAPI->setAttribute(nodeHandle, NODE_ID, &btnIdItem);
        ...
        nodeAPI->registerNodeEvent(nodeHandle, NODE_ON_CLICK_EVENT, EVENT_KEY_TEST, nullptr);
    ...
    static void OnEventReceive(ArkUI_NodeEvent *event)
    {
        ...
        if (eventId == EVENT_JOYSTICK_TEST) {
    ...
    napi_value ButtonSourceTypeTest::CreateNativeNode(napi_env env, napi_callback_info info)
    {
        ...
        ArkUI_AttributeItem textIdItem = {.string = "textValue"};
        nodeAPI->setAttribute(text3, NODE_ID, &textIdItem);
