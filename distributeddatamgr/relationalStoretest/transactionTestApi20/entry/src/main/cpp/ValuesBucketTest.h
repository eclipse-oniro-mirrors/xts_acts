...
#ifndef TRANSACTIONTESTAPI20_VALUESBUCKETTEST_H
#define TRANSACTIONTESTAPI20_VALUESBUCKETTEST_H
...
extern int g_vBInvalidParamCode;
...
#endif //TRANSACTIONTESTAPI20_VALUESBUCKETTEST_H