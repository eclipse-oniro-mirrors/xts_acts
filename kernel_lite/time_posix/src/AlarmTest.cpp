...
/**
 * @tc.name   testTimerCreateEventSignal
...
/**
 * @tc.name   testTimerCreateEventDefault
...
/**
 * @tc.name   testTimerCreateUniqueId
...
/**
 * @tc.name   testSetItTimerOldvalue
