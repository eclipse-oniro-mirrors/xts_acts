...
/**
 * @tc.name   HksDeriveTest001
 * @tc.number HksDeriveTest001
...
/**
 * @tc.name   HksDeriveTest003
 * @tc.number HksDeriveTest003
 * @tc.desc   The static function will return true;
 * @tc.type   FUNCTION
 * @tc.size   MEDIUMTEST
 * @tc.level  LEVEL1
...
/**
 * @tc.name   HksDeriveTest002
 * @tc.number HksDeriveTest002
 * @tc.desc   The static function will return true;
 * @tc.type   FUNCTION
 * @tc.size   MEDIUMTEST
 * @tc.level  LEVEL1
