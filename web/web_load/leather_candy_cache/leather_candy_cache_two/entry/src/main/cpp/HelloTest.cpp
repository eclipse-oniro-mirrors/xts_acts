...
static napi_value Doblankless_Success(napi_env env, napi_callback_info info)
{
    ...
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, g_tag,
                 "similarity:%{public}f,loadingTime:%{public}d,errCode:%{public}d", blanklessInfo.similarity,
    ...
    if (blanklessInfo.errCode == ARKWEB_BLANKLESS_SUCCESS) {
        if (blanklessInfo.similarity >= g_similarity) {
            OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, g_tag,
                         "similarity:%{public}f,loadingTime:%{public}d,errcode:%{public}d",
...
static napi_value Doblankless_ERR_KEY_NOT_MATCH(napi_env env, napi_callback_info info)
{
    ...
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, g_tag,
                 ...
                 blanklessInfo.loadingTime, blanklessInfo.errCode);
    if (blanklessInfo.errCode == ARKWEB_BLANKLESS_SUCCESS) {
        OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, g_tag, "similarity:%{public}f,loadingTime:%{public}d",
...
static napi_value Doblankless_INVALID_ARGS_GET_ZERO(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_get_cb_info(env, info, &argc, args, nullptr, nullptr);
...
static napi_value SetCacheCapacity100(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_get_cb_info(env, info, &argc, args, nullptr, nullptr);
    ...
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, g_tag, "%{public}s, length = %{public}d", webTagValue,
                 (int)webTagSize);
    uint32_t capacity = OH_NativeArkWeb_SetBlanklessLoadingCacheCapacity(100);
    OH_LOG_Print(LOG_APP, LOG_INFO, LOG_PRINT_DOMAIN, g_tag, "testLog: SetCacheCapacity0:capacity:%{public}d",
                 capacity);
    napi_create_uint32(env, capacity, &Capacity);
    return Capacity;
...
static napi_value Init(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        ...
        {"doblankless_INVALID_ARGS_SET_ZERO", nullptr, Doblankless_INVALID_ARGS_SET_ZERO, nullptr, nullptr, nullptr, napi_default,
         nullptr},
        {"doblankless_INVALID_ARGS_GET_ZERO", nullptr, Doblankless_INVALID_ARGS_GET_ZERO, nullptr, nullptr, nullptr, 
            napi_default, nullptr},
        ...
        {"setCacheCapacity100", nullptr, SetCacheCapacity100, nullptr, nullptr, nullptr, napi_default, nullptr},
