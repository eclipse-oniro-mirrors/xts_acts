...
export const arkWebHttpBodyStreamAsyncReadBufLenMinValue: () => number;
export const arkWebHttpBodyStreamAsyncReadBufLenMinBoundary: () => number;
export const arkWebHttpBodyStreamAsyncReadBufLenMaxBoundary: () => number;
