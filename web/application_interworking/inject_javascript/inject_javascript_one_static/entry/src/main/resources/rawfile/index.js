...
function postStringToApp() {
    console.log("In postStringToApp");
    if (h5Port) {
        console.log("In html send string message");
        h5Port.postMessage("hello world");
...
function postErrorToApp() {
    try {
        ...
        console.log("hwd ReferenceError:"+(e instanceof  SyntaxError));
        console.log("hwd ReferenceError:"+e.message);
        console.log("hwd ReferenceError:"+e.name);
        if (h5Port) {
...
function postStringToHtml() {
    console.log("postStringToHtml success in");
