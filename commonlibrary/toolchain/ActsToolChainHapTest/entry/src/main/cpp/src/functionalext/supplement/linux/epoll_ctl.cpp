...
#ifndef EPOLL_CTL_TEST
#define EPOLL_CTL_TEST
#endif
...
static int EpollCtlTestWithArgs(int argc, char* argv[])
{
    EpollCtl0100();
    return T_STATUS;
}

int EpollCtlTest(void)
{
    static char libcProgStub[] = "libc_test";
    char* libcArgvStub[] = { libcProgStub, nullptr };
    return EpollCtlTestWithArgs(1, libcArgvStub);
}

#ifdef EPOLL_CTL_TEST
#undef EPOLL_CTL_TEST
#endif