...
static int StrsignalTestImpl(int argc, char* argv[])
{
    Strsignal0100();
    Strsignal0200();
    return T_STATUS;
...
int StrsignalTest(void)
{
    static char libcProgStub[] = "libc_test";
    char* libcArgvStub[] = { libcProgStub, nullptr };
    return StrsignalTestImpl(1, libcArgvStub);
}
