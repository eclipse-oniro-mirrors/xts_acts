 ...
 * @tc.level     : Level 0
 */
void Lcong480100(void)
{
    unsigned short p[7] = { 0x0102, 0x0304, 0x0506, 0x0708, 0x090a, 0x0b0c, 0x0d0e };
    lcong48(p);
    long ret = mrand48();
    EXPECT_TRUE("Lcong480100", ret < pow(TWO, THRITYONE) && ret > -pow(TWO, THRITYONE));
}

static int Lcong48TestImpl(void)
{
    Lcong480100();
    return T_STATUS;
}

int Lcong48Test(void)
{
    return Lcong48TestImpl();
}
