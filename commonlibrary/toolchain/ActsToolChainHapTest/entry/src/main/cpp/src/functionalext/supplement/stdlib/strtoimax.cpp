...
static int StrtoimaxTestImpl(int argc, char* argv[])
{
    Strtoimax0100();
    Strtoimax0200();
    return T_STATUS;
...
int StrtoimaxTest(void)
{
    static char libcProgStub[] = "libc_test";
    char* libcArgvStub[] = { libcProgStub, nullptr };
    return StrtoimaxTestImpl(1, libcArgvStub);
}
