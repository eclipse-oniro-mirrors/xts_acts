...
static void Pipe2Test(const char* msg, int flag)
{
...
void Pipe20100(void)
{
    Pipe2Test("Pipe20100", 0);
    Pipe2Test("Pipe20100", O_CLOEXEC);
    Pipe2Test("Pipe20100", O_NONBLOCK);
}

static int Pipe2TestImpl(void)
{
    Pipe20100();
    return T_STATUS;
}
