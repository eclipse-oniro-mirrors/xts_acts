...
static int WcsnlenTestImpl(int argc, char* argv[])
{
    Wcsnlen0100();
    Wcsnlen0200();
    Wcsnlen0300();
...
int WcsnlenTest(void)
{
    static char libcProgStub[] = "libc_test";
    char* libcArgvStub[] = { libcProgStub, nullptr };
    return WcsnlenTestImpl(1, libcArgvStub);
}
