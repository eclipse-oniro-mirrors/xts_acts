...
static int CfsetospeedTestWithArgs(int argc, char* argv[])
{
    Cfsetospeed0100();
    Cfsetospeed0200();
    return T_STATUS;
...
int CfsetospeedTest(void)
{
    static char libcProgStub[] = "libc_test";
    char* libcArgvStub[] = { libcProgStub, nullptr };
    return CfsetospeedTestWithArgs(1, libcArgvStub);
}
