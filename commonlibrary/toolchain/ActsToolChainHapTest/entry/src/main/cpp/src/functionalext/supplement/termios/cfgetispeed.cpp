...
static int CfgetispeedTestWithArgs(int argc, char* argv[])
{
    Cfgetispeed0100();
    return T_STATUS;
}

int CfgetispeedTest(void)
{
    static char libcProgStub[] = "libc_test";
    char* libcArgvStub[] = { libcProgStub, nullptr };
    return CfgetispeedTestWithArgs(1, libcArgvStub);
}
