...
void Setgrent0100(void)
{
    ...
    char buf[BUFSIZ] = { 0 };
    (void)std::snprintf(buf, sizeof(buf), "%s", result->gr_name);
...
static int SetgrentTestImpl(int argc, char* argv[])
{
    Setgrent0100();
...
int SetgrentTest(void)
{
    static char libcProgStub[] = "libc_test";
    char* libcArgvStub[] = { libcProgStub, nullptr };
    return SetgrentTestImpl(1, libcArgvStub);
}
