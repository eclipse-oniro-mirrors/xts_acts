 ...
 * @tc.level     : Level 0
 */
void ResTraceFreeRegion0100(void)
{
...
static int ResTraceFreeRegionTestImpl(void)
{
    ResTraceFreeRegion0100();
    return T_STATUS;
}

int ResTraceFreeRegionTest(void)
{
    return ResTraceFreeRegionTestImpl();
}
