...
/**
 * @tc.name      : Wcscmp0500
 * @tc.desc      : One or both of the wide strings compared are equal to nullptr
 * @tc.level     : Level 1
 */
void Wcscmp0500(void)
{
    wchar_t str1[] = L"";
    wchar_t str2[] = L"";
    wchar_t str3[] = L"A";
...
static int WcscmpTestImpl(int argc, char* argv[])
{
    Wcscmp0100();
    Wcscmp0200();
    Wcscmp0300();
...
int WcscmpTest(void)
{
    ...
    return WcscmpTestImpl(1, libcArgvStub);
}
