...
// atand(+-max) is +-pi/2
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp+1023, 0x1.921fb54442d18p+0, -0x1.1a6264p-2, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fffffffffffffp+1023, -0x1.921fb54442d18p+0, 0x1.1a6264p-2, INEXACT)
// atand(+-1) is +-pi/4
T(ROUND_TO_NEAREST, 0x1p+0, 0x1.921fb54442d18p-1, -0x1.1a6264p-2, INEXACT)
T(ROUND_TO_NEAREST, -0x1p+0, -0x1.921fb54442d18p-1, 0x1.1a6264p-2, INEXACT)
// atand(tiny) is tiny
T(ROUND_TO_NEAREST, 0x1p-30, 0x1p-30, 0x1.555556p-10, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-30, -0x1p-30, -0x1.555556p-10, INEXACT)
...
T(ROUND_TO_NEAREST, -0x1.13284b2b5006dp-1, -0x1.f8f75bb5fd451p-2, 0x1.0a1192p-11, INEXACT)
T(ROUND_TO_NEAREST, 0x1.6ca8dfb825911p+0, 0x1.eadc6ce9cba6cp-1, -0x1.897aaep-5, INEXACT)
T(ROUND_TO_NEAREST, 0x1.c2ca609de7505p+0, 0x1.0de7f90a2292bp+0, -0x1.adec12p-2, INEXACT)
T(ROUND_TO_NEAREST, -0x1.55f11fba96889p+0, -0x1.db367aed1093p-1, 0x1.1aa32cp-3, INEXACT)
T(ROUND_TO_NEAREST, -0x1.15679e27084ddp-1, -0x1.fc72849d05c9p-2, 0x1.4db836p-2, INEXACT)
T(ROUND_TO_NEAREST, -0x1.41e131b093c41p-4, -0x1.413832eb4f31dp-4, -0x1.06e782p-6, INEXACT)
T(ROUND_TO_NEAREST, 0x1.281b0d18455f5p+0, 0x1.b74040cba5c63p-1, -0x1.881588p-2, INEXACT)
T(ROUND_TO_NEAREST, 0x1.b5ce34a51b239p+0, 0x1.0aab58c02e298p+0, -0x1.35666ep-2, INEXACT)
T(ROUND_TO_NEAREST, -0x1.583481079de4dp-2, -0x1.4c0e12c6c30bfp-2, 0x1.188ba8p-2, INEXACT)
T(ROUND_TO_NEAREST, -0x1.ea8223103b871p+0, -0x1.16fb9ae45d4fcp+0, -0x1.a14c14p-2, INEXACT)
...
T(ROUND_TO_NEAREST, 0x1.0000000000001p-1022, 0x1.0000000000001p-1022, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.0000000000002p-1022, 0x1.0000000000002p-1022, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.ffffffffffffbp-1022, 0x1.ffffffffffffbp-1022, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1p-1021, 0x1p-1021, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.0000000000003p-1021, 0x1.0000000000003p-1021, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1p-1020, 0x1p-1020, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.8p-27, 0x1.8p-27, 0x1.2p-2, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0000000000001p-1022, -0x1.0000000000001p-1022, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0000000000002p-1022, -0x1.0000000000002p-1022, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.ffffffffffffbp-1022, -0x1.ffffffffffffbp-1022, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-1021, -0x1p-1021, 0x0p+0, INEXACT)
...
T(ROUND_TO_NEAREST, 0x1p-1073, 0x1p-1073, 0x0p+0, INEXACT | UNDERFLOW)
T(ROUND_TO_NEAREST, 0x1.2p-1071, 0x1.2p-1071, 0x0p+0, INEXACT | UNDERFLOW)
T(ROUND_TO_NEAREST, 0x1p-1024, 0x1p-1024, 0x0p+0, INEXACT | UNDERFLOW)
T(ROUND_TO_NEAREST, 0x1p-1023, 0x1p-1023, 0x0p+0, INEXACT | UNDERFLOW)
T(ROUND_TO_NEAREST, 0x1.ffffffffffffcp-1023, 0x1.ffffffffffffcp-1023, 0x0p+0, INEXACT | UNDERFLOW)
T(ROUND_TO_NEAREST, 0x1.ffffffffffffep-1023, 0x1.ffffffffffffep-1023, 0x0p+0, INEXACT | UNDERFLOW)
T(ROUND_TO_NEAREST, -0x1p-1074, -0x1p-1074, 0x0p+0, INEXACT | UNDERFLOW)
T(ROUND_TO_NEAREST, -0x1p-1073, -0x1p-1073, 0x0p+0, INEXACT | UNDERFLOW)
T(ROUND_TO_NEAREST, -0x1.2p-1071, -0x1.2p-1071, 0x0p+0, INEXACT | UNDERFLOW)
T(ROUND_TO_NEAREST, -0x1p-1024, -0x1p-1024, 0x0p+0, INEXACT | UNDERFLOW)
