...
#ifndef UCB_LOG10_H_H
#define UCB_LOG10_H_H
...
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp+1023, 0x1.34413509f79ffp+8, 0x1.a4b4bap-5, INEXACT)
...
T(ROUND_TO_NEAREST, 0x1.000000000002p+0, 0x1.bcb7b1526e4f2p-49, -0x1.9cae5ap-2, INEXACT)
T(ROUND_TO_NEAREST, 0x1p+0, 0x0p+0, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.fffffffffffcp-1, -0x1.bcb7b1526e52ap-49, -0x1.de3f64p-8, INEXACT)
...
T(RD, 0x1.000000000002p+0, 0x1.bcb7b1526e4f2p-49, -0x1.9cae5ap-2, INEXACT)
T(RD, 0x1p+0, 0x0p+0, 0x0p+0, 0)
T(RD, 0x1.fffffffffffcp-1, -0x1.bcb7b1526e52ap-49, -0x1.de3f64p-8, INEXACT)
// log10d(min) is finite
T(ROUND_TO_NEAREST, 0x1p-1022, -0x1.33a7146f72a42p+8, -0x1.8cf2fap-5, INEXACT)
T(ROUND_TO_NEAREST, 0x1p-1074, -0x1.434e6420f4374p+8, -0x1.a0fae8p-4, INEXACT)
...
T(ROUND_TO_NEAREST, 0x1.24844b2b5006dp+5, 0x1.9024c06a2c714p+0, 0x1.aef3p-2, INEXACT)
T(ROUND_TO_NEAREST, 0x1.5671ffb825911p+6, 0x1.eeba5ddb56f6dp+0, -0x1.9e833ep-7, INEXACT)
T(ROUND_TO_NEAREST, 0x1.7817009de7505p+6, 0x1.f925b53114c7fp+0, 0x1.a6fc5ep-3, INEXACT)
T(ROUND_TO_NEAREST, 0x1.09b74fba96889p+4, 0x1.38657024f572dp+0, 0x1.e4ad62p-2, INEXACT)
T(ROUND_TO_NEAREST, 0x1.23a38e27084ddp+5, 0x1.8fcf347689cf5p+0, 0x1.5d3c72p-2, INEXACT)
T(ROUND_TO_NEAREST, 0x1.804881b093c41p+5, 0x1.ae7acf90f48a1p+0, 0x1.e587b8p-4, INEXACT)
T(ROUND_TO_NEAREST, 0x1.3baa8d18455f5p+6, 0x1.e5accf34b476ap+0, 0x1.554422p-3, INEXACT)
T(ROUND_TO_NEAREST, 0x1.730484a51b239p+6, 0x1.f7a33d27f78e2p+0, 0x1.291502p-2, INEXACT)
T(ROUND_TO_NEAREST, 0x1.4cc5b1079de4dp+5, 0x1.9e7a86923a334p+0, -0x1.b9e4c4p-5, INEXACT)
T(ROUND_TO_NEAREST, 0x1.0ca4d3103b871p+1, 0x1.49b1b2a6745efp-2, 0x1.b949bep-2, INEXACT)
// log10d(NAN) is NAN
...
T(ROUND_TO_NEAREST, -0x0p+0, -INF, 0x0p+0, DIVBYZERO)
// log10d(-ve) is NAN
T(ROUND_TO_NEAREST, -0x1p-1074, NAN, 0x0p+0, INVALID)
...
T(ROUND_TO_NEAREST, NAN, NAN, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1p-1073, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.cp-1072, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-1024, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-1023, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.ffffffffffffcp-1023, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.ffffffffffffep-1023, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.0000000000001p-1022, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.0000000000002p-1022, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-1021, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-1020, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-52, NAN, 0x0p+0, INVALID)
...
T(ROUND_TO_NEAREST, -0x1.ffffffffffffap-1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.ffffffffffffcp-1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.ffffffffffffep-1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.fffffffffffffp-1, NAN, 0x0p+0, INVALID)
...
T(ROUND_TO_NEAREST, -0x1.0000000000004p+0, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p+1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.0000000000002p+1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.ffffffffffffbp+1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p+2, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p+1022, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.0000000000002p+1022, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.0000000000004p+1022, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p+1023, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.0000000000002p+1023, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.ffffffffffffep+1023, NAN, 0x0p+0, INVALID)
