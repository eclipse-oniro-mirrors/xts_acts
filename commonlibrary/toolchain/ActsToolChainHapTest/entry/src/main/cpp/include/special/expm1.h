...
#ifndef SPECIAL_EXPM1_H_H
#define SPECIAL_EXPM1_H_H
...
// Verify these values.
// Special cases
T(ROUND_TO_NEAREST, 0x0p+0, 0x0p+0, 0x0p+0, 0)                           // zero
T(ROUND_TO_NEAREST, -0x0p+0, -0x0p+0, 0x0p+0, 0)                         // -zero
...
T(RZ, -0x0p+0, -0x0p+0, 0x0p+0, 0)                                       // -zero
T(ROUND_TO_NEAREST, 0x1p-1074, 0x1p-1074, 0x0p+0, INEXACT | UNDERFLOW)   // smallest denorm positive
T(ROUND_TO_NEAREST, -0x1p-1074, -0x1p-1074, 0x0p+0, INEXACT | UNDERFLOW) // smallest denorm negative
...
T(ROUND_TO_NEAREST, -INF, -0x1p+0, 0x0p+0, 0)                            // -INF
...
T(ROUND_TO_NEAREST,
  0x1.74c94bf209126p-10,
  0x1.750d2f63268fdp-10,
  -0x1p-1,
  INEXACT)                                                                    // 1.422066936819518703088993660799e-03
...
T(ROUND_TO_NEAREST,
  0x1.acf4bcbf84d75p-10,
  0x1.ad4ea1b49c9ap-10,
  -0x1p-1,
  INEXACT) // 1.636337299605409136352140997417e-03
T(ROUND_TO_NEAREST,
  0x1.d68e0ce210935p-10,
  0x1.d6fa3b3048628p-10,
  -0x1p-1,
  INEXACT) // 1.795024429626379926586143831457e-03
T(ROUND_TO_NEAREST,
  0x1.abccf85927836p-11,
  0x1.abf9a9cc4b305p-11,
  0x1p-1,
  INEXACT) // 8.159650125383391666006316356174e-04
T(ROUND_TO_NEAREST,
  0x1.42391da930c99p-12,
  0x1.4245ca9c2261dp-12,
  0x1p-1,
  INEXACT)                                                                    // 3.072959030527372078535341959338e-04
...
T(ROUND_TO_NEAREST,
  0x1.bbf2d53e60743p-12,
  0x1.bc0ae52f8e3cap-12,
  -0x1p-1,
  INEXACT) // 4.233823455238492033773922695872e-04
T(ROUND_TO_NEAREST,
  0x1.26f951de92a8bp-13,
  0x1.26fea1754f931p-13,
  -0x1p-1,
  INEXACT)                                                                    // 1.406545188323459134090848143828e-04
...
T(ROUND_TO_NEAREST,
  0x1.e1de96fada839p-13,
  0x1.e1ecc35ad2463p-13,
  0x1p-1,
  INEXACT) // 2.297732788421618006519803190102e-04
T(ROUND_TO_NEAREST,
  0x1.6a6b36be58808p-14,
  0x1.6a6f38ecb0f3ap-14,
  0x1p-1,
  INEXACT)                                                                    // 8.640737630608030534623553720053e-05
T(RZ, 0x1.655300604782ap-14, 0x1.6556e5e8bbe3cp-14, -0x1.43f796p-51, INEXACT) // 8.519273388116256639536472139440e-05
T(ROUND_TO_NEAREST,
  0x1.a253342489ff1p-14,
  0x1.a2588b57cf6fep-14,
  0x1p-1,
  INEXACT) // 9.973645553229528381514873425218e-05
T(ROUND_TO_NEAREST,
  0x1.27b366256f194p-15,
  0x1.27b4bbb56940ep-15,
  0x1p-1,
  INEXACT) // 3.525027959081213448956637623866e-05
T(ROUND_TO_NEAREST,
  0x1.dec504595f456p-15,
  0x1.dec883c20f85dp-15,
  -0x1p-1,
  INEXACT) // 5.707378358985801247976049621613e-05
T(ROUND_TO_NEAREST,
  0x1.0428907e1378fp-16,
  0x1.042914af76376p-16,
  -0x1p-1,
  INEXACT) // 1.550665228249693011904584982741e-05
T(ROUND_TO_NEAREST,
  0x1.2f9856c3059efp-16,
  0x1.2f990ac848cd1p-16,
  -0x1p-1,
  INEXACT)                                                                    // 1.809567653418027235469843494453e-05
...
T(ROUND_TO_NEAREST,
  0x1.51fce10251a48p-16,
  0x1.51fdc02094ef7p-16,
  -0x1p-1,
  INEXACT) // 2.014564325605376041324057201365e-05
T(ROUND_TO_NEAREST,
  0x1.7cbe2ad7e2c54p-16,
  0x1.7cbf45fafd5dap-16,
  0x1p-1,
  INEXACT)                                                                    // 2.269404180270066112307808525728e-05
...
T(ROUND_TO_NEAREST,
  0x1.b8c6eb5ffac92p-18,
  0x1.b8c74a3d94dbp-18,
  -0x1p-1,
  INEXACT) // 6.568089560214601817689401841438e-06
T(ROUND_TO_NEAREST,
  0x1.67ba80988725ap-19,
  0x1.67baa03052c7dp-19,
  -0x1p-1,
  INEXACT)                                                                   // 2.680186366411837655982387113029e-06
T(RZ, 0x1.84709ffc724e4p-19, 0x1.8470c4d2ce0a9p-19, -0x1.75431p-51, INEXACT) // 2.894103088933566825355532536879e-06
T(ROUND_TO_NEAREST,
  0x1.99213264807dcp-19,
  0x1.99215b4234ab9p-19,
  -0x1p-1,
  INEXACT)                                                                    // 3.048253619520621701221956001415e-06
...
T(ROUND_TO_NEAREST,
  0x1.1b990cab42256p-20,
  0x1.1b99167ca04b7p-20,
  -0x1p-1,
  INEXACT) // 1.056484317642688086023297286409e-06
T(ROUND_TO_NEAREST,
  0x1.11e54952cc21ep-20,
  0x1.11e5527b22f41p-20,
  -0x1p-1,
  INEXACT)                                                                    // 1.020340808021689558477860734764e-06
T(RZ, 0x1.3763a907b12f8p-20, 0x1.3763b4ddcbd83p-20, -0x1.9ff9c8p-51, INEXACT) // 1.160015530675047266680015300988e-06
T(ROUND_TO_NEAREST,
  0x1.a4406cb34c9d4p-20,
  0x1.a440824269011p-20,
  -0x1p-1,
  INEXACT)                                                                    // 1.565559426830292909422776698181e-06
...
T(ROUND_TO_NEAREST,
  0x1.afb5c5e4486f4p-21,
  0x1.afb5d1445ee81p-21,
  0x1p-1,
  INEXACT)                                                                    // 8.041226320679659189986313722054e-07
...
T(ROUND_TO_NEAREST,
  0x1.371a1ec60762fp-22,
  0x1.371a21ba285aap-22,
  0x1p-1,
  INEXACT)                                                                    // 2.897363454728492891089781154784e-07
...
T(ROUND_TO_NEAREST,
  0x1.6eb68e8c7b02ap-22,
  0x1.6eb692a7180e1p-22,
  0x1p-1,
  INEXACT) // 3.415282001917601564412057570108e-07
T(ROUND_TO_NEAREST,
  0x1.5540c0f13fd48p-23,
  0x1.5540c2b825688p-23,
  0x1p-1,
  INEXACT) // 1.589082852318328754247451009562e-07
T(ROUND_TO_NEAREST,
  0x1.a31972381bd0cp-23,
  0x1.a31974e638221p-23,
  -0x1p-1,
  INEXACT)                                                                    // 1.951583656930781513543448311976e-07
T(RZ, 0x1.08e89d859a836p-24, 0x1.08e89e0eaacfbp-24, -0x1.b7a0cap-52, INEXACT) // 6.167885232560242796691471391796e-08
T(ROUND_TO_NEAREST,
  0x1.1a4d6f93a29efp-24,
  0x1.1a4d702f49f7dp-24,
  0x1p-1,
  INEXACT)                                                                    // 6.572866900249659935210640301570e-08
...
T(ROUND_TO_NEAREST,
  0x1.725d1832dbe89p-24,
  0x1.725d193ec486fp-24,
  -0x1p-1,
  INEXACT)                                                                   // 8.623200713013558743784897154053e-08
...
T(ROUND_TO_NEAREST,
  0x1.f21ac1d3378f2p-25,
  0x1.f21ac2c58296bp-25,
  0x1p-1,
  INEXACT)                                                                    // 5.798699800341913557350355607270e-08
...
T(ROUND_TO_NEAREST,
  0x1.709790c9cef04p-26,
  0x1.7097910c25739p-26,
  0x1p-1,
  INEXACT)                                                            // 2.145488123900374738431499075167e-08
T(RZ, 0x1.97ef8c7a6a15ap-27, 0x1.97ef8ca30aceap-27, -0x1p+0, INEXACT) // 1.187249253495058302790544316630e-08
T(ROUND_TO_NEAREST,
  0x1.bddfe561dbef3p-27,
  0x1.bddfe5926531bp-27,
  0x1p-1,
  INEXACT)                                                                    // 1.297665858424598428062944399436e-08
...
T(ROUND_TO_NEAREST,
  0x1.9d6f375a07c12p-28,
  0x1.9d6f376ee5417p-28,
  0x1p-1,
  INEXACT)                                                                       // 6.016262899351159692087286881990e-09
...
T(ROUND_TO_NEAREST, 0x1.c24b71882cff3p-3, 0x1.f7a274060d907p-3, 0x1p-1, INEXACT) // 2.198704595263048788833515345686e-01
T(RZ, 0x1.fde31a71ddba9p-3, 0x1.217c79b0566b5p-2, -0x1.066766p-52, INEXACT)      // 2.489683214186844406601295531800e-01
T(ROUND_TO_NEAREST,
  0x1.f75b20f5ac212p-30,
  0x1.f75b20fd678fap-30,
  0x1p-1,
  INEXACT) // 1.831198357374760117422428918580e-09
T(ROUND_TO_NEAREST,
  0x1.816060fba05b5p-31,
  0x1.816060fde47e5p-31,
  -0x1p-1,
  INEXACT)                                                                   // 7.009957332081317687745861915295e-10
T(RZ, 0x1.fcffdbc85be3ep-31, 0x1.fcffdbcc4fec5p-31, -0x1.96b55p-55, INEXACT) // 9.258646011715036043020402617052e-10
T(ROUND_TO_NEAREST,
  0x1.efc075bb4e78fp-31,
  0x1.efc075bf0e82dp-31,
  0x1p-1,
  INEXACT) // 9.017672645180203612081538623233e-10
T(ROUND_TO_NEAREST,
  0x1.079df58d66228p-32,
  0x1.079df58deddd8p-32,
  0x1p-1,
  INEXACT)                                                                    // 2.397582903371179136683931512131e-10
...
T(ROUND_TO_NEAREST,
  0x1.22be606863db3p-33,
  0x1.22be6068b6682p-33,
  -0x1p-1,
  INEXACT)                                                                    // 1.322149085198737521897341807607e-10
...
T(ROUND_TO_NEAREST,
  0x1.eff9e72fe698cp-33,
  0x1.eff9e730d6d2ep-33,
  0x1p-1,
  INEXACT)                                                            // 2.255438557246551296427447616392e-10
...
T(ROUND_TO_NEAREST,
  0x1.095702237abdcp-34,
  0x1.095702239d1e6p-34,
  -0x1p-1,
  INEXACT)                                                            // 6.033130293470062662984341451641e-11
...
T(ROUND_TO_NEAREST,
  0x1.38de271070a65p-34,
  0x1.38de2710a0722p-34,
  0x1p-1,
  INEXACT)                                                            // 7.113789787869701429669294351813e-11
...
T(ROUND_TO_NEAREST,
  0x1.e10ba450e0138p-34,
  0x1.e10ba45151111p-34,
  -0x1p-1,
  INEXACT)                                                            // 1.093770779361761086321169770999e-10
T(RZ, 0x1.e2ffffffda07ap-34, 0x1.e30000004bf0bp-34, -0x1p+0, INEXACT) // 1.098214852370709582915546827006e-10
T(ROUND_TO_NEAREST,
  0x1.e53feae59a2c3p-34,
  0x1.e53feae60d25ap-34,
  0x1p-1,
  INEXACT)                                                            // 1.103330027926859625004644019823e-10
...
T(ROUND_TO_NEAREST,
  0x1.9327892d5759dp-35,
  0x1.9327892d7f082p-35,
  -0x1p-1,
  INEXACT)                                                            // 4.583335304535563948131400182231e-11
...
T(ROUND_TO_NEAREST,
  0x1.68f8e887525d9p-36,
  0x1.68f8e88762458p-36,
  0x1p-1,
  INEXACT)                                                            // 2.051889953832339597598697276729e-11
...
T(ROUND_TO_NEAREST,
  0x1.95aef19a6bb93p-36,
  0x1.95aef19a7fd05p-36,
  0x1p-1,
  INEXACT)                                                            // 2.306042995726105936178128527223e-11
...
T(ROUND_TO_NEAREST,
  0x1.85f1e2dccad35p-36,
  0x1.85f1e2dcdd632p-36,
  0x1p-1,
  INEXACT)                                                            // 2.216579945846740163251454060499e-11
...
T(ROUND_TO_NEAREST,
  0x1.afe1c60db945ep-37,
  0x1.afe1c60dc4a85p-37,
  0x1p-1,
  INEXACT)                                                            // 1.227482267461914424013486921320e-11
T(RZ, 0x1.b1ba5fdf09c34p-37, 0x1.b1ba5fdf153e9p-37, -0x1p+0, INEXACT) // 1.232729190914681615383629394667e-11
T(ROUND_TO_NEAREST,
  0x1.80d46fe77a36bp-37,
  0x1.80d46fe78340ap-37,
  -0x1p-1,
  INEXACT)                                                            // 1.093752168011161407811498738566e-11
...
T(ROUND_TO_NEAREST,
  0x1.9c0bce1f40b19p-37,
  0x1.9c0bce1f4b0e6p-37,
  -0x1p-1,
  INEXACT)                                                                    // 1.171105492185670062735711629842e-11
...
T(ROUND_TO_NEAREST,
  0x1.18ce54e43bc89p-38,
  0x1.18ce54e43e309p-38,
  -0x1p-1,
  INEXACT)                                                            // 3.990493025328016717818473197002e-12
T(RZ, 0x1.37ffffffff028p-38, 0x1.3800000001fafp-38, -0x1p+0, INEXACT) // 4.433786671139748749128281171632e-12
T(ROUND_TO_NEAREST,
  0x1.483cdb228d0a4p-38,
  0x1.483cdb229054p-38,
  0x1p-1,
  INEXACT)                                                                   // 4.664538532981070104301153949538e-12
...
T(ROUND_TO_NEAREST,
  0x1.8387d84827defp-38,
  0x1.8387d8482c743p-38,
  -0x1p-1,
  INEXACT)                                                            // 5.507141678851540396603104706463e-12
...
T(ROUND_TO_NEAREST,
  0x1.bfd7fe36b08dep-38,
  0x1.bfd7fe36b6acdp-38,
  0x1p-1,
  INEXACT)                                                                       // 6.364242079004326352489170501503e-12
...
T(ROUND_TO_NEAREST, 0x1.d073a1cb8cf81p-4, 0x1.ebceec01f86dap-4, 0x1p-1, INEXACT) // 1.133915252801767220569573169087e-01
T(RZ, 0x1.07ffffffffd2ap-40, 0x1.08000000005abp-40, -0x1p+0, INEXACT)            // 9.379164112031856308174832768330e-13
T(ROUND_TO_NEAREST,
  0x1.6eeee8953b88dp-40,
  0x1.6eeee8953c8fdp-40,
  0x1p-1,
  INEXACT) // 1.303608728285667019096179834925e-12
T(ROUND_TO_NEAREST,
  0x1.6fb79fd6dfea8p-40,
  0x1.6fb79fd6e0f29p-40,
  -0x1p-1,
  INEXACT)                                                                   // 1.306394220197366811490171403839e-12
...
T(ROUND_TO_NEAREST,
  0x1.cc39dd320459dp-41,
  0x1.cc39dd320528bp-41,
  0x1p-1,
  INEXACT) // 8.175256585893962896652626242275e-13
T(ROUND_TO_NEAREST,
  0x1.94bb650391d3dp-41,
  0x1.94bb65039273dp-41,
  0x1p-1,
  INEXACT)                                                                    // 7.189484742661675165154062653162e-13
T(RZ, 0x1.e93e8b71a4dd6p-41, 0x1.e93e8b71a5c72p-41, -0x1.0d1112p-51, INEXACT) // 8.690724855238409533128777904119e-13
T(ROUND_TO_NEAREST,
  0x1.1874eee5c5d0cp-42,
  0x1.1874eee5c5f73p-42,
  0x1p-1,
  INEXACT)                                                                   // 2.490956510279911583289984916904e-13
...
T(ROUND_TO_NEAREST,
  0x1.8d076a5427a2p-42,
  0x1.8d076a5427eefp-42,
  -0x1p-1,
  INEXACT)                                                            // 3.526325597726107824465563477484e-13
T(RZ, 0x1.dfffffffffda8p-42, 0x1.e0000000004afp-42, -0x1p+0, INEXACT) // 4.263256414560298192639140736935e-13
T(ROUND_TO_NEAREST,
  0x1.15d1f1225f82ap-43,
  0x1.15d1f1225f958p-43,
  0x1p-1,
  INEXACT)                                                          // 1.233769023243168389018266999356e-13
T(RZ, 0x1.542a278d2d01p-45, 0x1.542a278d2d08p-45, -0x1p+0, INEXACT) // 3.776586443654601935473502996355e-14
T(ROUND_TO_NEAREST,
  0x1.db2cfe686fe33p-45,
  0x1.db2cfe686ff1p-45,
  0x1p-1,
  INEXACT) // 5.275510661177437820176944937496e-14
T(ROUND_TO_NEAREST,
  0x1.1520cd1372fdep-46,
  0x1.1520cd1373003p-46,
  -0x1p-1,
  INEXACT) // 1.538370149106847187694267014300e-14
T(ROUND_TO_NEAREST,
  0x1.44c3b83e57142p-46,
  0x1.44c3b83e57175p-46,
  -0x1p-1,
  INEXACT)                                                                  // 1.802805294398302203023757228049e-14
T(RZ, 0x1.36406304452f6p-46, 0x1.3640630445325p-46, -0x1.584dp-51, INEXACT) // 1.722241853988860473407695988289e-14
T(ROUND_TO_NEAREST,
  0x1.ea8cfb6454784p-46,
  0x1.ea8cfb64547f9p-46,
  -0x1p-1,
  INEXACT)                                                                      // 2.723103470137968084262979037428e-14
T(ROUND_TO_NEAREST, 0x1.eeb53f23abp-46, 0x1.eeb53f23ab078p-46, 0x1p-1, INEXACT) // 2.746181030797642778648512859835e-14
T(ROUND_TO_NEAREST,
  0x1.3fffffffffffcp-48,
  0x1.4000000000009p-48,
  0x1p-1,
  INEXACT)                                                            // 4.440892098500623006250905788316e-15
T(RZ, 0x1.52a7fa9d2f8e5p-48, 0x1.52a7fa9d2f8f2p-48, -0x1p+0, INEXACT) // 4.699798436761761336777438422103e-15
T(ROUND_TO_NEAREST,
  0x1.ad5336963eef4p-48,
  0x1.ad5336963ef0ap-48,
  -0x1p-1,
  INEXACT)                                                                    // 5.958081967793449171579456825525e-15
...
T(ROUND_TO_NEAREST,
  0x1.ffffffffffffbp-49,
  0x1.0000000000006p-48,
  0x1p-1,
  INEXACT)                                                                       // 3.552713678800498957203358285361e-15
T(ROUND_TO_NEAREST, 0x1.6c30481c8c9e8p-5, 0x1.7467bb86605b2p-5, 0x1p-1, INEXACT) // 4.445661625176794418123904506501e-02
T(RZ, 0x1.7e6fd1401d233p-5, 0x1.878113fde1c06p-5, -0x1p+0, INEXACT)              // 4.668417805888615962350840504769e-02
T(ROUND_TO_NEAREST,
  0x1.be393873d8fa8p-5,
  0x1.ca99aa8488d0ap-5,
  -0x1p-1,
  INEXACT) // 5.447064424404796101342185465910e-02
T(ROUND_TO_NEAREST,
  0x1.7ffffffffffffp-50,
  0x1.8000000000004p-50,
  0x1p-1,
  INEXACT) // 1.332267629550187651293131696456e-15
T(ROUND_TO_NEAREST,
  0x1.94c583ada5b53p-51,
  0x1.94c583ada5b56p-51,
  0x1p-1,
  INEXACT)                                                                       // 7.021666937153402449716262382570e-16
T(ROUND_TO_NEAREST, 0x1.ffffffffffffdp-51, 0x1p-50, -0x1p-1, INEXACT)            // 8.881784197001249365160658765932e-16
T(ROUND_TO_NEAREST, 0x1.1dd3799f6bb5fp-6, 0x1.205575069701bp-6, 0x1p-1, INEXACT) // 1.744543912144124950258650130763e-02
...
T(ROUND_TO_NEAREST,
  0x1.0af5b58ee4bf4p-9,
  0x1.0b3b5a8b5d045p-9,
  -0x1p-1,
  INEXACT)                                                                  // 2.036741650451196275484200270967e-03
...
T(ROUND_TO_NEAREST,
  0x1.80345fb9bf501p+0,
  0x1.be1d656d0ed3cp+1,
  -0x1p-1,
  INEXACT)                                                                       // 1.500799162720170665252794606204e+00
T(ROUND_TO_NEAREST, 0x1.a083788425ab6p+0, 0x1.05abe6a4c4281p+2, 0x1p-1, INEXACT) // 1.627006084692465659458093796275e+00
T(ROUND_TO_NEAREST, 0x1.aca7ae8da5a7bp+0, 0x1.157d4acd7e557p+2, 0x1p-1, INEXACT) // 1.674433621961411544631914694037e+00
...
T(ROUND_TO_NEAREST, 0x1.aa1b465630fa4p+2, 0x1.84f6653f47e5ep+9, 0x1p-1, INEXACT) // 6.657914718791207775439033866860e+00
T(ROUND_TO_NEAREST,
  0x1.60bb5fb993b99p+3,
  0x1.de94d34fcccfep+15,
  0x1p-1,
  INEXACT) // 1.102287279363172167734319373267e+01
T(ROUND_TO_NEAREST,
  0x1.6d2883e37b4d7p+3,
  0x1.60d65c9585ca5p+16,
  0x1p-1,
  INEXACT) // 1.141119570188531717747082439018e+01
T(ROUND_TO_NEAREST,
  0x1.796c771af1e4bp+3,
  0x1.02d399f8e15f2p+17,
  0x1p-1,
  INEXACT)                                                                   // 1.179449038756060552657345397165e+01
...
T(ROUND_TO_NEAREST,
  -0x1.1ab099b07ee77p-1,
  -0x1.b275aa376de93p-2,
  -0x1p-1,
  INEXACT) // -5.521286037396312407210530182056e-01
T(ROUND_TO_NEAREST,
  -0x1.22c36ae45e85fp-1,
  -0x1.bbaed410a34b4p-2,
  0x1p-1,
  INEXACT) // -5.678971675654443940217674935411e-01
T(ROUND_TO_NEAREST,
  -0x1.2cd0c35ecc0b9p-1,
  -0x1.c6f71835c6056p-2,
  -0x1p-1,
  INEXACT) // -5.875302365511948510246043042571e-01
T(ROUND_TO_NEAREST,
  -0x1.80392a196b902p-1,
  -0x1.0e40f7c7610a8p-1,
  -0x1p-1,
  INEXACT)                                                                     // -7.504361301451185628508255831548e-01
T(RZ, -0x1.0f1f661a97dabp-10, -0x1.0efb84d590daap-10, 0x1.57b048p-51, INEXACT) // -1.034250838209386678598344921909e-03
T(ROUND_TO_NEAREST,
  -0x1.05f634cf839a4p-10,
  -0x1.05d4b5ac409bep-10,
  0x1p-1,
  INEXACT) // -9.993047459634163756647673437783e-04
T(ROUND_TO_NEAREST,
  -0x1.89a8c886e52f4p-10,
  -0x1.895d27435f0e8p-10,
  -0x1p-1,
  INEXACT) // -1.501691092675003398604349769130e-03
T(ROUND_TO_NEAREST,
  -0x1.a168287b8f008p-10,
  -0x1.a1132179c08b9p-10,
  -0x1p-1,
  INEXACT)                                                             // -1.592280836930195023204426263419e-03
T(RZ, -0x1.91ad2e5ca3434p-11, -0x1.9185ccefbfa54p-11, 0x1p+0, INEXACT) // -7.661371015089736037639855936732e-04
T(ROUND_TO_NEAREST,
  -0x1.0fcec2f150b9p-12,
  -0x1.0fc5be6923a5cp-12,
  -0x1p-1,
  INEXACT) // -2.592159863363191832363874311795e-04
T(ROUND_TO_NEAREST,
  -0x1.27613c160f4bdp-12,
  -0x1.275695cdad3f6p-12,
  0x1p-1,
  INEXACT) // -2.816961508676598985485839410359e-04
T(ROUND_TO_NEAREST,
  -0x1.2b94f4ceb8146p-12,
  -0x1.2b8a0068c3577p-12,
  -0x1p-1,
  INEXACT) // -2.857035259875749999211591578785e-04
T(ROUND_TO_NEAREST,
  -0x1.6d56dad4dbc5fp-12,
  -0x1.6d46904a8fd22p-12,
  -0x1p-1,
  INEXACT) // -3.484146848710730089669629361282e-04
T(ROUND_TO_NEAREST,
  -0x1.41273994c4678p-12,
  -0x1.411aa2cddc42cp-12,
  0x1p-1,
  INEXACT)                                                             // -3.062755798036507874637646153815e-04
T(RZ, -0x1.4ef3ddbb27828p-12, -0x1.4ee62c10c03a8p-12, 0x1p+0, INEXACT) // -3.194356938339714714614192558884e-04
T(ROUND_TO_NEAREST,
  -0x1.64e818f700ef9p-12,
  -0x1.64d88cb7de3c1p-12,
  0x1p-1,
  INEXACT)                                                                     // -3.403726872763658908328798791132e-04
T(RZ, -0x1.8503555f8030ep-12, -0x1.84f0dcdc27564p-12, 0x1.4a3778p-51, INEXACT) // -3.709917272943099404367006677319e-04
T(ROUND_TO_NEAREST,
  -0x1.f4ae809dd0631p-12,
  -0x1.f48fe80c0d45ap-12,
  -0x1p-1,
  INEXACT)                                                                     // -4.774872303308945659973405728493e-04
T(RZ, -0x1.cead59cec620dp-13, -0x1.cea0493527c42p-13, 0x1.b438c8p-54, INEXACT) // -2.206216581377571565956291488320e-04
T(ROUND_TO_NEAREST,
  -0x1.3fff180603bc4p-14,
  -0x1.3ffbf80fc0ep-14,
  0x1p-1,
  INEXACT) // -7.629310138688923667929508987129e-05
T(ROUND_TO_NEAREST,
  -0x1.fdb28a850de72p-14,
  -0x1.fdaa9cfb2b049p-14,
  -0x1p-1,
  INEXACT) // -1.215213361128676856654645677125e-04
T(ROUND_TO_NEAREST,
  -0x1.f5c9d0a8c2db9p-15,
  -0x1.f5c5f91e3e4bp-15,
  -0x1p-1,
  INEXACT)                                                             // -5.981783153260638213931724149752e-05
...
T(ROUND_TO_NEAREST,
  -0x1.d502542073e7dp-16,
  -0x1.d500a680b623bp-16,
  -0x1p-1,
  INEXACT)                                                             // -2.795512057379580969054995442935e-05
T(RZ, -0x1.7c47f56857315p-16, -0x1.7c46daf608a87p-16, 0x1p+0, INEXACT) // -2.266651918724205998158412189714e-05
T(ROUND_TO_NEAREST,
  -0x1.242015a4dce9p-17,
  -0x1.241fc24e9f691p-17,
  0x1p-1,
  INEXACT) // -8.706013270055255577964392621482e-06
T(ROUND_TO_NEAREST,
  -0x1.2601670e72e61p-17,
  -0x1.260112a4b4e09p-17,
  0x1p-1,
  INEXACT)                                                                     // -8.762046061947655628825322449149e-06
T(RZ, -0x1.3907c6e050d84p-17, -0x1.3907672f63356p-17, 0x1.9cb5c6p-51, INEXACT) // -9.329032253041801882060407580255e-06
T(ROUND_TO_NEAREST,
  -0x1.6c2d1aa96dccap-17,
  -0x1.6c2c99257990bp-17,
  -0x1p-1,
  INEXACT)                                                                     // -1.085329616300062053062432110284e-05
...
T(ROUND_TO_NEAREST,
  -0x1.e4df1156e57ecp-17,
  -0x1.e4de2bc01efc5p-17,
  0x1p-1,
  INEXACT)                                                                     // -1.445029253747603324156342785578e-05
T(RZ, -0x1.f0bdc4310c393p-17, -0x1.f0bcd33960ecap-17, 0x1.646968p-54, INEXACT) // -1.480404361772924135465159117819e-05
T(ROUND_TO_NEAREST,
  -0x1.3f4f5a5e1d5bap-17,
  -0x1.3f4ef6cc7b1aap-17,
  0x1p-1,
  INEXACT) // -9.516178746541966647050705963018e-06
T(ROUND_TO_NEAREST,
  -0x1.555b5316cb345p-17,
  -0x1.555ae14bc982ap-17,
  -0x1p-1,
  INEXACT)                                                             // -1.017322351301034006958948913146e-05
T(RZ, -0x1.14eddeb406831p-18, -0x1.14edb941d13bep-18, 0x1p+0, INEXACT) // -4.126566341989101753854555371115e-06
T(ROUND_TO_NEAREST,
  -0x1.998a1d6af0065p-18,
  -0x1.9989cb85a760ep-18,
  -0x1p-1,
  INEXACT) // -6.102614274306003069186805226609e-06
T(ROUND_TO_NEAREST,
  -0x1.ab79422f4afadp-18,
  -0x1.ab78e8f59fde2p-18,
  -0x1p-1,
  INEXACT) // -6.369854005410581971908124537807e-06
T(ROUND_TO_NEAREST,
  -0x1.6fddc52af837dp-18,
  -0x1.6fdd83174cb38p-18,
  0x1p-1,
  INEXACT)                                                             // -5.481634881982701329374441795439e-06
T(RZ, -0x1.db3c2d03b8371p-18, -0x1.db3bbebcbda03p-18, 0x1p+0, INEXACT) // -7.081554261851499442912642040548e-06
T(ROUND_TO_NEAREST,
  -0x1.8e53bbf839b9fp-18,
  -0x1.8e536e7f34ca3p-18,
  -0x1p-1,
  INEXACT) // -5.935536130353019351605422387896e-06
T(ROUND_TO_NEAREST,
  -0x1.2bdc15fbc0542p-19,
  -0x1.2bdc000803dd7p-19,
  -0x1p-1,
  INEXACT) // -2.234128940404326811033312166765e-06
T(ROUND_TO_NEAREST,
  -0x1.1216bde35b358p-19,
  -0x1.1216ab8c10fefp-19,
  0x1p-1,
  INEXACT)                                                                     // -2.042120955605979435538641086900e-06
T(RZ, -0x1.42d8d1f14a75ap-19, -0x1.42d8b87ee94f9p-19, 0x1.ea831ap-51, INEXACT) // -2.405397247291877123071424798839e-06
T(ROUND_TO_NEAREST,
  -0x1.1570e1f7cffb3p-2,
  -0x1.e610b3cac1306p-3,
  -0x1p-1,
  INEXACT)                                                           // -2.709384257796003114826532964798e-01
...
T(ROUND_TO_NEAREST,
  -0x1.0498e25388035p-20,
  -0x1.0498da0950f82p-20,
  -0x1p-1,
  INEXACT) // -9.708002338751465886665424978585e-07
T(ROUND_TO_NEAREST,
  -0x1.3f20a8b5e3b57p-20,
  -0x1.3f209c4750c32p-20,
  -0x1p-1,
  INEXACT) // -1.188842856578606281057314784932e-06
T(ROUND_TO_NEAREST,
  -0x1.64d77da92bd2cp-20,
  -0x1.64d76e1debef3p-20,
  0x1p-1,
  INEXACT)                                                                     // -1.329339151017446716228614239652e-06
...
T(ROUND_TO_NEAREST,
  -0x1.34b5c03fe14dp-21,
  -0x1.34b5ba6eca012p-21,
  0x1p-1,
  INEXACT)                                                             // -5.750171183516262970189872327786e-07
T(RZ, -0x1.c8299e237262ep-21, -0x1.c82991702176ap-21, 0x1p+0, INEXACT) // -8.496689968769756365639172698834e-07
T(ROUND_TO_NEAREST,
  -0x1.0f9b1c5ad2f3p-22,
  -0x1.0f9b1a1a7f6e3p-22,
  -0x1p-1,
  INEXACT)                                                             // -2.529527073815718499617648251654e-07
T(RZ, -0x1.8607ff42afa59p-22, -0x1.8607fa9e36f2fp-22, 0x1p+0, INEXACT) // -3.632448974214619337876985925156e-07
T(ROUND_TO_NEAREST,
  -0x1.b975fa8d78b3ep-22,
  -0x1.b975f49ae9626p-22,
  -0x1p-1,
  INEXACT) // -4.111424594927800921052916775789e-07
T(ROUND_TO_NEAREST,
  -0x1.8a8597b7c4b28p-23,
  -0x1.8a859557c5383p-23,
  0x1p-1,
  INEXACT)                                                             // -1.837135508100481621720405714382e-07
T(RZ, -0x1.3cc6c05cdacaap-23, -0x1.3cc6bed4df86ap-23, 0x1p+0, INEXACT) // -1.475104935104347234668339689662e-07
T(ROUND_TO_NEAREST,
  -0x1.a6575a3a33c26p-23,
  -0x1.a65757816faa1p-23,
  0x1p-1,
  INEXACT) // -1.966679564258717782011538343506e-07
T(ROUND_TO_NEAREST,
  -0x1.a75c69c705603p-23,
  -0x1.a75c670ae2dc4p-23,
  0x1p-1,
  INEXACT) // -1.971428231501148585428625841995e-07
T(ROUND_TO_NEAREST,
  -0x1.b1ec040e36b4dp-24,
  -0x1.b1ec029e7695fp-24,
  0x1p-1,
  INEXACT)                                                                     // -1.010303238598533392938650277322e-07
...
T(ROUND_TO_NEAREST,
  -0x1.b2d4689ccd32ep-25,
  -0x1.b2d467e427fa5p-25,
  0x1p-1,
  INEXACT)                                                             // -5.062084194041830923558835308648e-08
...
T(ROUND_TO_NEAREST,
  -0x1.0a674f3b47648p-26,
  -0x1.0a674f18a0094p-26,
  -0x1p-1,
  INEXACT)                                                                     // -1.550672766331305955332935542917e-08
...
T(ROUND_TO_NEAREST,
  -0x1.066c67246ca9cp-28,
  -0x1.066c671c04994p-28,
  -0x1p-1,
  INEXACT)                                                             // -3.818763781256577140510582459541e-09
T(RZ, -0x1.be4c1b674fc4bp-28, -0x1.be4c1b4eff5a7p-28, 0x1p+0, INEXACT) // -6.494480376497894852262762120610e-09
T(ROUND_TO_NEAREST,
  -0x1.4d4b7ec11a5fbp-29,
  -0x1.4d4b7eba52a9cp-29,
  -0x1p-1,
  INEXACT)                                                                   // -2.425039586285558039232762038754e-09
...
T(ROUND_TO_NEAREST,
  -0x1.64808871369c2p-30,
  -0x1.6480886d55b0bp-30,
  -0x1p-1,
  INEXACT) // -1.296947018793988569947992376481e-09
T(ROUND_TO_NEAREST,
  -0x1.649d68b5eeff4p-30,
  -0x1.649d68b20d72fp-30,
  -0x1p-1,
  INEXACT) // -1.297357372125221613015861791109e-09
T(ROUND_TO_NEAREST,
  -0x1.e09ccbbbb4315p-30,
  -0x1.e09ccbb4a7989p-30,
  0x1p-1,
  INEXACT)                                                                     // -1.748458030205084017555144185196e-09
...
T(ROUND_TO_NEAREST,
  -0x1.c1711a3ce6b76p-32,
  -0x1.c1711a3b5c306p-32,
  0x1p-1,
  INEXACT) // -4.087649418656948347732078449226e-10
T(ROUND_TO_NEAREST,
  -0x1.e84210839e30fp-32,
  -0x1.e8421081cc93p-32,
  -0x1p-1,
  INEXACT)                                                                     // -4.440681227476172495430103381685e-10
...
T(ROUND_TO_NEAREST,
  -0x1.679d5e93ff863p-34,
  -0x1.679d5e93c060dp-34,
  0x1p-1,
  INEXACT) // -8.176692162977554151767726243157e-11
T(ROUND_TO_NEAREST,
  -0x1.5bbf5535d63bfp-34,
  -0x1.5bbf55359b2fep-34,
  0x1p-1,
  INEXACT)                                                                     // -7.906860308958056434137659845696e-11
...
T(ROUND_TO_NEAREST,
  -0x1.24904c909613ap-35,
  -0x1.24904c90812e1p-35,
  -0x1p-1,
  INEXACT)                                                                 // -3.326063827966891529261519486370e-11
...
T(ROUND_TO_NEAREST,
  -0x1.454bc7e752cddp-35,
  -0x1.454bc7e738f84p-35,
  -0x1p-1,
  INEXACT)                                                                    // -3.698187572774437271313676380524e-11
...
T(ROUND_TO_NEAREST,
  -0x1.fc0dbb4780477p-35,
  -0x1.fc0dbb474143p-35,
  0x1p-1,
  INEXACT)                                                                     // -5.775901160010923387837778944470e-11
...
T(ROUND_TO_NEAREST,
  -0x1.1aa7bf951b169p-37,
  -0x1.1aa7bf9516364p-37,
  -0x1p-1,
  INEXACT)                                                                     // -8.033545869526220624438404816881e-12
...
T(ROUND_TO_NEAREST,
  -0x1.4ad1f828aed8p-37,
  -0x1.4ad1f828a829fp-37,
  0x1p-1,
  INEXACT)                                                                // -9.402475395023153449386122358904e-12
T(RZ, -0x1.62000000028cbp-37, -0x1.61fffffffae6ap-37, 0x1.ap-63, INEXACT) // -1.006128513837989020837436038674e-11
T(ROUND_TO_NEAREST,
  -0x1.9c0bce1f479a2p-37,
  -0x1.9c0bce1f3d3d5p-37,
  -0x1p-1,
  INEXACT)                                                                   // -1.171105492190241689648487611115e-11
T(RZ, -0x1.9e000000037cbp-37, -0x1.9dfffffff906ap-37, 0x1.8518p-62, INEXACT) // -1.176658770421033450905920633648e-11
T(ROUND_TO_NEAREST,
  -0x1.a3c26ba35ab44p-37,
  -0x1.a3c26ba34ff33p-37,
  -0x1p-1,
  INEXACT) // -1.193028125860295973090827351133e-11
T(ROUND_TO_NEAREST,
  -0x1.889aa805b318ap-37,
  -0x1.889aa805a9b04p-37,
  -0x1p-1,
  INEXACT)                                                                  // -1.115848039933907800212941046232e-11
...
T(ROUND_TO_NEAREST,
  -0x1.afe1c60dc0dcdp-37,
  -0x1.afe1c60db57a6p-37,
  0x1p-1,
  INEXACT)                                                                   // -1.227482267466936799736618946970e-11
...
T(ROUND_TO_NEAREST,
  -0x1.db3ec56b35986p-37,
  -0x1.db3ec56b27cf6p-37,
  -0x1p-1,
  INEXACT)                                                                // -1.350728097894548545342657391962e-11
...
T(ROUND_TO_NEAREST,
  -0x1.03f236c5e2208p-38,
  -0x1.03f236c5e0109p-38,
  0x1p-1,
  INEXACT)                                                                     // -3.694056946832428135899352828638e-12
...
T(ROUND_TO_NEAREST,
  -0x1.27cc5b22e42c3p-4,
  -0x1.1d5ebc315411fp-4,
  0x1p-1,
  INEXACT)                                                           // -7.221637344469926389489700113700e-02
T(RZ, -0x1.307bceefaca9bp-4, -0x1.25711647a6a74p-4, 0x1p+0, INEXACT) // -7.433682283844193772193165159479e-02
T(ROUND_TO_NEAREST,
  -0x1.8016ab422cd6dp-4,
  -0x1.6ea153d1f2241p-4,
  -0x1p-1,
  INEXACT) // -9.377161882257718794608791768042e-02
T(ROUND_TO_NEAREST,
  -0x1.a6a9c85b44efp-4,
  -0x1.9196522d0f038p-4,
  -0x1p-1,
  INEXACT)                                                           // -1.031892610956750555573080418981e-01
...
T(ROUND_TO_NEAREST,
  -0x1.079b137f36e9ep-40,
  -0x1.079b137f36623p-40,
  -0x1p-1,
  INEXACT) // -9.365158115655263657305890438656e-13
T(ROUND_TO_NEAREST,
  -0x1.1ba969c958275p-40,
  -0x1.1ba969c9578a3p-40,
  -0x1p-1,
  INEXACT)                                                              // -1.007769051937792474069225081426e-12
...
T(ROUND_TO_NEAREST,
  -0x1.8e374d3404617p-40,
  -0x1.8e374d34032bbp-40,
  0x1p-1,
  INEXACT)                                                                // -1.414747507685445108495983313229e-12
T(RZ, -0x1.6800000000546p-40, -0x1.67ffffffff574p-40, 0x1.ap-72, INEXACT) // -1.278976924368452964896868063321e-12
T(ROUND_TO_NEAREST,
  -0x1.6fb79fd6e09a9p-40,
  -0x1.6fb79fd6df928p-40,
  -0x1p-1,
  INEXACT)                                                                     // -1.306394220197935700109693346945e-12
...
T(ROUND_TO_NEAREST,
  -0x1.92a19fd3ece36p-42,
  -0x1.92a19fd3ec943p-42,
  0x1p-1,
  INEXACT) // -3.576084717497670103437019468551e-13
T(ROUND_TO_NEAREST,
  -0x1.003ff801ff659p-43,
  -0x1.003ff801ff558p-43,
  0x1p-1,
  INEXACT)                                                                    // -1.137978058668471035120966809530e-13
...
T(ROUND_TO_NEAREST,
  -0x1.6e9b2675a667ep-44,
  -0x1.6e9b2675a6577p-44,
  0x1p-1,
  INEXACT) // -8.140289677804272690617540726857e-14
T(ROUND_TO_NEAREST,
  -0x1.68443dcc7be9fp-44,
  -0x1.68443dcc7bda1p-44,
  0x1p-1,
  INEXACT)                                                                     // -7.999524775355732603496982519145e-14
...
T(ROUND_TO_NEAREST,
  -0x1.1433ec467f014p-45,
  -0x1.1433ec467efc9p-45,
  0x1p-1,
  INEXACT) // -3.066467347002827113941618819919e-14
T(ROUND_TO_NEAREST,
  -0x1.7dfea8e092241p-45,
  -0x1.7dfea8e0921b3p-45,
  -0x1p-1,
  INEXACT)                                                             // -4.240993826809857950728673304185e-14
T(RZ, -0x1.93813088978fap-45, -0x1.938130889785ap-45, 0x1p+0, INEXACT) // -4.479801494354726441275998402947e-14
T(ROUND_TO_NEAREST,
  -0x1.db2cfe686fec6p-45,
  -0x1.db2cfe686fde9p-45,
  0x1p-1,
  INEXACT)                                                             // -5.275510661177530590219398928485e-14
T(RZ, -0x1.e00000000004bp-45, -0x1.dffffffffff6ap-45, 0x0p+0, INEXACT) // -5.329070518200798725687745267544e-14
T(ROUND_TO_NEAREST,
  -0x1.419894c232a01p-46,
  -0x1.419894c2329cfp-46,
  -0x1p-1,
  INEXACT)                                                                     // -1.785216529469998673086290956588e-14
...
T(ROUND_TO_NEAREST,
  -0x1.afb41f432003dp-47,
  -0x1.afb41f432001p-47,
  -0x1p-1,
  INEXACT) // -1.198218196950057672080642324802e-14
T(ROUND_TO_NEAREST,
  -0x1.d41ea0e98afa3p-47,
  -0x1.d41ea0e98af6dp-47,
  0x1p-1,
  INEXACT)                                                                     // -1.299293014363185354831246721343e-14
...
T(ROUND_TO_NEAREST,
  -0x1.d64d51e0db1cap-49,
  -0x1.d64d51e0db1bdp-49,
  -0x1p-1,
  INEXACT) // -3.263375893225245720729697082594e-15
T(ROUND_TO_NEAREST,
  -0x1.b211b1c70d027p-49,
  -0x1.b211b1c70d01bp-49,
  0x1p-1,
  INEXACT)                                                                   // -3.011959563148490421233065631515e-15
...
T(ROUND_TO_NEAREST,
  -0x1.8000000000001p-50,
  -0x1.7fffffffffffdp-50,
  -0x1p-1,
  INEXACT)                                                                     // -1.332267629550188045723584306962e-15
...
T(ROUND_TO_NEAREST,
  -0x1.3988e1409212ep-51,
  -0x1.3988e1409212dp-51,
  -0x1p-1,
  INEXACT) // -5.438959822042072914295723383441e-16
T(ROUND_TO_NEAREST,
  -0x1.1984a797373d9p-6,
  -0x1.171d06916a997p-6,
  0x1p-1,
  INEXACT) // -1.718250623968118132034454959012e-02
T(ROUND_TO_NEAREST,
  -0x1.ad46640425f29p-6,
  -0x1.a7b337dd52c3bp-6,
  -0x1p-1,
  INEXACT)                                                                   // -2.620086447913575269930142042085e-02
...
T(ROUND_TO_NEAREST,
  -0x1.21f4ad15d2fd3p-8,
  -0x1.2150b5d6f3ad3p-8,
  0x1p-1,
  INEXACT)                                                                   // -4.424373871938019724125989995400e-03
...
T(ROUND_TO_NEAREST,
  -0x1.55f885f150ad4p+0,
  -0x1.795fb8be980dap-1,
  -0x1p-1,
  INEXACT) // -1.335823413290815331322392012225e+00
T(ROUND_TO_NEAREST,
  -0x1.90c0206fe6bccp+0,
  -0x1.94fe3e0155b34p-1,
  -0x1p-1,
  INEXACT)                                                           // -1.565431620902688614194175897865e+00
T(RZ, -0x1.0a54d87783d6fp+0, -0x1.4b1887d4d477bp-1, 0x1p+0, INEXACT) // -1.040357140711275496514076621679e+00
T(ROUND_TO_NEAREST,
  -0x1.90c0206fe6bccp+0,
  -0x1.94fe3e0155b34p-1,
...
T(ROUND_TO_NEAREST,
  -0x1.1bdf4f1b18e0fp+5,
  -0x1.ffffffffffffcp-1,
  0x1p-1,
  INEXACT) // -3.548403760118173266846497426741e+01
T(ROUND_TO_NEAREST,
  -0x1.19dc9df7850b1p+5,
  -0x1.ffffffffffffbp-1,
  0x1p-1,
  INEXACT) // -3.523272317290082611407342483290e+01
T(ROUND_TO_NEAREST,
  -0x1.1841a4bab2d6dp+5,
  -0x1.ffffffffffffap-1,
  0x1p-1,
  INEXACT) // -3.503205247743867545295870513655e+01
T(ROUND_TO_NEAREST,
  -0x1.14c61cb0378eap+5,
  -0x1.ffffffffffff7p-1,
  0x1p-1,
  INEXACT) // -3.459673440618082906894414918497e+01
T(ROUND_TO_NEAREST,
  -0x1.125b0a74605a3p+5,
  -0x1.ffffffffffff5p-1,
  -0x1p-1,
  INEXACT) // -3.429445353430789822368751629256e+01
T(ROUND_TO_NEAREST,
  -0x1.0e8d5f83f7466p+5,
  -0x1.fffffffffffedp-1,
  0x1p-1,
  INEXACT) // -3.381902983759282221853936789557e+01
T(ROUND_TO_NEAREST,
  -0x1.0a0b634b09bb3p+5,
  -0x1.fffffffffffdfp-1,
  0x1p-1,
  INEXACT) // -3.325556048034140843583372770809e+01
T(ROUND_TO_NEAREST,
  -0x1.072dc4ec4a614p+5,
  -0x1.fffffffffffd2p-1,
  -0x1p-1,
  INEXACT)                                                                  // -3.289734825708379162279015872627e+01
T(RZ, -0x1.06ecbf7622c43p+5, -0x1.fffffffffffdp-1, 0x1.1ebefep-44, INEXACT) // -3.286559955876921179651617421769e+01
T(ROUND_TO_NEAREST,
  -0x1.05e8a70c2f641p+5,
  -0x1.fffffffffffc9p-1,
  0x1p-1,
  INEXACT)                                                          // -3.273859986800790267125194077380e+01
T(RZ, -0x1.05b10c1c1ea7p+5, -0x1.fffffffffffc7p-1, 0x1p+0, INEXACT) // -3.271144887894195107946870848536e+01
T(ROUND_TO_NEAREST,
  -0x1.0414697c870cep+5,
  -0x1.fffffffffffbbp-1,
  0x1p-1,
  INEXACT)                                                                  // -3.250996682440892016074940329418e+01
...
T(ROUND_TO_NEAREST,
  -0x1.03d979054a9bep+5,
  -0x1.fffffffffffb9p-1,
  0x1p-1,
  INEXACT)                                                           // -3.248118785985887768674729159102e+01
T(RZ, -0x1.03ae5af88ad12p+5, -0x1.fffffffffffb7p-1, 0x1p+0, INEXACT) // -3.246013445066104452507715905085e+01
T(ROUND_TO_NEAREST,
  -0x1.03842086a9324p+5,
  -0x1.fffffffffffb6p-1,
  0x1p-1,
  INEXACT)                                                                   // -3.243951516345831009857647586614e+01
...
T(ROUND_TO_NEAREST,
  -0x1.021f0d232b53cp+5,
  -0x1.fffffffffffa9p-1,
  -0x1p-1,
  INEXACT)                                                           // -3.226516177631353343713271897286e+01
T(RZ, -0x1.01e55b7c11278p+5, -0x1.fffffffffffa5p-1, 0x1p+0, INEXACT) // -3.223699089934683570390916429460e+01
T(ROUND_TO_NEAREST,
  -0x1.01f0c451137d7p+5,
  -0x1.fffffffffffa7p-1,
  -0x1p-1,
  INEXACT) // -3.224256194439629297221472370438e+01
T(ROUND_TO_NEAREST,
  -0x1.01c3815eb6b48p+5,
  -0x1.fffffffffffa5p-1,
  -0x1p-1,
  INEXACT) // -3.222046159739562654067412950099e+01
T(ROUND_TO_NEAREST,
  -0x1.01816f63155c6p+5,
  -0x1.fffffffffffa1p-1,
  0x1p-1,
  INEXACT)                                                           // -3.218820073517740354418492643163e+01
T(RZ, -0x1.004a623f3ef34p+5, -0x1.fffffffffff91p-1, 0x1p+0, INEXACT) // -3.203632020388468504279444459826e+01
T(ROUND_TO_NEAREST,
  -0x1.002ea52c1fd9bp+5,
  -0x1.fffffffffff9p-1,
  0x1p-1,
  INEXACT) // -3.202277597877692727479370660149e+01
T(ROUND_TO_NEAREST,
  -0x1.001c5bff977dep+5,
  -0x1.fffffffffff9p-1,
  -0x1p-1,
  INEXACT)                                                           // -3.201384734803262688274116953835e+01
T(RZ, -0x1.00013baf59bc7p+5, -0x1.fffffffffff8dp-1, 0x1p+0, INEXACT) // -3.200060212128260417330238851719e+01
T(ROUND_TO_NEAREST,
  -0x1.fe584d79c245cp+4,
  -0x1.fffffffffff81p-1,
  0x1p-1,
  INEXACT)                                                                   // -3.189655826150952577791031217203e+01
...
T(ROUND_TO_NEAREST,
  -0x1.fce5171c90d01p+4,
  -0x1.fffffffffff76p-1,
  -0x1p-1,
  INEXACT)                                                           // -3.180593024404970847740514727775e+01
T(RZ, -0x1.fc0d1518e122bp+4, -0x1.fffffffffff6dp-1, 0x1p+0, INEXACT) // -3.175319394796876437681021343451e+01
T(ROUND_TO_NEAREST,
  -0x1.fb5aab402cdedp+4,
  -0x1.fffffffffff67p-1,
  0x1p-1,
  INEXACT)                                                                   // -3.170963597362963426462556526531e+01
T(RZ, -0x1.fa17fb834e007p+4, -0x1.fffffffffff5bp-1, 0x1.8d90c4p-44, INEXACT) // -3.163085509577652132406910823192e+01
T(ROUND_TO_NEAREST,
  -0x1.f9c2019d062bap+4,
  -0x1.fffffffffff57p-1,
  0x1p-1,
  INEXACT)                                                           // -3.160986481988468455028851167299e+01
T(RZ, -0x1.f8e15986afb67p+4, -0x1.fffffffffff4dp-1, 0x1p+0, INEXACT) // -3.155501701938501568633910210337e+01
T(ROUND_TO_NEAREST,
  -0x1.f87b161fedcf7p+4,
  -0x1.fffffffffff4ap-1,
  -0x1p-1,
  INEXACT) // -3.153005039665455555564221867826e+01
T(ROUND_TO_NEAREST,
  -0x1.f8384d65ed489p+4,
  -0x1.fffffffffff47p-1,
  -0x1p-1,
  INEXACT) // -3.151374568762961203560735157225e+01
T(ROUND_TO_NEAREST,
  -0x1.f7e0eaeda9ca7p+4,
  -0x1.fffffffffff43p-1,
  -0x1p-1,
  INEXACT)                                                                   // -3.149241154515462071117326559033e+01
...
T(ROUND_TO_NEAREST,
  -0x1.f54f5a8dbc633p+4,
  -0x1.fffffffffff22p-1,
  -0x1p-1,
  INEXACT) // -3.133187346807080686517110734712e+01
T(ROUND_TO_NEAREST,
  -0x1.f53cfc69477c8p+4,
  -0x1.fffffffffff21p-1,
  -0x1p-1,
  INEXACT) // -3.132738915562347870036319363862e+01
T(ROUND_TO_NEAREST,
  -0x1.f4e25ce18030cp+4,
  -0x1.fffffffffff1cp-1,
  -0x1p-1,
  INEXACT) // -3.130526435934284279483108548447e+01
T(ROUND_TO_NEAREST,
  -0x1.f4783271917d3p+4,
  -0x1.fffffffffff16p-1,
  -0x1p-1,
  INEXACT)                                                           // -3.127934498179076783230811997782e+01
T(RZ, -0x1.f45e147ed01f7p+4, -0x1.fffffffffff13p-1, 0x1p+0, INEXACT) // -3.127296876465149111368191370275e+01
T(ROUND_TO_NEAREST,
  -0x1.f432eb1ec59cdp+4,
  -0x1.fffffffffff11p-1,
  0x1p-1,
  INEXACT)                                                           // -3.126243125934870548121580213774e+01
...
T(ROUND_TO_NEAREST,
  -0x1.f33915bcf0e7fp+4,
  -0x1.fffffffffff03p-1,
  -0x1p-1,
  INEXACT)                                                         // -3.120143674664586441735991684254e+01
T(RZ, -0x1.f320eb6e57701p+4, -0x1.fffffffffffp-1, 0x1p+0, INEXACT) // -3.119553702451867494005455228034e+01
T(ROUND_TO_NEAREST,
  -0x1.f328f57b126ffp+4,
  -0x1.fffffffffff01p-1,
  0x1p-1,
  INEXACT) // -3.119749973368652362637476471718e+01

#endif // SPECIAL_EXPM1_H_H
