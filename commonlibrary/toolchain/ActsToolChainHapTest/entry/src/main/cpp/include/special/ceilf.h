...
#ifndef SPECIAL_CEILF_H_H
#define SPECIAL_CEILF_H_H
...
T(ROUND_TO_NEAREST, -0x0p+0, -0x0p+0, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1p+0, 0x1p+0, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1p+0, -0x1p+0, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1p-1, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-1, -0x0p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.0001p+0, 0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0001p+0, -0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.ffffp-1, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.ffffp-1, -0x0p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1p-100, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-100, -0x0p+0, 0x0p+0, INEXACT)
