...
#ifndef SPECIAL_SCALBLN_H_H
#define SPECIAL_SCALBLN_H_H
...
T(ROUND_TO_NEAREST,                     INF, -2147483647,                     INF,          0x0p+0, 0)
T(ROUND_TO_NEAREST,                    -INF,  2147483647,                    -INF,          0x0p+0, 0)
T(ROUND_TO_NEAREST,               0x1p+1023,       -2097,               0x1p-1074,          0x0p+0, 0)
T(ROUND_TO_NEAREST,               0x1p-1074,        2097,               0x1p+1023,          0x0p+0, 0)
T(ROUND_TO_NEAREST,              0x1.001p+0,       -1074,               0x1p-1074,          0x0p+0, INEXACT|UNDERFLOW)

#endif // SPECIAL_SCALBLN_H_H
