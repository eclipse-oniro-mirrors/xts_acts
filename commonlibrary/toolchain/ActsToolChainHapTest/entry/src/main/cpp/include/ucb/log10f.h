...
#ifndef UCB_LOG10F_H_H
#define UCB_LOG10F_H_H
...
T(ROUND_TO_NEAREST, 0x1.fffffep+127, 0x1.344136p+5, 0x1.f3039ep-2, INEXACT)
...
T(ROUND_TO_NEAREST, 0x1.00004p+0, 0x1.bcb77ap-20, 0x1.11fa56p-3, INEXACT)
T(ROUND_TO_NEAREST, 0x1p+0, 0x0p+0, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.ffff8p-1, -0x1.bcb7e8p-20, 0x1.d2db7ep-2, INEXACT)
...
T(ROUND_TO_NEAREST, 0x1p-126, -0x1.2f703p+5, 0x1.ae7e0cp-4, INEXACT)
T(ROUND_TO_NEAREST, 0x1p-149, -0x1.66d3e8p+5, -0x1.0997p-3, INEXACT)
...
T(ROUND_TO_NEAREST, 0x1.24844cp+5, 0x1.9024cp+0, -0x1.7605eap-2, INEXACT)
T(ROUND_TO_NEAREST, 0x1.5672p+6, 0x1.eeba5ep+0, 0x1.aaa14cp-6, INEXACT)
T(ROUND_TO_NEAREST, 0x1.7817p+6, 0x1.f925b6p+0, 0x1.fb3242p-2, INEXACT)
T(ROUND_TO_NEAREST, 0x1.09b75p+4, 0x1.38657p+0, -0x1.0801cap-3, INEXACT)
T(ROUND_TO_NEAREST, 0x1.23a38ep+5, 0x1.8fcf34p+0, -0x1.9ea21p-3, INEXACT)
T(ROUND_TO_NEAREST, 0x1.804882p+5, 0x1.ae7adp+0, 0x1.60441p-3, INEXACT)
T(ROUND_TO_NEAREST, 0x1.3baa8ep+6, 0x1.e5acdp+0, 0x1.e6b71ep-3, INEXACT)
T(ROUND_TO_NEAREST, 0x1.730484p+6, 0x1.f7a33cp+0, -0x1.ecfb84p-2, INEXACT)
T(ROUND_TO_NEAREST, 0x1.4cc5b2p+5, 0x1.9e7a86p+0, -0x1.ca6cb4p-2, INEXACT)
T(ROUND_TO_NEAREST, 0x1.0ca4d4p+1, 0x1.49b1b4p-2, -0x1.9af518p-4, INEXACT)
// log10s(NAN) is NAN
...
T(ROUND_TO_NEAREST, -0x0p+0, -INF, 0x0p+0, DIVBYZERO)
// log10s(-ve) is NAN
T(ROUND_TO_NEAREST, -0x1p-149, NAN, 0x0p+0, INVALID)
...
T(ROUND_TO_NEAREST, NAN, NAN, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1p-148, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.cp-147, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-128, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-127, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.fffff8p-127, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.fffffcp-127, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.000002p-126, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.000004p-126, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-125, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-124, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-23, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-21, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-2, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p-1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.fffff4p-1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.fffff8p-1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.fffffcp-1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.fffffep-1, NAN, 0x0p+0, INVALID)
...
T(ROUND_TO_NEAREST, -0x1.000008p+0, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p+1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.000004p+1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.fffff6p+1, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p+2, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p+126, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.000004p+126, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.000008p+126, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1p+127, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.000004p+127, NAN, 0x0p+0, INVALID)
T(ROUND_TO_NEAREST, -0x1.fffffcp+127, NAN, 0x0p+0, INVALID)
