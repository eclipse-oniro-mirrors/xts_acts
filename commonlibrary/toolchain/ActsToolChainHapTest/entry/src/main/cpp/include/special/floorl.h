...
#ifndef SPECIAL_FLOORL_H_H
#define SPECIAL_FLOORL_H_H
...
T(ROUND_TO_NEAREST, -0x0p+0L, -0x0p+0L, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1p+0L, 0x1p+0L, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1p+0L, -0x1p+0L, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1p-1L, 0x0p+0L, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-1L, -0x1p+0L, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.0001p+0L, 0x1p+0L, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0001p+0L, -0x1p+1L, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.ffffp-1L, 0x0p+0L, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.ffffp-1L, -0x1p+0L, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1p-100L, 0x0p+0L, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-100L, -0x1p+0L, 0x0p+0, INEXACT)
