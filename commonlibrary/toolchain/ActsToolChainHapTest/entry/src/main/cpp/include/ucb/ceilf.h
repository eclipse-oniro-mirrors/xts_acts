...
#ifndef UCB_CEILF_H_H
#define UCB_CEILF_H_H
...
T(ROUND_TO_NEAREST, -0x1p+0, -0x1p+0, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.dffffep+24, 0x1.dffffep+24, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1.dffffep+24, -0x1.dffffep+24, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.fffffep+127, 0x1.fffffep+127, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1.fffffep+127, -0x1.fffffep+127, 0x0p+0, 0)
...
T(RD, -0x1.fffffep+127, -0x1.fffffep+127, 0x0p+0, 0)
// integer - ulp
T(ROUND_TO_NEAREST, 0x1.fddddep+21, 0x1.fdddep+21, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fddddep+21, -0x1.fdddd8p+21, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffep+0, 0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fffffep+0, -0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffep-1, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fffffep-1, -0x0p+0, 0x0p+0, INEXACT)
...
// integer + ulp
T(ROUND_TO_NEAREST, 0x1.fddddap+21, 0x1.fdddep+21, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fddddap+21, -0x1.fdddd8p+21, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.000002p+0, 0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.000002p+0, -0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1p-126, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-126, -0x0p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1p-149, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-149, -0x0p+0, 0x0p+0, INEXACT)
...
T(ROUND_TO_NEAREST, 0x1.fffffep-2, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1p-1, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.000002p-1, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fffffep-2, -0x0p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-1, -0x0p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.000002p-1, -0x0p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.7ffffep+0, 0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.8p+0, 0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.800002p+0, 0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.7ffffep+0, -0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.8p+0, -0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.800002p+0, -0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.3ffffep+1, 0x1.8p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.4p+1, 0x1.8p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.400002p+1, 0x1.8p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.3ffffep+1, -0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.4p+1, -0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.400002p+1, -0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fdddcep+19, 0x1.fdddep+19, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fddddp+19, 0x1.fdddep+19, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fdddd2p+19, 0x1.fdddep+19, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fdddcep+19, -0x1.fdddcp+19, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fddddp+19, -0x1.fdddcp+19, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fdddd2p+19, -0x1.fdddcp+19, 0x0p+0, INEXACT)
...
T(ROUND_TO_NEAREST, -0x1.adeefcp+4, -0x1.ap+4, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.1ce3fp+6, 0x1.2p+6, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.602e1p+6, 0x1.64p+6, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0b246p+6, -0x1.08p+6, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.b171eep+4, -0x1.bp+4, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.f6eff2p+1, -0x1.8p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.ceaa3ep+5, 0x1.dp+5, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.560914p+6, 0x1.58p+6, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0ce902p+4, -0x1p+4, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.7f35b4p+6, -0x1.7cp+6, 0x0p+0, INEXACT)
...
T(ROUND_TO_NEAREST, 0x1.fffffcp+22, 0x1.fffffcp+22, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1p+23, 0x1p+23, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.000002p+23, 0x1.000002p+23, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.fffffap+51, 0x1.fffffap+51, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.fffffcp+51, 0x1.fffffcp+51, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.fffffep+51, 0x1.fffffep+51, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1p+52, 0x1p+52, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.000002p+52, 0x1.000002p+52, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.ffffdcp+118, 0x1.ffffdcp+118, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.ffffeep+118, 0x1.ffffeep+118, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.fffffep+118, 0x1.fffffep+118, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1p+119, 0x1p+119, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1.2p+12, -0x1.2p+12, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1.fffffcp+22, -0x1.fffffcp+22, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1p+23, -0x1p+23, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1.000002p+23, -0x1.000002p+23, 0x0p+0, 0)
...
T(ROUND_TO_NEAREST, 0x1.fffffep+2, 0x1p+3, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffp+8, 0x1p+9, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffep+17, 0x1p+18, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffap+22, 0x1.fffffcp+22, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffep+22, 0x1p+23, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fffffcp-127, -0x0p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.2p+2, -0x1p+2, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.000002p+3, -0x1p+3, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.00001p+9, -0x1p+9, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.000002p+18, -0x1p+18, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fffffap+22, -0x1.fffff8p+22, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fffffep+22, -0x1.fffffcp+22, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, NAN, NAN, 0x0p+0, 0)
...
T(RU, 0x1.fffffep+2, 0x1p+3, 0x0p+0, INEXACT)
T(RU, 0x1.000002p+3, 0x1.2p+3, 0x0p+0, INEXACT)
T(RU, 0x1.fffffp+8, 0x1p+9, 0x0p+0, INEXACT)
T(RU, 0x1.fffffep+17, 0x1p+18, 0x0p+0, INEXACT)
T(RU, 0x1.fffffap+22, 0x1.fffffcp+22, 0x0p+0, INEXACT)
T(RU, 0x1.fffffep+22, 0x1p+23, 0x0p+0, INEXACT)
T(RU, -0x1.fffffcp-127, -0x0p+0, 0x0p+0, INEXACT)
T(RU, -0x1.2p+2, -0x1p+2, 0x0p+0, INEXACT)
T(RU, -0x1.fffffep+2, -0x1.cp+2, 0x0p+0, INEXACT)
T(RU, -0x1.000002p+3, -0x1p+3, 0x0p+0, INEXACT)
T(RU, -0x1.00001p+9, -0x1p+9, 0x0p+0, INEXACT)
T(RU, -0x1.000002p+18, -0x1p+18, 0x0p+0, INEXACT)
