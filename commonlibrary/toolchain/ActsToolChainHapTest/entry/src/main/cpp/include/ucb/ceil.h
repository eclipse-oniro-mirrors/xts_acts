...
T(ROUND_TO_NEAREST, -0x1p+0, -0x1p+0, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp+52, 0x1.fffffffffffffp+52, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1.fffffffffffffp+52, -0x1.fffffffffffffp+52, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp+1023, 0x1.fffffffffffffp+1023, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1.fffffffffffffp+1023, -0x1.fffffffffffffp+1023, 0x0p+0, 0)
...
T(RD, -0x1.fffffffffffffp+1023, -0x1.fffffffffffffp+1023, 0x0p+0, 0)
// integer - ulp
T(ROUND_TO_NEAREST, 0x1.eeeeeeeeeeeefp+50, 0x1.eeeeeeeeeeefp+50, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.eeeeeeeeeeeefp+50, -0x1.eeeeeeeeeeeecp+50, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp+0, 0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fffffffffffffp+0, -0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp-1, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fffffffffffffp-1, -0x0p+0, 0x0p+0, INEXACT)
...
// integer + ulp
T(ROUND_TO_NEAREST, 0x1.eeeeeeeeeeeedp+50, 0x1.eeeeeeeeeeefp+50, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.eeeeeeeeeeeedp+50, -0x1.eeeeeeeeeeeecp+50, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.0000000000001p+0, 0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0000000000001p+0, -0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1p-1022, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-1022, -0x0p+0, 0x0p+0, INEXACT)
...
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp-2, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1p-1, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.0000000000001p-1, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fffffffffffffp-2, -0x0p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-1, -0x0p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0000000000001p-1, -0x0p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.7ffffffffffffp+0, 0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.8p+0, 0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.8000000000001p+0, 0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.7ffffffffffffp+0, -0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.8p+0, -0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.8000000000001p+0, -0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.3ffffffffffffp+1, 0x1.8p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.4p+1, 0x1.8p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.4000000000001p+1, 0x1.8p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.3ffffffffffffp+1, -0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.4p+1, -0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.4000000000001p+1, -0x1p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.eeeeeeeeeeee7p+48, 0x1.eeeeeeeeeeefp+48, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.eeeeeeeeeeee8p+48, 0x1.eeeeeeeeeeefp+48, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.eeeeeeeeeeee9p+48, 0x1.eeeeeeeeeeefp+48, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.eeeeeeeeeeee7p+48, -0x1.eeeeeeeeeeeep+48, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.eeeeeeeeeeee8p+48, -0x1.eeeeeeeeeeeep+48, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.eeeeeeeeeeee9p+48, -0x1.eeeeeeeeeeeep+48, 0x0p+0, INEXACT)
...
T(ROUND_TO_NEAREST, -0x1.adeefb2b5006dp+4, -0x1.ap+4, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.1ce3efb825911p+6, 0x1.2p+6, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.602e109de7505p+6, 0x1.64p+6, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0b245fba96889p+6, -0x1.08p+6, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.b171ee27084ddp+4, -0x1.bp+4, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.f6eff1b093c41p+1, -0x1.8p+1, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.ceaa3d18455f5p+5, 0x1.dp+5, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.560914a51b239p+6, 0x1.58p+6, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0ce901079de4dp+4, -0x1p+4, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.7f35b3103b871p+6, -0x1.7cp+6, 0x0p+0, INEXACT)
// INF,NAN, and subnormal number
T(ROUND_TO_NEAREST, 0x1p-1074, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1p-1074, -0x0p+0, 0x0p+0, INEXACT)
...
T(RD, NAN, NAN, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.2p+12, 0x1.2p+12, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1p+23, 0x1p+23, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.ffffffffffffep+51, 0x1.ffffffffffffep+51, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1p+52, 0x1p+52, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.0000000000001p+52, 0x1.0000000000001p+52, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.fffffffffffeep+1014, 0x1.fffffffffffeep+1014, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.ffffffffffff7p+1014, 0x1.ffffffffffff7p+1014, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp+1014, 0x1.fffffffffffffp+1014, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1p+1015, 0x1p+1015, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1.2p+12, -0x1.2p+12, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1p+23, -0x1p+23, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1.ffffffffffffep+51, -0x1.ffffffffffffep+51, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1p+52, -0x1p+52, 0x0p+0, 0)
...
T(ROUND_TO_NEAREST, -0x1.fffffffffffffp+1014, -0x1.fffffffffffffp+1014, 0x0p+0, 0)
T(ROUND_TO_NEAREST, -0x1p+1015, -0x1p+1015, 0x0p+0, 0)
T(ROUND_TO_NEAREST, 0x1.ep-1, 0x1p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp+2, 0x1p+3, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.ffffffffffff8p+8, 0x1p+9, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp+17, 0x1p+18, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp+22, 0x1p+23, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.ffffffffffffdp+51, 0x1.ffffffffffffep+51, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, 0x1.fffffffffffffp+51, 0x1p+52, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.ffffffffffffep-1023, -0x0p+0, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.2p+2, -0x1p+2, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0000000000001p+3, -0x1p+3, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0000000000008p+9, -0x1p+9, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0000000000001p+18, -0x1p+18, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.0000000000001p+23, -0x1p+23, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.ffffffffffffdp+51, -0x1.ffffffffffffcp+51, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, -0x1.fffffffffffffp+51, -0x1.ffffffffffffep+51, 0x0p+0, INEXACT)
T(ROUND_TO_NEAREST, NAN, NAN, 0x0p+0, 0)
