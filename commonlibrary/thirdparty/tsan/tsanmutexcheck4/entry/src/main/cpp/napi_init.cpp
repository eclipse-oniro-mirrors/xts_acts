...
void AnnotateRWLockReleased(const char *f, int l, void *m, long isw);
...
namespace RwMutexErrorUnlockedSequence {
__attribute__((optnone)) static napi_value RwMutexErrorUnlockedSequence(napi_env env, napi_callback_info info)
{
    int m = 0;
    ...
    bool findTsanLog = CheckTsanLog("ThreadSanitizer: read unlock of a write locked mutex", bufferLog) &&
...
static napi_value Init(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        { "rwMutexErrorUnlockedSequence", nullptr, RwMutexErrorUnlockedSequence::RwMutexErrorUnlockedSequence,
