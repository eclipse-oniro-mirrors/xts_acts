...
namespace RwMutexErrorLockedSequence {
__attribute__((optnone)) static napi_value RwMutexErrorLockedSequence(napi_env env, napi_callback_info info)
{
    int m = 0;
    ...
    bool findTsanLog = CheckTsanLog("ThreadSanitizer: read lock of a write locked mutex", bufferLog) &&
...
static napi_value Init(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        { "rwMutexErrorLockedSequence", nullptr, RwMutexErrorLockedSequence::RwMutexErrorLockedSequence,
