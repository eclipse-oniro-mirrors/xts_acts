...
describe("QueueTest", function () {
   ...
   * @tc.level  LEVEL1
   */
  it("testAdd020Adapt001", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, function () {
    let queue = new Queue();
    try {
      queue.add.bind({}, 10)();
