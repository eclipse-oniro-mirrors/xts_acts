...
export default function WorkerTest() {
    describe('WorkerTest', function () {
         ...
         * @tc.number worker_constructor_test_001
         * @tc.desc   worker constructor to Creates a worker instance.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_constructor_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
         ...
         * @tc.number worker_constructor_test_002
         * @tc.desc   worker constructor to Creates a worker instance.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_constructor_test_002', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js", {
         ...
         * @tc.number worker_constructor_test_003
         * @tc.desc   worker constructor to Creates a worker instance.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_constructor_test_003', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js", {
         ...
         * @tc.number worker_constructor_test_004
         * @tc.desc   worker constructor to Creates a worker instance.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_constructor_test_004', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js", {
         ...
         * @tc.number worker_constructor_test_005
         * @tc.desc   worker constructor to Creates a worker instance.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_constructor_test_005', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("/entry/ets/workers/worker.js");
            let isTerminate = false
            ss.onexit = function () {
                isTerminate = true
         ...
         * @tc.number worker_constructor_test_006
         * @tc.desc   worker constructor to Creates a worker instance.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_constructor_test_006', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
         ...
         * @tc.number worker_postMessage_test_001
         * @tc.desc   Sends a message to the worker thread.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_postMessage_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
         ...
         * @tc.number worker_postMessage_test_002
         * @tc.desc   Sends a message to the worker thread.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_postMessage_test_002', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
         ...
         * @tc.number worker_postMessage_test_003
         * @tc.desc   Sends a message to the worker thread.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_postMessage_test_003', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
         ...
         * @tc.number worker_postMessage_test_004
         * @tc.desc   Sends a message to the worker thread.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_postMessage_test_004', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
         ...
         * @tc.number worker_postMessage_test_005
         * @tc.desc   Sends a message to the worker thread.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_postMessage_test_005', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
         ...
         * @tc.number worker_postMessage_test_006
         * @tc.desc   Sends a message to the worker thread.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_postMessage_test_006', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
         ...
         * @tc.number worker_terminate_test_001
         * @tc.desc   Terminates the worker thread to stop the worker from receiving messages.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_terminate_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
            let res = 0
            let flag = false
         ...
         * @tc.number worker_terminate_test_002
         * @tc.desc   Terminates the worker thread to stop the worker from receiving messages.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_terminate_test_002', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
            let res = 0
            let flag = false
         ...
         * @tc.number worker_terminate_test_003
         * @tc.desc   Terminates the worker thread to stop the worker from receiving messages.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_terminate_test_003', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
            let res = 0
            let flag = false
         ...
         * @tc.number worker_terminate_test_004
         * @tc.desc   Terminates the worker thread to stop the worker from receiving messages.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_terminate_test_004', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker_002.js")
            let res = 0
            let flag = false
            ss.onexit = function () {
         ...
         * @tc.number worker_on_test_001
         * @tc.desc   Adds an event listener to the worker.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_on_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
         ...
         * @tc.number worker_on_test_002
         * @tc.desc   Adds an event listener to the worker.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_on_test_002', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
         ...
         * @tc.number worker_on_test_003
         * @tc.desc   Adds an event listener to the worker.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_on_test_003', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
         ...
         * @tc.number worker_once_test_001
         * @tc.desc   Adds an event listener to the worker and removes the event listener automically
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_once_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
         ...
         * @tc.number worker_once_test_002
         * @tc.desc   Adds an event listener to the worker and removes the event listener automically
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('worker_once_test_002', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
         ...
         * @tc.number worker_once_test_003
         * @tc.desc   Adds an event listener to the worker and removes the event listener automically
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_addEventListener_test_001
         ...
         * @tc.number worker_addEventListener_test_002
         * @tc.desc   Add an event listener to the Worker.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_addEventListener_test_003
         * @tc.desc   Add an event listener to the Worker.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_removeListener_test_001
         ...
         * @tc.number worker_removeListener_test_002
         * @tc.desc   Removes an event defined for the worker.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_removeListener_test_003
         * @tc.desc   Removes an event defined for the worker.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_parentPortClose_test_001
         ...
         * @tc.number worker_parentPortClose_test_002
         * @tc.desc   Close the worker thread to stop the worker from receiving messages.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_onmessageerror_test_001
         ...
         * @tc.number worker_onmessageerror_test_002
         * @tc.desc   The onmessage attribute of the worker specifies the event handler when the worker receives
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_new_second_worker_test_001
         ...
         * @tc.number worker_new_second_worker_test_002
         ...
         * @tc.number worker_second_worker_postMessage_test_001
         ...
         * @tc.number worker_second_worker_postMessage_test_002
         * @tc.desc   Check if the postMessage function of the second worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_second_worker_postMessage_test_003
         * @tc.desc   Check if the postMessage function of the second worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_third_worker_postMessage_test_001
         ...
         * @tc.number worker_second_worker_terminate_test_001
         ...
         * @tc.number worker_support_types_test_001
         ...
         * @tc.number worker_support_types_test_002
         * @tc.desc   Check the transmission types supported by Worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_support_types_test_003
         * @tc.desc   Check the transmission types supported by Worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_support_types_test_004
         * @tc.desc   Check the transmission types supported by Worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_support_types_test_005
         * @tc.desc   Check the transmission types supported by Worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_support_types_test_006
         * @tc.desc   Check the transmission types supported by Worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_support_types_test_007
         * @tc.desc   Check the transmission types supported by Worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_support_types_test_008
         * @tc.desc   Check the transmission types supported by Worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_support_types_test_009
         * @tc.desc   Check the transmission types supported by Worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
        ...
        // Check the transmission types supported by Worker is ok.
        /**
         * @tc.name   worker_support_types_test_010
         * @tc.number worker_support_types_test_010
         * @tc.desc   Check the transmission types supported by Worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_support_types_test_010', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker_027.js");
            let res;
            let flag = false;
            let isTerminate = false;
            ss.onmessage = function (d) {
         ...
         * @tc.number worker_SharedArrayBuffer_test_001
         ...
         * @tc.number worker_listener_test_001
         ...
         * @tc.number worker_listener_test_002
         * @tc.desc   Check the listener of worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_listener_test_003
         * @tc.desc   Check the listener of worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_listener_test_004
         * @tc.desc   Check the listener of worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_listener_test_005
         * @tc.desc   Check the listener of worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         ...
         * @tc.number worker_listener_test_006
         * @tc.desc   Check the listener of worker is ok.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
        ...
        // Test ThreadWorker.postMessage with empty array transfer parameter
        /**
         * @tc.name   worker_postMessage_empty_array_test_001
         * @tc.number worker_postMessage_empty_array_test_001
         * @tc.desc   Test ThreadWorker.postMessage with empty array transfer parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_postMessage_empty_array_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker_0002.js")
                let isTerminate = false
                ...
                const buffer = new ArrayBuffer(8)
                ss.postMessage("test message", { transfer: [] })
        ...
        // Test ThreadWorker.postMessage with non-empty array transfer parameter
        /**
         * @tc.name   worker_postMessage_non_empty_array_test_001
         * @tc.number worker_postMessage_non_empty_array_test_001
         * @tc.desc   Test ThreadWorker.postMessage with non-empty array transfer parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_postMessage_non_empty_array_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker_0002.js")
                let isTerminate = false
                ...
                ss.postMessage("test message", { transfer: [buffer1, buffer2] })
        ...
        // Test ThreadWorker.postMessage with empty array transfer parameter
        /**
         * @tc.name   worker_postMessage_empty_array_test_002
         * @tc.number worker_postMessage_empty_array_test_002
         * @tc.desc   Test ThreadWorker.postMessage with empty array transfer parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_postMessage_empty_array_test_002', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker_0002.js")
                let isTerminate = false
        ...
        // Test ThreadWorker.postMessage with non-empty array transfer parameter
        /**
         * @tc.name   worker_postMessage_non_empty_array_test_002
         * @tc.number worker_postMessage_non_empty_array_test_002
         * @tc.desc   Test ThreadWorker.postMessage with non-empty array transfer parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_postMessage_non_empty_array_test_002', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker_0002.js")
                let isTerminate = false
                ...
                const buffer1 = new ArrayBuffer(8)
                const buffer2 = new ArrayBuffer(16)
                ss.postMessage("test message", [buffer1, buffer2])
        ...
        // Test ThreadWorker.worker_postMessage_null_test_001 with null/undefined parameters
        /**
         * @tc.name   worker_postMessage_null_test_001
         * @tc.number worker_postMessage_null_test_001
         * @tc.desc   Test ThreadWorker.postMessage with null message parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_postMessage_null_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
                let isError = false
        ...
        // Test ThreadWorker.worker_postMessage_null_test_001 with null/undefined parameters
        /**
         * @tc.name   worker_postMessage_null_test_002
         * @tc.number worker_postMessage_null_test_002
         * @tc.desc   Test ThreadWorker.postMessage with null message parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_postMessage_null_test_002', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
                let isError = false
        ...
        // Test ThreadWorker.postMessage with undefined transfer parameter
        /**
         * @tc.name   worker_postMessage_undefined_test_001
         * @tc.number worker_postMessage_undefined_test_001
         * @tc.desc   Test ThreadWorker.postMessage with undefined transfer parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_postMessage_undefined_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
                let isError = false
                ...
                // Should not throw error for undefined transfer parameter
                expect(isError).assertTrue()
                done()
            })

        // Test ThreadWorker.on with empty string and null/undefined parameters
        /**
         * @tc.name   worker_on_empty_string_test_001
         * @tc.number worker_on_empty_string_test_001
         * @tc.desc   Test ThreadWorker.on with empty string type parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_on_empty_string_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
                ...
                ss.on("", () => {
                    eventCalled = true
                    console.info("empty event listener called")
                })

                ss.dispatchEvent({ type: "", timeStamp: 0 })
                ss.terminate()
                while (!isTerminate) {
                    await promiseCase()
                }

                expect(eventCalled).assertTrue()
                done()
            })
        // Test ThreadWorker.on with empty string and null/undefined parameters
        /**
         * @tc.name   worker_on_empty_string_test_002
         * @tc.number worker_on_empty_string_test_002
         * @tc.desc   Test ThreadWorker.on with empty string type parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_on_empty_string_test_002', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
                let isError = false
                ...
                try {
                    ...
                    ss.dispatchEvent({ type: null, timeStamp: 0 })
                } catch (error) {
                    isError = true
                    expect(error.code).assertEqual(401)
                }
        ...
        // Test ThreadWorker.on with empty string and null/undefined parameters
        /**
         * @tc.name   worker_on_empty_string_test_003
         * @tc.number worker_on_empty_string_test_003
         * @tc.desc   Test ThreadWorker.on with empty string type parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_on_empty_string_test_003', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
                let isError = false
                ...
                try {
                    ...
                    ss.dispatchEvent({ type: undefined, timeStamp: 0 })
                } catch (error) {
                    isError = true
                    expect(error.code).assertEqual(401)
                }
        ...
        // Test ThreadWorker.on with null listener parameter
        /**
         * @tc.name   worker_on_null_test_001
         * @tc.number worker_on_null_test_001
         * @tc.desc   Test ThreadWorker.on with null listener parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_on_null_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
            let isTerminate = false
            let isError = false
        ...
        // Test ThreadWorker.on with undefined listener parameter
        /**
         * @tc.name   worker_on_undefined_test_001
         * @tc.number worker_on_undefined_test_001
         * @tc.desc   Test ThreadWorker.on with undefined listener parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_on_undefined_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
            let isTerminate = false
            let isError = false
        ...
        // Test ThreadWorker.once with empty string and null/undefined parameters
        /**
         * @tc.name   worker_once_empty_string_test_001
         * @tc.number worker_once_empty_string_test_001
         * @tc.desc   Test ThreadWorker.once with empty string type parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_once_empty_string_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
        ...
        // Test ThreadWorker.once with empty string and null/undefined parameters
        /**
         * @tc.name   worker_once_empty_string_test_002
         * @tc.number worker_once_empty_string_test_002
         * @tc.desc   Test ThreadWorker.once with empty string type parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_once_empty_string_test_002', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
                let isError = false
        ...
        // Test ThreadWorker.once with empty string and null/undefined parameters
        /**
         * @tc.name   worker_once_empty_string_test_003
         * @tc.number worker_once_empty_string_test_003
         * @tc.desc   Test ThreadWorker.once with empty string type parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_once_empty_string_test_003', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
                let isError = false
        ...
        // Test ThreadWorker.once with null listener parameter
        /**
         * @tc.name   worker_once_null_test_001
         * @tc.number worker_once_null_test_001
         * @tc.desc   Test ThreadWorker.once with null listener parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_once_null_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
            let isTerminate = false
            let isError = false
        ...
        // Test ThreadWorker.once with undefined listener parameter
        /**
         * @tc.name   worker_once_undefined_test_001
         * @tc.number worker_once_undefined_test_001
         * @tc.desc   Test ThreadWorker.once with undefined listener parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_once_undefined_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
            let isTerminate = false
            let isError = false
        ...
        // Test ThreadWorker.off with empty string and null/undefined parameters
        /**
         * @tc.name   worker_off_empty_string_test_001
         * @tc.number worker_off_empty_string_test_001
         * @tc.desc   Test ThreadWorker.off with empty string type parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_off_empty_string_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
                ...
                try {
                    ...
                    errorThrown = true
                    console.info("off with empty string threw error as expected")
                }
        ...
        /**
         * @tc.name   worker_off_empty_string_test_002
         * @tc.number worker_off_empty_string_test_002
         * @tc.desc   Test ThreadWorker.off with empty string type parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_off_empty_string_test_002', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
                let errorThrown = false
        ...
        /**
         * @tc.name   worker_off_empty_string_test_003
         * @tc.number worker_off_empty_string_test_003
         * @tc.desc   Test ThreadWorker.off with empty string type parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_off_empty_string_test_003', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker.js")
                let isTerminate = false
                let errorThrown = false
        ...
        // Test ThreadWorker.off with null listener parameter
        /**
         * @tc.name   worker_off_null_test_001
         * @tc.number worker_off_null_test_001
         * @tc.desc   Test ThreadWorker.off with null listener parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_off_null_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
            let isTerminate = false
            let errorThrown = false
            ...
            try {
                ...
                errorThrown = true
                expect(error.code).assertEqual(401)
                console.info("off with null listener threw error as expected")
            }
        ...
        // Test ThreadWorker.off with undefined listener parameter
        /**
         * @tc.name   worker_off_undefined_test_001
         * @tc.number worker_off_undefined_test_001
         * @tc.desc   Test ThreadWorker.off with undefined listener parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_off_undefined_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1, async function (done) {
            let ss = new worker.Worker("entry/ets/workers/worker.js")
            let isTerminate = false
            let errorThrown = false
            ...
            try {
                ss.off("test", undefined)
            } catch (error) {
                errorThrown = true
                expect(error.code).assertEqual(401)
                console.info("off with undefined listener threw error as expected")
            }
        ...
        /**
         * @tc.name   worker_postMessage_non_empty_test_001
         * @tc.number worker_postMessage_non_empty_test_001
         * @tc.desc   Test ThreadWorker.postMessage with non-empty array transfer parameter.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL1
         */
        it('worker_postMessage_non_empty_test_001', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL1,
            async function (done) {
                let ss = new worker.Worker("entry/ets/workers/worker_0001.js")
                let isTerminate = false
                ...
                ss.on('message', (event) => {
                    ...
                    console.log('test worker results: ' + results)
                ...
                expect(isTerminate).assertEqual(true)
                console.log('test worker post message: ' + results)
                expect(results)
                    .assertDeepEquals([null,undefined,401,401,1,1,2,2,"success",401,401,401,401,"success",401,401,401,401,401,401,401])
                done()
            })
    })
}