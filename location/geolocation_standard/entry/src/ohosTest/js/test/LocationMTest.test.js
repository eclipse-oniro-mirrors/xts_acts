...
export default function geolocationTest_geo7() {
    ...
    /**
     * @tc.name   testGetCurrentLocation1500
    ...
    /**
     * @tc.name   testGetCurrentLocation1600
    ...
    it('testGetCurrentLocation1600', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
     ...
     /**
      * @tc.name   testGetCurrentLocation1700
    ...
    /**
     * @tc.name   test_LocationChange_0100
     * @tc.number test_LocationChange_0100
     * @tc.desc   Initiate a request for continuous positioning in a specified scenario and set a track tracing scenario.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('test_LocationChange_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
        enableLocationSwitch();
        let requestInfo = null;
        var locationChange = (location) => {
            console.info('[lbs_js] test_LocationChange_0100 data:' + JSON.stringify(location));
            expect(true).assertEqual(locationChange !=null);
        };
        try {
            geolocationm.on('locationChange', requestInfo, locationChange);
        } catch (error) {
            console.info("[lbs_js] null test_LocationChange_0100 try err." + JSON.stringify(error));
            expect(Number(error.code)).assertEqual(401);
        }
        try {
            geolocationm.on('locationChange', undefined, locationChange);
        } catch (error) {
            console.info("[lbs_js] undefined test_LocationChange_0100 try err." + JSON.stringify(error));
            expect(Number(error.code)).assertEqual(401);
        }
        await sleep(1500);
        done();
    ...
    /**
     * @tc.name   test_CachedGnssLocationsChange_0100
     * @tc.number test_CachedGnssLocationsChange_0100
     * @tc.desc   Setting the Gnss Batching Reporting Interval
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('test_CachedGnssLocationsChange_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
        var isAcessToken = canIUse("SystemCapability.Location.Location.Gnss");
        console.info("test_CachedGnssLocationsChange_0100 : " + isAcessToken);
        if (!isAcessToken) {
            console.info("The device does not support gnss");
            expect(isAcessToken).assertFalse();
            done();
            ...
            var cachedLocationsCb = (locations) => {
                console.log('[lbs_js] test_CachedGnssLocationsChange_0100:locations:' + JSON.stringify(locations));
                expect(true).assertEqual(locations !=null);
            }
            ...
            try {
                ...
                console.info("[lbs_js] null test_CachedGnssLocationsChange_0100 try err." + JSON.stringify(error));
                expect(Number(error.code)).assertEqual(401);
            }
            try {
                geolocationm.on('cachedGnssLocationsChange', undefined, cachedLocationsCb);
            } catch (error) {
                console.info("[lbs_js] undefined test_CachedGnssLocationsChange_0100 try err." + JSON.stringify(error));
                expect(Number(error.code)).assertEqual(401);
            }
            await sleep(1500);
            done();
    ...
    /**
     * @tc.name   test_GnssFenceStatusChange_0100
     * @tc.number test_GnssFenceStatusChange_0100
     * @tc.desc   Gnss fence function test
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('test_GnssFenceStatusChange_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
        var isAcessToken = canIUse("SystemCapability.Location.Location.Geofence");
        console.info("test_GnssFenceStatusChange_0100 : " + isAcessToken);
        if (!isAcessToken) {
            console.info("The device does not support geofence");
            expect(isAcessToken).assertFalse();
            done();
            ...
            await changedLocationMode();
            let geofenceRequest = null;
            let wantinfo = null;
            try {
                geolocationm.on('gnssFenceStatusChange', geofenceRequest, wantinfo);
            } catch (error) {
                console.info("[lbs_js] null ontest_GnssFenceStatusChange_0100 try error:"+ JSON.stringify(error));
                expect(Number(error.code)).assertEqual(401);
            }
            try {
                geolocationm.off('gnssFenceStatusChange',geofenceRequest, wantinfo);
            } catch (error) {
                console.info("[lbs_js] null offtest_GnssFenceStatusChange_0100 try error:"+ JSON.stringify(error));
                expect(Number(error.code)).assertEqual(401);
            }
            try {
                geolocationm.on('gnssFenceStatusChange', undefined, undefined);
            } catch (error) {
                console.info("[lbs_js] undefined ontest_GnssFenceStatusChange_0100 try error:"+ JSON.stringify(error));
                expect(Number(error.code)).assertEqual(401);
            }
            try {
                geolocationm.off('gnssFenceStatusChange',undefined, undefined);
            } catch (error) {
                console.info("[lbs_js] undefined offtest_GnssFenceStatusChange_0100 try error:"+ JSON.stringify(error));
                expect(Number(error.code)).assertEqual(401);
            }
            await sleep(1000);
            done();
    ...
    /**
     * @tc.name   test_GetCurrentLocation_0100
     * @tc.number test_GetCurrentLocation_0100
     * @tc.desc   Initiate a single location request in a specified scenario and set the navigation scenario.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('test_GetCurrentLocation_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
        let currentLocationRequest = null;
        try {
            geolocationm.getCurrentLocation(currentLocationRequest, (err, result) => {
                if (err) {
                    console.info("[lbs_js] null test_GetCurrentLocation_0100 callback err:  " + JSON.stringify(err));
                    expect(err.code).assertEqual(401);
                    done();
                } else {
                    console.info("[lbs_js] null test_GetCurrentLocation_0100 callback result:" + JSON.stringify(result));
                    expect(true).assertEqual(result != null);
                }
            });
        } catch (error) {
            console.info("[lbs_js] null test_GetCurrentLocation_0100 callback try err." + JSON.stringify(error));
            expect(Number(error.code)).assertEqual(401);
        }
        try {
            geolocationm.getCurrentLocation(undefined, (err, result) => {
                if (err) {
                    console.info("[lbs_js] undefined test_GetCurrentLocation_0100 callback err:  " + JSON.stringify(err));
                    expect(err.code).assertEqual(401);
                    done();
                } else {
                    console.info("[lbs_js] undefined test_GetCurrentLocation_0100 callback result:" + JSON.stringify(result));
                    expect(true).assertEqual(result != null);
                }
            });
        } catch (error) {
            console.info("[lbs_js] undefined test_GetCurrentLocation_0100 callback try err." + JSON.stringify(error));
            expect(Number(error.code)).assertEqual(401);
        }
        await sleep(1000);
        done();
    ...
    /**
     * @tc.name   test_GetCurrentLocation_0200
     * @tc.number test_GetCurrentLocation_0200
     * @tc.desc   Initiate a single location request in a specified scenario and set the navigation scenario.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('test_GetCurrentLocation_0200', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
        let currentLocationRequest = null;
        try {
            await geolocationm.getCurrentLocation(currentLocationRequest).then((result) => {
                console.info('[lbs_js] null test_GetCurrentLocation_0200 promise result ' + JSON.stringify(result));
                expect(true).assertEqual(result != null);
            }).catch(error => {
                console.info('[lbs_js] null test_GetCurrentLocation_0200 promise err:' + JSON.stringify(error));
                expect(error.code).assertEqual(401);
            })
        } catch (error) {
            console.info("[lbs_js] null test_GetCurrentLocation_0200 promise try err." + JSON.stringify(error));
            expect(Number(error.code)).assertEqual(401);
        }
        try {
            await geolocationm.getCurrentLocation(undefined).then((result) => {
                console.info('[lbs_js] undefined test_GetCurrentLocation_0200 promise result ' + JSON.stringify(result));
                expect(true).assertEqual(result != null);
            }).catch(error => {
                console.info('[lbs_js] undefined test_GetCurrentLocation_0200 promise err:' + JSON.stringify(error));
                expect(error.code).assertEqual(401);
            })
        } catch (error) {
            console.info("[lbs_js] undefined test_GetCurrentLocation_0200 promise try err." + JSON.stringify(error));
            expect(Number(error.code)).assertEqual(401);
        }
        await sleep(1000);
        done();
    ...
    /**
     * @tc.name   SUB_HSS_mSendCommand_0300
     * @tc.number SUB_HSS_mSendCommand_0300
     * @tc.desc   Test sendCommand api .
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('SUB_HSS_mSendCommand_0300', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
        var isAcessToken = canIUse("SystemCapability.Location.Location.Gnss");
        console.info("SUB_HSS_mSendCommand_0300 : " + isAcessToken);
        if (!isAcessToken) {
            console.info("The device does not support gnss");
            expect(isAcessToken).assertFalse();
            done();
            ...
            try {
                await geolocationm.sendCommand(requestInfo, (err, result) => {
                    if (err) {
                        console.info('SUB_HSS_mSendCommand_0300 null callback err01:' + JSON.stringify(err));
                        expect(true).assertEqual(JSON.stringify(err) != null);
                        done();
                    }
                    console.info('SUB_HSS_mSendCommand_0300 null callback result:' + JSON.stringify(result));
                });
            } catch (error) {
                console.info('SUB_HSS_mSendCommand_0300 null callback err02:' + JSON.stringify(error));
                expect(Number(error.code)).assertEqual(401);
            }
            try {
                await geolocationm.sendCommand(undefined, (err, result) => {
                    if (err) {
                        console.info('SUB_HSS_mSendCommand_0300 undefined callback err01:' + JSON.stringify(err));
                        expect(true).assertEqual(JSON.stringify(err) != null);
                        done();
                    }
                    console.info('SUB_HSS_mSendCommand_0300 undefined callback result:' + JSON.stringify(result));
                });
            } catch (error) {
                console.info('SUB_HSS_mSendCommand_0300 undefined callback err02:' + JSON.stringify(error));
                expect(Number(error.code)).assertEqual(401);
            }
            await sleep(1000);
            done();
    ...
    /**
     * @tc.name   SUB_HSS_mSendCommand_0400
     * @tc.number SUB_HSS_mSendCommand_0400
     * @tc.desc   Test sendCommand1 api .
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('SUB_HSS_mSendCommand_0400', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
        var isAcessToken = canIUse("SystemCapability.Location.Location.Gnss");
        console.info("SUB_HSS_mSendCommand_0400 : " + isAcessToken);
        if (!isAcessToken) {
            console.info("The device does not support gnss");
            expect(isAcessToken).assertFalse();
            done();
            ...
            try {
                geolocationm.sendCommand(requestInfo).then((result) => {
                    console.info('[lbs_js] null SUB_HSS_mSendCommand_0400 promise result:' + result);
                    done();
                }).catch(error => {
                    console.info('[lbs_js] null SUB_HSS_mSendCommand_0400 promise err01:' + JSON.stringify(error));
                    expect(true).assertEqual(JSON.stringify(error) != null);
                    done();
                })
            } catch (error) {
                console.info('[lbs_js] null SUB_HSS_mSendCommand_0400 promise err02:' + JSON.stringify(error));
                expect(Number(error.code)).assertEqual(401);
            }
            try {
                geolocationm.sendCommand(undefined).then((result) => {
                    console.info('[lbs_js] undefined SUB_HSS_mSendCommand_0400 promise result:' + result);
                    done();
                }).catch(error => {
                    console.info('[lbs_js] undefined SUB_HSS_mSendCommand_0400 promise err01:' + JSON.stringify(error));
                    expect(true).assertEqual(JSON.stringify(error) != null);
                    done();
                })
            } catch (error) {
                console.info('[lbs_js] undefined SUB_HSS_mSendCommand_0400 promise err02:' + JSON.stringify(error));
                expect(Number(error.code)).assertEqual(401);
            }
            await sleep(1000);
            done();
    ...
    /**
     * @tc.name   test_AddGnssGeofence_0100
     * @tc.number test_AddGnssGeofence_0100
     * @tc.desc   Test the function of locating the validity period of the fence.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('test_AddGnssGeofence_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
        var isAcessToken = canIUse("SystemCapability.Location.Location.Geofence");
        console.info("test_AddGnssGeofence_0100 : " + isAcessToken);
        if (!isAcessToken) {
            console.info("The device does not support geofence");
            expect(isAcessToken).assertFalse();
            done();
            ...
            try {
                await geolocationm.addGnssGeofence(fenceRequest).then((id) => {
                    console.info("[lbs_js] null test_AddGnssGeofence_0100 addGnssGeofence success, id = " + id);
                    expect(true).assertEqual(id != -1);
                }).catch((err) => {
                    console.info("[lbs_js] null test_AddGnssGeofence_0100 add error=" + JSON.stringify(error));
                    expect(true).assertEqual(JSON.stringify(err) != null);
                }
                );
            } catch (error) {
                console.info("[lbs_js] null test_AddGnssGeofence_0100 add try error:"+ JSON.stringify(error));
                if (error.code == "801") {
            ...
            try {
                await geolocationm.addGnssGeofence(undefined).then((id) => {
                    console.info("[lbs_js] undefined test_AddGnssGeofence_0100 addGnssGeofence success, id = " + id);
                    expect(true).assertEqual(id != -1);
                }).catch((err) => {
                    console.info("[lbs_js] undefined test_AddGnssGeofence_0100 add error=" + JSON.stringify(error));
                    expect(true).assertEqual(JSON.stringify(err) != null);
                }
                );
            } catch (error) {
                console.info("[lbs_js] undefined test_AddGnssGeofence_0100 add try error:"+ JSON.stringify(error));
                if (error.code == "801") {
                    expect(Number(error.code)).assertEqual(801)
                } else {
                    expect(Number(error.code)).assertEqual(401);
    ...
    /**
     * @tc.name   test_AddGnssGeofence_0200
     * @tc.number test_AddGnssGeofence_0200
     * @tc.desc   Test the function of locating the validity period of the fence.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('test_AddGnssGeofence_0200', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
        var isAcessToken = canIUse("SystemCapability.Location.Location.Geofence");
        console.info("test_AddGnssGeofence_0200 : " + isAcessToken);
        if (!isAcessToken) {
            console.info("The device does not support geofence");
            expect(isAcessToken).assertFalse();
            done();
            ...
            await changedLocationMode();
            let geofence = { "latitude": 31.12, "longitude": 121.11, "radius": 1, "expiration": 1, "coordinateSystemType": geolocationm.CoordinateSystemType.GCJ02};
            let fenceRequest = {
                "geofence": geofence,
                "monitorTransitionEvents": [],
                "geofenceTransitionCallback" : (err, transition) => {
                    if (err) {
                        console.info("test_AddGnssGeofence_0200 transition callback  err:" + err);
                        expect(true).assertEqual(JSON.stringify(err) != null);
                        return;
                    }
                    console.info("[lbs_js] test_AddGnssGeofence_0200 callback result:" + JSON.stringify(transition));
                    expect(true).assertEqual(transition != null);
                    expect(true).assertEqual(transition.geofenceId != -1)
                    expect(true).assertEqual(transition.transitionEvent != -1)
                },
            ...
            try {
                await geolocationm.addGnssGeofence(fenceRequest).then((id) => {
                    console.info("[lbs_js] test_AddGnssGeofence_0200 addGnssGeofence success, id = " + id);
                    fenceId = id;
                    expect(true).assertEqual(id != -1);
                }).catch((err) => {
                    console.info("[lbs_js] test_AddGnssGeofence_0200 add error=" + JSON.stringify(error));
                    expect(true).assertEqual(JSON.stringify(err) != null);
                }
                );
            } catch (error) {
                console.info("[lbs_js] test_AddGnssGeofence_0200 add try error:"+ JSON.stringify(error));
                if (error.code == "801") {
                    expect(error.code).assertEqual("801")
                } else {
                    expect(true).assertEqual(JSON.stringify(error) != null);
    ...
    /**
     * @tc.name   test_GetCurrentLocation_re_0100
     * @tc.number test_GetCurrentLocation_re_0100
     * @tc.desc   Initiate a single location request in a specified scenario and set the navigation scenario.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('test_GetCurrentLocation_re_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
        let currentLocationRequest = { "priority": request_priority_UNSET, "scenario": request_scenario_NAVIGATION, "timeoutMs": 1000, "maxAccuracy": 10 };
        try {
            geolocationm.getCurrentLocation(currentLocationRequest, (err, location) => {
                if (err) {
                    console.info("[lbs_js] test_GetCurrentLocation_re_0100 callback err:  " + JSON.stringify(err));
                    expect(err.code).assertEqual(3301200);
                    console.info('[lbs_js] test_GetCurrentLocation_re_0100 reject after');
                    done();
                } else {
                    console.info("[lbs_js] test_GetCurrentLocation_re_0100 callback result:" + JSON.stringify(location));
                    expect(true).assertEqual(location != null);
                    expect(true).assertEqual(location.latitude != -1)
                    expect(true).assertEqual(location.longitude != -1)
                    expect(true).assertEqual(location.altitude != -1)
            ...
            console.info("[lbs_js] test_GetCurrentLocation_re_0100 callback try err." + JSON.stringify(error));
            expect(true).assertFalse();
        }
        await sleep(1000);
        done();
    ...
    /**
     * @tc.name   test_GetCurrentLocation_re_0200
     * @tc.number test_GetCurrentLocation_re_0200
     * @tc.desc   Initiate a single location request in a specified scenario and set the navigation scenario.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('test_GetCurrentLocation_re_0200', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
        let currentLocationRequest = { "priority": request_priority_FIRST_FIX, "scenario": request_scenario_NAVIGATION, "timeoutMs": 1000, "maxAccuracy": 10 };
        try {
            await geolocationm.getCurrentLocation(currentLocationRequest).then((location) => {
                console.info('[lbs_js] test_GetCurrentLocation_re_0200 promise result ' + JSON.stringify(location));
                expect(true).assertEqual(location != null);
                expect(true).assertEqual(location.latitude != -1)
                expect(true).assertEqual(location.longitude != -1)
                expect(true).assertEqual(location.altitude != -1)
                ...
                console.info('[lbs_js] test_GetCurrentLocation_re_0200 promise err:' + JSON.stringify(error));
                expect(error.code).assertEqual(3301200);
            })
        } catch (error) {
            console.info("[lbs_js] test_GetCurrentLocation_re_0200 promise try err." + JSON.stringify(error));
            expect(true).assertFalse();
        }
        await sleep(1000);
        done();
    ...
    /**
     * @tc.name   test_LocationChange_getLastLocation_0100
     * @tc.number test_LocationChange_getLastLocation_0100
     * @tc.desc   Obtain the last location after a single location.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
    it('test_LocationChange_getLastLocation_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function(done) {
        enableLocationSwitch();
        let requestInfo = {"priority":request_priority_UNSET, "scenario":request_scenario_NAVIGATION, "timeInterval":0,
            "distanceInterval": 0, "maxAccuracy": 0};
        var locationChange = (location) => {
            console.info('[lbs_js] test_LocationChange_getLastLocation_0100: data: ' + JSON.stringify(location));
            expect(true).assertEqual(locationChange !=null);
        };
        try {
            geolocationm.on('locationChange', requestInfo, locationChange);
        } catch (error) {
            console.info("[lbs_js] test_LocationChange_getLastLocation_0100 try err." + JSON.stringify(error));
            expect(true).assertFalse();
        }
        try {
            geolocationm.off('locationChange', locationChange);
        ...
        try {
            ...
            console.info('[lbs_js] test_LocationChange_getLastLocation_0100 getLastLocation: sucess');
            ...
            console.info("[lbs_js] test_LocationChange_getLastLocation_0100 error:"+ error)
            if (error.code == "801") {
                expect(error.code).assertEqual("801")
            } else {
                expect(error.code).assertEqual("3301200");
