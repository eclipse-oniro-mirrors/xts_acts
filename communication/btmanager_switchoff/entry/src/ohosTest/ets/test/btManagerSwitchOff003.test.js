...
export default function btManagerError003Test() {
    describe('btManagerError003Test', function() {
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_0100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_0200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_0300
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_0400
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_0500
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_0600
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_0700
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_0800
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_0900
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_1000
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_1100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_1200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_1600
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_1700
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_1800
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_1900
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_2000
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_2200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_2800
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_2900
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_3000
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_3100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SwitchOff_3200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_3300
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_3400
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_3600
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_3700
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_3800
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_3900
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_BLESCAN_0800
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_4000
         * @tc.number SUB_COMMUNICATION_BTMANAGER_SWITCHOFF_4000
         * @tc.desc   Test ClassicStartBLEScan api.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL2
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BTMANAGER_SWITCH_0400
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_A2DP_0100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_ACCESS_0100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_ACCESS_0200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_ACCESS_0300
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_ACCESS_0400
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BASEPROFILE_0100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BASEPROFILE_0200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_SOCKET_0100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_SOCKET_0200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_SOCKET_0300
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_0100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_0200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_0300
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_0400
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_0500
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_0600
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_0700
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_0800
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_0900
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_1000
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_1100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_1200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_1300
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_1400
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_1500
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_1600
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_1700
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_1800
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_1900
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_2000
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_2100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_2200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_CONNECTION_2300
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_0100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_0200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_0300
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_0400
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_0500
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_0600
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_0700
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_0800
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_0900
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_1400
         * @tc.number SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_1400
         * @tc.desc   test getConnectedBLEDevices profile bt use api21
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_1400', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
                    ...
                    console.error( `getConnectedBLEDevices BleProfile error, error code is: ${e.code}, error message is: ${e.message}`);
                    expect(true).assertEqual(Number(e.code) == 2900003);
                  }
            } else {
                expect(true).assertTrue();
            }
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_1000
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_1100
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_1200
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_DISABLED_BLE_1300
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_CONNECTION_GETREMOTEDEVICETRANSPORT_0100
         * @tc.number SUB_COMMUNICATION_BLUETOOTH_CONNECTION_GETREMOTEDEVICETRANSPORT_0100
         * @tc.desc   Test getRemoteDeviceTransport
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_COMMUNICATION_BLUETOOTH_CONNECTION_GETREMOTEDEVICETRANSPORT_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
                    let transport = connection.getRemoteDeviceTransport("00:11:22:33:44:55");
                    console.info('[bluetooth_js] getRemoteDeviceTransport result:' + transport);
                    expect(true).assertFalse();
                  } catch (e) {
                    console.error( `getRemoteDeviceTransport get error, error code is: ${e.code}, error message is: ${e.message}`);
                    expect(Number(e.code)).assertEqual(2900003);
                  }
            } else {
                expect(true).assertTrue();
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTHBLE_GATTCLIENTDEVICE_UPDATECONNECTIONPARAM_OFF_0100
         * @tc.number SUB_COMMUNICATION_BLUETOOTHBLE_GATTCLIENTDEVICE_UPDATECONNECTIONPARAM_OFF_0100
         * @tc.desc   Test updateConnectionParam Bluetooth is turned off.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_COMMUNICATION_BLUETOOTHBLE_GATTCLIENTDEVICE_UPDATECONNECTIONPARAM_OFF_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
                    await gattClient.updateConnectionParam(ble.ConnectionParam.LOW_POWER);
					console.info('[bt_arkts]get device updateConnectionParam is' + JSON.stringify(device))
                    expect(true).assertFalse();
                } catch (e) {
                    console.error( `updateConnectionParam get error, error code is: ${e.code}, error message is: ${e.message}`);
                    expect(Number(e.code)).assertEqual(2900003);
                }
            } else {
                expect(true).assertTrue();
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTHBLE_GATTSERVER_GETSERVICE_OFF_0100
         * @tc.number SUB_COMMUNICATION_BLUETOOTHBLE_GATTSERVER_GETSERVICE_OFF_0100
         * @tc.desc   Test getService Bluetooth is turned off.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_COMMUNICATION_BLUETOOTHBLE_GATTSERVER_GETSERVICE_OFF_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
                    let serviceUuid = '00001888-0000-1000-8000-00805f9b34fb';
					let return_gattservice = gattServer.getService(serviceUuid);
					console.info('[bt_arkts]gattServer getService get return_values is ' + JSON.stringify(return_gattservice));
                    expect(true).assertFalse();
                } catch (e) {
                    console.error( `getService error, error code is: ${e.code}, error message is: ${e.message}`);
                    expect(Number(e.code)).assertEqual(2900003);
                }
            } else {
                expect(true).assertTrue();
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTHBLE_GATTSERVER_GETSERVICES_OFF_0100
         * @tc.number SUB_COMMUNICATION_BLUETOOTHBLE_GATTSERVER_GETSERVICES_OFF_0100
         * @tc.desc   Test getServices Bluetooth is turned off.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_COMMUNICATION_BLUETOOTHBLE_GATTSERVER_GETSERVICES_OFF_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
                    let return_list = gattServer.getServices();
                    ...
                    console.error( `getServices error, error code is: ${e.code}, error message is: ${e.message}`);
                    expect(Number(e.code)).assertEqual(2900003);
                }
            } else {
                expect(true).assertTrue();
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTHBLE_GATTSERVER_GETCONNECTEDSTATE_OFF_0100
         * @tc.number SUB_COMMUNICATION_BLUETOOTHBLE_GATTSERVER_GETCONNECTEDSTATE_OFF_0100
         * @tc.desc   Test GattServer getConnectedState Bluetooth is turned off.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_COMMUNICATION_BLUETOOTHBLE_GATTSERVER_GETCONNECTEDSTATE_OFF_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
                    let return_status = gattServer.getConnectedState('01:02:00:02:03:01');
					console.info('[bt_arkts]get status is' + JSON.stringify(return_status))
                    expect(true).assertFalse();
                } catch (e) {
                    console.error( `GattServer getConnectedState error, error code is: ${e.code}, error message is: ${e.message}`);
                    expect(Number(e.code)).assertEqual(2900003);
                }
            } else {
                expect(true).assertTrue();
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTHBLE_GATTCLIENTDEVICE_GETCONNECTEDSTATE_OFF_0100
         * @tc.number SUB_COMMUNICATION_BLUETOOTHBLE_GATTCLIENTDEVICE_GETCONNECTEDSTATE_OFF_0100
         * @tc.desc   Test GattClientDevice getConnectedState Bluetooth is turned off.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_COMMUNICATION_BLUETOOTHBLE_GATTCLIENTDEVICE_GETCONNECTEDSTATE_OFF_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
                    let return_status=gattClient.getConnectedState();
					console.info('[bt_arkts]client ProfileConnectionState 0200 is' + JSON.stringify(return_status))
                    expect(true).assertFalse();
                } catch (e) {
                    console.error( `GattClientDevice getConnectedState error, error code is: ${e.code}, error message is: ${e.message}`);
                    expect(Number(e.code)).assertEqual(2900003);
                }
            } else {
                expect(true).assertTrue();
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTHCONNECTION_LOCALNAME_OFF_0100
         * @tc.number SUB_COMMUNICATION_BLUETOOTHCONNECTION_LOCALNAME_OFF_0100
         * @tc.desc   Test setLocalName api10
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL3
         */
        it('SUB_COMMUNICATION_BLUETOOTHCONNECTION_LOCALNAME_OFF_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
                    connection.setLocalName('1111111111111111111111');
                    await sleep(1000);
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_BLE_S_OFF_0100
         * @tc.number SUB_COMMUNICATION_BLUETOOTH_BLE_S_OFF_0100
         * @tc.desc   Test setLocalName api10
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL3
         */
         it('SUB_COMMUNICATION_BLUETOOTH_BLE_S_OFF_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_BLE_S_OFF_0200
         * @tc.number SUB_COMMUNICATION_BLUETOOTH_BLE_S_OFF_0200
         * @tc.desc   Test setLocalName api10
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL3
         */
        it('SUB_COMMUNICATION_BLUETOOTH_BLE_S_OFF_0200', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
                    let deviceId = "00:11:22:33:44:55";
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_BLE_C_OFF_0100
         * @tc.number SUB_COMMUNICATION_BLUETOOTH_BLE_C_OFF_0100
         * @tc.desc   Test setLocalName api10
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL3
         */
         it('SUB_COMMUNICATION_BLUETOOTH_BLE_C_OFF_0100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
                    let phyValue = {
                        txPhy : ble.BlePhy.BLE_PHY_1M,
                    ...
                    await gattClient.setPhy(phyValue);
                    console.info('[bt_arkts]不应该成功');
                    expect().assertFail();
                } catch (err) {
                    console.error("errCode:" + err.code + ",errMessage:" + err.message);
        ...
        /**
         * @tc.name   SUB_COMMUNICATION_BLUETOOTH_BLE_C_OFF_0200
         * @tc.number SUB_COMMUNICATION_BLUETOOTH_BLE_C_OFF_0200
         * @tc.desc   Test setLocalName api10
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL3
         */
        it('SUB_COMMUNICATION_BLUETOOTH_BLE_C_OFF_0200', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            if (!closeUnsupport) {
                try {
                    await gattClient.readPhy();
                    console.info('[bt_arkts]不应该成功');
                    expect().assertFail();
                } catch (err) {
                    console.error("errCode:" + err.code + ",errMessage:" + err.message);
