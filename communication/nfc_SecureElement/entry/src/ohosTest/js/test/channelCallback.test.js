...
export default function channelCallbacktest() {
    describe('channelCallbacktest', function () {
                ...
                if (getReader == undefined) {
                    ...
                    .catch(error => {
                        if (error === 401) {
                            ...
                            expect(3300101).assertEqual(error);
                        } else if (error === 3300102) {
                            console.info("[NFC_test]09 openBasicChannel_p2_callback occurs exception:" + error);
                            expect(3300102).assertEqual(error);
                        } else if (error === 3300103) {
                            console.info("[NFC_test]09 openBasicChannel_p2_callback occurs exception:" + error);
                            expect(3300103).assertEqual(error);
                        } else if (error === 3300104) {
                            console.info("[NFC_test]09 openBasicChannel_p2_callback occurs exception:" + error);
                            expect(3300104).assertEqual(error);
                        } else {
                            console.info("[NFC_test]09 openBasicChannel_p2_callback occurs exception:" + error);
                            expect().assertFail();
                        }
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_0901
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_0901
         * @tc.desc   open BasicChannel Check whether the channel is a basic channel.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_0901', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]09 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    function P2BasicChannel_callback(){
                        return new Promise((resolve, reject) => {
                            Session.openBasicChannel(null, undefined,
                                (err, result) => {
                                    if(err) {
                                        console.info("[NFC_test]09 openBasicChannel data == null" + err.code + "---" + err);
                                        reject(err.code);
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_0902
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_0902
         * @tc.desc   open BasicChannel Check whether the channel is a basic channel.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_0902', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]09 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    function P2BasicChannel_callback(){
                        return new Promise((resolve, reject) => {
                            Session.openBasicChannel(undefined, null,
                                (err, result) => {
                                    if(err) {
                                        console.info("[NFC_test]09 openBasicChannel data == null" + err.code + "---" + err);
                                        reject(err.code);
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_0903
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_0903
         * @tc.desc   open BasicChannel Check whether the channel is a basic channel.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_0903', Level.LEVEL0, async function (done) {
            let aidArray1 = [];
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]09 This function is not supported because the phone NFC chip is ST chip.");
                    ...
                    function P2BasicChannel_callback(){
                        return new Promise((resolve, reject) => {
                            Session.openBasicChannel(aidArray1, null,
                                (err, result) => {
                                    if(err) {
                                        console.info("[NFC_test]09 openBasicChannel data == null" + err.code + "---" + err);
                                        reject(err.code);
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1001
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1001
         * @tc.desc   open LogicalChannel Check whether the channel is closed.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1001', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]10 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    function LogicalChannel_callback(){
                        return new Promise((resolve, reject) => {
                            Session.openLogicalChannel(null, null,
                                (err, result) => {
                                    if(err) {
                                        console.info("[NFC_test]10 openLogicalChannel data == null" + err);
                                        reject(err.code);
                    ...
                    .catch(error => {
                        console.info("[NFC_test]10 openBasicChannel failed" + error + "--error.code--" + error.code);
                        if (error.code === 401) {
                            console.info("[NFC_test]10 openBasicChannel failed" + error.code);
                            expect(401).assertEqual(error.code);
                        } else {
                            console.info("[NFC_test]10 openLogicalChannel occurs exception:" + error);
                            expect().assertFail();
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1002
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1002
         * @tc.desc   open LogicalChannel Check whether the channel is closed.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1002', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]10 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    function LogicalChannel_callback(){
                        return new Promise((resolve, reject) => {
                            Session.openLogicalChannel(undefined, undefined,
                                (err, result) => {
                                    if(err) {
                                        console.info("[NFC_test]10 openLogicalChannel data == null" + err);
                                        reject(err.code);
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1003
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1003
         * @tc.desc   open LogicalChannel Check whether the channel is closed.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1003', Level.LEVEL0, async function (done) {
            let array = [];
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]10 This function is not supported because the phone NFC chip is ST chip.");
                    ...
                    function LogicalChannel_callback(){
                        return new Promise((resolve, reject) => {
                            Session.openLogicalChannel(array, null,
                                (err, result) => {
                                    if(err) {
                                        console.info("[NFC_test]10 openLogicalChannel data == null" + err);
                                        reject(err.code);
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1101
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1101
         * @tc.desc   open BasicChannel Returns the data received from the application selection command.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1101', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]11 This function is not supported because the phone NFC chip is ST chip.");
                } else {
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1102
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1102
         * @tc.desc   open BasicChannel Returns the data received from the application selection command.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1102', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]11 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    function BasicChannel_callback(){
                        return new Promise((resolve, reject) => {
                            Session.openBasicChannel(undefined,
                                (err, result) => {
                                    if(err) {
                                        console.info("[NFC_test]11 to get openBasicChannel:" + JSON.stringify(err));
                                        reject(err.code);
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1103
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1103
         * @tc.desc   open BasicChannel Returns the data received from the application selection command.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1103', Level.LEVEL0, async function (done) {
            let aidArray1 = [];
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]11 This function is not supported because the phone NFC chip is ST chip.");
                    ...
                    function BasicChannel_callback(){
                        return new Promise((resolve, reject) => {
                            Session.openBasicChannel(aidArray1,
                                (err, result) => {
                                    if(err) {
                                        console.info("[NFC_test]11 to get openBasicChannel:" + JSON.stringify(err));
                                        reject(err.code);
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1202
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1202
         * @tc.desc   open LogicalChannel Send an APDU command to the SE
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1202', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]12 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    function LogicalChannel_callback(){
                        return new Promise((resolve, reject) => {
                            Session.openLogicalChannel(null,
                                (err, result) => {
                                    if(err) {
                                        console.info("[NFC_test]12 failed to get openLogicalChannel:" + JSON.stringify(err));
                                        reject(err.code);
                                        ...
                                        console.info("[NFC_test]12 openLogicalChannel data != null " + result);
                                        let nfcLogicalChannel = result;
                                        nfcLogicalChannel.transmit(null, (err, data) => {
                                            if (err) {
                                                if (err.code === 401) {
                                                    console.info("[NFC_test]09 openBasicChannel_p2_callback occurs exception:" + err.code + "---" + err);
                                                    expect(401).assertEqual(err.code);
                                                } else {
                                                    console.info("[NFC_test]09 openBasicChannel_p2_callback occurs exception:" + err);
                                                    expect().assertFail();
                                                }
                                            } else {
                                                console.info("[NFC_test]12 Send an APDU command1 to the SE: " + data);
                    ...
                    .catch(err => {
                        if (err.code === 401) {
                            console.info("[NFC_test]12 openLogicalChannel_callback occurs exception:" + err.code + "---" + err);
                            expect(401).assertEqual(err.code);
                        } else {
                            console.info("[NFC_test]12 openLogicalChannel_callback occurs exception:" + err.code + "---" + err);
                            expect().assertFail();
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1203
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1203
         * @tc.desc   open LogicalChannel Send an APDU command to the SE
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1203', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]12 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    function LogicalChannel_callback(){
                        return new Promise((resolve, reject) => {
                            Session.openLogicalChannel(undefined,
                                (err, result) => {
                                    if(err) {
                                        console.info("[NFC_test]12 failed to get openLogicalChannel:" + JSON.stringify(err));
                                        reject(err.code);
                                        ...
                                        console.info("[NFC_test]12 openLogicalChannel data != null " + result);
                                        let nfcLogicalChannel = result;
                                        nfcLogicalChannel.transmit(undefined, (err, data) => {
                                            if (err) {
                                                if (err.code === 401) {
                                                    console.info("[NFC_test]09 openBasicChannel_p2_callback occurs exception:" + err.code + "---" + err);
                                                    expect(401).assertEqual(err.code);
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1204
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1204
         * @tc.desc   open LogicalChannel Send an APDU command to the SE
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1204', Level.LEVEL0, async function (done) {
            let array = [];
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]12 This function is not supported because the phone NFC chip is ST chip.");
                    ...
                    function LogicalChannel_callback(){
                        return new Promise((resolve, reject) => {
                            Session.openLogicalChannel(array,
                                (err, result) => {
                                    if(err) {
                                        console.info("[NFC_test]12 failed to get openLogicalChannel:" + JSON.stringify(err));
                                        reject(err.code);
                    ...
                    .catch(err => {
                        if (err === 3300101) {
                            console.info("[NFC_test]12 openLogicalChannel_callback occurs exception:" + err);
                            expect(3300101).assertEqual(err);
                        } else {
                            console.info("[NFC_test]12 openLogicalChannel_callback occurs exception:" + err);
                            expect().assertFail();
                        }
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1301
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1301
         * @tc.desc   open LogicalChannel Send an APDU command to the SE
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1301', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]13 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openBasicChannel(null);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]13 openBasicChannel openBasicChannel data: " + data);
                        if ( data != undefined && data != null){
                            console.info("[NFC_test]13 openBasicChannel data != null");
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1302
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1302
         * @tc.desc   open LogicalChannel Send an APDU command to the SE
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1302', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]13 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openBasicChannel(undefined);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]13 openBasicChannel openBasicChannel data: " + data);
                        if ( data != undefined && data != null){
                            console.info("[NFC_test]13 openBasicChannel data != null");
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1303
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1303
         * @tc.desc   open LogicalChannel Send an APDU command to the SE
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1303', Level.LEVEL0, async function (done) {
            let aidArray1 = [];
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]13 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openBasicChannel(aidArray1);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]13 openBasicChannel openBasicChannel data: " + data);
                        if ( data != undefined && data != null){
                            console.info("[NFC_test]13 openBasicChannel data != null");
                ...
                if (err.code === 3300101) {
                    console.info("[NFC_test] MifareClassicTag5 writeSingleBlock1 err: " + err);
                    expect(3300101).assertEqual(err.code);
                }else {
                    console.info("[NFC_test] MifareClassicTag5 writeSingleBlock1 err: " + err);
                    expect().assertFail();
                }
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1401
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1401
         * @tc.desc   open LogicalChannel Check whether the channel is a basic channel.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1401', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]14 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openLogicalChannel(null);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]14  openLogicalChannel data: " + data);
                    }).catch((error)=> {
                        console.info("[NFC_test]14 openLogicalChannel catch error" + error.code + "---" + error);
                ...
                if (err.code === 401) {
                    console.info("[NFC_test]14 openLogicalChannel exception:" + err.code + "---" + err);
                    expect(401).assertEqual(err.code);
                } else {
                    console.info("[NFC_test]14 openLogicalChannel exception:" + err.code + "---" + err);
                    expect().assertFail();
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1402
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1402
         * @tc.desc   open LogicalChannel Check whether the channel is a basic channel.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1402', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]14 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openLogicalChannel(undefined);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]14  openLogicalChannel data: " + data);
                    }).catch((error)=> {
                        console.info("[NFC_test]14 openLogicalChannel catch error" + error.code + "---" + error);
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1403
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1403
         * @tc.desc   open LogicalChannel Check whether the channel is a basic channel.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1403', Level.LEVEL0, async function (done) {
            let array = [];
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]14 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openLogicalChannel(array);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]14  openLogicalChannel data: " + data);
                    }).catch((err)=> {
                        if (err.code === 3300101) {
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1501
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1501
         * @tc.desc   open BasicChannel Check whether the channel is a basic channel.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1501', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]15 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openBasicChannel(null,null);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]15  openBasicChannel data: " + data);
                        if ( data != undefined && data != null){
                            console.info("[NFC_test]15 openBasicChannel data != null");
                ...
                if (err.code === 401) {
                    console.info("[NFC_test] 15 openBasicChannel occurs exception err: " + err);
                    expect(401).assertEqual(err.code);
                }else {
                    console.info("[NFC_test] 15 openBasicChannel occurs exception err: " + err);
                    expect().assertFail();
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1502
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1502
         * @tc.desc   open BasicChannel Check whether the channel is a basic channel.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1502', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]15 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openBasicChannel(undefined,undefined);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]15  openBasicChannel data: " + data);
                        if ( data != undefined && data != null){
                            console.info("[NFC_test]15 openBasicChannel data != null");
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1503
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1503
         * @tc.desc   open BasicChannel Check whether the channel is a basic channel.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1503', Level.LEVEL0, async function (done) {
            let aidArray1 = [];
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]15 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openBasicChannel(aidArray1,p2);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]15  openBasicChannel data: " + data);
                        if ( data != undefined && data != null){
                            console.info("[NFC_test]15 openBasicChannel data != null");
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1601
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1601
         * @tc.desc   Check whether the channel is closed.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1601', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]16 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openLogicalChannel(null,null);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]16  openLogicalChannel data: " + data);
                        if ( data != undefined && data != null){
                            console.info("[NFC_test]16 openLogicalChannel data != null");
                ...
                if (err.code === 401) {
                    console.info("[NFC_test]16 openLogicalChannel_Promise occurs exception:" + err.code + "---" + err);
                    expect(401).assertEqual(err.code);
                } else {
                    console.info("[NFC_test]16 openLogicalChannel_Promise occurs exception:" + err.code + "---" + err);
                    expect().assertFail();
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1602
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1602
         * @tc.desc   Check whether the channel is closed.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1602', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]16 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openLogicalChannel(undefined,undefined);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]16  openLogicalChannel data: " + data);
                        if ( data != undefined && data != null){
                            console.info("[NFC_test]16 openLogicalChannel data != null");
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_1603
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_1603
         * @tc.desc   Check whether the channel is closed.
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_1603', Level.LEVEL0, async function (done) {
            let array = [];
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]16 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                    let getPromise = Session.openLogicalChannel(array,undefined);
                    await getPromise.then((data) => {
                        console.info("[NFC_test]16  openLogicalChannel data: " + data);
                        if ( data != undefined && data != null){
                            console.info("[NFC_test]16 openLogicalChannel data != null");
                                    ...
                                    if(err) {
                                        ...
                                        nfcLogicalChannel.transmit(cmdData).then((data) => {
                                            ...
                                            if (error.code === 401) {
                                                ...
                                                console.info("[NFC_test]26 transmit failed" + error + "--error.code--" + error.code);
                                                expect(3300101).assertEqual(error.code);
                                            } else if (error.code === 3300103) {
                                                console.info("[NFC_test]26 transmit failed" + error + "--error.code--" + error.code);
                                                expect(3300103).assertEqual(error.code);
                                            } else if (error.code === 3300104) {
                                                console.info("[NFC_test]26 transmit failed" + error + "--error.code--" + error.code);
                                                expect(3300104).assertEqual(error.code);
                                            } else  {
                                                console.info("[NFC_test]26 transmit failed" + error + "--error.code--" + error.code);
                                                expect().assertFail();
                                            }
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_2602
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_2602
         * @tc.desc   open LogicalChannel Send an APDU command to the SE
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_2602', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]26 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                            ...
                            Session.openLogicalChannel(aidArray,
                                (err, result) => {
                                    if(err) {
                                        ...
                                        console.info("[NFC_test]26 openLogicalChannel data != null " + result);
                                        let nfcLogicalChannel = result;
                                        nfcLogicalChannel.transmit(null).then((data) => {
                                            console.info("[NFC_test]26 Send an APDU command to the SE: " + data);
                                            if (data.length > 0) {
                                                expect(data.length > 0).assertTrue();
                                            } else {
                ...
                if (error.code === 401) {
                        console.info("[NFC_test] MifareClassicTag5 writeSingleBlock1 error: " + error);
                        expect(401).assertEqual(err.code);
                    }else {
                        console.info("[NFC_test] MifareClassicTag5 writeSingleBlock1 error: " + error);
                        expect(801).assertEqual(error.code);
        ...
        /**
         * @tc.name   SUB_Communication_Ese_LogicalChannel_js_2603
         * @tc.number SUB_Communication_Ese_LogicalChannel_js_2603
         * @tc.desc   open LogicalChannel Send an APDU command to the SE
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it('SUB_Communication_Ese_LogicalChannel_js_2603', Level.LEVEL0, async function (done) {
            try {
                if (getReader == undefined) {
                    console.info("[NFC_test]26 This function is not supported because the phone NFC chip is ST chip.");
                } else {
                            ...
                            Session.openLogicalChannel(aidArray,
                                (err, result) => {
                                    if(err) {
                                        ...
                                        console.info("[NFC_test]26 openLogicalChannel data != null " + result);
                                        let nfcLogicalChannel = result;
                                        nfcLogicalChannel.transmit(undefined).then((data) => {
                                            console.info("[NFC_test]26 Send an APDU command to the SE: " + data);
                                            if (data.length > 0) {
                                                expect(data.length > 0).assertTrue();
                                            } else {
