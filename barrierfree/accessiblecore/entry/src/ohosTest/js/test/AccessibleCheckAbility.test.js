...
describe('AccessibleCheckAbilityAdapt001', function () {
    const TIMEOUT = 1000;
    ...
    /**
     * @tc.name   SUB_BASIC_BARRIERFREE_Accessibility_InquiriesSeniorMode_0300
     * @tc.number SUB_BASIC_BARRIERFREE_Accessibility_InquiriesSeniorMode_0300
     * @tc.desc   Test isSeniorModeEnabled() function in promise mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL0
     */
    it('SUB_BASIC_BARRIERFREE_Accessibility_InquiriesSeniorMode_0300', TestType.FUNCTION | Size.SmallTest| Level.LEVEL0, async function (done) {
        console.info('SUB_BASIC_BARRIERFREE_Accessibility_InquiriesSeniorMode_0300');

        accessibility.isSeniorModeEnabled().then((result) => {
            console.info(`AccessibilityApi: SUB_BASIC_BARRIERFREE_Accessibility_InquiriesSeniorMode_0300 result: ${result}`);
            expect(typeof (result)).assertEqual('boolean');
            expect(result).assertEqual(false);
            done();
        }).catch((err) => {
            console.error(`AccessibilityApi: SUB_BASIC_BARRIERFREE_Accessibility_InquiriesSeniorMode_0300 has error: ${err.code}`);
            expect(null).assertFail();
            done();
        });
    })
    ...
    /**
     * @tc.name   SUB_BASIC_BARRIERFREE_Accessibility_InquiriesSeniorMode_0100
     * @tc.number SUB_BASIC_BARRIERFREE_Accessibility_InquiriesSeniorMode_0100
     * @tc.desc   onSeniorModeStateChange
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL0
     */
    it('SUB_BASIC_BARRIERFREE_Accessibility_InquiriesSeniorMode_0100', TestType.FUNCTION | Size.SmallTest| Level.LEVEL0, async function (done) {
        console.info('SUB_BASIC_BARRIERFREE_Accessibility_InquiriesSeniorMode_0100');
          let callbackdata = (data) => {
              console.info(domain, tag, 'on SeniorMode state changed');
          }
          let result = false;
          try {
              accessibility.onSeniorModeStateChange(callbackdata);
              accessibility.offSeniorModeStateChange(callbackdata);
              accessibility.offSeniorModeStateChange();
              result = true;
          } catch (error) {
              hilog.error(domain, tag, ` SUB_BASIC_BARRIERFREE_Accessibility_InquiriesSeniorMode_0100 failed. code: ${error.code}, msg: ${error.message}`);
              expect(null).assertFail();
              done();
          }
          expect(result).assertEqual(true);
