...
ani_int test_Object_SetProperty_Boolean([[maybe_unused]] ani_env *env, [[maybe_unused]] ani_object object)
{
    ani_class cls = {};
    ani_object obj = {};
    ASSERT_EQ(GetClassObject(env, &obj, &cls, "entry.src.main.src.ets.AccessingFiledsOfObjects.TestField"), ANI_TRUE);
...
ani_int test_Object_SetProperty_Ref([[maybe_unused]] ani_env *env, [[maybe_unused]] ani_object object)
{
    ...
    ani_ref value = {};
    ani_string testField;
    std::string name = "stringValue";
    env->String_NewUTF8(name.c_str(), name.size(), &testField);
    ASSERT_EQ(env->Object_SetPropertyByName_Ref(obj, "stringValue", testField), ANI_OK);
    return ANI_TRUE;
}
...
ani_int test_Class_FindIndexableGetter([[maybe_unused]] ani_env *env, [[maybe_unused]] ani_object object)
{
    ...
    ani_method value;
    ASSERT_EQ(
        env->Class_FindIndexableGetter(cls, "d:C{entry.src.main.src.ets.AccessingFiledsOfObjects.TestField}", &value),
        ANI_OK);
    ASSERT_NE(value, nullptr);
    return ANI_TRUE;
}
...
ani_int test_Class_FindIndexableSetter([[maybe_unused]] ani_env *env, [[maybe_unused]] ani_object object)
{
    ...
    ani_method value;
    ASSERT_EQ(env->Class_FindIndexableSetter(cls, "dz:", &value), ANI_OK);
    ASSERT_NE(value, nullptr);
    return ANI_TRUE;
}
...
{
    ani_class cls = {};
    ASSERT_EQ(env->FindClass("entry.src.main.src.ets.AccessingFiledsOfObjects.Singleton", &cls), ANI_OK);
...
ani_int test_Object_SetField_Ref([[maybe_unused]] ani_env *env, [[maybe_unused]] ani_object object)
{
    ...
    std::string name = "stringValue";
    env->String_NewUTF8(name.c_str(), name.size(), &testField);
    ASSERT_EQ(env->Object_SetField_Ref(obj, field, testField), ANI_OK);
    return ANI_TRUE;
}
