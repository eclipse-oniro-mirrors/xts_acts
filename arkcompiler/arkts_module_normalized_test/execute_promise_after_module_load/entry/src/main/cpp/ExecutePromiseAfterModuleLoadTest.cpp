...
{
    napi_value module;
    napi_load_module_with_info(env, "entry/src/ohosTest/ets/utils/LogMap",
    ...
    napi_create_string_utf8(env, "testLoadSoExecutePromisePendingJob", NAPI_AUTO_LENGTH, &key);
    napi_value value = nullptr;
    napi_create_string_utf8(env, "libentry.so", NAPI_AUTO_LENGTH, &value);
    napi_value argv[2];
    argv[0] = key;
    argv[1] = value;
    size_t argc = 2;
