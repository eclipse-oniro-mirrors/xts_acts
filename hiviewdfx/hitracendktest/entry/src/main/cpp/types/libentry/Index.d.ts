...
export const oHHiTraceIsIdValid: () => boolean;
export const oHHiTraceIsFlagEnabled: () => boolean;
export const oHHiTraceIsTraceEnabled: () => boolean;
export const oHHiTraceIsTraceEnabl2: () => boolean;
