...
export default function FileSahre_PersistPermission_test() {
    describe('PersistPermission_test', function () {
      ...
      /**
 	        * @tc.name   FileShare_persistPermission_006
 	        * @tc.number SUB_BASIC_FM_FileAPI_FileShare_PersistPermission_0600
 	        * @tc.desc   Test persistPermission() interfaces with null parameter
 	        * @tc.type   FUNCTION
 	        * @tc.size   MEDIUMTEST
 	        * @tc.level  LEVEL3
 	        */
 	       it('FileShare_persistPermission_006', Level.LEVEL3, async function (done) {
 	         try {
 	           fileShare.persistPermission(null).then(() => {
 	             console.info("FileShare_persistPermission_006 should not succeed");
 	             expect(false).assertTrue();
 	             done();
 	           }).catch((err) => {
 	             console.info("FileShare_persistPermission_006 failed with error message: " + err.message + ", error code: " + err.code);
 	             expect(err.code === 401).assertTrue();
 	             done();
 	           });
 	         } catch (e) {
 	           console.info('FileShare_persistPermission_006 has failed for ' + e.message + ", err code: " + e.code);
 	       ...
 	       /**
 	        * @tc.name   FileShare_persistPermission_007
 	        * @tc.number SUB_BASIC_FM_FileAPI_FileShare_PersistPermission_0700
 	        * @tc.desc   Test persistPermission() interfaces with undefined parameter
 	        * @tc.type   FUNCTION
 	        * @tc.size   MEDIUMTEST
 	        * @tc.level  LEVEL3
 	        */
 	       it('FileShare_persistPermission_007', Level.LEVEL3, async function (done) {
 	         try {
 	           fileShare.persistPermission(undefined).then(() => {
 	             console.info("FileShare_persistPermission_007 should not succeed");
 	             expect(false).assertTrue();
 	             done();
 	           }).catch((err) => {
 	             console.info("FileShare_persistPermission_007 failed with error message: " + err.message + ", error code: " + err.code);
 	             expect(err.code === 401).assertTrue();
 	             done();
 	           });
 	         } catch (e) {
 	           console.info('FileShare_persistPermission_007 has failed for ' + e.message + ", err code: " + e.code);
 	           expect(e.code === 401).assertTrue();
 	           done();
 	         }
 	       });
 	       ...
 	       /**
 	        * @tc.name   FileShare_persistPermission_008
 	        * @tc.number SUB_BASIC_FM_FileAPI_FileShare_PersistPermission_0800
 	        * @tc.desc   Test persistPermission() interfaces with empty array parameter
 	        * @tc.type   FUNCTION
 	        * @tc.size   MEDIUMTEST
 	        * @tc.level  LEVEL3
 	        */
 	       it('FileShare_persistPermission_008', Level.LEVEL3, async function (done) {
 	         try {
 	           let policies = [];
 	           fileShare.persistPermission(policies).then(() => {
 	             console.info("FileShare_persistPermission_008 successfully");
 	             expect(false).assertTrue();
 	             done();
 	           }).catch((err) => {
 	             console.info("FileShare_persistPermission_008 failed with error message: " + err.message + ", error code: " + err.code);
 	             expect(err.code === 401).assertTrue();
 	             done();
 	           });
 	         } catch (e) {
 	           console.info('FileShare_persistPermission_008 has failed for ' + e.message + ", err code: " + e.code);
 	           if(e.code === 801){
 	             expect(e.message == "The device doesn't support this api").assertTrue();
 	           }
 	           done();
