...
describe('fileIO_fs_fsync', function () {
  ...
  /**
   * @tc.name   fileIO_test_fsync_sync_003
   * @tc.number SUB_DF_FILEIO_FSYNC_SYNC_0300
   * @tc.desc   Test fsyncSync() interface. Fd is null.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
  it('fileIO_test_fsync_sync_003', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, function () {
    try {
      fileIO.fsyncSync(null);
      expect(false).assertTrue();
    } catch (e) {
      console.log('fileIO_test_fsync_sync_003 has failed for ' + e.message + ', code: ' + e.code);
      expect(e.code).assertEqual(13900020);
    }
  });

  /**
   * @tc.name   fileIO_test_fsync_sync_004
   * @tc.number SUB_DF_FILEIO_FSYNC_SYNC_0400
   * @tc.desc   Test fsyncSync() interface. Fd is undefined.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
  it('fileIO_test_fsync_sync_004', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, function () {
    try {
      fileIO.fsyncSync(undefined);
      expect(false).assertTrue();
    } catch (e) {
      console.log('fileIO_test_fsync_sync_004 has failed for ' + e.message + ', code: ' + e.code);
      expect(e.code).assertEqual(13900020);
    }
  });
  ...
  /**
   * @tc.name   fileIO_test_fsync_async_008
   * @tc.number SUB_DF_FILEIO_FSYNC_ASYNC_0800
   * @tc.desc   Test fsync() interface. Promise. Fd is null.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
  it('fileIO_test_fsync_async_008', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
    ...
    try {
      ...
      console.log('fileIO_test_fsync_async_008 has failed for ' + e.message + ', code: ' + e.code);
      expect(e.code).assertEqual(13900020);
      done();
    }
  });
  ...
  /**
   * @tc.name   fileIO_test_fsync_async_009
   * @tc.number SUB_DF_FILEIO_FSYNC_ASYNC_0900
   * @tc.desc   Test fsync() interface. Promise. Fd is undefined.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
  it('fileIO_test_fsync_async_009', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
    ...
    try {
      ...
      console.log('fileIO_test_fsync_async_009 has failed for ' + e.message + ', code: ' + e.code);
      expect(e.code).assertEqual(13900020);
      done();
    }
  });
  ...
  /**
   * @tc.name   fileIO_test_fsync_async_010
   * @tc.number SUB_DF_FILEIO_FSYNC_ASYNC_1000
   * @tc.desc   Test fsync() interface. Callback. Fd is null.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
  it('fileIO_test_fsync_async_010', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {

    try {
      fileIO.fsync(null, (err) => {
        expect(false).assertTrue();
      });
    } catch (e) {
      console.log('fileIO_test_fsync_async_010 has failed for ' + e.message + ', code: ' + e.code);
      expect(e.code).assertEqual(13900020);
      done();
    }
  });
  ...
  /**
   * @tc.name   fileIO_test_fsync_async_011
   * @tc.number SUB_DF_FILEIO_FSYNC_ASYNC_1100
   * @tc.desc   Test fsync() interface. Callback. Fd is undefined.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
  it('fileIO_test_fsync_async_011', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {

    try {
      fileIO.fsync(undefined, (err) => {
        expect(false).assertTrue();
      });
    } catch (e) {
      console.log('fileIO_test_fsync_async_011 has failed for ' + e.message + ', code: ' + e.code);
      expect(e.code).assertEqual(13900020);
      done();
    }
  });
