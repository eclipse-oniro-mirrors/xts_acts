...
describe('fileIO_fs_rmdir', function () {
   ...
   * @tc.desc   Test rmdirSync() interface. Test first parameter is null.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
  it('fileIO_test_rmdir_sync_005', Level.LEVEL0, function () {
    try {
   ...
   * @tc.desc   Test rmdirSync() interface. Test first parameter is undefined.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
  it('fileIO_test_rmdir_sync_006', Level.LEVEL0, function () {
    try {
   ...
   * @tc.number SUB_STORAGE_FILEIO_RMDIR_ASYNC_ASYNC_0600
   ...
   * @tc.desc   Test rmdir() interface. Promise. Test first parameter is null.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
   ...
   * @tc.desc   Test rmdir() interface. Promise. Test first parameter is undefined.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
   ...
   * @tc.desc   Test rmdir() interface. Callback. Test first parameter is null.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
  it('fileIO_test_rmdir_async_009', Level.LEVEL0, async function (done) {
    try {
      fileIO.rmdir(null, (err) => {
        if (err) {
   ...
   * @tc.desc   Test rmdir() interface. Callback. Test first parameter is undefined.
   * @tc.type   FUNCTION
   * @tc.size   MEDIUMTEST
   * @tc.level  LEVEL0
   */
  it('fileIO_test_rmdir_async_010', Level.LEVEL0, async function (done) {
    try {
      fileIO.rmdir(undefined, (err) => {
        if (err) {
