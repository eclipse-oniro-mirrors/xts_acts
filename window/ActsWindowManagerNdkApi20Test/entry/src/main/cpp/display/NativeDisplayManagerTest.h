 ...
 */
#ifndef ACE_C_ARKUI_KEY_CODE_TEST_API20_NATIVEDISPLAYMANAGERTEST_H
#define ACE_C_ARKUI_KEY_CODE_TEST_API20_NATIVEDISPLAYMANAGERTEST_H
...
#endif //ACE_C_ARKUI_KEY_CODE_TEST_API20_NATIVEDISPLAYMANAGERTEST_H
