...
export default function DeviceInfoTest() {
    describe('DeviceInfoTest', function () {
         ...
         * @tc.level  LEVEL0
         */
        it('device_info_test_010', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
