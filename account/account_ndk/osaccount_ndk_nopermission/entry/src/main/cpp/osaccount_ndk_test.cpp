...
static napi_value OsAccountGetAccountNameById(napi_env env, napi_callback_info info)
{
    ...
    napi_value result = nullptr;
    NAPI_CALL(env, napi_create_int32(env, returnValue == OS_ACCOUNT_ERR_PERMISSION_DENIED ? 0 : -1, &result));
    return result;
}
...
static napi_value Init(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        {"osAccountGetAccountNameById", nullptr, OsAccountGetAccountNameById, nullptr, nullptr, nullptr, napi_default,
         nullptr},
    };
