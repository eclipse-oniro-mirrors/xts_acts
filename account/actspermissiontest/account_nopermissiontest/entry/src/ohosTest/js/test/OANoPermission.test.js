...
export default function ActsOANoPermissionTest() {
  describe('ActsOANoPermissionTest', function () {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_0100
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_0200
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_0300
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_0400
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_0500
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_0600
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_0700
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_0800
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_0900
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_1000
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_1100
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_1200
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_1300
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_1400
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_1500
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_1600
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_1700
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_1800
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_1900
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_2000
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_2100
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_2200
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_2300
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_2400
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_2500
     * @tc.number SUB_Account_OsAccount_NoPermission_2500
     * @tc.desc   isOsAccountActived with null localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_2500', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_2500 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
        accountManager.isOsAccountActived(0, (err, data) => {
          console.info(tag + "err: " + JSON.stringify(err));
          try {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_2600
     * @tc.number SUB_Account_OsAccount_NoPermission_2600
     * @tc.desc   isOsAccountActived with undefined localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_2600', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_2600 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_2700
     * @tc.number SUB_Account_OsAccount_NoPermission_2700
     * @tc.desc   isOsAccountActived with null localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_2700', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_2700 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
        accountManager.isOsAccountConstraintEnable(0, "constraint.bluetooth", (err, data) => {
          console.info(tag + "err: " + JSON.stringify(err));
          try {
            expect(err.code).not().assertUndefined();
          } catch (e) {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_2800
     * @tc.number SUB_Account_OsAccount_NoPermission_2800
     * @tc.desc   isOsAccountActived with undefined localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_2800', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_2800 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
        await accountManager.isOsAccountConstraintEnable(0, "constraint.bluetooth");
        console.info("====>run err");
        expect().assertFail();
        done();
      } catch (err) {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_2900
     * @tc.number SUB_Account_OsAccount_NoPermission_2900
     * @tc.desc   isOsAccountActived with null localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_2900', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_2900 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_3000
     * @tc.number SUB_Account_OsAccount_NoPermission_3000
     * @tc.desc   isOsAccountActived with undefined localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_3000', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_3000 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
        await accountManager.isOsAccountVerified();
        console.info(tag + "end");
        done();
      } catch (err) {
        console.info(tag + "catch err: " + JSON.stringify(err));
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_3100
     * @tc.number SUB_Account_OsAccount_NoPermission_3100
     * @tc.desc   isOsAccountActived with null localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_3100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_3100 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_3200
     * @tc.number SUB_Account_OsAccount_NoPermission_3200
     * @tc.desc   isOsAccountActived with undefined localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_3200', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_3200 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_3300
     * @tc.number SUB_Account_OsAccount_NoPermission_3300
     * @tc.desc   isOsAccountActived with null localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_3300', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_3300 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
        accountManager.getCreatedOsAccountsCount((err, data) => {
          console.info(tag + "err: " + JSON.stringify(err));
          try {
            expect(err.code).not().assertUndefined();
          } catch (e) {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_3400
     * @tc.number SUB_Account_OsAccount_NoPermission_3400
     * @tc.desc   isOsAccountActived with undefined localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_3400', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_3400 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_3500
     * @tc.number SUB_Account_OsAccount_NoPermission_3500
     * @tc.desc   isOsAccountActived with null localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_3500', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_3500 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      let domainInfo = {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_3600
     * @tc.number SUB_Account_OsAccount_NoPermission_3600
     * @tc.desc   isOsAccountActived with undefined localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_3600', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_3600 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      let domainInfo = {
        accountName: 'testAccountName',
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_3700
     * @tc.number SUB_Account_OsAccount_NoPermission_3700
     * @tc.desc   isOsAccountActived with null localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_3700', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_3700 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
        accountManager.getOsAccountAllConstraints(0, (err, data) => {
          console.info(tag + "err: " + JSON.stringify(err));
          try {
            expect(err.code).not().assertUndefined();
          } catch (e) {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_3800
     * @tc.number SUB_Account_OsAccount_NoPermission_3800
     * @tc.desc   isOsAccountActived with undefined localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_3800', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_3800 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
        await accountManager.getOsAccountAllConstraints(0);
        console.info("====>run err");
        expect().assertFail();
        done();
      } catch (err) {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_3900
     * @tc.number SUB_Account_OsAccount_NoPermission_3900
     * @tc.desc   isOsAccountActived with null localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_3900', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_3900 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_4000
     * @tc.number SUB_Account_OsAccount_NoPermission_4000
     * @tc.desc   isOsAccountActived with undefined localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_4000', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_4000 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_4100
     * @tc.number SUB_Account_OsAccount_NoPermission_4100
     * @tc.desc   isOsAccountActived with null localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_4100', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_4100 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
        accountManager.getDistributedVirtualDeviceId((err, data) => {
          console.info(tag + "err: " + JSON.stringify(err));
          try {
            expect(err.code).not().assertUndefined();
          } catch (e) {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_4200
     * @tc.number SUB_Account_OsAccount_NoPermission_4200
     * @tc.desc   isOsAccountActived with undefined localId callback mode.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL3
     */
    it('SUB_Account_OsAccount_NoPermission_4200', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_4200 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
        await accountManager.getDistributedVirtualDeviceId();
        console.info("====>run err");
        expect().assertFail();
        done();
      } catch (err) {
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_4300
     * @tc.number SUB_Account_OsAccount_NoPermission_4300
     * @tc.desc   no ohos.permission.GET_LOCAL_ACCOUNT_IDENTIFIERS.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL0
     */
    it('SUB_Account_OsAccount_NoPermission_4300', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_4300 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
        await accountManager.getOsAccountLocalIds();
        console.info(tag + "run err");
        expect().assertFail();
        done();
      } catch (err) {
        console.info(tag + "catch err: " + JSON.stringify(err));
    ...
    /**
     * @tc.name   SUB_Account_OsAccount_NoPermission_4400
     * @tc.number SUB_Account_OsAccount_NoPermission_4400
     * @tc.desc   no ohos.permission.GET_LOCAL_ACCOUNT_IDENTIFIERS.
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL0
     */
    it('SUB_Account_OsAccount_NoPermission_4400', TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async (done) => {
      let tag = "====>SUB_Account_OsAccount_NoPermission_4400 "
      console.info(tag + "start====");
      let accountManager = osAccount.getAccountManager();
      try {
        await accountManager.getOsAccountNameByLocalId(100);
        console.info(tag + "run err");
        expect().assertFail();
        done();
      } catch (err) {
