...
static napi_value OHNativeVSyncRequestFrameNullptr(napi_env env, napi_callback_info info)
{
    ...
    if (res != NATIVE_ERROR_INVALID_ARGUMENTS) {
        napi_create_int32(env, FAIL, &result);
        return result;
    }
...
static napi_value OHNativeVSyncDVSyncSwitch(napi_env env, napi_callback_info info)
{
    ...
    if ((OH_NativeVSync_DVSyncSwitch(nativeVSync, true) == NATIVE_ERROR_OK) ||
        (OH_NativeVSync_DVSyncSwitch(nativeVSync, false) == NATIVE_ERROR_OK)) {
        napi_create_int32(env, SUCCESS, &result);
    } else {
        napi_create_int32(env, FAIL, &result);
    }
...
static napi_value OHNativeVSyncDVSyncSwitchNullptr(napi_env env, napi_callback_info info)
{
    ...
    char param[] = "test";
    OH_NativeVSync_RequestFrame(nativeVSync, MyFrameCallback, &param);
    if ((OH_NativeVSync_DVSyncSwitch(nullptr, true) == NATIVE_ERROR_INVALID_ARGUMENTS) ||
        (OH_NativeVSync_DVSyncSwitch(nullptr, false) != NATIVE_ERROR_INVALID_ARGUMENTS)) {
        napi_create_int32(env, SUCCESS, &result);
    } else {
        napi_create_int32(env, FAIL, &result);
    }
...
{
    napi_value result = nullptr;
    if (OH_NativeVSync_SetExpectedFrameRateRange(nullptr, nullptr) == NATIVE_ERROR_INVALID_ARGUMENTS) {
        napi_create_int32(env, SUCCESS, &result);
    } else {
        napi_create_int32(env, FAIL, &result);
    }
...
static napi_value OHNativeVSyncSetExpectedFrameRateRange002(napi_env env, napi_callback_info info)
{
    ...
    OH_NativeVSync *vsync = OH_NativeVSync_Create("test", sizeof("test"));
    if (OH_NativeVSync_SetExpectedFrameRateRange(vsync, &range) != NATIVE_ERROR_OK) {
        napi_create_int32(env, FAIL, &result);
        return result;
    }
    range = {0, 144, 144};
    ...
    range = {145, 145, 145};
    if (OH_NativeVSync_SetExpectedFrameRateRange(vsync, &range) != NATIVE_ERROR_INVALID_ARGUMENTS) {
        napi_create_int32(env, FAIL, &result);
        return result;
    }
...
static napi_value OHNativeErrorCodeCover(napi_env env, napi_callback_info info)
{
    napi_value result = nullptr;
