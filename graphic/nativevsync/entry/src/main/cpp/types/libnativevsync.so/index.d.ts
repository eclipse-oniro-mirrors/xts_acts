 ...
 */
export const oHNativeVSyncCreate: () => number;
export const oHNativeVSyncCreateFOne: () => number;
export const oHNativeVSyncRequestFrame: () => number;
export const oHNativeVSyncRequestFrameFOne: () => number;
