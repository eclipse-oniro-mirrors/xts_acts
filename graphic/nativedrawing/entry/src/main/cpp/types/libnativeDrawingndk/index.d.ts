...
export const oHDrawingTextVerticalAlignmentBaseline: () => number;
export const oHDrawingTextVerticalAlignmentCenter: () => number;
export const oHDrawingTextVerticalAlignmentTop: () => number;