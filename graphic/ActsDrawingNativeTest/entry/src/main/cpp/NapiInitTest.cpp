...
static const napi_property_descriptor g_drawingNativeDescriptors[] = {
    ...
    DECL_NAPI_DESC(DrawingPointNegateOffset),
    ...
    DECL_NAPI_DESC(DrawingCanvasDrawGlyphs),
    DECL_NAPI_DESC(DrawingCanvasIsOpaque),
    ...
    DECL_NAPI_DESC(DrawingFontGetMetrics),
    ...
    DECL_NAPI_DESC(DrawingPathPart4GetData),
    DECL_NAPI_DESC(DrawingCanvasDrawPixelMapMesh),
    DECL_NAPI_DESC(DrawingCanvasResetClip),
