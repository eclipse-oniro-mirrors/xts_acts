...
// Path Part4 DrawingPathPart4GetData related functions
napi_value DrawingPathPart4GetData(napi_env env, napi_callback_info info)
{
    return NapiTry(env, [&]() -> napi_value {
        int32_t caseNum = GetInt32Arg(env, info, ARG_INDEX, DEFAULT_ARG);
        static const std::array<DrawingNativeFn, PATH_PART4_GET_DATA_HANDLER_COUNT> handlers = {
            OHOS::Rosen::Drawing::TestPathGetPointDataNormal,
            OHOS::Rosen::Drawing::TestPathGetPointDataNull,
            OHOS::Rosen::Drawing::TestPathGetPointDatAbnormal,
            OHOS::Rosen::Drawing::TestPathGetPointDataMultipleCalls,
            OHOS::Rosen::Drawing::TestPathGetVerbDataNormal,
            OHOS::Rosen::Drawing::TestPathGetVerbDataNull,
            OHOS::Rosen::Drawing::TestPathGetVerbDataAbnormal,
            OHOS::Rosen::Drawing::TestPathGetVerbDataMultipleCalls,
            OHOS::Rosen::Drawing::TestPathGetConicWeightNormal,
            OHOS::Rosen::Drawing::TestPathGetConicWeightNull,
            OHOS::Rosen::Drawing::TestPathGetConicWeightAbnormal,
            OHOS::Rosen::Drawing::TestPathGetConicWeightMultipleCalls,
            OHOS::Rosen::Drawing::TestPathConvertToSvgStringNormal1,
            OHOS::Rosen::Drawing::TestPathConvertToSvgStringNormal2,
            OHOS::Rosen::Drawing::TestPathConvertToSvgStringNull,
            OHOS::Rosen::Drawing::TestPathConvertToSvgStringAbnormal,
            OHOS::Rosen::Drawing::TestPathConvertToSvgStringMultipleCalls,
            OHOS::Rosen::Drawing::TestPathGetLastPointNormal,
            OHOS::Rosen::Drawing::TestPathGetLastPointNull,
            OHOS::Rosen::Drawing::TestPathGetLastPointMultipleCalls,
            OHOS::Rosen::Drawing::TestPathIsEqualNormal,
            OHOS::Rosen::Drawing::TestPathIsEqualNull,
            OHOS::Rosen::Drawing::TestPathIsEqualMultipleCalls,
        };
        int result = DispatchByCaseNum(caseNum, handlers);
        napi_value resultValue;
        napi_create_int32(env, result, &resultValue);
...
// Canvas Part6 DrawingCanvasResetClip related functions
napi_value DrawingCanvasResetClip(napi_env env, napi_callback_info info)
{
    return NapiTry(env, [&]() -> napi_value {
        int32_t caseNum = GetInt32Arg(env, info, ARG_INDEX, DEFAULT_ARG);
        static const std::array<DrawingNativeFn, CANVAS_PART6_RESET_CLIP_HANDLER_COUNT> handlers = {
            OHOS::Rosen::Drawing::TestCanvasResetClipNormal,
            OHOS::Rosen::Drawing::TestCanvasResetClipNull,
            OHOS::Rosen::Drawing::TestCanvasResetClipMultipleCalls,
        };
        int result = DispatchByCaseNum(caseNum, handlers);
        napi_value resultValue;
        napi_create_int32(env, result, &resultValue);
...
// Canvas Part6 related functions
napi_value DrawingCanvasDrawGlyphs(napi_env env, napi_callback_info info)
{
    return NapiTry(env, [&]() -> napi_value {
        int32_t caseNum = GetInt32Arg(env, info, ARG_INDEX, DEFAULT_ARG);
        static const std::array<DrawingNativeFn, CANVAS_PART6_DRAW_GLYPHS_HANDLER_COUNT> handlers = {
            OHOS::Rosen::Drawing::TestCanvasDrawGlyphsNormal,
            OHOS::Rosen::Drawing::TestCanvasDrawGlyphsNull,
            OHOS::Rosen::Drawing::TestCanvasDrawGlyphsAbnormal,
            OHOS::Rosen::Drawing::TestCanvasDrawGlyphsMultipleCalls
        };
        int result = DispatchByCaseNum(caseNum, handlers);
        napi_value resultValue;
        napi_create_int32(env, result, &resultValue);
...
// Canvas Part6 related functions
napi_value DrawingCanvasIsOpaque(napi_env env, napi_callback_info info)
{
    return NapiTry(env, [&]() -> napi_value {
        int32_t caseNum = GetInt32Arg(env, info, ARG_INDEX, DEFAULT_ARG);
        static const std::array<DrawingNativeFn, CANVAS_PART6_IS_OPAQUE_HANDLER_COUNT> handlers = {
            OHOS::Rosen::Drawing::TestCanvasIsOpaqueNormal,
            OHOS::Rosen::Drawing::TestCanvasIsOpaqueNull,
            OHOS::Rosen::Drawing::TestCanvasIsOpaqueMultipleCalls
        };
        int result = DispatchByCaseNum(caseNum, handlers);
        napi_value resultValue;
        napi_create_int32(env, result, &resultValue);
