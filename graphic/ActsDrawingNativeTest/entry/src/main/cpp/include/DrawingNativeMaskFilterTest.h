...
#ifndef ACTSDRAWINGNATIVETEST_DRAWING_NATIVE_MASK_FILTER_TEST_H
#define ACTSDRAWINGNATIVETEST_DRAWING_NATIVE_MASK_FILTER_TEST_H
...
#endif // ACTSDRAWINGNATIVETEST_DRAWING_NATIVE_MASK_FILTER_TEST_H
