...
#ifndef ACTSDRAWINGNATIVETEST_DRAWING_CANVAS_DRAW_RECORD_CMD_TEST_H
#define ACTSDRAWINGNATIVETEST_DRAWING_CANVAS_DRAW_RECORD_CMD_TEST_H
...
#endif // ACTSDRAWINGNATIVETEST_DRAWING_CANVAS_DRAW_RECORD_CMD_TEST_H
