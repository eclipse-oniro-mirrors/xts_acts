...
napi_value testNativeWindowCreateNativeWindowNullptr(napi_env env, napi_callback_info info)
{
    ...
    OHNativeWindow *nativeWindow = OH_NativeWindow_CreateNativeWindow(nullptr);
...
napi_value testNativeWindowGetSurfaceIdNullptr(napi_env env, napi_callback_info info)
{
    ...
    if (NATIVE_ERROR_INVALID_ARGUMENTS == r) {
        napi_create_int32(env, SUCCESS, &result);
    } else {
...
napi_value testNativeWindowCreateNativeWindowBufferFromSurfaceBufferNullptr(napi_env env, napi_callback_info info)
{
    ...
    NAPI_ASSERT(env, buffer == nullptr, "buffer != nullptr");
    if (buffer == nullptr) {
        napi_create_int32(env, SUCCESS, &result);
    } else {
        napi_create_int32(env, FAIL, &result);
...
napi_value testNativeWindowCreateNativeWindowBufferFromNativeBufferNormal(napi_env env, napi_callback_info info)
{
    ...
    if (bufferHandle1 == nullptr || bufferHandle1->format != config.format || bufferHandle1->height != config.height ||
        bufferHandle1->width != config.width || bufferHandle1->usage != config.usage) {
        napi_create_int32(env, CONSTANT_2, &result);
        return result;
    }
...
napi_value testNativeWindowNativeWindowFlushBufferNormal(napi_env env, napi_callback_info info)
{
    ...
    if (flag != NATIVE_ERROR_BUFFER_STATE_INVALID) {
        napi_create_int32(env, CONSTANT_2, &result);
        return result;
    }
    delete initNative;
...
napi_value testNativeWindowNativeWindowFlushBufferErrorCode(napi_env env, napi_callback_info info)
{
    ...
    NAPI_ASSERT(env, nativeWindowBuffer != nullptr, "nativeWindowBuffer == nullptr");
    // 1.
    int32_t flag = OH_NativeWindow_NativeWindowFlushBuffer(nativeWindow, nativeWindowBuffer, -1, region);
    if (flag != NATIVE_ERROR_BUFFER_NOT_IN_CACHE) {
        napi_create_int32(env, FAIL, &result);
        return result;
    }
    delete initNative;
...
napi_value testNativeWindowGetLastFlushedBufferV2Nullptr(napi_env env, napi_callback_info info)
{
    ...
    // 1.
    int32_t flag1 = OH_NativeWindow_GetLastFlushedBufferV2(nullptr, &nativeWindowBuffer, &fenceFd, matrix);
    // 2.
    int32_t flag2 = OH_NativeWindow_GetLastFlushedBufferV2(nativeWindow, nullptr, &fenceFd, matrix);
    ...
    // 3.
    OH_NativeWindow_NativeWindowRequestBuffer(nativeWindow, &nativeWindowBuffer, &fenceFd);
    OH_NativeWindow_NativeWindowDetachBuffer(nativeWindow, nativeWindowBuffer);
    int32_t flag3 = OH_NativeWindow_GetLastFlushedBufferV2(nativeWindow, &nativeWindowBuffer, &fenceFd, matrix);
    if (flag3 != NATIVE_ERROR_UNKNOWN) {
        napi_create_int32(env, flag3, &result);
        return result;
    }
    delete initNative;
    napi_create_int32(env, SUCCESS, &result);
...
napi_value testNativeWindowGetLastFlushedBufferNullptr(napi_env env, napi_callback_info info)
{
    ...
    // 1.
    int32_t flag1 = OH_NativeWindow_GetLastFlushedBuffer(nullptr, &nativeWindowBuffer, &fenceFd, matrix);
    // 2.
    int32_t flag2 = OH_NativeWindow_GetLastFlushedBuffer(nativeWindow, nullptr, &fenceFd, matrix);
    if (flag1 != NATIVE_ERROR_INVALID_ARGUMENTS && flag2 != NATIVE_ERROR_INVALID_ARGUMENTS) {
        napi_create_int32(env, CONSTANT_1, &result);
        return result;
    }
...
napi_value testNativeWindowNativeObjectReferenceNullptr(napi_env env, napi_callback_info info)
{
    ...
    if (magicId != NATIVE_ERROR_INVALID_ARGUMENTS) {
        napi_create_int32(env, CONSTANT_1, &result);
        return result;
    }
...
napi_value testNativeWindowNativeWindowAttachBufferNormal(napi_env env, napi_callback_info info)
{
    ...
    if (flag != NATIVE_ERROR_BUFFER_IN_CACHE) {
        napi_create_int32(env, CONSTANT_1, &result);
        return result;
    }
...
napi_value testNativeWindowNativeWindowHandleOptCodeAbnormal(napi_env env, napi_callback_info info)
{
    napi_value result = nullptr;
    InitNativeWindow* initNative = new InitNativeWindow();
    OHNativeWindow *nativeWindow = nullptr;
    ...
    initNative->returnNativeImage();

    int32_t width = 0;
    int32_t height = 0;
    int64_t desiredPresentTimeStamp = 0;
    int32_t flag = OH_NativeWindow_NativeWindowHandleOpt(nativeWindow, -CONSTANT_1, NULL, NULL);
    if (flag != NATIVE_ERROR_OK) {
        napi_create_int32(env, FAIL, &result);
        return result;
    }
    flag = OH_NativeWindow_NativeWindowHandleOpt(nativeWindow, SET_DESIRED_PRESENT_TIMESTAMP, desiredPresentTimeStamp);
    if (flag != NATIVE_ERROR_OK) {
        napi_create_int32(env, FAIL, &result);
        return result;
    }
    flag = OH_NativeWindow_NativeWindowHandleOpt(nativeWindow, CONSTANT_25, &height, &width);
    if (flag != NATIVE_ERROR_OK) {
        napi_create_int32(env, FAIL, &result);
        return result;
    }
...
napi_value testNativeWindowNativeWindowFlushBufferAbnormalRegion(napi_env env, napi_callback_info info)
{
    napi_value result = nullptr;
    ...
    Region region{.rects = &rect, .rectNumber = 3000};
    int32_t flag = OH_NativeWindow_NativeWindowFlushBuffer(nativeWindow, nativeWindowBuffer, fenceFd, region);
    if (flag != NATIVE_ERROR_OK) {
        napi_create_int32(env, CONSTANT_1, &result);
        return result;
...
napi_value testNativeWindowNativeWindowRequestBufferDefaultWidthAndHeight(napi_env env, napi_callback_info info)
{
    napi_value result = nullptr;

    // 0.
    InitNativeWindow* initNative = new InitNativeWindow(false);
    OHNativeWindow *nativeWindow = nullptr;
    nativeWindow = initNative->returnNativeWindow();
    if (nativeWindow == nullptr) {
        napi_create_int32(env, CONSTANT_998899, &result);
    ...
    int32_t width = 0;
    int32_t height = 0;
    int flag = OH_NativeWindow_NativeWindowHandleOpt(nativeWindow, GET_BUFFER_GEOMETRY, &height, &width);
    if (flag != NATIVE_ERROR_OK) {
        napi_create_int32(env, CONSTANT_1000 + CONSTANT_2, &result);
        return result;
    }
    if (width != 0x50 || height != 0x50) {
        napi_create_int32(env, CONSTANT_1000 + CONSTANT_3, &result);
        return result;
    }
