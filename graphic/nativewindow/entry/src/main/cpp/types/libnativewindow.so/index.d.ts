...
export const testNativeWindowNativeWindowHandleOptCodeAbnormal: () => number;
...
export const testNativeWindowCleanCacheBeforeBufferRequested: () => number;
export const testNativeWindowCleanCacheWhenBufferRequested: () => number;
export const testNativeWindowCleanCacheWhenBufferFlushed: () => number;
export const testNativeWindowCleanCacheWhenBufferAcquired: () => number;
export const testNativeWindowCleanCacheWhenBufferReleased: () => number;
export const testNativeWindowCleanCacheLoopWhenBufferRequested: () => number;
export const testNativeWindowCleanCacheLoopWhenBufferFlushed: () => number;
export const testNativeWindowPreAllocBufferAbNormalPra: () => number;
export const testNativeWindowPreAllocBufferAbNormalPra2: () => number;
export const testNativeWindowPreAllocBufferBufferCnt: () => number;
export const testNativeWindowPreAllocBufferAbnormal: () => number;
export const testNativeWindowPreAllocBufferDetachAttach: () => number;
export const testNativeWindowPreAllocBufferDetachAttach02: () => number;
export const testNativeWindowPreAllocBufferNormal: () => number;
export const testNativeWindowCleanBufferUsage: () => number;
export const testNativeWindowLockBufferNormal: () => number;
export const testNativeWindowUnlockAndFlushBufferAbnormal01: () => number;
export const testNativeWindowUnlockAndFlushBufferAbnormal02: () => number;
export const testNativeWindowUnlockAndFlushBufferAbnormal03: () => number;
export const testNativeWindowUnlockAndFlushBufferAbnormal04: () => number;
export const testNativeWindowLockBufferNull: () => number;
export const testNativeWindowUnLockAndFlushBufferNull: () => number;
export const testNativeWindowLockBufferUpdateArea: () => number;
export const testNativeWindowLockBufferUpperLimit: () => number;
export const testNativeWindowLockBufferMultipleCalls: () => number;
export const testNativeWindowUnLockAndFlushBufferMultipleCalls: () => number;
export const testNativeWindowLockAndUnLockAndRequest: () => number;
export const OHNativeErrorCodeCover: () => number;
export const testNativeWindowNativeWindowFlushBufferAbnormalRegion: () => number;
export const testNativeWindowNativeWindowRequestBufferDefaultWidthAndHeight: () => number;
