...
namespace OHOS {
    ...
    /**
     * @tc.name   TestVulkanFragment_shader_interlockTestCase
     * @tc.number TestVulkanFragment_shader_interlockTestCase
     * @tc.desc   TestVulkanFragment_shader_interlockTestCase
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
