...
namespace OHOS {
    ...
    void ActsVulkanBinding_modelTest::SetUpTestCase(void)
    {
    }
    // Test suite cleanup action, which is executed after the last test case
    void ActsVulkanBinding_modelTest::TearDownTestCase(void)
    {
    }
    // Preset action of the test case
    void ActsVulkanBinding_modelTest::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsVulkanBinding_modelTest::TearDown()
    {
    }

    /**
     * @tc.name   TestVulkanBing_modelTestCase
     * @tc.number TestVulkanBing_modelTestCase
     * @tc.desc   TestVulkanBing_modelTestCase
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
