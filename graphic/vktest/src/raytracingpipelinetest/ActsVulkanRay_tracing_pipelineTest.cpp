...
namespace OHOS {
    ...
    void ActsVulkanRay_tracing_pipelineTest::SetUpTestCase(void)
    {
    }
    // Test suite cleanup action, which is executed after the last test case
    void ActsVulkanRay_tracing_pipelineTest::TearDownTestCase(void)
    {
    }
    // Preset action of the test case
    void ActsVulkanRay_tracing_pipelineTest::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsVulkanRay_tracing_pipelineTest::TearDown()
    {
    }

    /**
     * @tc.name   TestVulkanRay_tracing_pipelineTestCase
     * @tc.number TestVulkanRay_tracing_pipelineTestCase
     * @tc.desc   TestVulkanRay_tracing_pipelineTestCase
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
