...
namespace OHOS {
    ...
    void ActsVulkanClippingTest::SetUpTestCase(void)
    {
    }
    // Test suite cleanup action, which is executed after the last test case
    void ActsVulkanClippingTest::TearDownTestCase(void)
    {
    }
    // Preset action of the test case
    void ActsVulkanClippingTest::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsVulkanClippingTest::TearDown()
    {
    }

    /**
     * @tc.name   TestVulkanClippingTestCase
     * @tc.number TestVulkanClippingTestCase
     * @tc.desc   TestVulkanClippingTestCase
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
