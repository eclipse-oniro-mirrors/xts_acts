...
namespace OHOS {
    ...
    void ActsVulkanConditional_renderingTest::SetUpTestCase(void)
    {
    }
    // Test suite cleanup action, which is executed after the last test case
    void ActsVulkanConditional_renderingTest::TearDownTestCase(void)
    {
    }
    // Preset action of the test case
    void ActsVulkanConditional_renderingTest::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsVulkanConditional_renderingTest::TearDown()
    {
    }

    /**
     * @tc.name   TestVulkanConditional_renderingTestCase
     * @tc.number TestVulkanConditional_renderingTestCase
     * @tc.desc   TestVulkanConditional_renderingTestCase
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
