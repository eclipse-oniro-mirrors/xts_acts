...
namespace OHOS {
    ...
    void ActsVulkanTessellationTest::SetUpTestCase(void)
    {
    }
    // Test suite cleanup action, which is executed after the last test case
    void ActsVulkanTessellationTest::TearDownTestCase(void)
    {
    }
    // Preset action of the test case
    void ActsVulkanTessellationTest::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsVulkanTessellationTest::TearDown()
    {
    }

    /**
     * @tc.name   TestVulkanTessellationTestCase
     * @tc.number TestVulkanTessellationTestCase
     * @tc.desc   TestVulkanTessellationTestCase
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
