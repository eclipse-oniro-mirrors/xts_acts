...
#include <stdlib.h>
#include "ActsVulkanSynchronization2Test.h"
...
namespace OHOS {
    ...
    void ActsVulkanSynchronization2Test::SetUpTestCase(void)
    {
    }
    // Test suite cleanup action, which is executed after the last test case
    void ActsVulkanSynchronization2Test::TearDownTestCase(void)
    {
    }
    // Preset action of the test case
    void ActsVulkanSynchronization2Test::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsVulkanSynchronization2Test::TearDown()
    {
    }

    /**
     * @tc.name   TestVulkanSynchronization2TestCase
     * @tc.number TestVulkanSynchronization2TestCase
     * @tc.desc   TestVulkanSynchronization2TestCase
     * @tc.type   FUNCTION
     * @tc.size   MEDIUMTEST
     * @tc.level  LEVEL2
     */
