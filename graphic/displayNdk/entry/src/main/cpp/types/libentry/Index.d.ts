...
export const testNativeDisplayManager_ErrorCode_enum: () => number;
export const testNativeDisplayManager_FoldDisplayMode_enum: () => number;
export const testNativeDisplayManager_SourceMode_enum: () => number;
export const getAreaLinsterCount:() => number;
export const unregisterDisplayRemoveListenerOutRange: () => number;
export const unregisterDisplayAddListenerOutRange: () => number;
export const unregisterAvailableAreaChangeListenerOutRange: () => number;
export const unregisterFoldDisplayModeChangeListenerOutRange: () => number;
export const unregisterDisplayChangeListenerOutRange: () => number;
