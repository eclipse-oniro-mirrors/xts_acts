...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Build_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceBuild03()
{
    ...
    graphArgs.operands = {
        depthToSpaceModel.input, depthToSpaceModel.input, depthToSpaceModel.output, depthToSpaceModel.blockSize
    };
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Build_04
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceBuild04()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
    ...
    OHNNGraphArgs graphArgs = depthToSpaceModel.graphArgs;
    graphArgs.operands = {
        depthToSpaceModel.input, depthToSpaceModel.output, depthToSpaceModel.output, depthToSpaceModel.blockSize
    };
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Build_05
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceBuild05()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
    ...
    graphArgs.operands = { depthToSpaceModel.input, depthToSpaceModel.output, depthToSpaceModel.blockSize, activation };
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_Finish_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelFinish01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_Finish_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelFinish02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_Finish_03
 ...
 * @tc.level  LEVEL1
 */
int SUBAINNRtFuncNorthDepthToSpaceModelFinish03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_SetOperandValue_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelSetOperandValue01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_SetOperandValue_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelSetOperandValue02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_SetOperandValue_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelSetOperandValue03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_SpecifyInputsAndOutputs_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelSpecifyInputsAndOutputs01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_SpecifyInputsAndOutputs_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelSpecifyInputsAndOutputs02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_SpecifyInputsAndOutputs_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelSpecifyInputsAndOutputs03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_SpecifyInputsAndOutputs_04
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelSpecifyInputsAndOutputs04()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_SpecifyInputsAndOutputs_05
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelSpecifyInputsAndOutputs05()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_SpecifyInputsAndOutputs_06
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelSpecifyInputsAndOutputs06()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_SpecifyInputsAndOutputs_07
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelSpecifyInputsAndOutputs07()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_SpecifyInputsAndOutputs_08
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelSpecifyInputsAndOutputs08()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_AddOperation_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelAddOperation01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_AddOperation_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelAddOperation02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_AddOperation_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelAddOperation03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_AddOperation_04
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelAddOperation04()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_AddOperation_05
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelAddOperation05()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_AddOperation_06
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelAddOperation06()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_AddOperation_07
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelAddOperation07()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_AddOperation_08
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelAddOperation08()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_DepthToSpace_Model_AddOperation_09
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthDepthToSpaceModelAddOperation09()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
