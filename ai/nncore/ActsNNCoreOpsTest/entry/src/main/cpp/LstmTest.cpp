...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Build_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmBuild02()
{
    ...
    graphArgs.operands = { lSTMModel.input,     lSTMModel.input,      lSTMModel.wih,      lSTMModel.whh, lSTMModel.bias,
                           lSTMModel.hx,        lSTMModel.cx,         lSTMModel.output,   lSTMModel.hy,  lSTMModel.cy,
                           lSTMModel.inputSize, lSTMModel.hiddenSize, lSTMModel.numLayers };
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Build_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmBuild03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
    ...
    graphArgs.operands = { lSTMModel.input,     lSTMModel.wih,        lSTMModel.whh,      lSTMModel.bias, lSTMModel.hx,
                           lSTMModel.cx,        lSTMModel.output,     lSTMModel.output,   lSTMModel.hy,   lSTMModel.cy,
                           lSTMModel.inputSize, lSTMModel.hiddenSize, lSTMModel.numLayers };
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Build_04
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmBuild04()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
    ...
    graphArgs.operands = { lSTMModel.input, lSTMModel.wih,       lSTMModel.whh,        lSTMModel.bias,
                           lSTMModel.hx,    lSTMModel.cx,        lSTMModel.output,     lSTMModel.hy,
                           lSTMModel.cy,    lSTMModel.inputSize, lSTMModel.hiddenSize, lSTMModel.numLayers,
                           activation };
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_Finish_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelFinish01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_Finish_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelFinish02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_Finish_03
 ...
 * @tc.level  LEVEL1
 */
int SUBAINNRtFuncNorthLstmModelFinish03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_SetOperandValue_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelSetOperandValue01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_SetOperandValue_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelSetOperandValue02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_SetOperandValue_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelSetOperandValue03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_SpecifyInputsAndOutputs_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelSpecifyInputsAndOutputs01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_SpecifyInputsAndOutputs_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelSpecifyInputsAndOutputs02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_SpecifyInputsAndOutputs_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelSpecifyInputsAndOutputs03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_SpecifyInputsAndOutputs_04
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelSpecifyInputsAndOutputs04()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_SpecifyInputsAndOutputs_05
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelSpecifyInputsAndOutputs05()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_SpecifyInputsAndOutputs_06
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelSpecifyInputsAndOutputs06()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_SpecifyInputsAndOutputs_07
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelSpecifyInputsAndOutputs07()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_SpecifyInputsAndOutputs_08
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelSpecifyInputsAndOutputs08()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_AddOperation_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelAddOperation01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_AddOperation_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelAddOperation02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_AddOperation_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelAddOperation03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_AddOperation_04
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelAddOperation04()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_AddOperation_05
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelAddOperation05()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_AddOperation_06
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelAddOperation06()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_AddOperation_07
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelAddOperation07()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_AddOperation_08
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelAddOperation08()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_LSTM_Model_AddOperation_09
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthLstmModelAddOperation09()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
