...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Build_01
 ...
 * @tc.level  LEVEL1
 */
int SUBAINNRtFuncNorthUnstackBuild01()
{
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Build_02
 ...
 * @tc.level  LEVEL1
 */
int SUBAINNRtFuncNorthUnstackBuild02()
{
    if (IsSupportNPU() == false) {
        return OH_NN_SUCCESS;
    }
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Build_03
 ...
 * @tc.level  LEVEL1
 */
int SUBAINNRtFuncNorthUnstackBuild03()
{
    if (IsSupportNPU() == false) {
        return OH_NN_SUCCESS;
    }
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Build_04
 ...
 * @tc.level  LEVEL1
 */
int SUBAINNRtFuncNorthUnstackBuild04()
{
    if (IsSupportNPU() == false) {
        return OH_NN_SUCCESS;
    }
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Build_06
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackBuild06()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
    ...
    OHNNGraphArgs graphArgs = unstackModel.graphArgs;
    graphArgs.operands = {
        unstackModel.input, unstackModel.input, unstackModel.output, unstackModel.output, unstackModel.axis
    };
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Build_07
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackBuild07()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
    ...
    graphArgs.operands = {
        unstackModel.input, unstackModel.output, unstackModel.output, unstackModel.axis, activation
    };
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_Finish_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelFinish01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_Finish_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelFinish02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_Finish_03
 ...
 * @tc.level  LEVEL1
 */
int SUBAINNRtFuncNorthUnstackModelFinish03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_SetOperandValue_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelSetOperandValue01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_SetOperandValue_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelSetOperandValue02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_SetOperandValue_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelSetOperandValue03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_SpecifyInputsAndOutputs_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelSpecifyInputsAndOutputs01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_SpecifyInputsAndOutputs_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelSpecifyInputsAndOutputs02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_SpecifyInputsAndOutputs_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelSpecifyInputsAndOutputs03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_SpecifyInputsAndOutputs_04
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelSpecifyInputsAndOutputs04()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_SpecifyInputsAndOutputs_05
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelSpecifyInputsAndOutputs05()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_SpecifyInputsAndOutputs_06
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelSpecifyInputsAndOutputs06()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_SpecifyInputsAndOutputs_07
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelSpecifyInputsAndOutputs07()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_SpecifyInputsAndOutputs_08
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelSpecifyInputsAndOutputs08()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_AddOperation_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelAddOperation01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_AddOperation_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelAddOperation02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_AddOperation_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelAddOperation03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_AddOperation_04
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelAddOperation04()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_AddOperation_05
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelAddOperation05()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_AddOperation_06
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelAddOperation06()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_AddOperation_07
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelAddOperation07()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_AddOperation_08
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelAddOperation08()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Unstack_Model_AddOperation_09
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthUnstackModelAddOperation09()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
