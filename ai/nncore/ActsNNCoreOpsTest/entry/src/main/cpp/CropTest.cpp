...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Build_04
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropBuild04()
{
    ...
    graphArgs.operands = { cropModel.input,  cropModel.input, cropModel.shape,
                           cropModel.output, cropModel.axis,  cropModel.offsets };
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Build_05
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropBuild05()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
    ...
    CropModel1 cropModel;
    OHNNGraphArgs graphArgs = cropModel.graphArgs;
    graphArgs.operands = { cropModel.input,  cropModel.shape, cropModel.output,
                           cropModel.output, cropModel.axis,  cropModel.offsets };
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Build_06
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropBuild06()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
    ...
    graphArgs.operands = { cropModel.input, cropModel.shape,   cropModel.output,
                           cropModel.axis,  cropModel.offsets, activation };
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_Finish_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelFinish01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_Finish_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelFinish02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_Finish_03
 ...
 * @tc.level  LEVEL1
 */
int SUBAINNRtFuncNorthCropModelFinish03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_SetOperandValue_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelSetOperandValue01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_SetOperandValue_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelSetOperandValue02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_SetOperandValue_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelSetOperandValue03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_SpecifyInputsAndOutputs_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelSpecifyInputsAndOutputs01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_SpecifyInputsAndOutputs_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelSpecifyInputsAndOutputs02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_SpecifyInputsAndOutputs_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelSpecifyInputsAndOutputs03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_SpecifyInputsAndOutputs_04
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelSpecifyInputsAndOutputs04()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_SpecifyInputsAndOutputs_05
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelSpecifyInputsAndOutputs05()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_SpecifyInputsAndOutputs_06
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelSpecifyInputsAndOutputs06()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_SpecifyInputsAndOutputs_07
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelSpecifyInputsAndOutputs07()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_SpecifyInputsAndOutputs_08
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelSpecifyInputsAndOutputs08()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_AddOperation_01
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelAddOperation01()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_AddOperation_02
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelAddOperation02()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_AddOperation_03
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelAddOperation03()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_AddOperation_04
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelAddOperation04()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_AddOperation_05
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelAddOperation05()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_AddOperation_06
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelAddOperation06()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_AddOperation_07
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelAddOperation07()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_AddOperation_08
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelAddOperation08()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
...
/**
 * @tc.name   SUB_AI_NNRt_Func_North_Crop_Model_AddOperation_09
 ...
 * @tc.level  LEVEL2
 */
int SUBAINNRtFuncNorthCropModelAddOperation09()
{
    OH_NNModel* model = OH_NNModel_Construct();
    EXPECT_NE(nullptr, model);
