...
struct AvgPoolDynamicModel {
    // ADD MODEL (for dynamic shape testing)
    float inputValue0[4] = { 0, 1, 2, 3 };
    float inputValue1[4] = { 0, 1, 2, 3 };
    int8_t activationValue = OH_NN_FUSED_NONE;
    float outputValue[4] = { 0 };
    ...
    OHNNOperandTest input0 = { OH_NN_FLOAT32,
                               OH_NN_TENSOR,
                               { -1, -1, -1, -1 },
                               inputValue0,
                               ADD_DATA_LENGTH };
    OHNNOperandTest input1 = { OH_NN_FLOAT32,
                               OH_NN_TENSOR,
                               { -1, -1, -1, -1 },
                               inputValue1,
                               ADD_DATA_LENGTH };
    OHNNOperandTest activation = { OH_NN_INT8,
                                   ...
                                   &activationValue,
                                   sizeof(int8_t) };
    OHNNOperandTest output = { OH_NN_FLOAT32,
                               OH_NN_TENSOR,
                               { -1, -1, -1, -1 },
                               outputValue,
                               ADD_DATA_LENGTH };
...
void Free(OH_NNModel* model = nullptr,
...
int GetExecutorInputOutputTensorDesc(OH_NNExecutor* executor,
                                     std::vector<NN_TensorDesc*>& inputTensorDescs,
                                     size_t& inputCount,
                                     std::vector<NN_TensorDesc*>& outputTensorDescs,
                                     size_t& outputCount);
int GetExecutorInputOutputTensorByDesc(OH_NNExecutor* executor,
