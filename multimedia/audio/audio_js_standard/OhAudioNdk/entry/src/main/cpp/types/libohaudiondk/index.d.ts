...
export const DeInitOpenSlesTest: () => number;
export const InitOpenSlesTest: () => number;
export const TestOpenSlesRecorder: () => number;
export const TestOpenSlesRecorderInValid: () => number;