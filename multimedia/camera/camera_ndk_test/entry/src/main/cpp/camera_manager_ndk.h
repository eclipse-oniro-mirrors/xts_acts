...
#define TORCH_MODE_OFF 3
#define TORCH_MODE_ON 4
#define TORCH_MODE_AUTO 5
#define SMOOTH_ZOOM_MODE_NORMAL 2
...
public:
    ...
    Camera_Device* cameraDevices_;
    uint32_t cameraSize_;
    Camera_DeviceQueryInfo* deviceQueryInfo_;
    bool isDeviceQueryInfoInvalid_;
    ...
    bool isPhotoQualityPrioritizationSupported_;
    OH_PhotoNative *photoNative_;
    OH_ImageNative *mainImage_;
    OH_PictureNative *pictureNative_;
    ...
    uint32_t effectTypeSize_;
    Camera_ControlCenterEffectType* controlCenterEffectType_;
    ...
    static OH_PhotoNative* g_photoNative;
    ...
    Camera_ErrorCode GetSupportedFullOutputCapability(void);
    Camera_ErrorCode CreatePreviewOutput(void);
    Camera_ErrorCode CreateDeferredPreviewOutput(void);
    Camera_ErrorCode CreatePhotoOutput(char* photoSurfaceId);
    Camera_ErrorCode CreateHeifPhotoOutput(char* photoSurfaceId, int idx);
    int AdjustHeifIdx(int idx);
    Camera_ErrorCode CreateVideoOutput(char* videoId);
    Camera_ErrorCode CreateMetadataOutput(void);
    Camera_ErrorCode CreateMetadataOutputWithObjectTypes();
    ...
    Camera_ErrorCode MetadataOutputRemoveMetadataObjectTypes();
    bool IsMetadataObjectTypeValid();
 	Camera_ErrorCode MetadataOutputAddMetadataObjectTypes();
    ...
    Camera_ErrorCode GetCameraDevices(int useCaseCode);
    Camera_ErrorCode DeleteCameraDevices(int useCaseCode);
    Camera_ErrorCode SetInvalidDeviceQueryInfo(bool isDeviceQueryInfoInvalid);
    ...
    Camera_ErrorCode SessionGetPhotoRotationWithoutDeviceDegree();
    Camera_ErrorCode SessionGetVideoRotation(int rotation);
    Camera_ErrorCode SessionGetVideoRotationWithoutDeviceDegree();
    Camera_ErrorCode SessionGetPreviewRotation(int rotation);
    Camera_ErrorCode SessionGetPreviewRotationWithoutDisplayRotation();
    ...
    Camera_ErrorCode SessionIsControlCenterSupported(void);
    Camera_ErrorCode SessionGetSupportedEffectTypes(int useCaseCode);
    Camera_ErrorCode SessionDeleteSupportedEffectTypes(int useCaseCode);
    Camera_ErrorCode SessionEnableControlCenter(bool enabled);
    Camera_ErrorCode RegisterControlCenterEffectStatusChange(int useCaseCode);
    Camera_ErrorCode UnregisterControlCenterEffectStatusChange(int useCaseCode);
    ...
    Camera_ErrorCode CameraInputRegisterOcclusionDetectionCallback(void);
    ...
    Camera_ErrorCode CameraInputUnRegisterOcclusionDetectionCallback(void);
    ...
    Camera_ErrorCode GetSupportedFullCameraOutputCapabilityWithSceneMode(int useCaseCode);
    ...
    Camera_ErrorCode IsPhotoQualityPrioritizationSupported(int useCaseCode, int quality);
    Camera_ErrorCode SetPhotoQualityPrioritization(int useCaseCode, int quality);
    Camera_ErrorCode AddDeferredSurface(int useCaseCode, char* surfaceId);
    Camera_ErrorCode GetMainImage(int useCaseCode);
    Camera_ErrorCode GetUncompressedImage(int useCaseCode);
    Camera_ErrorCode PhotoNativeRelease(int useCaseCode);
    Camera_ErrorCode CreatePhotoOutputWithoutSurface(int useCaseCode);
    Camera_ErrorCode CreateYuvPhotoOutputWithoutSurface(int useCaseCode);
    ...
    Camera_ErrorCode SetTorchModeOnWithLevel(double level);
    ...
    Camera_ErrorCode RegisterSystemPressureLevel(int useCaseCode);
    Camera_ErrorCode UnregisterSystemPressureLevel(int useCaseCode);
    ...
    Camera_ErrorCode CreatePreviewOutputByIndex(int index);
    Camera_ErrorCode CreateVideoOutputByIndex(char* videoId, int index);
    Camera_ErrorCode MacroStatusChangeTest(void);
    Camera_ErrorCode IsoInfoChangeTest(void);
    Camera_ErrorCode CameraOcclusionDetectChangeTest(void);
    Camera_ErrorCode TestRegisterFlashStateChangeCallback(int useCaseCode);
    Camera_ErrorCode TestUnregisterFlashStateChangeCallback(int useCaseCode);
    Camera_ErrorCode IsExposureMeteringModeSupported(int useCaseCode);
    Camera_ErrorCode GetExposureMeteringMode(int useCaseCode);
    Camera_ErrorCode SetExposureMeteringMode(int useCaseCode);
    Camera_ErrorCode GetSupportedISORange(int useCaseCode);
    Camera_ErrorCode getIso(int useCaseCode);
    Camera_ErrorCode setIso(int useCaseCode);

    Camera_ErrorCode GetCameraDevices(void);

    Camera_ErrorCode TestPhyAptNullSession();
    Camera_ErrorCode TestPhyAptNullApts();
    Camera_ErrorCode TestPhyAptNoInput();
    Camera_ErrorCode TestPhyAptNoOutput();

    Camera_ErrorCode TestDelPhyApts();
    Camera_ErrorCode TestDelPhyAptsNullSession();
    Camera_ErrorCode TestDelPhyAptsNullApts();

    Camera_ErrorCode TestLensDistNullCam();
    Camera_ErrorCode TestLensDistNullLens();
    Camera_ErrorCode TestLensDistNullSize();

    Camera_ErrorCode TestIntrinsicNullCam();
    Camera_ErrorCode TestIntrinsicNullData();
    Camera_ErrorCode TestIntrinsicNullSize();

    Camera_ErrorCode TestSensorSizeNullCam();
    Camera_ErrorCode TestSensorSizeNullW();
    Camera_ErrorCode TestSensorSizeNullH();

    Camera_ErrorCode TestEqFocalNullCam();
    Camera_ErrorCode TestEqFocalNullData();
    Camera_ErrorCode TestEqFocalNullSize();
    Camera_ErrorCode TestEqFocal();

    Camera_ErrorCode TestIsLogicNullCam();
    Camera_ErrorCode TestIsLogicNullFlag();
    Camera_ErrorCode TestIsLogic();

    Camera_ErrorCode TestLogicCamDevsNullCam();
    Camera_ErrorCode TestLogicCamDevsNullData();
    Camera_ErrorCode TestLogicCamDevsNullSize();
    Camera_ErrorCode TestLogicCamDevs();
    Camera_ErrorCode DeleteConstituentCameraDevices(int useCaseCode);
    Camera_ErrorCode GetLensFocalLength(int useCaseCode);
    Camera_ErrorCode GetMinimumFocusDistance(int useCaseCode);

    // exposure state callback
    Camera_ErrorCode RegisterExposureStateChangeCallback();
    Camera_ErrorCode UnregisterExposureStateChangeCallback();
    Camera_ErrorCode RegisterExposureStateChangeCallbackWithoutSession();
    Camera_ErrorCode UnregisterExposureStateChangeCallbackWithoutSession();
    
    Camera_ErrorCode RegisterExposureStateChangeCallback(int useCaseCode);
    Camera_ErrorCode UnregisterExposureStateChangeCallback(int useCaseCode);
    bool WaitForExposureFinish();
    // colorTint
    Camera_ErrorCode GetColorTintRange();
    Camera_ErrorCode SetColorTint(int useCaseCode);
    Camera_ErrorCode GetColorTint(int useCaseCode);
    Camera_ErrorCode GetZoomPointInfos(int useCaseCode);
    Camera_ErrorCode DeleteZoomPointInfo(int useCaseCode);
