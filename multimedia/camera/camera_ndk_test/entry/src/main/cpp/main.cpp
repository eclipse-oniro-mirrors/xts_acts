...
{
    ndkCamera_->GetSupportedFullOutputCapability();
...
static napi_value CreateDeferredPreviewOutput(napi_env env, napi_callback_info info)
{
    napi_value result;

    Camera_ErrorCode ret = ndkCamera_->CreateDeferredPreviewOutput();
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value CreateHeifPhotoOutput(napi_env env, napi_callback_info info)
{
    napi_value result;
    ...
    surfaceId = new char[typeLen + 1];
    napi_get_value_string_utf8(env, args[0], surfaceId, typeLen + 1, &typeLen);
    napi_get_value_int32(env, args[1], &idx);
    Camera_ErrorCode ret = ndkCamera_->CreateHeifPhotoOutput(surfaceId, idx);
    napi_create_int32(env, ret, &result);
    return result;
}

static napi_value AdjustHeifIdx(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    ...
    idx = ndkCamera_->AdjustHeifIdx(idx);
...
static napi_value IsMetadataObjectTypeValid(napi_env env, napi_callback_info info)
{
    napi_value result;

    bool ret = ndkCamera_->IsMetadataObjectTypeValid();
    napi_create_int32(env, ret, &result);
    return result;
}

static napi_value CreateMetadataOutputWithObjectTypes(napi_env env, napi_callback_info info)
{
    size_t argc;
    napi_value result = nullptr;
    Camera_ErrorCode ret = ndkCamera_->CreateMetadataOutputWithObjectTypes();
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value CameraInputOcclusionDetection(napi_env env, napi_callback_info info)
{
    napi_value result;

    Camera_ErrorCode ret = ndkCamera_->CameraInputRegisterOcclusionDetectionCallback();
    ret = ndkCamera_->CameraInputUnRegisterOcclusionDetectionCallback();
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value MetadataOutputRemoveMetadataObjectTypes(napi_env env, napi_callback_info info)
{
    napi_value result = nullptr;
    Camera_ErrorCode code = ndkCamera_->MetadataOutputRemoveMetadataObjectTypes();
    napi_create_int32(env, code, &result);
    return result;
}
    
static napi_value MetadataOutputAddMetadataObjectTypes(napi_env env, napi_callback_info info)
{
    napi_value result = nullptr;
    Camera_ErrorCode code = ndkCamera_->MetadataOutputAddMetadataObjectTypes();
    napi_create_int32(env, code, &result);
    return result;
}
...
static napi_value SessionGetPhotoRotationWithoutDeviceDegree(napi_env env, napi_callback_info info)
{
    napi_value result;

    Camera_ErrorCode ret = ndkCamera_->SessionGetPhotoRotationWithoutDeviceDegree();
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value SessionGetVideoRotationWithoutDeviceDegree(napi_env env, napi_callback_info info)
{
    napi_value result;

    Camera_ErrorCode ret = ndkCamera_->SessionGetVideoRotationWithoutDeviceDegree();
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value SessionGetPreviewRotationWithoutDisplayRotation(napi_env env, napi_callback_info info)
{
    napi_value result;

    Camera_ErrorCode ret = ndkCamera_->SessionGetPreviewRotationWithoutDisplayRotation();
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value SessionIsControlCenterSupported(napi_env env, napi_callback_info info)
{
    napi_value result;
    ndkCamera_->SessionIsControlCenterSupported();
    napi_get_boolean(env, ndkCamera_->isContolCenterSupported_, &result);
    return result;
}
...
static napi_value SessionGetSupportedEffectTypes(napi_env env, napi_callback_info info)
{
    ...
    int32_t index;
    napi_get_value_int32(env, args[0], &index);
    Camera_ErrorCode code = ndkCamera_->SessionGetSupportedEffectTypes(index);

    napi_value effectTypeSize = nullptr;
    napi_create_object(env, &effectTypeSize);
    napi_value jsValue = nullptr;

    napi_create_int32(env, ndkCamera_->effectTypeSize_, &jsValue);
    napi_set_named_property(env, effectTypeSize, "effectTypeSize", jsValue);

    napi_create_int32(env, code, &jsValue);
    napi_set_named_property(env, effectTypeSize, "errorCode", jsValue);
    return effectTypeSize;
}

static napi_value SessionDeleteSupportedEffectTypes(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    int32_t index;
    napi_get_value_int32(env, args[0], &index);
    Camera_ErrorCode code = ndkCamera_->SessionDeleteSupportedEffectTypes(index);

    napi_create_int32(env, code, &result);
    return result;
}

static napi_value SessionEnableControlCenter(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    bool isEnable;
    napi_get_value_bool(env, args[0], &isEnable);
    Camera_ErrorCode code = ndkCamera_->SessionEnableControlCenter(isEnable);
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value SessionRegisterControlCenterEffectStatusChange(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->RegisterControlCenterEffectStatusChange(index);
 
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value SessionUnregisterControlCenterEffectStatusChange(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->UnregisterControlCenterEffectStatusChange(index);
...
static napi_value OHCameraManagerGetSupportedFullCameraOutputCapabilityWithSceneMode(napi_env env,
    napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    ...
    Camera_ErrorCode code = ndkCamera_->GetSupportedFullCameraOutputCapabilityWithSceneMode(index);
...
static napi_value OHCameraInputIsPhysicalCameraOrientationVariable(napi_env env, napi_callback_info info)
{
    napi_value obj = nullptr;
    napi_create_object(env, &obj);
    bool isVariable = false;
    Camera_ErrorCode code = ndkCamera_->IsPhysicalCameraOrientationVariable(&isVariable);
    napi_value jsValue = nullptr;
    napi_create_int32(env, code, &jsValue);
    napi_set_named_property(env, obj, "errorCode", jsValue);
    napi_get_boolean(env, isVariable, &jsValue);
    napi_set_named_property(env, obj, "isVariable", jsValue);
    return obj;
}
static napi_value OHCameraInputGetPhysicalCameraOrientation(napi_env env, napi_callback_info info)
{
    napi_value obj = nullptr;
    napi_create_object(env, &obj);
    uint32_t orientation = 1;
    Camera_ErrorCode code = ndkCamera_->GetPhysicalCameraOrientation(&orientation);
    napi_value jsValue = nullptr;
    napi_create_int32(env, code, &jsValue);
    napi_set_named_property(env, obj, "errorCode", jsValue);
    napi_create_int32(env, orientation, &jsValue);
    napi_set_named_property(env, obj, "orientation", jsValue);
    return obj;
}
static napi_value OHCameraInputUsePhysicalCameraOrientation(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_get_cb_info(env, info, &argc, args, nullptr, nullptr);
    ...
    bool isUsed;
    napi_get_value_bool(env, args[0], &isUsed);

    Camera_ErrorCode code = ndkCamera_->UsePhysicalCameraOrientation(isUsed);
...
static napi_value OHPhotoOutputIsPhotoQualityPrioritizationSupported(napi_env env, napi_callback_info info)
{
    size_t argc = 2;
    napi_value args[2] = {nullptr};
    ...
    Camera_ErrorCode code = ndkCamera_->IsPhotoQualityPrioritizationSupported(index, quality);

    napi_value photoQualityPrioritizationInstance = nullptr;
    napi_create_object(env, &photoQualityPrioritizationInstance);
    napi_value jsValue = nullptr;

    bool isPhotoQualityPrioritizationSupported = ndkCamera_->isPhotoQualityPrioritizationSupported_;
    napi_get_boolean(env, isPhotoQualityPrioritizationSupported, &jsValue);
    napi_set_named_property(env, photoQualityPrioritizationInstance, "isPhotoQualityPrioritizationSupported", jsValue);

    napi_create_int32(env, code, &jsValue);
    napi_set_named_property(env, photoQualityPrioritizationInstance, "errorCode", jsValue);

    return photoQualityPrioritizationInstance;
}

static napi_value OHPhotoOutputSetPhotoQualityPrioritization(napi_env env, napi_callback_info info)
{
    size_t argc = 2;
    napi_value args[NUMBER_2] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->SetPhotoQualityPrioritization(index, quality);
...
static napi_value OHPhotoNativeGetUncompressedImage(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->GetUncompressedImage(index);
...
static napi_value OHCameraManagerCreateYuvPhotoOutputWithoutSurface(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->CreateYuvPhotoOutputWithoutSurface(index);
...
static napi_value OHCameraManagerIsTorchLevelControlSupported(napi_env env, napi_callback_info info)
{
    napi_value result;
    bool code = ndkCamera_->IsTorchLevelControlSupported();
    napi_create_int32(env, code, &result);
    return result;
}
 
static napi_value OHCameraManagerSetTorchModeOnWithLevel(napi_env env, napi_callback_info info)
{
    size_t argc = 2;
    napi_value args[2] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode ret = ndkCamera_->SetTorchModeOnWithLevel(level);
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value OHPreviewOutputAddDeferredSurface(napi_env env, napi_callback_info info)
{
    napi_value result;
    ...
    surfaceId = new char[typeLen + 1];
    napi_get_value_string_utf8(env, args[1], surfaceId, typeLen + 1, &typeLen);

    Camera_ErrorCode ret = ndkCamera_->AddDeferredSurface(index, surfaceId);
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value SessionRegisterSystemPressureLevel(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->RegisterSystemPressureLevel(index);
 
    napi_create_int32(env, code, &result);
    return result;
}
 
static napi_value SessionUnregisterSystemPressureLevel(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->UnregisterSystemPressureLevel(index);
...
static napi_value OHCameraManagerGetCameraDevices(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->GetCameraDevices(index);
 
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraManagerDeleteCameraDevices(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->DeleteCameraDevices(index);

    napi_create_int32(env, code, &result);
    return result;
}
 
static napi_value SetInvalidDeviceQueryInfo(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    bool isDeviceQueryInfoInvalid;
    napi_get_value_bool(env, args[0], &isDeviceQueryInfoInvalid);

    Camera_ErrorCode code = ndkCamera_->SetInvalidDeviceQueryInfo(isDeviceQueryInfoInvalid);
    napi_create_int32(env, code, &result);
...
{
    napi_value previewProfile = nullptr;
    napi_value previewProfiles = nullptr;
    napi_value jsValue = nullptr;

    napi_status status = napi_create_array(env, &previewProfiles);
    
    for (uint32_t i = 0; i < ndkCamera_->cameraOutputCapability_->previewProfilesSize; i++) {
        napi_create_object(env, &previewProfile);
        napi_create_int32(env, ndkCamera_->cameraOutputCapability_->previewProfiles[i]->format, &jsValue);
        napi_set_named_property(env, previewProfile, "format", jsValue);

        napi_create_int32(env, ndkCamera_->cameraOutputCapability_->previewProfiles[i]->size.height, &jsValue);
        napi_set_named_property(env, previewProfile, "height", jsValue);

        napi_create_int32(env, ndkCamera_->cameraOutputCapability_->previewProfiles[i]->size.width, &jsValue);
        napi_set_named_property(env, previewProfile, "width", jsValue);

        napi_set_element(env, previewProfiles, i, previewProfile);
    }
...
{
    napi_value videoProfile = nullptr;
    napi_value videoProfiles = nullptr;
    napi_value jsValue = nullptr;

    napi_status status = napi_create_array(env, &videoProfiles);
    
    for (uint32_t i = 0; i < ndkCamera_->cameraOutputCapability_->videoProfilesSize; i++) {
        napi_create_object(env, &videoProfile);
        napi_create_int32(env, ndkCamera_->cameraOutputCapability_->videoProfiles[i]->format, &jsValue);
        napi_set_named_property(env, videoProfile, "format", jsValue);

        napi_create_int32(env, ndkCamera_->cameraOutputCapability_->videoProfiles[i]->size.height, &jsValue);
        napi_set_named_property(env, videoProfile, "height", jsValue);

        napi_create_int32(env, ndkCamera_->cameraOutputCapability_->videoProfiles[i]->size.width, &jsValue);
        napi_set_named_property(env, videoProfile, "width", jsValue);

        napi_create_int32(env, ndkCamera_->cameraOutputCapability_->videoProfiles[i]->range.min, &jsValue);
        napi_set_named_property(env, videoProfile, "min", jsValue);

        napi_create_int32(env, ndkCamera_->cameraOutputCapability_->videoProfiles[i]->range.max, &jsValue);
        napi_set_named_property(env, videoProfile, "max", jsValue);

        napi_set_element(env, videoProfiles, i, videoProfile);
    }
    return videoProfiles;
}

static napi_value createVideoOutputByIndex(napi_env env, napi_callback_info info)
{
    size_t argc = 2;
    napi_value args[2] = {nullptr};
    napi_value result;
    ...
    int32_t index;
    napi_get_value_int32(env, args[1], &index);
    Camera_ErrorCode ret = ndkCamera_->CreateVideoOutputByIndex(videoId, index);
    napi_create_int32(env, ret, &result);
    return result;
}

static napi_value createPreviewOutputByIndex(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    int32_t index;
    napi_get_value_int32(env, args[0], &index);
    Camera_ErrorCode ret = ndkCamera_->CreatePreviewOutputByIndex(index);
    napi_create_int32(env, ret, &result);
    return result;
}

static napi_value GetMacroStatusChangeTest(napi_env env, napi_callback_info info)
{
    napi_value jsValue = nullptr;

    napi_create_int32(env, ndkCamera_->MacroStatusChangeTest(), &jsValue);

    return jsValue;
}

static napi_value GetIsoInfoChangeTest(napi_env env, napi_callback_info info)
{
    napi_value jsValue = nullptr;

    napi_create_int32(env, ndkCamera_->IsoInfoChangeTest(), &jsValue);

    return jsValue;
}

static napi_value TestRegisterFlashStateChangeCallback(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->TestRegisterFlashStateChangeCallback(index);
 
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value TestUnregisterFlashStateChangeCallback(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->TestUnregisterFlashStateChangeCallback(index);
...
static napi_value IsExposureMeteringModeSupported(napi_env env, napi_callback_info info)
{
    ...
    Camera_ErrorCode code = ndkCamera_->IsExposureMeteringModeSupported(index);
...
static napi_value GetExposureMeteringMode(napi_env env, napi_callback_info info)
{
    ...
    Camera_ErrorCode code = ndkCamera_->GetExposureMeteringMode(index);
...
static napi_value SetExposureMeteringMode(napi_env env, napi_callback_info info)
{
    ...
    Camera_ErrorCode code = ndkCamera_->SetExposureMeteringMode(index);
...
static napi_value GetSupportedISORange(napi_env env, napi_callback_info info)
{
    ...
    Camera_ErrorCode code = ndkCamera_->GetSupportedISORange(index);
...
static napi_value getIso(napi_env env, napi_callback_info info)
{
    ...
    Camera_ErrorCode code = ndkCamera_->getIso(index);
...
static napi_value setIso(napi_env env, napi_callback_info info)
{
    ...
    Camera_ErrorCode code = ndkCamera_->setIso(index);
...
{
    ndkCamera_->GetCameraDevices();

    napi_value cameraInfo = nullptr;
    if (ndkCamera_->cameras_ != nullptr) {
        napi_create_object(env, &cameraInfo);
        napi_value jsValue = nullptr;
        napi_create_int32(env, ndkCamera_->cameras_->cameraPosition, &jsValue);
        napi_set_named_property(env, cameraInfo, "cameraPosition", jsValue);
        ...
        napi_create_string_utf8(env, ndkCamera_->cameras_->cameraId,
            sizeof(ndkCamera_->cameras_->cameraId) + 1, &jsValue);
        napi_set_named_property(env, cameraInfo, "cameraId", jsValue);
    }
    return cameraInfo;
}

static napi_value OHCaptureSessionTestPhyAptNullSession(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestPhyAptNullSession();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCaptureSessionTestPhyAptNullApts(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestPhyAptNullApts();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCaptureSessionTestPhyAptNoInput(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestPhyAptNoInput();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCaptureSessionTestPhyAptNoOutput(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestPhyAptNoOutput();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCaptureSessionTestDelPhyApts(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestDelPhyApts();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCaptureSessionTestDelPhyAptsNullSession(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestDelPhyAptsNullSession();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCaptureSessionTestDelPhyAptsNullApts(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestDelPhyAptsNullApts();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestLensDistNullCam(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestLensDistNullCam();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestLensDistNullLens(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestLensDistNullLens();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestLensDistNullSize(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestLensDistNullSize();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestIntrinsicNullCam(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestIntrinsicNullCam();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestIntrinsicNullData(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestIntrinsicNullData();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestIntrinsicNullSize(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestIntrinsicNullSize();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestSensorSizeNullCam(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestSensorSizeNullCam();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestSensorSizeNullW(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestSensorSizeNullW();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestSensorSizeNullH(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestSensorSizeNullH();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestEqFocalNullCam(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestEqFocalNullCam();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestEqFocalNullData(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestEqFocalNullData();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestEqFocalNullSize(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestEqFocalNullSize();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestEqFocal(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestEqFocal();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestIsLogicNullCam(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestIsLogicNullCam();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestIsLogicNullFlag(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestIsLogicNullFlag();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestIsLogic(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestIsLogic();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestLogicCamDevsNullCam(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestLogicCamDevsNullCam();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestLogicCamDevsNullData(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestLogicCamDevsNullData();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestLogicCamDevsNullSize(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestLogicCamDevsNullSize();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCameraTestLogicCamDevs(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->TestLogicCamDevs();
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value DeleteConstituentCameraDevices(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->DeleteConstituentCameraDevices(index);
 
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value GetLensFocalLength(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->GetLensFocalLength(index);
 
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value GetMinimumFocusDistance(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->GetMinimumFocusDistance(index);
 
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value OHCaptureSessionRegisterExposureStateChangeCallback(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->RegisterExposureStateChangeCallback();
 
    napi_create_int32(env, code, &result);
    return result;
}
 
static napi_value OHCaptureSessionUnregisterExposureStateChangeCallback(napi_env env, napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->UnregisterExposureStateChangeCallback();
 
    napi_create_int32(env, code, &result);
    return result;
}
 
static napi_value OHCaptureSessionRegisterExposureStateChangeCallbackWithoutSession(napi_env env,
    napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->RegisterExposureStateChangeCallbackWithoutSession();
 
    napi_create_int32(env, code, &result);
    return result;
}
 
static napi_value OHCaptureSessionUnregisterExposureStateChangeCallbackWithoutSession(napi_env env,
    napi_callback_info info)
{
    napi_value result;
    Camera_ErrorCode code = ndkCamera_->UnregisterExposureStateChangeCallbackWithoutSession();
 
    napi_create_int32(env, code, &result);
    return result;
}

static napi_value GetEnumExposureState(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    if (index == 0) {
        napi_create_int32(env, OH_CAMERA_EXPOSURE_STATE_SCAN, &result);
    } else if (index == 1) {
        napi_create_int32(env, OH_CAMERA_EXPOSURE_STATE_CONVERGED, &result);
    }

    return result;
}

static napi_value SessionRegisterExposureStateChangeCallback(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->RegisterExposureStateChangeCallback(index);

    napi_create_int32(env, code, &result);
    return result;
}

static napi_value SessionUnregisterExposureStateChangeCallback(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value result;
    ...
    Camera_ErrorCode code = ndkCamera_->UnregisterExposureStateChangeCallback(index);

    napi_create_int32(env, code, &result);
    return result;
}

static napi_value WaitForExposureFinish(napi_env env, napi_callback_info info)
{
    napi_value result;
    bool ret = ndkCamera_->WaitForExposureFinish();
...
{
    napi_value result;
    Camera_ErrorCode ret = ndkCamera_->GetColorTintRange();
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value SetColorTint(napi_env env, napi_callback_info info)
{
    ...
    // 将参数转为C++对象
    int32_t useCaseCode;
    napi_get_value_int32(env, args[0], &useCaseCode);
    // 调用C++函数
    napi_value result;
    Camera_ErrorCode ret = ndkCamera_->SetColorTint(useCaseCode);
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value GetColorTint(napi_env env, napi_callback_info info)
{
    ...
    // 调用C++函数
    napi_value result;
    Camera_ErrorCode ret = ndkCamera_->GetColorTint(useCaseCode);
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value GetZoomPointInfos(napi_env env, napi_callback_info info)
{
    ...
    // 调用C++函数
    napi_value result;
    Camera_ErrorCode ret = ndkCamera_->GetZoomPointInfos(useCaseCode);
    napi_create_int32(env, ret, &result);
    return result;
}

static napi_value DeleteZoomPointInfo(napi_env env, napi_callback_info info)
{
    // 获取ArkTs传过来的参数
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    ...
    // 调用C++函数
    napi_value result;
    Camera_ErrorCode ret = ndkCamera_->DeleteZoomPointInfo(useCaseCode);
    napi_create_int32(env, ret, &result);
    return result;
}
...
static napi_value Init(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        ...
        { "getMacroStatusChangeTest", nullptr, GetMacroStatusChangeTest, nullptr, nullptr, nullptr, napi_default, nullptr },
        { "getIsoInfoChangeTest", nullptr, GetIsoInfoChangeTest, nullptr, nullptr, nullptr, napi_default, nullptr },
        ...
        { "getSupportedFullOutputCapability", nullptr, GetSupportedFullOutputCapability, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        ...
        { "createHeifPhotoOutput", nullptr, CreateHeifPhotoOutput, nullptr, nullptr, nullptr, napi_default, nullptr },
        { "adjustHeifIdx", nullptr, AdjustHeifIdx, nullptr, nullptr, nullptr, napi_default, nullptr },
        ...
        { "IsMetadataObjectTypeValid", nullptr, IsMetadataObjectTypeValid, nullptr,
 	             nullptr, nullptr, napi_default, nullptr },
        { "CreateMetadataOutputWithObjectTypes", nullptr, CreateMetadataOutputWithObjectTypes,
        ...
        { "cameraInputOcclusionDetection", nullptr, CameraInputOcclusionDetection, nullptr, nullptr, nullptr, napi_default, nullptr },
        ...
        { "MetadataOutputAddMetadataObjectTypes", nullptr, MetadataOutputAddMetadataObjectTypes, nullptr,
            nullptr, nullptr, napi_default, nullptr },
 	    { "MetadataOutputRemoveMetadataObjectTypes", nullptr, MetadataOutputRemoveMetadataObjectTypes,
            nullptr, nullptr, nullptr, napi_default, nullptr },
        { "previewOutputStop", nullptr, PreviewOutputStop, nullptr, nullptr, nullptr, napi_default, nullptr },
        ...
        { "sessionIsFocusModeSupported", nullptr, SessionIsFocusModeSupported, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "sessionIsControlCenterSupported", nullptr, SessionIsControlCenterSupported, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "sessionGetSupportedEffectTypes", nullptr, SessionGetSupportedEffectTypes, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "sessionDeleteSupportedEffectTypes", nullptr, SessionDeleteSupportedEffectTypes, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "sessionEnableControlCenter", nullptr, SessionEnableControlCenter, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "sessionRegisterControlCenterEffectStatusChange", nullptr, SessionRegisterControlCenterEffectStatusChange,
            nullptr, nullptr, nullptr, napi_default, nullptr },
        { "sessionUnregisterControlCenterEffectStatusChange", nullptr, SessionUnregisterControlCenterEffectStatusChange,
            nullptr, nullptr, nullptr, napi_default, nullptr },
        ...
        { "sessionGetPhotoRotation", nullptr, SessionGetPhotoRotation, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "sessionGetPhotoRotationWithoutDeviceDegree", nullptr, SessionGetPhotoRotationWithoutDeviceDegree, nullptr,
            nullptr, nullptr, napi_default, nullptr },
        { "sessionGetVideoRotation", nullptr, SessionGetVideoRotation, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "sessionGetVideoRotationWithoutDeviceDegree", nullptr, SessionGetVideoRotationWithoutDeviceDegree, nullptr,
            nullptr, nullptr, napi_default, nullptr },
        { "sessionGetPreviewRotation", nullptr, SessionGetPreviewRotation, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "sessionGetPreviewRotationWithoutDisplayRotation", nullptr, SessionGetPreviewRotationWithoutDisplayRotation,
            nullptr, nullptr, nullptr, napi_default, nullptr },
        ...
        { "sessionUnregisterAutoDeviceSwitchStatusChange", nullptr, SessionUnregisterAutoDeviceSwitchStatusChange,
            nullptr, nullptr, nullptr, napi_default, nullptr },
        { "sessionRegisterSystemPressureLevel", nullptr, SessionRegisterSystemPressureLevel,
            nullptr, nullptr, nullptr, napi_default, nullptr },
        { "sessionUnregisterSystemPressureLevel", nullptr, SessionUnregisterSystemPressureLevel,
            nullptr, nullptr, nullptr, napi_default, nullptr },
        ...
        { "sessionEnableMacro", nullptr, SessionEnableMacro, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "getPreviewProfiles", nullptr, getPreviewProfiles, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "getVideoProfiles", nullptr, getVideoProfiles, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "createVideoOutputByIndex", nullptr, createVideoOutputByIndex, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "createPreviewOutputByIndex", nullptr, createPreviewOutputByIndex, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "createDeferredPreviewOutput", nullptr, CreateDeferredPreviewOutput, nullptr, nullptr, nullptr,
            napi_default, nullptr },
    };
    napi_property_descriptor desc1[] = {
        ...
        {"oHCameraManagerGetSupportedCameraOutputCapabilityWithSceneMode", nullptr,
            ...
            nullptr},
        {"oHCameraManagerGetSupportedFullCameraOutputCapabilityWithSceneMode", nullptr,
            OHCameraManagerGetSupportedFullCameraOutputCapabilityWithSceneMode, nullptr, nullptr, nullptr, napi_default,
            nullptr},
        ...
        {"oHCameraInputOpenSecureCamera", nullptr, OHCameraInputOpenSecureCamera, nullptr, nullptr, nullptr,
            napi_default, nullptr},
        {"oHCameraInputIsPhysicalCameraOrientationVariable", nullptr, OHCameraInputIsPhysicalCameraOrientationVariable,
            nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHCameraInputGetPhysicalCameraOrientation", nullptr, OHCameraInputGetPhysicalCameraOrientation, nullptr,
            nullptr, nullptr, napi_default, nullptr},
        {"oHCameraInputUsePhysicalCameraOrientation", nullptr, OHCameraInputUsePhysicalCameraOrientation, nullptr,
            nullptr, nullptr, napi_default, nullptr},
        ...
        { "getCameraDevices", nullptr, GetCameraDevices, nullptr, nullptr, nullptr, napi_default, nullptr },
        { "oHCaptureSessionTestPhyAptNullSession", nullptr, OHCaptureSessionTestPhyAptNullSession, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHCaptureSessionTestPhyAptNullApts", nullptr, OHCaptureSessionTestPhyAptNullApts, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCaptureSessionTestPhyAptNoInput", nullptr, OHCaptureSessionTestPhyAptNoInput, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCaptureSessionTestPhyAptNoOutput", nullptr, OHCaptureSessionTestPhyAptNoOutput, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCaptureSessionTestDelPhyApts", nullptr, OHCaptureSessionTestDelPhyApts, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCaptureSessionTestDelPhyAptsNullSession", nullptr, OHCaptureSessionTestDelPhyAptsNullSession, nullptr,
            nullptr, nullptr, napi_default, nullptr },
        { "oHCaptureSessionTestDelPhyAptsNullApts", nullptr, OHCaptureSessionTestDelPhyAptsNullApts, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHCameraTestLensDistNullCam", nullptr, OHCameraTestLensDistNullCam, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestLensDistNullLens", nullptr, OHCameraTestLensDistNullLens, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestLensDistNullSize", nullptr, OHCameraTestLensDistNullSize, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestIntrinsicNullCam", nullptr, OHCameraTestIntrinsicNullCam, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestIntrinsicNullData", nullptr, OHCameraTestIntrinsicNullData, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestIntrinsicNullSize", nullptr, OHCameraTestIntrinsicNullSize, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestSensorSizeNullCam", nullptr, OHCameraTestSensorSizeNullCam, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestSensorSizeNullW", nullptr, OHCameraTestSensorSizeNullW, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestSensorSizeNullH", nullptr, OHCameraTestSensorSizeNullH, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestEqFocalNullCam", nullptr, OHCameraTestEqFocalNullCam, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestEqFocalNullData", nullptr, OHCameraTestEqFocalNullData, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestEqFocalNullSize", nullptr, OHCameraTestEqFocalNullSize, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestEqFocal", nullptr, OHCameraTestEqFocal, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestIsLogicNullCam", nullptr, OHCameraTestIsLogicNullCam, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestIsLogicNullFlag", nullptr, OHCameraTestIsLogicNullFlag, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestIsLogic", nullptr, OHCameraTestIsLogic, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestLogicCamDevsNullCam", nullptr, OHCameraTestLogicCamDevsNullCam, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestLogicCamDevsNullData", nullptr, OHCameraTestLogicCamDevsNullData, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestLogicCamDevsNullSize", nullptr, OHCameraTestLogicCamDevsNullSize, nullptr, nullptr, nullptr,
            napi_default, nullptr },
        { "oHCameraTestLogicCamDevs", nullptr, OHCameraTestLogicCamDevs, nullptr, nullptr, nullptr,
            napi_default, nullptr },
    };
    napi_property_descriptor desc2[] = {
        ...
        {"oHPreviewOutputDeleteProfile", nullptr, OHPreviewOutputDeleteProfile, nullptr, nullptr, nullptr, napi_default,
            nullptr},
        {"oHPreviewOutputAddDeferredSurface", nullptr, OHPreviewOutputAddDeferredSurface, nullptr, nullptr, nullptr,
            napi_default, nullptr},
        ...
        {"oHPhotoOutputDeleteProfile", nullptr, OHPhotoOutputDeleteProfile, nullptr, nullptr, nullptr, napi_default,
            nullptr},
        { "oHTestRegisterFlashStateChangeCallback", nullptr, TestRegisterFlashStateChangeCallback, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHTestUnregisterFlashStateChangeCallback", nullptr, TestUnregisterFlashStateChangeCallback, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHIsExposureMeteringModeSupported", nullptr, IsExposureMeteringModeSupported, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHGetExposureMeteringMode", nullptr, GetExposureMeteringMode, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHSetExposureMeteringMode", nullptr, SetExposureMeteringMode, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHGetSupportedISORange", nullptr, GetSupportedISORange, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHgetIso", nullptr, getIso, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHsetIso", nullptr, setIso, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHDeleteConstituentCameraDevices", nullptr, DeleteConstituentCameraDevices, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHGetLensFocalLength", nullptr, GetLensFocalLength, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHGetMinimumFocusDistance", nullptr, GetMinimumFocusDistance, nullptr, nullptr,
            nullptr, napi_default, nullptr },
        { "oHCaptureSessionRegisterExposureStateChangeCallback", nullptr,
            OHCaptureSessionRegisterExposureStateChangeCallback, nullptr, nullptr, nullptr, napi_default, nullptr },
        { "oHCaptureSessionUnregisterExposureStateChangeCallback", nullptr,
            OHCaptureSessionUnregisterExposureStateChangeCallback, nullptr, nullptr, nullptr, napi_default, nullptr },
        { "oHCaptureSessionRegisterExposureStateChangeCallbackWithoutSession", nullptr,
            OHCaptureSessionRegisterExposureStateChangeCallbackWithoutSession,
            nullptr, nullptr, nullptr, napi_default, nullptr },
        { "oHCaptureSessionUnregisterExposureStateChangeCallbackWithoutSession", nullptr,
            OHCaptureSessionUnregisterExposureStateChangeCallbackWithoutSession,
            nullptr, nullptr, nullptr, napi_default, nullptr },
        { "getEnumExposureState", nullptr, GetEnumExposureState, nullptr, nullptr, nullptr, napi_default, nullptr },
        { "sessionRegisterExposureStateChangeCallback", nullptr, SessionRegisterExposureStateChangeCallback,
            nullptr, nullptr, nullptr, napi_default, nullptr },
        { "sessionUnregisterExposureStateChangeCallback", nullptr, SessionUnregisterExposureStateChangeCallback,
            nullptr, nullptr, nullptr, napi_default, nullptr },
        {"waitForExposureFinish", nullptr, WaitForExposureFinish, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"getColorTintRange", nullptr, GetColorTintRange, nullptr, nullptr, nullptr, napi_default, nullptr },
        {"setColorTint", nullptr, SetColorTint, nullptr, nullptr, nullptr, napi_default, nullptr },
        {"getColorTint", nullptr, GetColorTint, nullptr, nullptr, nullptr, napi_default, nullptr },
        {"getZoomPointInfos", nullptr, GetZoomPointInfos, nullptr, nullptr, nullptr, napi_default, nullptr },
        {"deleteZoomPointInfo", nullptr, DeleteZoomPointInfo, nullptr, nullptr, nullptr, napi_default, nullptr },
    };
    napi_property_descriptor desc3[] = {
        ...
        {"oHCameraManagerSetTorchMode", nullptr, OHCameraManagerSetTorchMode, nullptr, nullptr, nullptr,
         napi_default, nullptr},
        {"oHCameraManagerIsTorchLevelControlSupported", nullptr, OHCameraManagerIsTorchLevelControlSupported,
         nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHCameraManagerSetTorchModeOnWithLevel", nullptr, OHCameraManagerSetTorchModeOnWithLevel,
         nullptr, nullptr, nullptr, napi_default, nullptr},
    ...
    napi_property_descriptor desc4[] = {
        ...
        {"oHPhotoOutputEnableMovingPhoto", nullptr, OHPhotoOutputEnableMovingPhoto, nullptr, nullptr, nullptr,
            napi_default, nullptr},
        {"oHPhotoOutputIsPhotoQualityPrioritizationSupported", nullptr,
            OHPhotoOutputIsPhotoQualityPrioritizationSupported, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHPhotoOutputSetPhotoQualityPrioritization", nullptr, OHPhotoOutputSetPhotoQualityPrioritization, nullptr,
            nullptr, nullptr, napi_default, nullptr},
        {"oHPhotoNativeGetMainImage", nullptr, OHPhotoNativeGetMainImage, nullptr, nullptr, nullptr, napi_default,
            nullptr},
        {"oHPhotoNativeGetUncompressedImage", nullptr, OHPhotoNativeGetUncompressedImage, nullptr, nullptr, nullptr,
            napi_default, nullptr},
        ...
        {"oHCameraManagerCreatePhotoOutputWithoutSurface", nullptr, OHCameraManagerCreatePhotoOutputWithoutSurface,
            nullptr, nullptr, nullptr, napi_default, nullptr},
        {"oHCameraManagerCreateYuvPhotoOutputWithoutSurface", nullptr,
            OHCameraManagerCreateYuvPhotoOutputWithoutSurface, nullptr, nullptr, nullptr, napi_default, nullptr},
        ...
        {"oHCameraManagerGetCameraConcurrentInfos", nullptr, OHCameraManagerGetCameraConcurrentInfos, nullptr,
            nullptr, nullptr, napi_default, nullptr},
        {"oHCameraManagerGetCameraDevices", nullptr, OHCameraManagerGetCameraDevices, nullptr,
            nullptr, nullptr, napi_default, nullptr},
        {"oHCameraManagerDeleteCameraDevices", nullptr, OHCameraManagerDeleteCameraDevices, nullptr,
            nullptr, nullptr, napi_default, nullptr},
        {"setInvalidDeviceQueryInfo", nullptr, SetInvalidDeviceQueryInfo, nullptr,
            nullptr, nullptr, napi_default, nullptr},
    };
