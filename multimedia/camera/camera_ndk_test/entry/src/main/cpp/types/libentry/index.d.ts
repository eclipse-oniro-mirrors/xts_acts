...
interface photoQualityPrioritizationInstance {
  errorCode: number;
  isPhotoQualityPrioritizationSupported: boolean;
}
...
interface effectTypeSize {
  errorCode: number;
  effectTypeSize: number;
}
...
interface orientationVariable {
  errorCode: number;
  isVariable: boolean;
}

interface physicalCameraOrientation {
  errorCode: number;
  orientation: number;
}
...
export const getMacroStatusChangeTest: () => number;

export const getIsoInfoChangeTest: () => number;
...
export const getSupportedFullOutputCapability: () => cameraOutputCapability;

export const createPreviewOutput: () => number;

export const createDeferredPreviewOutput: () => number;

export const adjustHeifIdx: (idx: number) => number;

export const createPhotoOutput: (surfaceId: string) => number;

export const createHeifPhotoOutput: (surfaceId: string, idx: number) => number;
...
export const cameraInputOcclusionDetection: () => number;
...
export const MetadataOutputRemoveMetadataObjectTypes: () => number; 
 	  
export const MetadataOutputAddMetadataObjectTypes: () => number; 

export const CreateMetadataOutputWithObjectTypes: () => number; 

export const IsMetadataObjectTypeValid: () => number;
...
export const sessionIsControlCenterSupported: () => boolean;

export const sessionGetSupportedEffectTypes: (index: number) => effectTypeSize;

export const sessionDeleteSupportedEffectTypes: (index: number) => number;

export const sessionEnableControlCenter: (enable: boolean) => number;

export const sessionRegisterControlCenterEffectStatusChange: (index:number) => number;
 
export const sessionUnregisterControlCenterEffectStatusChange: (index:number) => number;

export const sessionGetPhotoRotation: (a: number) => number;

export const sessionGetPhotoRotationWithoutDeviceDegree: () => number;

export const sessionGetVideoRotation: (a: number) => number;

export const sessionGetVideoRotationWithoutDeviceDegree: () => number;

export const sessionGetPreviewRotation: (a: number) => number;

export const sessionGetPreviewRotationWithoutDisplayRotation: () => number;

export const sessionGetImageRotation: (a: number) => number;
...
export const oHCameraManagerGetSupportedFullCameraOutputCapabilityWithSceneMode: (index:number) => number;
...
export const oHPreviewOutputAddDeferredSurface: (index:number, surfaceId: string) => number;
...
export const oHPhotoOutputIsPhotoQualityPrioritizationSupported: (a:number, b:number) => photoQualityPrioritizationInstance;

export const oHPhotoOutputSetPhotoQualityPrioritization: (a:number, b:number) => number;

export const oHPhotoNativeGetMainImage: (index:number) => number;

export const oHPhotoNativeGetUncompressedImage: (index:number) => number;
...
export const oHCameraManagerCreateYuvPhotoOutputWithoutSurface: (index:number) => number;
...
export const oHCameraManagerIsTorchLevelControlSupported: () => number;
 
export const oHCameraManagerSetTorchModeOnWithLevel: (level:number) => number;
...
export const sessionRegisterSystemPressureLevel: (index:number) => number;
 
export const sessionUnregisterSystemPressureLevel: (index:number) => number;
...
export const oHCameraManagerGetCameraDevices: (index:number) => number;

export const oHCameraManagerDeleteCameraDevices: (index:number) => number;

export const setInvalidDeviceQueryInfo: (isDeviceQueryInfoInvalid:boolean) => number;

export const oHCameraInputOpenConcurrentCameras: (index:number) => number;

export const oHCameraInputIsPhysicalCameraOrientationVariable: () => orientationVariable;

export const oHCameraInputGetPhysicalCameraOrientation: () => physicalCameraOrientation;

export const oHCameraInputUsePhysicalCameraOrientation: (isUsed:boolean) => number;
...
export const getPreviewProfiles: () => Array<profile>;

export const getVideoProfiles: () => Array<videoProfile>;

export const createVideoOutputByIndex: (surfaceId: string, index: number) => number;

export const createPreviewOutputByIndex: (index: number) => number;

export const oHTestRegisterFlashStateChangeCallback: (index:number) => number;

export const oHTestUnregisterFlashStateChangeCallback: (index:number) => number;

export const oHIsExposureMeteringModeSupported: (index:number) => number;

export const oHGetExposureMeteringMode: (index:number) => number;

export const oHSetExposureMeteringMode: (index:number) => number;

export const oHGetSupportedISORange: (index:number) => number;

export const oHgetIso: (index:number) => number;

export const oHsetIso: (index:number) => number;

export const getCameraDevices: () => cameraInfo;

export const oHCaptureSessionTestPhyAptNullSession: () => number;
export const oHCaptureSessionTestPhyAptNullApts: () => number;
export const oHCaptureSessionTestPhyAptNoInput: () => number;
export const oHCaptureSessionTestPhyAptNoOutput: () => number;

export const oHCaptureSessionTestDelPhyApts: () => number;
export const oHCaptureSessionTestDelPhyAptsNullSession: () => number;
export const oHCaptureSessionTestDelPhyAptsNullApts: () => number;

export const oHCameraTestLensDistNullCam: () => number;
export const oHCameraTestLensDistNullLens: () => number;
export const oHCameraTestLensDistNullSize: () => number;

export const oHCameraTestIntrinsicNullCam: () => number;
export const oHCameraTestIntrinsicNullData: () => number;
export const oHCameraTestIntrinsicNullSize: () => number;

export const oHCameraTestSensorSizeNullCam: () => number;
export const oHCameraTestSensorSizeNullW: () => number;
export const oHCameraTestSensorSizeNullH: () => number;

export const oHCameraTestEqFocalNullCam: () => number;
export const oHCameraTestEqFocalNullData: () => number;
export const oHCameraTestEqFocalNullSize: () => number;
export const oHCameraTestEqFocal: () => number;

export const oHCameraTestIsLogicNullCam: () => number;
export const oHCameraTestIsLogicNullFlag: () => number;
export const oHCameraTestIsLogic: () => number;

export const oHCameraTestLogicCamDevsNullCam: () => number;
export const oHCameraTestLogicCamDevsNullData: () => number;
export const oHCameraTestLogicCamDevsNullSize: () => number;
export const oHCameraTestLogicCamDevs: () => number;

export const oHDeleteConstituentCameraDevices: (index:number) => number;

export const oHGetLensFocalLength: (index:number) => number;

export const oHGetMinimumFocusDistance: (index:number) => number;

export const oHCaptureSessionRegisterExposureStateChangeCallback: () => number;
 
export const oHCaptureSessionUnregisterExposureStateChangeCallback: () => number;
 
export const oHCaptureSessionRegisterExposureStateChangeCallbackWithoutSession: () => number;
 
export const oHCaptureSessionUnregisterExposureStateChangeCallbackWithoutSession: () => number;

export const getEnumExposureState: (index: number) => number;

export const sessionRegisterExposureStateChangeCallback: (index:number) => number;

export const sessionUnregisterExposureStateChangeCallback: (index:number) => number;

export const waitForExposureFinish: () => boolean;

export const getColorTintRange: () => number;

export const setColorTint: (index: number) => number;

export const getColorTint: (index: number) => number;

export const getZoomPointInfos: (index: number) => number;

export const deleteZoomPointInfo: (index: number) => number;