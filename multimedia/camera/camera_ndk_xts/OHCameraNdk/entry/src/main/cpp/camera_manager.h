...
public:
    ...
    bool isMovingPhotoSupported_; // 是否支持moving模式
    ...
    Camera_ErrorCode IsMovingPhotoSupported(int useCaseCode);  // 检查是否支持moving拍照
    ...
    Camera_ErrorCode CameraInputRegisterOcclusionDetectionCallback(int useCaseCode); // 注册相机镜头脏污检测事件回调
    ...
    Camera_ErrorCode CameraInputUnRegisterOcclusionDetectionCallback(int useCaseCode); //  注销相机镜头脏污检测事件回调
