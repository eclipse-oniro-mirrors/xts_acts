...
export const OHCameraInputOpenConcurrentCamerasErr: (a:number) => number;
export const TestCreateDeferredPreviewOutputSucc: () => number;
export const TestCreateDeferredPreviewOutputWithNullArgs: () => number;
export const TestCreateDeferredPreviewOutputWithInvalidProfile: () => number;
export const TestIsTorchLevelControlSupportedErr: () => number;
export const TestIsTorchLevelControlSupportedSucc: () => number;
export const TestSetTorchModeOnWithLevelErr: () => number;
export const TestGetPhysicalApertureSucc: () => number;
export const TestGetPhysicalApertureWithNullSession: () => number;
export const TestGetPhysicalApertureWithUnconfiguredSession: () => number;
export const TestSetPhysicalApertureSucc: () => number;
export const TestSetPhysicalApertureWithNullSession: () => number;
export const TestSetPhysicalApertureWithUnconfiguredStream: () => number;
export const TestGetSupportedExposureDurationRangeSucc: () => number;
export const TestGetSupportedExposureDurationRangeWithNullSession: () => number;
export const TestGetSupportedExposureDurationRangeWithUnconfiguredStream: () => number;
export const TestSetExposureDurationSucc: () => number;
export const TestSetExposureDurationWithInvalidValue: () => number;
export const TestSetExposureDurationWithUnconfiguredStream: () => number;
export const TestGetExposureDurationSucc: () => number;
export const TestGetExposureDurationWithUnconfiguredStream: () => number;
export const TestAddDeferredSurfaceSucc: (a:string) => number;
export const TestAddDeferredSurfaceErr: (a:string) => number;
export const TestAddDeferredSurfaceWithEmptyStr: (a:string) => number;
