...
#define LOG_TAG "MediaAssetManagerNDK"
...
{
    LOGI("OH_MediaAssetManager_ImageForPath start");
    napi_value result;
    ...
    {
    case CASE_INDEX_1:
        requestId = OH_MediaAssetManager_RequestImageForPath(manager, srcUri.c_str(), options, destUri.c_str(), callback);
        LOGI("OH_MediaAssetManager_RequestVideoForPath %{public}d",requestId);
        break;
    case CASE_INDEX_2:
        requestId = OH_MediaAssetManager_RequestVideoForPath(manager, srcUri.c_str(), options, destUri.c_str(), callback);
        LOGI("OH_MediaAssetManager_RequestVideoForPath %{public}d",requestId);
        break;    
    default:
        break;
