 ...
 * @tc.level  LEVEL2
 */
HWTEST_F(HwdecApiNdkTest, VIDEO_HWDEC_API_ADD_0010, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(g_codecName.c_str());
    ASSERT_NE(vdec_, NULL);
    format = OH_AVFormat_Create();
 ...
 * @tc.level  LEVEL2
 */
HWTEST_F(HwdecApiNdkTest, VIDEO_HWDEC_API_ADD_0020, TestSize.Level2)
{
 ...
 * @tc.level  LEVEL2
 */
HWTEST_F(HwdecApiNdkTest, VIDEO_HWDEC_API_ADD_0030, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(g_codecName.c_str());
    OH_AVCodecBufferAttr attr;
    attr.pts = -1;
 ...
 * @tc.level  LEVEL2
 */
HWTEST_F(HwdecApiNdkTest, VIDEO_HWDEC_API_ADD_0040, TestSize.Level2)
{
    vdec_ = OH_VideoDecoder_CreateByName(g_codecName.c_str());
    OH_AVCodecBufferAttr attr;
    attr.pts = -1;
