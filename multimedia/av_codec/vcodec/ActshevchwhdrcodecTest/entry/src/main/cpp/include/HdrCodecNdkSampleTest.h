...
#ifndef ACTSHEVCHWHDRCODECTEST_HDRCODECNDKSAMPLETEST_H
#define ACTSHEVCHWHDRCODECTEST_HDRCODECNDKSAMPLETEST_H
...
public:
    ...
    void SendDataEnd(OH_AVCodec *codec, uint32_t index, OH_AVCodecBufferAttr attr, uint32_t bufferSize);
    ...
    void ProcessAdditionalRead(uint32_t &buffersize, void *&pBuffer);
    void ProcessInitialSearch(uint32_t &bufferSize, void *&pBuffer);
    ...
    const char *outDir = "/data/storage/el2/base/haps/entry_test/files/1920_1080_10_30Mb.h264";
    bool needEncode = false;
    bool needTransCode = false;
    int32_t defaultWidth = 3840;
    int32_t defaultHeight = 2160;
    int32_t defaultRotation = 0;
    ...
    uint32_t repeatStartFlushStopBeforeEos = 0;
...
#endif //ACTSHEVCHWHDRCODECTEST_HDRCODECNDKSAMPLETEST_H
