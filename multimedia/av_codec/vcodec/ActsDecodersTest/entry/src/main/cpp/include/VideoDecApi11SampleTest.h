...
// #include "iconsumer_surface.h"  // 已注释：Surface 模式测试用例已禁用
...
public:
    ...
    const char *fileSourcesha256Vc1[64] = {
    ...
    const char *fileSourcesha256Nv21[64] = {
    ...
    const char *fileSourcesha256Yuvi[64] = {
        "bc", "cc", "c8", "26", "9b", "58", "0a", "c4", "fe", "e8", "f4", "ab", "38", "1a", "d5", "42",
        "67", "bd", "d3", "80", "fc", "84", "be", "c6", "27", "45", "b6", "28", "bb", "5f", "08", "87",
        "7b", "fd", "94", "ae", "c7", "1d", "68", "05", "98", "04", "4b", "b1", "7f", "89", "d2", "70",
...
private:
    ...
    // sptr<Surface> cs[2] = {};  // 已注释：Surface 模式测试已禁用
    // sptr<Surface> ps[2] = {};  // 已注释：Surface 模式测试已禁用
};
} // namespace Media
} // namespace OHOS
