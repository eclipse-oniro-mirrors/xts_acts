...
protected:
    ...
    const char *ginpDir1080pVp8 = "/data/test/media/vp8_1080x1920@30fps.ivf";
    ...
    const char *ginpDirVp9L4P0 = "/data/test/media/vp9_4_0_p0_2048x1088@30fps.ivf";
    const char *ginpDirVp9L4P1 = "/data/test/media/vp9_4_0_p1_2048x1088@30fps.ivf";
    ...
    const char *ginpDirAv1Main8bit = "/data/test/media/av1_main_L4.0_1920x1080.ivf";
    const char *ginpDirAv1High8bit =  "/data/test/media/av1_high_L4.0_1920x1080.ivf";
};
...
/**
 * @tc.name   VIDEO_AV1DEC_FUNCTION_0015
 ...
 * @tc.level  LEVEL0
 */
HWTEST_F(DecFuncNdkTest, VIDEO_AV1DEC_FUNCTION_0015, TestSize.Level0)
{
    const int32_t *profiles = nullptr;
    uint32_t profileNum = 0;
    OH_AVCapability_GetSupportedProfiles(g_capAv1, &profiles, &profileNum);
    if (g_capAv1 != nullptr && (profiles[0] == AV1_PROFILE_MAIN)) {
        auto vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->INP_DIR = ginpDirAv1Main8bit;
        vDecSample->outputYuvFlag = true;
        ASSERT_EQ(AV_ERR_OK, vDecSample->CreateVideoDecoder(g_codecNameAv1));
        ASSERT_EQ(AV_ERR_OK, vDecSample->ConfigureVideoDecoder());
        ASSERT_EQ(AV_ERR_OK, vDecSample->SetVideoDecoderCallback());
...
/**
 * @tc.name   VIDEO_AV1DEC_FUNCTION_0016
 ...
 * @tc.level  LEVEL0
 */
HWTEST_F(DecFuncNdkTest, VIDEO_AV1DEC_FUNCTION_0016, TestSize.Level0)
{
    const int32_t *profiles = nullptr;
    uint32_t profileNum = 0;
    OH_AVCapability_GetSupportedProfiles(g_capAv1, &profiles, &profileNum);
    if (g_capAv1 != nullptr && (profiles[1] == AV1_PROFILE_HIGH)) {
        auto vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->INP_DIR = ginpDirAv1High8bit;
        vDecSample->outputYuvFlag = true;
        ASSERT_EQ(AV_ERR_OK, vDecSample->CreateVideoDecoder(g_codecNameAv1));
        ASSERT_EQ(AV_ERR_OK, vDecSample->ConfigureVideoDecoder());
        ASSERT_EQ(AV_ERR_OK, vDecSample->SetVideoDecoderCallback());
...
/**
 * @tc.name   VIDEO_VP9DEC_FUNCTION_0019
 ...
 * @tc.level  LEVEL0
 */
HWTEST_F(DecFuncNdkTest, VIDEO_VP9DEC_FUNCTION_0019, TestSize.Level0)
{
    const int32_t *profiles = nullptr;
    uint32_t profileNum = 0;
    OH_AVCapability_GetSupportedProfiles(g_capVp9, &profiles, &profileNum);
    if (g_capVp9 != nullptr && (profiles[0] == VP9_PROFILE_0)) {
        auto vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->INP_DIR = ginpDirVp9L4P0;
        vDecSample->outputYuvFlag = true;
        ASSERT_EQ(AV_ERR_OK, vDecSample->CreateVideoDecoder(g_codecNameVp9));
        ASSERT_EQ(AV_ERR_OK, vDecSample->ConfigureVideoDecoder());
        ASSERT_EQ(AV_ERR_OK, vDecSample->SetVideoDecoderCallback());
...
/**
 * @tc.name   VIDEO_VP9DEC_FUNCTION_0020
 ...
 * @tc.level  LEVEL0
 */
HWTEST_F(DecFuncNdkTest, VIDEO_VP9DEC_FUNCTION_0020, TestSize.Level0)
{
    const int32_t *profiles = nullptr;
    uint32_t profileNum = 0;
    OH_AVCapability_GetSupportedProfiles(g_capVp9, &profiles, &profileNum);
    if (g_capVp9 != nullptr && (profiles[1] == VP9_PROFILE_1)) {
        auto vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->INP_DIR = ginpDirVp9L4P1;
        vDecSample->outputYuvFlag = true;
        ASSERT_EQ(AV_ERR_OK, vDecSample->CreateVideoDecoder(g_codecNameVp9));
        ASSERT_EQ(AV_ERR_OK, vDecSample->ConfigureVideoDecoder());
        ASSERT_EQ(AV_ERR_OK, vDecSample->SetVideoDecoderCallback());
...
/**
 * @tc.name   VIDEO_VP8DEC_FUNCTION_0021
 ...
 * @tc.level  LEVEL0
 */
HWTEST_F(DecFuncNdkTest, VIDEO_VP8DEC_FUNCTION_0021, TestSize.Level0)
{
    if (g_capVp8 != nullptr) {
        auto vDecSample = make_shared<VDecAPI11Sample>();
        vDecSample->INP_DIR = ginpDir1080pVp8;
        vDecSample->outputYuvFlag = true;
        ASSERT_EQ(AV_ERR_OK, vDecSample->CreateVideoDecoder(g_codecNameVp8));
        ASSERT_EQ(AV_ERR_OK, vDecSample->ConfigureVideoDecoder());
        ASSERT_EQ(AV_ERR_OK, vDecSample->SetVideoDecoderCallback());
