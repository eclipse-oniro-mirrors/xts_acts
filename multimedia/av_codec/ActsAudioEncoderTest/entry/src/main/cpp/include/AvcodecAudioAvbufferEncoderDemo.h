...
constexpr int PARAM_CHECK_CONFIGURE_CHANNEL_DEFAULT = 1;
constexpr int PARAM_CHECK_CONFIGURE_CHANNEL_ZERO = 0;
constexpr int PARAM_CHECK_CONFIGURE_CHANNEL_ONE = 1;
constexpr int PARAM_CHECK_CONFIGURE_CHANNEL_TWO = 2;
constexpr int PARAM_CHECK_CONFIGURE_CHANNEL_THREE = 3;
constexpr int PARAM_CHECK_CONFIGURE_SAMPLE_RATE_DEFAULT = 8000;
constexpr int PARAM_CHECK_CONFIGURE_SAMPLE_RATE_8K = 8000;
constexpr int PARAM_CHECK_CONFIGURE_SAMPLE_RATE_12K = 12000;
constexpr int PARAM_CHECK_CONFIGURE_SAMPLE_RATE_16K = 16000;
constexpr int PARAM_CHECK_CONFIGURE_SAMPLE_RATE_24K = 24000;
constexpr int PARAM_CHECK_CONFIGURE_SAMPLE_RATE_48K = 48000;
constexpr int PARAM_CHECK_CONFIGURE_SAMPLE_RATE_8K_LESS = 7999;
constexpr int PARAM_CHECK_CONFIGURE_SAMPLE_RATE_8K_GREATER = 8001;
constexpr int PARAM_CHECK_CONFIGURE_SAMPLE_RATE_48K_GREATER = 48001;
constexpr int PARAM_CHECK_CONFIGURE_BIT_RATE_8K = 8000;
constexpr int PARAM_CHECK_CONFIGURE_BIT_RATE_48K = 48000;
constexpr int PARAM_CHECK_CONFIGURE_COMPLEXITY_DEFAULT = 10;
constexpr int PARAM_CHECK_CONFIGURE_COMPLEXITY_ONE = 1;
constexpr int PARAM_CHECK_CONFIGURE_COMPLEXITY_TEN = 10;
constexpr int PARAM_CHECK_CONFIGURE_COMPLEXITY_ZERO = 0;
constexpr int PARAM_CHECK_CONFIGURE_COMPLEXITY_ELEVEN = 11;
constexpr int PARAM_CHECK_CONFIGURE_SAMPLE_BIT_DEFAULT = 16;
constexpr int PARAM_CHECK_PUSH_INPUT_INDEX_DEFAULT = -1;
constexpr int PARAM_CHECK_PUSH_INPUT_INDEX_EIGHT = 8;
constexpr int PARAM_CHECK_CONFIGURE_BIT_RATE_DEFAULT = 64000;
constexpr int PARAM_CHECK_CONFIGURE_BIT_RATE_6K = 6000;
constexpr int PARAM_CHECK_CONFIGURE_BIT_RATE_6K_LESS = 5999;
constexpr int PARAM_CHECK_CONFIGURE_BIT_RATE_510K = 510000;
constexpr int PARAM_CHECK_CONFIGURE_BIT_RATE_510K_GREATER = 510001;
...
public:
    ...
    **/
    ...
    int64_t bitRate, int32_t sampleFormat, int32_t sampleBit, int32_t complexity);
    OH_AVErrCode Configure(OH_AVCodec* codec, OH_AVFormat* format, int32_t channel, int32_t sampleRate,
                           int64_t bitRate, int32_t sampleFormat, int32_t syncMode);
private:
    void ClearQueue();
    int32_t CreateEnc();
