...
const char *g_video = OH_AVCODEC_MIMETYPE_VIDEO_AVC;
const char *g_audio = OH_AVCODEC_MIMETYPE_AUDIO_AAC;
...
static napi_value OH_LowPowerAudioSink_SetLoudnessGain0100(napi_env env, napi_callback_info info)
{
    ...
    const double loudnessGain = 24.0;
    OH_AVErrCode errcode = OH_LowPowerAudioSink_SetLoudnessGain(nullptr, loudnessGain);
    int32_t res = 1;
    if (errcode == AV_ERR_INVALID_VAL) {
        res = 0;
    }
...
static napi_value OH_LowPowerAudioSinkCallback_Create0100(napi_env env, napi_callback_info info)
{
    OH_LowPowerAudioSinkCallback *callback = OH_LowPowerAudioSinkCallback_Create();
    int32_t res = 1;
    if (callback == nullptr) {
...
static napi_value OH_LowPowerVideoSink_GetLatestPts0100(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
    ...
    OH_LowPowerVideoSink_OnTargetArrived onTargetArrived;
    OH_AVErrCode errcode = OH_LowPowerVideoSink_GetLatestPts(nullptr, NULL);
    int32_t res = 1;
    if (errcode == AV_ERR_INVALID_VAL) {
        res = 0;
    }
...
static napi_value OH_LowPowerAVSink_GetCapability0100(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
    ...
    OH_LowPowerAVSink_Capability *capability = OH_LowPowerAVSink_GetCapability();
    int32_t res = 1;
...
static napi_value OH_LowPowerVideoSink_CreateByMime0100(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
    ...
    const char *mime = OH_AVCODEC_MIMETYPE_AUDIO_AC3;
    OH_LowPowerVideoSink *VideoSink = OH_LowPowerVideoSink_CreateByMime(mime);
    int32_t res = 1;
...
static napi_value OH_LowPowerVideoSinkCallback_Create0100(napi_env env, napi_callback_info info)
{
...
static napi_value OH_LowPowerAudioSink_CreateByMime0100(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
    ...
    const char *mime = OH_AVCODEC_MIMETYPE_VIDEO_VC1;
    OH_LowPowerAudioSink *AudioSink = OH_LowPowerAudioSink_CreateByMime(mime);
    int32_t res = 1;
...
static napi_value OH_LowPowerAudioSink_Prepare0200(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
    ...
    OH_LowPowerVideoSink *VideoSink = OH_LowPowerVideoSink_CreateByMime(g_video);
    OH_AVFormat *Format = OH_AVFormat_Create();
    ...
    OH_LowPowerAudioSink *AudioSink = OH_LowPowerAudioSink_CreateByMime(g_audio);
...
static napi_value OH_LowPowerAudioSink_Pause0200(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
    ...
    test = OH_LowPowerAudioSink_Start(AudioSink);
    test = OH_LowPowerVideoSink_StartDecoder(VideoSink);
    test = OH_LowPowerVideoSink_StartRenderer(VideoSink);
    OH_AVErrCode errcode = OH_LowPowerAudioSink_Pause(AudioSink);
    int32_t res = 1;
    if (errcode == AV_ERR_OK) {
        res = 0;
    }
...
static napi_value OH_LowPowerAudioSink_Resume0200(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
    ...
    test = OH_LowPowerAudioSink_Prepare(AudioSink);
    test = OH_LowPowerAudioSink_Start(AudioSink);
    test = OH_LowPowerAudioSink_Pause(AudioSink);
    test = OH_LowPowerVideoSink_StartDecoder(VideoSink);
    test = OH_LowPowerVideoSink_StartRenderer(VideoSink);
...
static napi_value OH_LowPowerAudioSink_Flush0200(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
...
static napi_value OH_LowPowerAudioSink_Stop0200(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
...
static napi_value OH_LowPowerAudioSink_Reset0200(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
    ...
    test = OH_LowPowerAudioSink_Start(AudioSink);
    test = OH_LowPowerAudioSink_Pause(AudioSink);
    OH_AVErrCode errcode = OH_LowPowerAudioSink_Reset(AudioSink);
    int32_t res = 1;
    if (errcode == AV_ERR_OK) {
        res = 0;
    }
...
static napi_value OH_LowPowerAudioSink_SetVolume0200(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
    ...
    test = OH_LowPowerVideoSink_StartDecoder(VideoSink);
    test = OH_LowPowerVideoSink_StartRenderer(VideoSink);
    OH_AVErrCode errcode = OH_LowPowerAudioSink_SetVolume(AudioSink, 0.0);
    int32_t res = 1;
    if (errcode == AV_ERR_OK) {
        res = 0;
    }
...
static napi_value OH_LowPowerAudioSink_SetVolume0300(napi_env env, napi_callback_info info)
{
    if (!OH_LowPowerAVSink_GetCapability()) {
        napi_value retValue;
        napi_create_int32(env, 0, &retValue);
    ...
    test = OH_LowPowerVideoSink_StartDecoder(VideoSink);
    test = OH_LowPowerVideoSink_StartRenderer(VideoSink);
    OH_AVErrCode errcode = OH_LowPowerAudioSink_SetVolume(AudioSink, 1.0);
    int32_t res = 1;
    if (errcode == AV_ERR_OK) {
        res = 0;
    }
...
napi_property_descriptor desc[] = {
    ...
    {"OH_AVSamplesBuffer_AppendOneBuffer0100", nullptr, OH_AVSamplesBuffer_AppendOneBuffer0100, nullptr, nullptr,
     nullptr, napi_default, nullptr},
    {"OH_LowPowerAudioSink_SetLoudnessGain0100", nullptr, OH_LowPowerAudioSink_SetLoudnessGain0100, nullptr, nullptr,
     nullptr, napi_default, nullptr},
    {"OH_LowPowerAudioSinkCallback_Create0100", nullptr, OH_LowPowerAudioSinkCallback_Create0100, nullptr, nullptr,
     nullptr, napi_default, nullptr},
    {"OH_LowPowerVideoSink_GetLatestPts0100", nullptr, OH_LowPowerVideoSink_GetLatestPts0100, nullptr, nullptr,
     nullptr, napi_default, nullptr},
    {"OH_LowPowerAVSink_GetCapability0100", nullptr, OH_LowPowerAVSink_GetCapability0100, nullptr, nullptr,
     nullptr, napi_default, nullptr},
    {"OH_LowPowerVideoSink_CreateByMime0100", nullptr, OH_LowPowerVideoSink_CreateByMime0100, nullptr, nullptr,
     nullptr, napi_default, nullptr},
    {"OH_LowPowerVideoSinkCallback_Create0100", nullptr, OH_LowPowerVideoSinkCallback_Create0100, nullptr, nullptr,
     nullptr, napi_default, nullptr},
    {"OH_LowPowerAudioSink_CreateByMime0100", nullptr, OH_LowPowerAudioSink_CreateByMime0100, nullptr, nullptr,
     nullptr, napi_default, nullptr},
    {"OH_LowPowerAudioSink_Prepare0200", nullptr, OH_LowPowerAudioSink_Prepare0200, nullptr,
     nullptr, nullptr, napi_default, nullptr},
    {"OH_LowPowerAudioSink_Pause0200", nullptr, OH_LowPowerAudioSink_Pause0200, nullptr,
     nullptr, nullptr, napi_default, nullptr},
    {"OH_LowPowerAudioSink_Resume0200", nullptr, OH_LowPowerAudioSink_Resume0200, nullptr,
     nullptr, nullptr, napi_default, nullptr},
    {"OH_LowPowerAudioSink_Flush0200", nullptr, OH_LowPowerAudioSink_Flush0200, nullptr,
     nullptr, nullptr, napi_default, nullptr},
    {"OH_LowPowerAudioSink_Stop0200", nullptr, OH_LowPowerAudioSink_Stop0200, nullptr,
     nullptr, nullptr, napi_default, nullptr},
    {"OH_LowPowerAudioSink_Reset0200", nullptr, OH_LowPowerAudioSink_Reset0200, nullptr,
     nullptr, nullptr, napi_default, nullptr},
    {"OH_LowPowerAudioSink_SetVolume0200", nullptr, OH_LowPowerAudioSink_SetVolume0200, nullptr,
     nullptr, nullptr, napi_default, nullptr},
    {"OH_LowPowerAudioSink_SetVolume0300", nullptr, OH_LowPowerAudioSink_SetVolume0300, nullptr,
     nullptr, nullptr, napi_default, nullptr},
