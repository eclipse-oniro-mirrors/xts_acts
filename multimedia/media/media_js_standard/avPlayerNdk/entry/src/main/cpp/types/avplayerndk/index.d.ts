...
export const AvPlayerSetDataSource: () => number;
export const AvPlayerSetDataSourceError: () => number;
export const AvPlayerSetDataSourceErrorOne: () => number;
export const AvPlayerSetDataSourceErrorTwo: () => number;
export const AvPlayerSetDataSourceErrorThree: () => number;
