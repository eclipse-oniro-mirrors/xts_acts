...
export const testSetVideoSuperResolution:
    (fdSrc: media.AVFileDescriptor, isEnableSuperResolution: boolean, isEnable: boolean) => NdkAVPlayerResult;
export const testSetVideoSuperResolutionForStatusIdle:() => number;
export const testSetVideoSuperResolutionError: () => number;
export const testSetTargetVideoWindowSize:
    (fdSrc: media.AVFileDescriptor, width: number, height: number, isEnable: boolean) => NdkAVPlayerResult;
export const testSetTargetVideoWindowSizeErr:
    (fdSrc: media.AVFileDescriptor, width: number, height: number, isEnable: boolean) => NdkAVPlayerResult;
export const testSetTargetVideoWindowSizeError: () => number;
export const testSetTargetVideoWindowSizeForStatusIdle:() => number;
...
export const OhAVPlayerSetPlaybackRangeError: () => number;
...
export const AVMediaSourceDestroy: () => number;
export const AVMediaSourceDestroyAbnormal: () => number;
...
export const AVPlayerOnSubtitleInfoUpdate: (fd: media.AVFileDescriptor, subfd: number) => NdkAVPlayerResult;
export const testAVMediaSourceLoaderDestroy: () => number;
export const OhAVPlayerSetPlaybackRangeErr: () => number;
export const OhAVPlayerAddFDSubtitleSourceErr: () => number;
export const OhAVPlayerSelectTrackWithModeErr: () => number;
export const OhAVPlaybackStrategySetPreferHDRErr: () => number;
export const OhAVPlaySetPreferredHeightErr: () => number;
export const OhSetPreferredWidthErr: () => number;
export const OhAVPlaySetPreferredBufferDurationErr: () => number;
export const OhAVPlaybackStrategySetMutedMediaTypeErr: () => number;
export const OhAVPlaybackStrategySetPreferredAudioLanguageErr: () => number;
export const OhAVPlaySetPreferredSubtitleLanguageErr: () => number;
export const OhAVPlaybackStrategySetShowFirstFrameOnPrepareErr: () => number;
export const OhAVPlayBufferDurationForPlayingErr: () => number;
export const OhAVPlaybackStrategySetThresholdForAutoQuickPlayErr: () => number;
export const OhAVPlaybackStrategySetKeepDecodingOnMuteErr: () => number;