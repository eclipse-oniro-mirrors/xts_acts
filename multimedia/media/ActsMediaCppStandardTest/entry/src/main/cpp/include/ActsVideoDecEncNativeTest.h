...
/**
 * @file Video decode/encode test declarations (native media API).
 */
#ifndef ACTSMEDIACPPSTANDARDTEST_ACTS_VIDEO_DEC_ENC_NATIVE_TEST_H
#define ACTSMEDIACPPSTANDARDTEST_ACTS_VIDEO_DEC_ENC_NATIVE_TEST_H
...
#endif // ACTSMEDIACPPSTANDARDTEST_ACTS_VIDEO_DEC_ENC_NATIVE_TEST_H
