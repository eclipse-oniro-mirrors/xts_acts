...
#ifndef AUDIODECENC_NATIVE_SAMPLE_H
#define AUDIODECENC_NATIVE_SAMPLE_H
...
class ADecEncNativeSample : public NoCopyable {
public:
    ADecEncNativeSample() = default;
    ~ADecEncNativeSample() override;
    ...
    void SetReadPath(const char* inpPath, const uint32_t* esData, uint32_t length);
    void SetEosState(bool needSetEos);
    void SetSavePath(const char* outpPath);
    void ReRead();
    void ResetDecParam();
    void ResetEncParam();
...
#endif // AUDIODECENC_NATIVE_SAMPLE_H
