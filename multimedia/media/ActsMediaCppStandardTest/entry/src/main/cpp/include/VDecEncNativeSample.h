...
#ifndef VIDEODECENC_NATIVE_SAMPLE_H
#define VIDEODECENC_NATIVE_SAMPLE_H
...
class VDecEncNativeSample : public NoCopyable {
public:
    VDecEncNativeSample() = default;
    ~VDecEncNativeSample() override;
...
private:
    ...
    void InputFuncDec();
    bool ProcessOneInputDecFrame(uint32_t index, OH_AVMemory* buffer);
    void OutputFuncDec();
    int32_t WriteToFile();
...
#endif // VIDEODECENC_NATIVE_SAMPLE_H
