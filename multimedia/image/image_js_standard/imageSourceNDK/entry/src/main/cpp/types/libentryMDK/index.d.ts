...
export const TestGetImagePropertyShort: (fd: number, key: image.PropertyKey|image.DngPropertyKey|image.WebPPropertyKey|image.GifPropertyKey|image.HeifsPropertyKey|image.PngPropertyKey|image.JfifPropertyKey|image.TiffPropertyKey) => number;
export const TestGetImagePropertyLong: (fd: number, key: image.PropertyKey|image.DngPropertyKey|image.WebPPropertyKey|image.GifPropertyKey|image.HeifsPropertyKey|image.PngPropertyKey|image.JfifPropertyKey|image.TiffPropertyKey) => number;
export const TestGetImagePropertyDouble: (fd: number, key: image.PropertyKey|image.DngPropertyKey|image.WebPPropertyKey|image.GifPropertyKey|image.HeifsPropertyKey|image.PngPropertyKey|image.JfifPropertyKey|image.TiffPropertyKey) => number;
export const TestGetImagePropertyArraySize: (fd: number, key: image.PropertyKey|image.DngPropertyKey|image.WebPPropertyKey|image.GifPropertyKey|image.HeifsPropertyKey|image.PngPropertyKey|image.JfifPropertyKey|image.TiffPropertyKey) => number;
export const TestGetImagePropertyString: (fd: number, key: image.PropertyKey|image.DngPropertyKey|image.WebPPropertyKey|image.GifPropertyKey|image.HeifsPropertyKey|image.PngPropertyKey|image.JfifPropertyKey|image.TiffPropertyKey, size: number) => string | number;
export const TestGetImagePropertyIntArray: (fd: number, key: image.PropertyKey|image.DngPropertyKey|image.WebPPropertyKey|image.GifPropertyKey|image.HeifsPropertyKey|image.PngPropertyKey|image.JfifPropertyKey|image.TiffPropertyKey, size: number) => Array<number> | number;
export const TestGetImagePropertyDoubleArray: (fd: number, key: image.PropertyKey|image.DngPropertyKey|image.WebPPropertyKey|image.GifPropertyKey|image.HeifsPropertyKey|image.PngPropertyKey|image.JfifPropertyKey|image.TiffPropertyKey, size: number) => Array<number> | number;
export const TestGetImagePropertyBlob: (fd: number, key: image.PropertyKey|image.DngPropertyKey|image.WebPPropertyKey|image.GifPropertyKey|image.HeifsPropertyKey|image.PngPropertyKey|image.JfifPropertyKey|image.TiffPropertyKey, size: number) => ArrayBuffer | number;
...
export const TestCreateImageRawData: (fd: number) => myRawData;
export const TestCreateImageRawDataSucc: (fd: number) => number;
export const TestGetBufferFromRawDataSucc: (fd: number) => number;
export const TestDestroyImageRawDataSucc: (fd: number) => number;
export const TestDestroyImageRawDataInvalidParam: () => number;
export const TestCreateImageRawDataNullptr: () => ErrorCode;
export const TestGetBufferFromRawDataNullptr: () => ErrorCode;
export const TestGetBitsPerPixelFromRawDataNullptr: () => ErrorCode;