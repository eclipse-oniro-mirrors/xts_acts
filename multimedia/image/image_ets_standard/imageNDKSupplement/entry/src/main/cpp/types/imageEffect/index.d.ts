...
export const OhImageReceiverNativeGetSize:() => number;
export const OhInitReceiverOptionsGetCapacity:() => number;
export const OhInitReceiverOptions:() => number;
export const ImageReceiverNativeSuppTest:(a: number) => number;
export const ImageReceiverNativeGetCapacitySuppTest:(a: number) => number;
export const ComposeOptionsReleaseSuppTest:() => number;
export const OHImageNativeGetComponentTypesSupp:() => number;
export const OHPackingOptionsForSequenceGetFrameCountSupp:(a: number) => number;