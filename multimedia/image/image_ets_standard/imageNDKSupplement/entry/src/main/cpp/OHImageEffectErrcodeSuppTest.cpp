...
napi_value OHImageEffectErrorCodeSupp(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    ...
    switch (index) {
    case CASE_INDEX_1:
        number = EFFECT_ERROR_PERMISSION_DENIED;
        break;
    case CASE_INDEX_2:
        number = EFFECT_BUFFER_SIZE_NOT_MATCH;
        break;
    case CASE_INDEX_3:
        number = EFFECT_COLOR_SPACE_NOT_MATCH;
        break;
    case CASE_INDEX_4:
        number = EFFECT_INPUT_OUTPUT_NOT_MATCH;
        break;
    case CASE_INDEX_5:
        number = EFFECT_EFFECT_NUMBER_LIMITED;
        break;
    case CASE_INDEX_6:
        number = EFFECT_INPUT_OUTPUT_NOT_SUPPORTED;
        break;
    case CASE_INDEX_7:
        number = EFFECT_ALLOCATE_MEMORY_FAILED;
        break;
    default:
        break;
    }
...
napi_value OHIRNdkErrorCodeTestSupp(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_get_cb_info(env, info, &argc, args, nullptr, nullptr);
    ...
    switch (index) {
    case CASE_INDEX_1:
        number = IMAGE_RESULT_IMAGE_RESULT_BASE;
        break;
    case CASE_INDEX_2:
        number = IMAGE_RESULT_ERR_IPC;
        break;
    case CASE_INDEX_3:
        number = IMAGE_RESULT_ERR_SHAMEM_NOT_EXIST;
        break;
    case CASE_INDEX_4:
        number = IMAGE_RESULT_ERR_SHAMEM_DATA_ABNORMAL;
        break;
    case CASE_INDEX_5:
        number = IMAGE_RESULT_DECODE_ABNORMAL;
        break;
    case CASE_INDEX_6:
        number = IMAGE_RESULT_DATA_ABNORMAL;
        break;
    case CASE_INDEX_7:
        number = IMAGE_RESULT_MALLOC_ABNORMAL;
        break;
    case CASE_INDEX_8:
        number = IMAGE_RESULT_DATA_UNSUPPORT;
        break;
    case CASE_INDEX_9:
        number = IMAGE_RESULT_INIT_ABNORMAL;
        break;
    case CASE_INDEX_10:
        number = IMAGE_RESULT_TOO_LARGE;
        break;
    case CASE_INDEX_11:
        number = IMAGE_RESULT_TRANSFORM;
        break;
    case CASE_INDEX_12:
        number = IMAGE_RESULT_COLOR_CONVERT;
        break;
    case CASE_INDEX_13:
        number = IMAGE_RESULT_CROP;
        break;
    default:
        break;
    }
