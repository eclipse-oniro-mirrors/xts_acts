...
napi_value OHEffectBufferInfoGetTextureIdTest(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    ...
    switch (index) {
    case CASE_INDEX_1:
        textureId = IMAGE_EFFECT_2;
        code = OH_EffectBufferInfo_SetTextureId(bufferInfo, textureId);
