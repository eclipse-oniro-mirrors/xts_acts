...
#define CASE_INDEX_21 21
#define CASE_INDEX_22 22
#define CASE_INDEX_23 23
#define CASE_INDEX_24 24
#define CASE_INDEX_25 25
#define CASE_INDEX_26 26
#define CASE_INDEX_27 27
...
napi_value IRNdkErrCodeSupplementTest(napi_env env, napi_callback_info info)
{
    size_t argc = 1;
    ...
    switch (index) {
    case CASE_INDEX_1:
        number = IRNdkErrCode::IMAGE_RESULT_SOURCE_DATA_INCOMPLETE;
        break;
    case CASE_INDEX_2:
        number = IRNdkErrCode::IMAGE_RESULT_MISMATCHED_FORMAT;
        break;
    case CASE_INDEX_3:
        number = IRNdkErrCode::IMAGE_RESULT_UNKNOWN_FORMAT;
        break;
    case CASE_INDEX_4:
        number = IRNdkErrCode::IMAGE_RESULT_SOURCE_UNRESOLVED;
        break;
    case CASE_INDEX_5:
        number = IRNdkErrCode::IMAGE_RESULT_DECODE_FAILED;
        break;
    case CASE_INDEX_6:
        number = IRNdkErrCode::IMAGE_RESULT_PLUGIN_REGISTER_FAILED;
        break;
    case CASE_INDEX_7:
        number = IRNdkErrCode::IMAGE_RESULT_PLUGIN_CREATE_FAILED;
        break;
    case CASE_INDEX_8:
        number = IRNdkErrCode::IMAGE_RESULT_ENCODE_FAILED;
        break;
    case CASE_INDEX_9:
        number = IRNdkErrCode::IMAGE_RESULT_ADD_PIXEL_MAP_FAILED;
        break;
    case CASE_INDEX_10:
        number = IRNdkErrCode::IMAGE_RESULT_HW_DECODE_UNSUPPORT;
        break;
    case CASE_INDEX_11:
        number = IRNdkErrCode::IMAGE_RESULT_DECODE_HEAD_ABNORMAL;
        break;
    case CASE_INDEX_12:
        number = IRNdkErrCode::IMAGE_RESULT_DECODE_EXIF_UNSUPPORT;
        break;
    case CASE_INDEX_13:
        number = IRNdkErrCode::IMAGE_RESULT_PROPERTY_NOT_EXIST;
        break;
    case CASE_INDEX_14:
        number = IRNdkErrCode::IMAGE_RESULT_MEDIA_DATA_UNSUPPORT;
        break;
    case CASE_INDEX_15:
        number = IRNdkErrCode::IMAGE_RESULT_MEDIA_TOO_LARGE;
        break;
    case CASE_INDEX_16:
        number = IRNdkErrCode::IMAGE_RESULT_MEDIA_MALLOC_FAILED;
        break;
    case CASE_INDEX_17:
        number = IRNdkErrCode::IMAGE_RESULT_MEDIA_END_OF_STREAM;
        break;
    case CASE_INDEX_18:
        number = IRNdkErrCode::IMAGE_RESULT_MEDIA_IO_ABNORMAL;
        break;
    case CASE_INDEX_19:
        number = IRNdkErrCode::IMAGE_RESULT_MEDIA_MALFORMED;
        break;
    case CASE_INDEX_20:
        number = IRNdkErrCode::IMAGE_RESULT_SOURCE_DATA;
        break;
    default:
        break;
    }
