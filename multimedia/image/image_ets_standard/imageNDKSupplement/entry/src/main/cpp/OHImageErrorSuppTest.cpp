...
napi_value OHImageAlphaTypeSupp(napi_env env, napi_callback_info info)
{
    ...
    switch (index) {
    case CASE_INDEX_1:
        number = OHOS_PIXEL_MAP_ALPHA_TYPE_UNKNOWN;
        break;
    case CASE_INDEX_2:
        number = OHOS_PIXEL_MAP_ALPHA_TYPE_OPAQUE;
        break;
    case CASE_INDEX_3:
        number = OHOS_PIXEL_MAP_ALPHA_TYPE_PREMUL;
        break;
    case CASE_INDEX_4:
        number = OHOS_PIXEL_MAP_ALPHA_TYPE_UNPREMUL;
        break;
    case CASE_INDEX_5:
        number = OHOS_PIXEL_MAP_READ_ONLY;
        break;
    case CASE_INDEX_6:
        number = OHOS_PIXEL_MAP_EDITABLE;
        break;
    case CASE_INDEX_7:
        number = OHOS::Media::OHOS_PIXEL_MAP_FORMAT_NONE;
        break;
    case CASE_INDEX_8:
        number = OHOS::Media::OHOS_PIXEL_MAP_FORMAT_RGBA_8888;
        break;
    case CASE_INDEX_9:
        number = OHOS::Media::OHOS_PIXEL_MAP_FORMAT_RGB_565;
        break;
    default:
        break;
    }
...
napi_value OHImageErrorCodeSupp(napi_env env, napi_callback_info info)
{
    ...
    switch (index) {
    case CASE_INDEX_1:
        number = IMAGE_UNSUPPORTED_MIME_TYPE;
        break;
    case CASE_INDEX_2:
        number = IMAGE_UNKNOWN_MIME_TYPE;
        break;
    case CASE_INDEX_3:
        number = IMAGE_TOO_LARGE;
        break;
    case CASE_INDEX_4:
        number = IMAGE_DMA_OPERATION_FAILED;
        break;
    case CASE_INDEX_5:
        number = IMAGE_UNSUPPORTED_CONVERSION;
        break;
    case CASE_INDEX_6:
        number = IMAGE_INVALID_REGION;
        break;
    case CASE_INDEX_7:
        number = IMAGE_UNSUPPORTED_MEMORY_FORMAT;
        break;
    case CASE_INDEX_8:
        number = IMAGE_INVALID_PARAMETER;
        break;
    case CASE_INDEX_9:
        number = IMAGE_UNSUPPORTED_DATA_FORMAT;
        break;
    case CASE_INDEX_10:
        number = IMAGE_LOCK_UNLOCK_FAILED;
        break;
    case CASE_INDEX_11:
        number = IMAGE_INIT_FAILED;
        break;
    case CASE_INDEX_12:
        number = IMAGE_CREATE_PIXELMAP_FAILED;
        break;
    case CASE_INDEX_13:
        number = IMAGE_ALLOCATOR_MODE_UNSUPPORTED;
        break;
    case CASE_INDEX_14:
        number = IMAGE_SOURCE_UNSUPPORTED_MIME_TYPE;
        break;
    case CASE_INDEX_15:
        number = IMAGE_SOURCE_TOO_LARGE;
        break;
    case CASE_INDEX_16:
        number = IMAGE_DECODE_FAILED;
        break;
    case CASE_INDEX_17:
        number = IMAGE_SOURCE_ALLOC_FAILED;
        break;
    case CASE_INDEX_18:
        number = IMAGE_ENCODE_FAILED;
        break;
    default:
        break;
    }
...
napi_value OHImageScaleModeSupp(napi_env env, napi_callback_info info)
{
    ...
    switch (index) {
    case CASE_INDEX_1:
        number = OHOS::Media::OHOS_PIXEL_MAP_SCALE_MODE_FIT_TARGET_SIZE;
        break;
    case CASE_INDEX_2:
        number = OHOS::Media::OHOS_PIXEL_MAP_SCALE_MODE_CENTER_CROP;
        break;
    default:
        break;
    }
...
napi_value OHImageAuxiliaryPictureSupp(napi_env env, napi_callback_info info)
{
    ...
    switch (index) {
    case CASE_INDEX_1:
        number = AUXILIARY_PICTURE_TYPE_GAINMAP;
        break;
    case CASE_INDEX_2:
        number = AUXILIARY_PICTURE_TYPE_DEPTH_MAP;
        break;
    case CASE_INDEX_3:
        number = AUXILIARY_PICTURE_TYPE_UNREFOCUS_MAP;
        break;
    case CASE_INDEX_4:
        number = AUXILIARY_PICTURE_TYPE_LINEAR_MAP;
        break;
    case CASE_INDEX_5:
        number = AUXILIARY_PICTURE_TYPE_FRAGMENT_MAP;
        break;
    default:
        break;
    }
...
napi_value MediaLibraryErrorCode(napi_env env, napi_callback_info info)
{
    ...
    switch (index) {
    case CASE_INDEX_1:
        number = MEDIA_LIBRARY_PERMISSION_DENIED;
        break;
    case CASE_INDEX_2:
        number = MEDIA_LIBRARY_INVALID_DISPLAY_NAME;
        break;
    case CASE_INDEX_3:
        number = MEDIA_LIBRARY_INVALID_ASSET_URI;
        break;
    case CASE_INDEX_4:
        number = MEDIA_LIBRARY_INVALID_PHOTO_KEY;
        break;
    case CASE_INDEX_5:
        number = MEDIA_LIBRARY_VIDEO;
        break;
    default:
        break;
    }
