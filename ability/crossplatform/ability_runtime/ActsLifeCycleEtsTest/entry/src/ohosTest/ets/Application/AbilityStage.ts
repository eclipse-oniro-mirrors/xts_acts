  ...
  onCreate() {
    ...
    let AbilityLifecycleCallback:AbilityLifecycleCallback = {
      ...
      onAbilityDestroy(ability) {
        ...
        commonEventManager.publish('AbilityStage_onAbilityDestroy', (err, data) => {
          console.log('AbilityStage onAbilityDestroy publish succeed' + JSON.stringify(err) + JSON.stringify(data));
        });
      },
