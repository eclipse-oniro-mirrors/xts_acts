...
export default class MainAbility13 extends Ability {
  onCreate(want: Want, launchParam: AbilityConstant.LaunchParam) {
    ...
    let AbilityLifecycleCallback2: AbilityLifecycleCallback = {
      ...
      onAbilityForeground(ability) {
        ...
        commonEventManager.publish('MainAbility13_onAbilityForeground', (err, data) => {
          console.log('MainAbility13 onDestroy publish succeed' + JSON.stringify(err) + JSON.stringify(data));
        });
      },
      onAbilityBackground(ability) {
        console.log('[Demo] AbilityLifecycleCallback1 onAbilityBackground ability:'
  ...
  async onDestroy():Promise<void> {
    ...
    commonEventManager.publish('MainAbility13_onDestroy', (err, data) => {
      console.log('MainAbility13 onDestroy publish succeed' + JSON.stringify(err) + JSON.stringify(data));
    });
  }
  ...
  onForeground() {
    ...
    commonEventManager.publish('MainAbility13_onForeground', (err, data) => {
      console.log('MainAbility13 onForeground publish succeed' + JSON.stringify(err) + JSON.stringify(data));
    });
  }
