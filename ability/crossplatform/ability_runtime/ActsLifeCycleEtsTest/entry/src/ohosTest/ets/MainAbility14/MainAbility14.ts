...
export default class MainAbility14 extends Ability {
  ...
  async onDestroy():Promise<void> {
    ...
    commonEventManager.publish('MainAbility14_onDestroy', (err, data) => {
      console.log('MainAbility14 onDestroy publish succeed' + JSON.stringify(err) + JSON.stringify(data));
    });
  }
  ...
  onForeground() {
    ...
    commonEventManager.publish('MainAbility14_onForeground', (err, data) => {
      console.log('MainAbility14 onForeground publish succeed' + JSON.stringify(err) + JSON.stringify(data));
    });
  }
