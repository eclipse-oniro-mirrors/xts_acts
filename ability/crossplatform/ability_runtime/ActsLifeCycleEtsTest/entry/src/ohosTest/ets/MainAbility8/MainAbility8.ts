...
export default class MainAbility8 extends Ability {
  ...
  async onDestroy():Promise<void> {
    ...
    commonEventManager.publish('MainAbility8_onDestroy', (err, data) => {
      console.log('MainAbility8 onDestroy publish succeed' + JSON.stringify(err) + JSON.stringify(data));
    });
  }
  ...
  onForeground() {
    ...
    commonEventManager.publish('MainAbility8_onForeground', (err, data) => {
