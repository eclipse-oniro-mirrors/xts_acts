...
export default class MainAbility extends Ability {
  onCreate(want: Want, launchParam: AbilityConstant.LaunchParam) {
    ...
    let AbilityLifecycleCallback:AbilityLifecycleCallback = {
      ...
      onAbilityForeground(ability) {
        ...
        commonEventManager.publish('FeatureMainAbility_onAbilityForeground', (err, data) => {
          console.log('FeatureMainAbility onAbilityForeground publish succeed' + JSON.stringify(err) + JSON.stringify(data));
        });
  ...
  async onDestroy():Promise<void> {
    ...
    commonEventManager.publish('FeatureMainAbility_onDestroy', (err, data) => {
      console.log('FeatureMainAbility onDestroy publish succeed' + JSON.stringify(err) + JSON.stringify(data));
    });
  }
  ...
  onForeground() {
    ...
    commonEventManager.publish('FeatureMainAbility_onForeground', (err, data) => {
      console.log('FeatureMainAbility onForeground publish succeed' + JSON.stringify(err) + JSON.stringify(data));
    });
  }
