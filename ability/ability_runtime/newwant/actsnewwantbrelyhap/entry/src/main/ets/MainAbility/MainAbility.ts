...
export default class MainAbility extends Ability {
    ...
    async onForeground(): Promise<void> {
        await eventBusPlus.emit('HapB_MainAbility_onForeground_Success');
            ...
            if (globalThis.abilityWant.action === 'startHapB') {
                    globalThis.hapBAbilityContext.startAbility({
                        ...
                        await eventBusPlus.onWait('HapA_Second05_onForeground_Success').then(()=>{
                            globalThis.hapBAbilityContext.moveAbilityToBackground(); 
                        });
                    })
            }
    ...
    async onBackground(): Promise<void> {
        ...
        await eventBusPlus.emit('HapB_MainAbility_onBackground_Success');
