...
export default class CallerInfo07 extends UIAbility {
  onCreate(want, launchParam):void {
    ...
    commonEventManager.publish('ACTS_TEST_ON_CREATE_WANT', options, function () {
      hilog.info(0x0000, 'testTag', '%{public}s', 'commonEventManager CallerInfo07 publish ACTS_TEST_ON_CREATE_WANT');
    });
  }
  ...
  onForeground():void {
    ...
    commonEventManager.publish('CallerInfo07_onForeground', () => {});
  }
