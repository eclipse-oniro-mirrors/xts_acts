...
import { HuksSignVerifyDSA, HuksSignVerifyECC, HuksSignVerifyRSA, } from './utils/param/signVerify/publicSignVerifyParam';
...
async function generateKeyFunc(srcKeyAlias, HuksOptions) {
...
async function deleteKeyFunc(srcKeyAlias, HuksOptions) {
...
async function exportKeyFunc(srcKeyAlias, HuksOptions) {
    await huksCallback.exportKey(srcKeyAlias, HuksOptions)
        ...
        .catch((err) => {
            logger.log(`test exportKey err: " + ${JSON.stringify(err)}`);
            expect(null).assertFail();
        });
}

export default function SecurityHuksAccessControlJsunit() {
    describe("SecurityHuksAccessControlJsunit", function () {
        ...
        /**
         * @tc.name   Security_HUKS_AccessControl_API8_0100
         * @tc.number Security_HUKS_AccessControl_API8_0100
         * @tc.desc   Security_HUKS_AccessControl_API8_0100
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL0
         */
        it("Security_HUKS_AccessControl_API8_0100", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
            let srcKeyAlias = "Security_HUKS_AccessControl_API8_0100";
            let HuksOptions = {
        ...
        /**
         * @tc.name   Security_HUKS_AccessControl_API8_0200
         * @tc.number Security_HUKS_AccessControl_API8_0200
         * @tc.desc   Security_HUKS_AccessControl_API8_0200
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL2
         */
        it("Security_HUKS_AccessControl_API8_0200", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
            let srcKeyAlias = "Security_HUKS_AccessControl_API8_0200";
            let HuksOptions = {
                properties: new Array(
        ...
        /**
         * @tc.name   Security_HUKS_AccessControl_API8_0300
         * @tc.number Security_HUKS_AccessControl_API8_0300
         * @tc.desc   Security_HUKS_AccessControl_API8_0300
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL2
         */
        it("Security_HUKS_AccessControl_API8_0300", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
            let srcKeyAlias = "Security_HUKS_AccessControl_API8_0300";
            let HuksOptions = {
                properties: new Array(
                    HuksSignVerifyDSA.HuksKeyAlgDSA,
                    HuksSignVerifyDSA.HuksKeyRSAPurposeSINGVERIFY,
        ...
        /**
         * @tc.name   Security_HUKS_AccessControl_API8_0400
         * @tc.number Security_HUKS_AccessControl_API8_0400
         * @tc.desc   Security_HUKS_AccessControl_API8_0400
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL2
         */
        it("Security_HUKS_AccessControl_API8_0400", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
            let srcKeyAlias = "Security_HUKS_AccessControl_API8_0400";
            let HuksOptions = {
                properties: new Array(
        ...
        /**
         * @tc.name   Security_HUKS_AccessControl_API8_0500
         * @tc.number Security_HUKS_AccessControl_API8_0500
         * @tc.desc   Security_HUKS_AccessControl_API8_0500
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL2
         */
        it("Security_HUKS_AccessControl_API8_0500", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
            let srcKeyAlias = "Security_HUKS_AccessControl_API8_0500";
            let HuksOptions = {
                properties: new Array(
        ...
        /**
         * @tc.name   Security_HUKS_AccessControl_API8_0600
         * @tc.number Security_HUKS_AccessControl_API8_0600
         * @tc.desc   Security_HUKS_AccessControl_API8_0600
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL2
         */
        it("Security_HUKS_AccessControl_API8_0600", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
            let srcKeyAlias = "Security_HUKS_AccessControl_API8_0600";
            let HuksOptions = {
                properties: new Array(
                    HuksSignVerifyDSA.HuksKeyAlgDSA,
                    HuksSignVerifyDSA.HuksKeyRSAPurposeSINGVERIFY,
        ...
        /**
         * @tc.name   Security_HUKS_AccessControl_API8_0700
         * @tc.number Security_HUKS_AccessControl_API8_0700
         * @tc.desc   Security_HUKS_AccessControl_API8_0700
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL2
         */
        it("Security_HUKS_AccessControl_API8_0700", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
            let srcKeyAlias = "Security_HUKS_AccessControl_API8_0700";
            let HuksOptions = {
                properties: new Array(
                    HuksCipherAES.HuksKeyAlgAES,
                    HuksCipherAES.HuksKeyPurpose,
        ...
        /**
         * @tc.name   Security_HUKS_AccessControl_API8_0800
         * @tc.number Security_HUKS_AccessControl_API8_0800
         * @tc.desc   Security_HUKS_AccessControl_API8_0800
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL2
         */
        it("Security_HUKS_AccessControl_API8_0800", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
            let srcKeyAlias = "Security_HUKS_AccessControl_API8_0800";
            let HuksOptions = {
                properties: new Array(
        ...
        /**
         * @tc.name   Security_HUKS_AccessControl_API8_0900
         * @tc.number Security_HUKS_AccessControl_API8_0900
         * @tc.desc   Security_HUKS_AccessControl_API8_0900
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL2
         */
        it("Security_HUKS_AccessControl_API8_0900", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
            let srcKeyAlias = "Security_HUKS_AccessControl_API8_0900";
            let HuksOptions = {
                properties: new Array(
                    HuksSignVerifyDSA.HuksKeyAlgDSA,
                    HuksSignVerifyDSA.HuksKeyRSAPurposeSINGVERIFY,
        ...
        /**
         * @tc.name   Security_HUKS_AccessControl_API8_1000
         * @tc.number Security_HUKS_AccessControl_API8_1000
         * @tc.desc   Security_HUKS_AccessControl_API8_1000
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL2
         */
        it("Security_HUKS_AccessControl_API8_1000", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
            let srcKeyAlias = "Security_HUKS_AccessControl_API8_1000";
            let HuksOptions = {
                properties: new Array(
                    HuksCipherAES.HuksKeyAlgAES,
        ...
        /**
         * @tc.name   Security_HUKS_AccessControl_API8_9000
         * @tc.number Security_HUKS_AccessControl_API8_9000
         * @tc.desc   Security_HUKS_AccessControl_API8_9000
         * @tc.type   FUNCTION
         * @tc.size   MEDIUMTEST
         * @tc.level  LEVEL2
         */
        it("Security_HUKS_AccessControl_API8_9000", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL2, async function (done) {
