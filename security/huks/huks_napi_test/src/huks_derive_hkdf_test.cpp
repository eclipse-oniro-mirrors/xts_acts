...
static struct OH_Huks_Param g_hkdfFinishParams001[] = {
    ...
    {.tag = OH_HUKS_TAG_KEY_ALIAS,
     .blob = {strlen("HksHKDFDeriveKeyAliasFinalTest001"), (uint8_t *)"HksHKDFDeriveKeyAliasFinalTest001"}},
    {.tag = OH_HUKS_TAG_ALGORITHM, .uint32Param = OH_HUKS_ALG_AES},
...
/**
 * @tc.name   Security_HUKS_NAPI_Derive_hkdf_0100
 ...
 * @tc.level  LEVEL1
 */
HWTEST_F(HuksDeriveHKDFTest, Security_HUKS_NAPI_Derive_hkdf_0100, TestSize.Level1)
{
