...
static OH_Huks_Result HksEccSignVerifyTestNormalCase(struct OH_Huks_Blob keyAlias,
...
/**
 * @tc.name   SecurityHuksNapiSignVerifyEcc0100
 * @tc.number Security_HUKS_NAPI_SignVerify_ECC_0100
 * @tc.desc   alg-ECC pur-Sign
 * @tc.type   FUNCTION
 * @tc.size   MEDIUMTEST
 * @tc.level  LEVEL0
 */
int SecurityHuksNapiSignVerifyEcc0100()
{
