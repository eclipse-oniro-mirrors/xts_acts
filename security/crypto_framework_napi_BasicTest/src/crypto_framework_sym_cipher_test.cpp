...
class SYMCIPHER_AES_WRAP_TEST : public testing::TestWithParam<SymCipherSpec> {
public:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

class SYMCIPHER_CHACHA20_POLY1305_TEST : public testing::TestWithParam<SymCipherSpec> {
public:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};
...
class SYMCIPHER_CHACHA20_IV_ERROR_TEST : public testing::TestWithParam<SymCipherSpec> {
public:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};
...
SymCipherSpec g_symCipherData[] = {
    ...
    {(uint8_t *)"ChaCha20", (uint8_t *)"ChaCha20", 16, 0, 0, OH_CRYPTO_SYM_CIPHER_TEST_DATA_SIZE, true},
};

SymCipherSpec g_symAesWrapCipherData[] = {
    /* aes wrap with iv */
    {(uint8_t *)"AES128", (uint8_t *)"AES128-WRAP", 8, 0, 0, OH_CRYPTO_SYM_CIPHER_TEST_DATA_SIZE, false},
    {(uint8_t *)"AES192", (uint8_t *)"AES192-WRAP", 8, 0, 0, OH_CRYPTO_SYM_CIPHER_TEST_DATA_SIZE, false},
    {(uint8_t *)"AES256", (uint8_t *)"AES256-WRAP", 8, 0, 0, OH_CRYPTO_SYM_CIPHER_TEST_DATA_SIZE, false},
    /* aes wrap without iv */
    {(uint8_t *)"AES128", (uint8_t *)"AES128-WRAP", 0, 0, 0, OH_CRYPTO_SYM_CIPHER_TEST_DATA_SIZE, false},
    {(uint8_t *)"AES192", (uint8_t *)"AES192-WRAP", 0, 0, 0, OH_CRYPTO_SYM_CIPHER_TEST_DATA_SIZE, false},
    {(uint8_t *)"AES256", (uint8_t *)"AES256-WRAP", 0, 0, 0, OH_CRYPTO_SYM_CIPHER_TEST_DATA_SIZE, false},
};

SymCipherSpec g_symChaCha20Poly1305CipherData[] = {
    {(uint8_t *)"ChaCha20", (uint8_t *)"ChaCha20|Poly1305", 12, 16, 16, OH_CRYPTO_SYM_CIPHER_TEST_DATA_SIZE, true},
};
...
SymCipherSpec g_chaCha20IvError[] = {
    {(uint8_t *)"ChaCha20", (uint8_t *)"ChaCha20", 15, 0, 0, OH_CRYPTO_SYM_CIPHER_TEST_DATA_SIZE, true},
};
...
INSTANTIATE_TEST_CASE_P(OHCryptoFrameworkSymCipherIvErrorNapiTest, SYMCIPHER_CHACHA20_IV_ERROR_TEST, ::testing::ValuesIn(g_chaCha20IvError));
INSTANTIATE_TEST_CASE_P(OHCryptoFrameworkSymCipherNapiTest, SYMCIPHER_AES_WRAP_TEST, ::testing::ValuesIn(g_symAesWrapCipherData));
INSTANTIATE_TEST_CASE_P(OHCryptoFrameworkSymCipherNapiTest, SYMCIPHER_CHACHA20_POLY1305_TEST, ::testing::ValuesIn(g_symChaCha20Poly1305CipherData));
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_0500
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_0600
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_0700
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_0800
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_0900
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1000
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1200
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1300
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1400
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1500
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1600
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1700
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1800
 * @tc.number SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1800
 * @tc.desc   algorithm is Sym Cipher
 * @tc.type   FUNCTION
 * @tc.size   MEDIUMTEST
 * @tc.level  LEVEL0
 */
HWTEST_F(OHCryptoFrameworkSymCipherNapiTest, SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1800, TestSize.Level0)
{
    OH_CryptoSymKeyGenerator *genCtx = nullptr;
    OH_CryptoSymCipher *encCtx = nullptr;
    OH_CryptoSymKey *keyCtx = nullptr;
    ...
    ASSERT_EQ(OH_CryptoSymCipherParams_Create(&params), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipherParams_SetParam(params, CRYPTO_IV_DATABLOB, (Crypto_DataBlob *)&ivBlob), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Create((const char *)"AES256-WRAP", &encCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Init(encCtx, CRYPTO_ENCRYPT_MODE, keyCtx, params), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Final(encCtx, (Crypto_DataBlob *)&msgBlob, &outUpdate), CRYPTO_OPERTION_ERROR);
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1900
 * @tc.number SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1900
 * @tc.desc   algorithm is Sym Cipher
 * @tc.type   FUNCTION
 * @tc.size   MEDIUMTEST
 * @tc.level  LEVEL0
 */
HWTEST_F(OHCryptoFrameworkSymCipherNapiTest, SUB_Security_CryptoFramework_NAPI_SymCipher_Test_1900, TestSize.Level0)
{
    OH_CryptoSymKeyGenerator *genCtx = nullptr;
    OH_CryptoSymCipher *encCtx = nullptr;
    OH_CryptoSymKey *keyCtx = nullptr;
    ...
    ASSERT_EQ(randomObj->generateRandom(randomObj, randomLen, &msgBlob), HCF_SUCCESS);
    ASSERT_EQ(randomObj->generateRandom(randomObj, ivLen, &ivBlob), HCF_SUCCESS);
    ASSERT_EQ(OH_CryptoSymKeyGenerator_Create((const char *)"AES128", &genCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymKeyGenerator_Generate(genCtx, &keyCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipherParams_Create(&params), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipherParams_SetParam(params, CRYPTO_IV_DATABLOB, (Crypto_DataBlob *)&ivBlob), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Create((const char *)"AES128-WRAP", &encCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Init(encCtx, CRYPTO_ENCRYPT_MODE, keyCtx, params), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Final(encCtx, (Crypto_DataBlob *)&msgBlob, &outUpdate), CRYPTO_OPERTION_ERROR);
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2000
 * @tc.number SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2000
 * @tc.desc   algorithm is Sym Cipher
 * @tc.type   FUNCTION
 * @tc.size   MEDIUMTEST
 * @tc.level  LEVEL0
 */
HWTEST_F(OHCryptoFrameworkSymCipherNapiTest, SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2000, TestSize.Level0)
{
    OH_CryptoSymKeyGenerator *genCtx = nullptr;
    OH_CryptoSymCipher *decCtx = nullptr;
    OH_CryptoSymKey *keyCtx = nullptr;
    ...
    ASSERT_EQ(randomObj->generateRandom(randomObj, randomLen, &msgBlob), HCF_SUCCESS);
    ASSERT_EQ(randomObj->generateRandom(randomObj, ivLen, &ivBlob), HCF_SUCCESS);
    ASSERT_EQ(OH_CryptoSymKeyGenerator_Create((const char *)"AES192", &genCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymKeyGenerator_Generate(genCtx, &keyCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipherParams_Create(&params), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipherParams_SetParam(params, CRYPTO_IV_DATABLOB, (Crypto_DataBlob *)&ivBlob), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Create((const char *)"AES192-WRAP", &decCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Init(decCtx, CRYPTO_DECRYPT_MODE, keyCtx, params), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Final(decCtx, (Crypto_DataBlob *)&msgBlob, &decUpdate), CRYPTO_OPERTION_ERROR);
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2100
 * @tc.number SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2100
 * @tc.desc   algorithm is Sym Cipher
 * @tc.type   FUNCTION
 * @tc.size   MEDIUMTEST
 * @tc.level  LEVEL0
 */
HWTEST_F(OHCryptoFrameworkSymCipherNapiTest, SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2100, TestSize.Level0)
{
    OH_CryptoSymKeyGenerator *genCtx = nullptr;
    OH_CryptoSymCipher *decCtx = nullptr;
    OH_CryptoSymKey *keyCtx = nullptr;
    ...
    ASSERT_EQ(OH_CryptoSymCipherParams_SetParam(params, CRYPTO_IV_DATABLOB, (Crypto_DataBlob *)&ivBlob), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Create((const char *)"AES192-WRAP", &decCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Init(decCtx, CRYPTO_DECRYPT_MODE, keyCtx, params), CRYPTO_INVALID_PARAMS);
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2200
 * @tc.number SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2200
 * @tc.desc   algorithm is Sym Cipher
 * @tc.type   FUNCTION
 * @tc.size   MEDIUMTEST
 * @tc.level  LEVEL0
 */
HWTEST_F(OHCryptoFrameworkSymCipherNapiTest, SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2200, TestSize.Level0)
{
    OH_CryptoSymKeyGenerator *genCtx = nullptr;
    OH_CryptoSymCipher *encCtx = nullptr;
    OH_CryptoSymCipher *decCtx = nullptr;
    ...
    HcfBlob ivBlob = {.data = ivData, .len = sizeof(ivData)};
    HcfBlob kekBlob = {.data = kekData, .len = sizeof(kekData)};
    HcfBlob keyBlob = {.data = keyData, .len = sizeof(keyData)};
    Crypto_DataBlob outUpdate = {.data = nullptr, .len = 0};
    Crypto_DataBlob decUpdate = {.data = nullptr, .len = 0};

    ASSERT_EQ(OH_CryptoSymKeyGenerator_Create((const char *)"AES128", &genCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymKeyGenerator_Convert(genCtx, (Crypto_DataBlob *)&kekBlob, &keyCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Create((const char *)"AES128-WRAP", &encCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipherParams_Create(&params), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Init(encCtx, CRYPTO_ENCRYPT_MODE, keyCtx, params), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Final(encCtx, (Crypto_DataBlob *)&keyBlob, &outUpdate), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Create((const char *)"AES128-WRAP", &decCtx), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipherParams_SetParam(params, CRYPTO_IV_DATABLOB, (Crypto_DataBlob *)&ivBlob), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Init(decCtx, CRYPTO_DECRYPT_MODE, keyCtx, params), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Final(decCtx, &outUpdate, &decUpdate), CRYPTO_OPERTION_ERROR);
...
/**
 * @tc.name   SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2300
 * @tc.number SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2300
 * @tc.desc   algorithm is Sym Cipher
 * @tc.type   FUNCTION
 * @tc.size   MEDIUMTEST
 * @tc.level  LEVEL0
 */
HWTEST_F(OHCryptoFrameworkSymCipherNapiTest, SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2300, TestSize.Level0)
{
    OH_CryptoSymKeyGenerator *genCtx = nullptr;
    OH_CryptoSymCipher *encCtx = nullptr;
    OH_CryptoSymKey *keyCtx = nullptr;
    ...
    ASSERT_EQ(OH_CryptoSymCipherParams_Create(&params), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Init(encCtx, CRYPTO_ENCRYPT_MODE, keyCtx, params), CRYPTO_SUCCESS);
    ASSERT_EQ(OH_CryptoSymCipher_Update(encCtx, (Crypto_DataBlob *)&keyBlob, &outUpdate), CRYPTO_OPERTION_ERROR);
...
HWTEST_P(SYMCIPHER_AES_WRAP_TEST, SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2600, TestSize.Level0)
{
    SymCipherSpec symCipherData = GetParam();
    OH_CryptoSymKeyGenerator *genCtx = nullptr;
    OH_CryptoSymCipher *encCtx = nullptr;
...
HWTEST_P(SYMCIPHER_CHACHA20_POLY1305_TEST, SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2700, TestSize.Level0)
{
    SymCipherSpec symCipherAEADData = GetParam();
    OH_CryptoSymKeyGenerator *genCtx = nullptr;
    OH_CryptoSymCipher *encCtx = nullptr;
    ...
    Crypto_DataBlob decUpdate = {.data = nullptr, .len = 0};
    Crypto_DataBlob tag = {.data = nullptr, .len = 0};
    uint8_t tagArr[OH_CRYPTO_CHACHA20_POLY1305_TAG_LEN] = {0};
    Crypto_DataBlob tagInit = {.data = reinterpret_cast<uint8_t *>(tagArr), .len = OH_CRYPTO_CHACHA20_POLY1305_TAG_LEN};
...
HWTEST_P(SYMCIPHER_CHACHA20_POLY1305_TEST, SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2800, TestSize.Level0)
{
    SymCipherSpec symCipherAEADData = GetParam();
    OH_CryptoSymKeyGenerator *genCtx = nullptr;
    OH_CryptoSymCipher *encCtx = nullptr;
...
HWTEST_P(SYMCIPHER_CHACHA20_IV_ERROR_TEST, SUB_Security_CryptoFramework_NAPI_SymCipher_Test_2900, TestSize.Level0)
{
    SymCipherSpec symCipherData = GetParam();
    OH_CryptoSymKeyGenerator *genCtx = nullptr;
    OH_CryptoSymCipher *encCtx = nullptr;
    ...
    EXPECT_EQ(OH_CryptoSymCipherParams_SetParam(params, CRYPTO_IV_DATABLOB, (Crypto_DataBlob *)&ivBlob), CRYPTO_SUCCESS);
    EXPECT_EQ(OH_CryptoSymCipher_Create((const char *)symCipherData.cipherAlgName, &encCtx), CRYPTO_SUCCESS);
    EXPECT_EQ(OH_CryptoSymCipher_Init(encCtx, CRYPTO_ENCRYPT_MODE, keyCtx, params), CRYPTO_OPERTION_ERROR);
