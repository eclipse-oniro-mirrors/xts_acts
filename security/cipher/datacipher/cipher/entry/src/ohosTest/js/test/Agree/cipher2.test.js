...
describe('cipher2_test', function () {
  ...
  afterEach(function () {});
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_0100
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_0200
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_0300
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_0400
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_0500
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_0600
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_0700
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_0800
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_0900
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_1000
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_1100
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_1200
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_2300
