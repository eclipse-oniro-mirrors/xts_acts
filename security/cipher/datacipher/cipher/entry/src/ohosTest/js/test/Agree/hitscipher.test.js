...
describe('hitscipher_test', function () {
  ...
  afterEach(function () {});
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_2400
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_2500
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_2600
   ...
   /**
    * @tc.name   SUB_Security_DataPro_cipher_2700
